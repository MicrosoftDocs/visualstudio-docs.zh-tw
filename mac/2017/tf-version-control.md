...
Azure Repos 提供了兩種版本控制模型[：Git、](/azure/devops/repos/git/?view=azure-devops)分散式版本控制系統和[團隊基礎版本控制](/azure/devops/repos/tfvc/index?view=azure-devops)（TFVC），即集中式版本控制系統。
...
TFVC 延伸模組的更新會定期進行。 要訪問更新，請從功能表中選擇**Visual Studio >擴展...** 然後選擇 **"更新**"選項卡。挑選清單中的擴展，然後按 **"更新**"按鈕：
