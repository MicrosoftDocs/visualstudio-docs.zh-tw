...
ms.locfileid: "74983635"
---
# <a name="default-keyboard-shortcuts-in-visual-studio-for-mac"></a>Visual Studio for Mac 中的預設鍵盤快速鍵

如需鍵盤協助工具的相關資訊，請參閱 [如何：使用鍵盤流覽](accessibility.md#how-to-use-keyboard-navigation)。

只需使用適當的鍵盤快速鍵，您就可以在 Visual Studio for Mac 中存取各種命令。 此文件列出 **Visual Studio** 按鍵繫結關係配置的預設快速鍵。 如需如何變更按鍵繫結關係配置的相關詳細資訊，請參閱[自訂 IDE](customizing-the-ide.md#key-bindings)。 您也可以使用**Visual Studio for Mac**  >  **喜好**設定] 功能表項目，並**Environment**  >  在 [**喜好**設定] 視窗中選擇環境**金鑰**系結，來自訂命令的快捷方式。
