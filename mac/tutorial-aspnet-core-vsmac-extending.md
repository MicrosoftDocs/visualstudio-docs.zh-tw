---
title: 延伸現有的 ASP.NET Core Web 應用程式
description: 本檔包含影片教學課程，示範如何擴充 eShopOnWeb 範例 ASP.NET Core 應用程式。
...
ms.locfileid: "85949966"
---
# <a name="tutorial-extending-an-existing-aspnet-core-web-application"></a>教學課程：擴充現有的 ASP.NET Core web 應用程式

在這些教學課程中，您將使用[eShopOnWeb reference 應用程式](https://github.com/dotnet-architecture/eShopOnWeb)。 每個步驟都是由影片和教學課程檔組成。
...
## <a name="step-2-working-with-the-eshoponweb-solution"></a>步驟2：使用 eShopOnWeb 解決方案

您將瞭解如何在 Visual Studio for Mac 中使用 eShopOnWeb 解決方案。
...
您將瞭解如何將 Docker 容器新增至 eShopOnWeb 應用程式，以及如何執行和 debug docker 化應用程式。
