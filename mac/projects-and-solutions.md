---
title: "專案和方案"
description: "本文件概述 Xamarin Studio 中的專案和方案。"
author: asb3993
ms.author: amburns
ms.date: 04/14/2017
ms.topic: article
...
若要建立新的專案或方案，請參閱[建立新的專案和方案](~/create-new-projects.md)主題。

## <a name="project-and-solution-options"></a>專案和方案選項

按兩下 [專案/方案名稱]，或者按一下滑鼠右鍵並瀏覽至 [選項]，即可管理專案和方案的屬性。 [管理方案和專案屬性](~/managing-solutions-and-project-properties.md)主題提供這些選項的詳細資訊。
