---
title: 安裝 Visual Studio for Mac 的預覽或更新
...
ms.locfileid: "58856115"
---
# <a name="install-a-preview-or-update-for-visual-studio-for-mac"></a>安裝 Visual Studio for Mac 的預覽或更新

Visual Studio for Mac 的新版本正式發行之前，會先提供預覽版本。 預覽版本讓您有機會嘗試新功能並獲得最新的 Bug 修正，再將其完整納入產品中。

預覽版本會散發至 Visual Studio for Mac 作為更新，而非透過個別下載。 如[更新](update.md)一文中所述，Visual Studio for Mac 有兩個更新程式通道：[穩定] 及 [預覽]。
