...
1. 在 [方案] 視窗中，以滑鼠右鍵按一下 DockerDemoFrontEnd 專案，然後選取 [ **新增] > 新增 Docker 支援** ： ![ 新增 docker 支援]](media/docker-quickstart-3.png)
...
1. 建立之後，請移至 [方案] 視窗，以滑鼠右鍵按一下 [MyWebAPI] 專案，然後選取 [ **新增] > 新增 Docker 支援** ]。
