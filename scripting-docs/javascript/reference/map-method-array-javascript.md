---
title: map 方法 （陣列） (JavaScript) |Microsoft 文件
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24640838"
---
# <a name="map-method-array-javascript"></a>map 方法 (陣列) (JavaScript)
在陣列中的每個項目上呼叫定義的回呼函式，並傳回包含結果的陣列。  
...
## <a name="remarks"></a>備註  
 ...
 除了陣列物件之外，任何具有 `map` 屬性且具有數值索引屬性名稱的物件都可以使用 `length` 方法。  
