---
title: "Math.atan 函式 (JavaScript) |Microsoft 文件"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="mathatan-function-javascript"></a>Math.atan 函式 (JavaScript)
傳回一個數字的反正切值。  
...
## <a name="remarks"></a>備註  
 所需`number`引數是數值運算式所需的反正切值。  
  
 傳回值是的反正切值`number`引數，以弧度為單位。  
