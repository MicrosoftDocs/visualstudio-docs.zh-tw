---
title: subarray 方法 (Float64Array) |Microsoft 文件
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24639818"
---
# <a name="subarray-method-float64array"></a>subarray 方法 (Float64Array)
取得新 Float64Array 檢視[ArrayBuffer 物件](../../javascript/reference/arraybuffer-object.md)儲存為這個陣列，指定子陣列的第一個和最後一個成員。  
