---
title: "constructor 屬性 (Intl.NumberFormat) |Microsoft 文件"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intlnumberformat"></a>constructor 屬性 (Intl.NumberFormat)
指定的函式，建立格式器。  
