...
|SCRIPTSTATE_INITIALIZED|已初始化腳本，但未執行 (連接到其他物件或接收事件) 或執行任何程式碼。 藉由呼叫 [IActiveScriptParse：:P arsescripttext](../../winscript/reference/iactivescriptparse-parsescripttext.md) 方法，即可查詢程式碼以進行執行。|  
