---
title: "IJsDebugBreakPoint 介面 |Microsoft 文件"
ms.custom: 
ms.date: 01/18/2017
...
|[IJsDebugBreakPoint::GetDocumentPosition 方法](../../winscript/reference/ijsdebugbreakpoint-getdocumentposition-method.md)|傳回陳述式在繫結中斷點的位置。|  
