...
#### [SCRIPTTHREADID 常數](scriptthreadid-constants.md)
...
## [動態指令碼偵錯工具介面](active-script-debugger-interfaces.md)
...
#### [DEBUG_TEXT 常數](debug-text-constants.md)
...
#### [TEXT_DOC_ATTR 常數](text-doc-attr-constants.md)
...
### [IActiveScriptSiteDebug32 介面](iactivescriptsitedebug32-interface.md)
...
## [動態指令碼分析工具介面](active-script-profiler-interfaces.md)
...
#### [PROFILER_PROPERTY_TYPE_SUBSTRING_INFO 結構](profiler-property-type-substring-info-structure.md)
...
## [偵錯屬性介面](debug-property-interfaces.md)
...
### [IPerPropertyBrowsing2 介面 1](iperpropertybrowsing2-interface-1.md)
...
## [分派擴充功能介面](dispatch-extension-interfaces.md)
