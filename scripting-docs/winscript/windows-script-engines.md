...
|類別|描述|  
|-|-|  
|CATID_ActiveScript|表示 (Clsid) 的類別識別碼是 Windows Script engine，至少支援 ([IActiveScript](../winscript/reference/iactivescript.md) `IPersistStorage` 、 `IPersistStreamInit` 或 IPersistPropertyBag 介面) 的 IActiveScript 介面和持續性機制。|  
