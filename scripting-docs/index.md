...
ms.locfileid: "29989209"
---
# <a name="scripting-technologies"></a>指令碼技術

此頁面會提供 JavaScript、TypeScript、ECMAScript 參考文件的連結，以及可讓您使用這些語言撰寫應用程式之 Visual Studio 技術的連結。
