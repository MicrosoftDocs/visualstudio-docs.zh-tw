---
title: Visual Studio 訂用帳戶中軟體下載項目的產品可用性 |Microsoft Docs
author: evanwindom
ms.author: lank
manager: lank
...
- **產品不包含在訂用帳戶中。** 因為特殊的授權條款、技術限制或開發工具相關問題，所以某些 Microsoft 產品不包括在訂用帳戶中。 如果您想要建議將產品加入訂用帳戶中，請傳送電子郵件給您的 Visual Studio [Customer 服務中心](https://visualstudio.microsoft.com/subscriptions/support/)。
...
- **您的國家/地區無法使用此產品。** 有些 Microsoft 產品會因為區域限制而無法取得。
...
- 某些軟體下載項目可能需要產品金鑰，才能加以安裝及啟用。  如需如何取得及管理您的產品金鑰的詳細資訊，請參閱我們的[產品金鑰](product-keys.md)文章。 
