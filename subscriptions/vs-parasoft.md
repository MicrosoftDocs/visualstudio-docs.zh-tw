...
| 使用 GitHub Enterprise Visual Studio Enterprise 訂用帳戶 | Vl | 6 個月       |  Yes       |
...
<sup>1</sup>  *包括： Microsoft 合作夥伴網路 (Enterprise) 。排除：非轉售 (NFR) ，Visual Studio 產業合作夥伴 (VSIP) 、FTE、MCT Software & Services Developer、BizSpark、假想、最有價值專家 (MVP) 、區域主管 (RD) 。 MCT Software & Services，NFR Basic*
