...
如果您在 Microsoft 帳戶下有另一個**相同**訂用帳戶層級的有效 Visual Studio 訂用帳戶，則可以透過在 Visual Studio 訂用帳戶入口網站中加入[替代帳戶](/manage-vs-subscriptions#linking-my-subscription-to-existing-vsts-or-azure-subscriptions/)，將它連結到此 Azure 權益。 如果這樣沒有用，您也可以嘗試[移轉您的 Azure 權益](/azure/billing/billing-subscription-transfer/)至有效 Visual Studio 訂用帳戶。
