...
<sup>1</sup>  *包含：Microsoft Partner Network (Enterprise)。排除：其他「禁止轉售 (NFR)」、Visual Studio Industry Partner (VSIP)、FTE、MCT Software & Services Developer、BizSpark、Imagine、Microsoft Valued Professional (MVP)、Region Director (RD)、MCT Software & Services、Microsoft 合作夥伴網路 (Professional)。*
