...
在 Azure AD 中設定電子郵件網域時，不再允許使用工作/學校電子郵件地址建立新個人 Microsoft 帳戶 (MSA) 的功能。 這代表什麼？ 如果您的組織使用依賴 Azure AD 的 Microsoft 365 或其他 Microsoft 商務服務，且您已將功能變數名稱新增至您的 Azure AD 租使用者，則使用者將無法再使用網域中的電子郵件地址建立新的個人 Microsoft 帳戶。
