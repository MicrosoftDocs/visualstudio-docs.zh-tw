---
title: Visual Studio 訂用帳戶中的 CAST 醒目提示權益 |Microsoft 檔
author: evanwindom
ms.author: v-evwin
manager: lank
...
| 訂用帳戶層級                                                 |     通道                                            | 優點                                                          | 可續約？    |
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard)   | VL, Azure, 零售, | 評定5個應用程式的三個月|  不會。  僅提供給新訂閱者使用          |
| 使用 GitHub Enterprise Visual Studio Enterprise 訂用帳戶  | Vl | 評定5個應用程式的三個月|  不會。  僅提供給新訂閱者使用          |
| Visual Studio Professional (Standard) | VL, Azure, 零售                                       | 3個月評估1個應用程式                                                             |  不會。  僅提供給新訂閱者使用                  |
| 使用 GitHub Enterprise Visual Studio Professional 訂用帳戶 | Vl                                       | 3個月評估1個應用程式                                                            |  不會。  僅提供給新訂閱者使用                  |
