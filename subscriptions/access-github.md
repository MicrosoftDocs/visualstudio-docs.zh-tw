...
如果您的組織有尚未約滿的 EA，可以購買「升級」SKU，將 GitHub Enterprise 新增到您現有的 Visual Studio Enterprise 或 Visual Studio Professional 訂用帳戶。 然後，當您的協定重新創建時，您可以購買優惠。

Visual Studio Enterprise、Visual Studio Professional 與 GitHub Enterprise 的現有 SKU 也會各自繼續開放使用。 

要瞭解有關福利和選項的詳細資訊，請訪問https://visualstudio.microsoft.com/subscriptions/visual-studio-github。 
...
| 如何管理我的使用者帳戶和設定檔？       | [設置和管理 GitHub 使用者帳戶](https://help.github.com/en/categories/setting-up-and-managing-your-github-user-account)    |
| 如何管理我對 GitHub 的存取？   | [驗證到 GitHub](https://help.github.com/en/categories/authenticating-to-github)                           |
...
答：設置 GitHub 訂閱的過程可能需要一段時間。  若您已等待多時，而尚未收到任何消息，建議您與 GitHub 系統管理員連絡。  這可能是因為您的系統管理員仍在處理指派，或 決定不指派 GitHub 訂用帳戶給您。 

### <a name="q--how-do-i-reach-my-github-administrator"></a>問：如何聯繫 GitHub 管理員？
答：如果您使用的是 GitHub 企業伺服器，則可以按一下用戶端底部可見的 **"支援**"連結，以便與管理員連接。

### <a name="q-do-i-get-the-full-visual-studio-subscription-professional-or-enterprise-or-do-i-just-get-the-ide-with-this-offering"></a>問：我是否獲得完整的 Visual Studio 訂閱（專業版還是企業版），還是只獲得此產品中的 IDE？
答：除了 GitHub 企業版訂閱外，您還將收到完整的視覺化工作室訂閱。  您可獲得這些訂用帳戶中包含的所有權益，例如軟體下載、雲端服務、技術支援及合作夥伴權益，就如同單獨購買訂用帳戶。
