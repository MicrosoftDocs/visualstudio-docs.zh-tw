---
title: Visual Studio 訂用帳戶中的技術支援權益 | Microsoft Docs
author: evanwindom
ms.author: lank
manager: lank
ms.date: 08/01/2018
...
當您有問題或需要有關技術問題的協助時，有多種可用的支援資源。

> [!NOTE]
> 訂閱並不一定會包含全部的權益。  如需是否符合資格的詳細資訊，請參閱下列文章。

- [Azure 諮詢對談](vs-azure-advisory-chat.md)：即時取得使用 Azure 的協助。

- [Azure 社群](vs-azure-community.md)：透過精選論壇直接取得 Azure 小組的協助。
