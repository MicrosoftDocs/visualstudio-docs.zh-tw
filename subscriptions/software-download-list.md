...
2. 登入訂用帳戶。 (深入了解如何使用 [Microsoft 帳戶](sign-in-msa.md)、[公司或學校帳戶](sign-in-work.md)或 [GitHub](sign-in-github.md) 認證登入。)
