...
## <a name="sign-in"></a>登入
   ...
   > ![Azure DevOps 磚](_img/vs-azure-devops/vs-azure-devops-tile.png "按一下 [開始使用] 以登入 Azure DevOps。")
...
<sup>2</sup> * 基本方案包括定義發行管線和多階段持續部署 (CD) 管線，以及使用核准和閘道來控制部署;當啟用 [管線的自由存取] 預覽功能時，專案關係人會取得所有 Azure Pipelines 功能的存取權。 *
