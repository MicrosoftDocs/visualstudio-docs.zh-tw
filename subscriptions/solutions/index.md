---
title: 訂閱支援解決方案
description: 包含 Visual Studio 訂用帳戶之檔案的清單支援 widget 內容
ms.topic: conceptual
...
ms.locfileid: "100496276"
---
# <a name="visual-studio-subscriptions-support-widget-content-includes-files"></a>Visual Studio 訂閱支援 widget 內容包含檔案

## <a name="admin-solutions"></a>管理解決方案
...
## <a name="benefit-activations"></a>權益啟用
...
## <a name="download-activate-or-use-software"></a>下載、啟用或使用軟體

### <a name="downloads-and-activations"></a>下載和啟用
...
### <a name="find-and-use-product-keys"></a>尋找並使用產品金鑰
...
### <a name="use-product-features"></a>使用產品功能
...
## <a name="other-solutions-or-no-solution"></a>其他解決方案或沒有解決方案

[!INCLUDE [No solution](other-or-no-solution/includes/no-solution.md)]

## <a name="portal-issues"></a>入口網站的問題
...
## <a name="purchase-renew-or-cancel-subscriptions"></a>購買、續訂或取消訂閱

### <a name="help-with-purchases"></a>購買的協助
...
### <a name="help-with-renewals"></a>有關續約的說明
...
### <a name="help-with-canceling"></a>取消的協助
...
### <a name="order-or-purchase-status"></a>訂購或購買狀態
...
## <a name="issues-with-signing-in"></a>登入的問題 
