...
> ![從下載頁面取得金鑰](_img/product-keys/download-get-key.png "在 [資訊] 頁面上選取 [取得金鑰]，讓任何下載取得該產品的金鑰。")
...
若要匯出您的金鑰，請直接選取 [產品金鑰] 頁面最右邊的 [ **匯出所有金鑰** ] 連結。  即會建立標題為 KeysExport.xml 的 .xml 檔案，而您可以選擇開啟或儲存檔案。  您必須使用可以處理 .xml 檔案的應用程式開啟檔案。  例如，您可以使用 Excel 將檔案開啟為唯讀活頁簿。
