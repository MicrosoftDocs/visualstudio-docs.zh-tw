...
3. 若要完成此程序，您必須提供代表：
   ...
   - 您用於登入訂用帳戶的電子郵件地址
   - 您的電話號碼
   - 訂用帳戶識別碼；您可在[訂用帳戶](https://my.visualstudio.com/subscriptions)索引標籤上找到。

   > [!div class="mx-imgBorder"]
   > ![技術支援權益尋找訂用帳戶識別碼](_img/vs-tech-support/vs-tech-support-subID-cropped.png)

4. 程序完成之後，您會收到一封電子郵件，其中含有您建立支援事件時會用到的**合約識別碼**和**存取識別碼**。 
...
線上提交事件時，系統會先提示您登入。 使用下拉式清單，選取您需要協助的產品。 例如，若要提交 Visual Studio Enterprise 2017 事件，請選取 [開發人員工具] 系列，再選取 [Visual Studio 2017] 產品，然後選擇 [Visual Studio Enterprise 2017] 版本。
