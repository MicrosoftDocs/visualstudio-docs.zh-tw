...
> [!NOTE]
> [下載](https://my.visualstudio.com/downloads/featured)頁面只會顯示您的訂用帳戶所包含的下載。  如果您有多個訂用帳戶或方案成員資格，就會顯示您持有的**最高訂用帳戶**的下載，即使您目前使用不同的訂用帳戶檢視。  例如，如果您有一個視覺化工作室企業版訂閱和一個與同一登入識別碼 關聯的 Visual Studio 專業版訂閱，則顯示的下載將是企業版訂閱中包含的下載，即使您當前正在查看您的專業訂閱權益。

> [!NOTE]
> 我們知道 Office 365 產品金鑰的可用性問題。  我們正在調查原因，並將在問題解決時更新本文。 
...
要瞭解有關查找、申領和匯出產品金鑰的詳細資訊，請查看我們的產品金鑰文檔：
