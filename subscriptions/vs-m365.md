---
title: Visual Studio 訂用帳戶中 Microsoft 365 開發人員訂閱 |Microsoft 檔
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
<sup>1</sup>  *包括：非轉售 (NFR) 、Visual Studio 產業合作夥伴 (VSIP) 、FTE、BizSpark、MCT Software & Services Developer。排除： MCT Software & Services、Microsoft 合作夥伴網路 (MPN) 、假想、最有價值專家 (MVP) 、區域主管 (RD) 、NFR Basic。*
