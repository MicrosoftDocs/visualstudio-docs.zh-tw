---
title: "Power BI Pro 權益"
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 10/3/2017
Ms.topic: Get-Started-Article
Description: "了解如何啟用隨附於 Visual Studio 訂用帳戶的 Power BI Pro 訂用帳戶。"
...
---
# <a name="activating-the-power-bi-pro-benefit-in-visual-studio-subscriptions"></a>啟用 Visual Studio 訂用帳戶的 Power BI Pro 權益

開發、測試及部署 Office 和 SharePoint 增益集。  包括一個租用戶的 SharePoint Online 開發人員網站。 

若要使用 Power BI Pro，您必須設定帳戶，或使用現有的帳戶登入。 
1.  按一下權益磚底部的 [取得程式碼] 連結。   您會收到已順利擷取代碼的通知。  按一下 [啟動]。 
...
![Power BI Pro 權益付款](_img\vs-pbi\vs-pbi-payment-blurred-cropped.png)
