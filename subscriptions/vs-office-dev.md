...
5.  下一個步驟是建立帳戶。  提供您的連絡資訊，然後按一下 [下一步]。
    > [!div class="mx-imgBorder"]
    > ![Office 365 開發人員權益帳戶](_img\vs-office-dev\vs-office-dev-account-cropped.png)

6.  提供有關您將在何處使用訂用帳戶的必要資訊，然後按一下 [下一步]。  此資訊用來判斷訂用帳戶的可用性和任何適用的稅金。
    > [!div class="mx-imgBorder"]
    > ![Office 365 開發人員權益連絡資訊](_img\vs-office-dev\vs-office-dev-contact-cropped.png)

7.  為您的帳戶建立使用者名稱和密碼。
    > [!div class="mx-imgBorder"]
    > ![Office 365 開發人員權益使用者名稱](_img\vs-office-dev\vs-office-dev-username-cropped.png)
...
10. 下一頁將確認您的訂用帳戶為免費提供。  按 [下一步]  以繼續。
    > [!div class="mx-imgBorder"]
    > ![Office 365 開發人員權益此作業外觀](_img\vs-office-dev\vs-office-dev-price.png)
...
12. 此時，您已成功兌換 Office 365 開發人員訂用帳戶權益。  您會看到一個用來確認訂單的頁面。  此頁面會提供[登入頁面](https://portal.office.com "Office 365 登入頁面")的連結。  建議您在此頁面插入書籤以供稍後使用。  您還需要記錄此頁面上顯示的使用者識別碼。  (設定帳戶時所提供的電子郵件地址也會收到歡迎電子郵件。)按一下 [啟動安裝程式] 以繼續。
    > [!div class="mx-imgBorder"]
    > ![Office 365 開發人員權益已確認訂單](_img\vs-office-dev\vs-office-dev-confirm.png)
...
2. 按一下 [啟動安裝程式] 之後，「步驟 1」會要求連線到您所擁有的現有網域，或繼續使用兌換程序期間的租用戶設定。  在下列範例中，我們選擇繼續使用 appsbyjane2017.onmicrosoft.com 網域。
    > [!div class="mx-imgBorder"]
    > ![Office 365 開發人員權益管理中心](_img\vs-office-dev\vs-office-dev-admin-cropped.png)
...
5.  選擇您慣用的語言，然後按一下 [安裝]。
    > [!div class="mx-imgBorder"]
    > ![Office 365 開發人員權益安裝應用程式](_img\vs-office-dev\vs-office-dev-install-cropped.png)
