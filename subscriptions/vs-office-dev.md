...
Visual Studio Enterprise 標準或 Visual Studio Enterprise 年度雲端訂閱的訂閱者可享有 Office 365 開發人員訂用帳戶權益。  Office 365 開發人員訂用帳戶可讓訂閱者開發、測試及部署適用於 Microsoft Office 和 Microsoft SharePoint 的增益集。  這項權益可提供給一個租用戶及最多 25 名使用者。
...
1. 請前往 [https://my.visualstudio.com](https://my.visualstudio.com) 以登入訂閱者入口網站。
