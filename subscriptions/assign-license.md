...
2. 若要將授權指派給單一 Visual Studio 訂閱者，請在資料表的頂端選取 [ **新增**]，然後選擇 [ **個別訂閱者**]。
   ...
   > ![新增一位訂閱者](_img/assign-license-add/add-subscriber-individual.png "選取 [新增]，然後選擇 [個別訂閱者] 來指派單一訂用帳戶。")
3. 將資訊輸入至新訂閱者的表單欄位。 如果您的組織使用 Azure Active Directory，[名稱]**** 欄位會作為搜尋功能來尋找您目前目錄中的人員，如此您就可以從搜尋結果中選取正確的使用者。 選取該人員之後，會自動填入登入電子郵件和通知電子郵件。
   ...
   > [!div class="mx-imgBorder"]
   > ![可下載下載] (media/access-to-downloads.png "選擇 [允許] 以提供訂閱者軟體下載的存取權。」) 
   ...
   > [!div class="mx-imgBorder"]
   > ![選擇 [新增] 按鈕](media/add-button.png "選取 [新增] 以儲存資訊，並將訂閱指派給訂閱者。")

## <a name="resend-assignment-emails"></a>重新傳送指派電子郵件
新增訂閱者之後，系統會將指派電子郵件自動傳送給新的訂閱者，並提供進一步的指示。 您可以選取 [訂閱者]，然後選取頂端功能表中的 [ **重新** 傳送] 按鈕，隨時重新傳送指派電子郵件。  若要重新傳送電子郵件給多個使用者，請在選取訂閱者時按住 **Ctrl** 鍵。  當您選取 [ **重新** 傳送] 按鈕時，您會看到對話方塊，要求您確認是否要重新傳送給那些訂閱者。  
