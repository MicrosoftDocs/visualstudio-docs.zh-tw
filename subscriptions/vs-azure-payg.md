...
1. 要使用 Azure 即用即付訂閱權益,[https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs)請登入 並按一下福利磁貼底部的 **「啟動」** 連結。
   > [!div class="mx-imgBorder"]
   > ![Azure PAYG 磚](_img/vs-azure-payg/vs-azure-payg-tile.png)

2. 如果已啟動 Azure 帳戶作為訂閱權益的一部分(例如,如果您有企業版訂閱並啟動每月 150 美元的 Azure DevTest 個人信用額度),請跳到步驟 5。
...
### <a name="q--what-if-i-want-to-make-changes-to-this-subscription"></a>問:如果我想更改此訂閱,該怎麼辦?
答:要更改任何 Azure 訂閱:
...
許多訂閱包括與 Azure 相關的其他好處,如 Azure DevOps 和 Azure DevTest 個人信用。  如需有關這些權益的詳細資訊，請參閱：
