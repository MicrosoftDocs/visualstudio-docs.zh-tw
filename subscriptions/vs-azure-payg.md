...
ms.locfileid: "68681149"
---
# <a name="azure-devtest-pay-as-you-go-subscriptions"></a>Azure 開發/測試隨用隨付訂用帳戶
...
許多訂用帳戶包含額外的 Azure 相關權益，例如 Azure DevOps 和 Azure 點數。  如需有關這些權益的詳細資訊，請參閱：
