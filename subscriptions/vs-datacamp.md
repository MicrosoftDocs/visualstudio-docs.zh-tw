...
---
# <a name="the-datacamp-training-benefit-in-visual-studio-subscriptions"></a>Visual Studio 訂用帳戶的 DataCamp 訓練課程權益
...
| 訂用帳戶等級/方案                                                  | 優勢               | 可續約？                                                         |
|-------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------|
| Visual Studio Enterprise Standard                                             | 3 個月              |  否。 僅提供給新訂閱者使用。                            |
| Visual Studio Enterprise 年度                                               | 3 個月              |  否。 僅提供給新訂閱者使用。                            |
| Visual Studio Enterprise 每月                                              | 無法使用         |                                                                    |
| Visual Studio Professional Standard                                           | 3 個月              |  否。 僅提供給新訂閱者使用。                            |
| Visual Studio Professional 年度                                             | 3 個月              |  否。 僅提供給新訂閱者使用。                            | 
| Visual Studio Professional 每月                                            | 無法使用         |                                                                    |
| Visual Studio Test Pro                                                        | 3 個月              |  否。 僅提供給新訂閱者使用。                            |
| MSDN 平台                                                                | 3 個月              |  否。 僅提供給新訂閱者使用。                            |
| Visual Studio Dev Essentials                                                  | 2 個月              |  否。 僅提供給新訂閱者使用。                            |
...
您可以隨時停止，並在下一個工作階段繼續訓練。  只要前往 [http://www.datacamp.com](http://www.datacamp.com) 並登入即可。  您會看到儀表板，並可以直接從暫停的地方繼續訓練。 只要按一下 [Continue Track] (繼續路徑) 即可。![DataCamp 繼續訓練](_img\vs-datacamp\vs-datacamp-continue-training.png)
