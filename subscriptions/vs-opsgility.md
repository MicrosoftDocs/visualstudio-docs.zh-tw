---
title: Visual Studio 訂用帳戶的 Skill Me Up - Powered by Opsgility 權益 | Microsoft Docs
author: evanwindom
ms.author: lank
manager: lank
ms.date: 10/02/2018
...
選取的 Visual Studio 訂用帳戶包含長達六個月的專家、隨選訓練課程存取權，可存取即時實驗室環境和認證學習路徑。
...
| 訂用帳戶層級                                                 |     通道                                            | 優勢                                                          | 可續約？    |
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (標準、年度雲端)   | VL、Azure、零售 | 6 個月       |  否。  僅提供給新訂閱者使用          |
