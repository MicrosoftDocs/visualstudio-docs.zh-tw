...
#### [啟用零售訂閱](activate-store-subscriptions.md)
#### [登入](signing-in.md)
##### [替代身分識別](vs-alternate-identity.md)
##### [使用別名登入](aliasing.md)
...
#### [退出 Visual Studio Dev Essentials](leave-vsde.md)
...
#### [Visual Studio 應用程式中心](vs-visual-studio-app-center.md)
...
#### [Xamarin University 訓練](vs-xamarin.md)
...
## 取得 Visual Studio 訂閱
### [比較訂閱選項](https://visualstudio.microsoft.com/vs/pricing)
### 購買雲端訂閱
#### [總覽](vscloud-overview.md)
