...
3. 在 [ **Azure 服務**] 底下，選擇 [**成本管理 + 帳單**]。
   ...
   > ![選擇 [Azure 服務] 下的 [成本管理 + 帳單]](_img/cloud-admin/azure-cost-billing.png "從 [Azure 服務] 群組中選擇 [成本管理]")
...
9. 在使用者清單中，向下捲動至您想要設為系統管理員的使用者，並加以選取。 
   > [!div class="mx-imgBorder"]
   > ![選擇角色、使用者存取管理員](_img/cloud-admin/add-role-user-access-admin.png "選擇 [角色]，選取 [使用者存取系統管理員]，然後選取使用者的名稱，使其成為系統管理員。")
10. 按一下 [檔案] 。
