...
| 訂用帳戶層級                                                 |     通道                                            | 優點                                                          | 可續約？    |
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard)   | VL, Azure, 零售, 選取的 NFR<sup>1</sup> | 6 個月       |  不可以。  僅提供給新訂閱者使用          |
| 含 GitHub Enterprise 的 Visual Studio Enterprise   | Vl | 6 個月       |  不可以。  僅提供給新訂閱者使用          |
...
<sup>1</sup>  *包括：非轉售 (NFR) ，Visual Studio 產業合作夥伴 (VSIP) 。 排除： Microsoft 合作夥伴網路 (MPN) 、FTE、MCT Software & Services Developer、BizSpark、假想、最有價值專家 (MVP) 、區域主管 (RD) 。 MCT 軟體 & 服務。*
