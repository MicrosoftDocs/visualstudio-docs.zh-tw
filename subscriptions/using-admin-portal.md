...
ms.locfileid: "80233170"
---
# <a name="overview-of-the-visual-studio-subscriptions-administrator-portal"></a>視覺化工作室訂閱管理員門戶概述
...
要查看有關組織中為每個協定購買、分配和仍然可用的訂閱許可證數量的其他資訊，請按一下頂部圖示以啟用滑出面板。
> [!div class="mx-imgBorder"]
> ![Visual Studio 訂用帳戶管理入口網站訂閱者頁面](_img/using-admin-portal/subscribers-page.png)

## <a name="the-details-page"></a>詳細資料頁面
有關您正在查看的協定的詳細資訊，請選擇第二個圖示以查看"協定詳細資訊"選項卡。幻燈片顯示協定狀態、購買帳戶、組織詳細資訊、超級管理員和其他相關資訊。
> [!div class="mx-imgBorder"]
