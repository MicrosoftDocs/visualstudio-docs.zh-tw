...
資料來源可在 [資料來源] 視窗中以項目形式用於專案。 表單設計介面是在專案中，使用中的視窗或您可以選擇來開啟它 （開啟專案時） 時，會顯示此視窗**檢視** > **其他 Windows**  >  **資料來源**。 您可以從建立控制項繫結至基礎資料，這個視窗拖曳項目，您也可以設定資料來源，以滑鼠右鍵按一下。
