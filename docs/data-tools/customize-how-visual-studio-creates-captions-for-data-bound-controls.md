...
您可以在**HKEY_CURRENT_USER \software\microsoft\visualstudio\15.0\data** designer 登錄機碼中設定**SmartCaptionExpression**、 **SmartCaptionReplacement**和**SmartCaptionSuffix**值，以自訂建立這些標籤的方式。

::: moniker-end

::: moniker range=">=vs-2019"

您可以在**HKEY_CURRENT_USER \software\microsoft\visualstudio\16.0\data** designer 登錄機碼中設定**SmartCaptionExpression**、 **SmartCaptionReplacement**和**SmartCaptionSuffix**值，以自訂建立這些標籤的方式。
