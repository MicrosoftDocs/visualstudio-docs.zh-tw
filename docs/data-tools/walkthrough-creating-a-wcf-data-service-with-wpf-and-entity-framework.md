---
title: 使用 WPF 和 Entity Framework 建立 WCF 資料服務
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
6. 在 [方案總管]  中，開啟 **NorthwindCustomers.svc** 檔案的捷徑功能表，然後選擇 [在瀏覽器中檢視]  。 Internet Explorer 會開啟，並顯示服務的 XML 結構描述。
