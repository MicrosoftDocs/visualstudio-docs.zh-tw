...
2.  [定義圖層以代表主要功能區域或元件](#CreateLayers)應用程式。 根據這些圖層的功能，例如「簡報」或「服務」來為圖層命名。 如果您有[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]解決方案中，您可以將每個圖層關聯的集合*成品*，例如專案、 命名空間、 檔案等等。
