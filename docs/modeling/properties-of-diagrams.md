...
|將填滿色彩公開為屬性|如果為 `True` ，則使用者可以設定產生之設計工具的圖表填滿色彩。 若要設定此屬性，請以滑鼠右鍵按一下 [圖表] 圖形，然後按一下 [ **新增公開**]。|False|
|將文字色彩公開為屬性|如果為 `True` ，則使用者可以在產生的設計工具中設定圖表的文字色彩。 若要設定此屬性，請以滑鼠右鍵按一下 [圖表] 圖形，然後按一下 [ **新增公開**]。|False|
