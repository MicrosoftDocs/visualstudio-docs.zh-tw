...
## <a name="changing-the-tab-icon"></a>變更 Tab 圖示
 若要變更瀏覽器的索引標籤圖示，請在 .bmp 檔案中使用16x16 圖元的圖示。 將圖示檔放在 [\DslPackage\Resources\] 資料夾中，然後將檔案名變更為 **ModelExplorerToolWindowBitmaps.bmp**。 例如，您可以將 Visual Studio 安裝 .ico 圖示檔變更為 .bmp 格式，然後將它重新命名為 **DSLLanguageName\DslPackage\Resources\ModelExplorerToolWindowBitmaps.bmp**。 當您在瀏覽器的索引標籤上停駐在 **方案總管** 一起時，產生的設計工具會在您的瀏覽器上顯示此圖示。
