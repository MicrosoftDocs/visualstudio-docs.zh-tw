...
##  <a name="shapeTypes"></a>基本類型的圖形和連接器  
 DSL 圖表顯示的集合*圖形*互連透過線路或*連接器*。  一般而言 (但並非絕對)：  
...
|圖形類型|描述|  
|----------------|-----------------|  
|幾何圖形|一般用途的矩形或橢圓形。 您可以在相對於圖形邊界的特定位置，顯示文字和圖示裝飾項目。<br /><br /> 若要建立巢狀圖形幾何形狀內部，請參閱[巢狀圖形](../modeling/nesting-shapes.md)。|  
...
##  <a name="shapeInheritance"></a>繼承圖形  
