...
4.  在 **選取的組件**清單中，選擇自訂組件。  
    ...
    > [!NOTE]  
    >  組件才會出現在**指派參考組件 Lobsystem**對話方塊中，如果您已新增至專案，其中包含組件的參考。 如需詳細資訊，請參閱[＜How to：新增或移除參考使用加入參考對話方塊](https://msdn.microsoft.com/3bd75d61-f00c-47c0-86a2-dd1f20e231c9)。  
  
5.  在 **參考屬性**群組中，開啟清單中所顯示**LobSystem 範圍**屬性，選擇 LOB 系統的方法，使用自訂的組件，然後選擇  **確定**  按鈕。  
  
    > [!NOTE]  
    >  偵錯自訂組件中的程式碼，您必須新增至方案套件的組件。 如需詳細資訊，請參閱[＜How to：新增和移除其他組件](../sharepoint/how-to-add-and-remove-additional-assemblies.md)。  
