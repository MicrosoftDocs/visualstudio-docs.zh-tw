---
title: URL 選擇器對話方塊 （SharePoint 程式開發）
ms.date: 02/02/2017
ms.topic: conceptual
f1_keywords:
 ...
 **專案資料夾**會顯示一份定義專案中，或在執行 SharePoint 的本機伺服器上的資料夾。 選擇展開按鈕顯示子資料夾。
...
- 在 SharePoint 內容資料庫中找不到檔案。
  ...
  **資料夾的內容**顯示選取的資料夾中的檔案清單。 選擇檔案，然後選擇**確定**按鈕以關閉對話方塊，並將您選擇傳送至呼叫它的處理序。

  **檔案類型**可讓您選擇從一份適用於您正在執行工作的檔案。
