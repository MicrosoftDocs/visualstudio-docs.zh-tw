...
## <a name="create-an-association"></a>建立關聯
 選擇 建立關聯**關聯**Visual Studio 中的控制**工具箱**，選擇第一個實體 （稱為來源實體），然後選擇 第二個實體 (稱為目的地實體）。 您可以定義中的關聯的詳細資料**關聯編輯器**。 如需詳細資訊，請參閱[如何：建立實體之間的關聯](../sharepoint/how-to-create-an-association-between-entities.md)。
