...
- <xref:System.IServiceProvider.GetService%2A>方法的 managed VSPackage，衍生自<xref:Microsoft.VisualStudio.Shell.Package>類別。 如需詳細資訊，請參閱[如何：取得服務](../extensibility/how-to-get-a-service.md)。
