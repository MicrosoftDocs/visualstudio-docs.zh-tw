...
6. 在 [ *VisualWebPart1*] 下，開啟適用于) 的 *VisualWebPart1* [!INCLUDE[csprcs](../sharepoint/includes/csprcs-md.md)] 或 (*VisualWebPart1* 的 ([!INCLUDE[vbprvb](../sharepoint/includes/vbprvb-md.md)] ，然後加入下列) 程式碼：
