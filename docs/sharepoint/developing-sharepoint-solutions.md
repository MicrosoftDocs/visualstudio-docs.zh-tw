...
|複製到輸出目錄|指定是否要將原始程式檔複製到輸出目錄。 可為下列其中一個值：<br /><br /> -   不*複製*<br />-   *一律複製*<br />*如果有更新*，-   複製<br /><br /> 如需詳細資訊，請參閱 [檔案屬性](/previous-versions/visualstudio/visual-studio-2010/0c6xyb66\(v\=vs.100\))。|
...
|部署路徑|SharePoint 伺服器檔案上檔案的相對路徑，例如 Workflow1.xaml\\。 將 *Deployment Path* 值串連至 *Deployment Root* 值的結尾，即可建立檔案的完整路徑。<br /><br /> 針對 [*部署類型*] 屬性選取*RootFile*的值，會將 [*部署根*] 屬性變更為 \<SharePointRoot >\\，產生 \<SharePointRoot > \Workflow1 的完整路徑\\. 如需詳細資訊，請參閱[封裝和部署 SharePoint 方案](../sharepoint/packaging-and-deploying-sharepoint-solutions.md)。|
|Deployment Root|字串。 在 SharePoint 伺服器部署檔案的根資料夾。 例如，\<SharePointRoot > \Template\Features\\\<功能 >\\。<br /><br /> *Deployment Root* 屬性值是依據 *Deployment Type* 設定而定。|
|RootFile|檔案的部署類型會決定其 *Deployment Root* 值。 可為下列其中一個值：<br /><br /> NoDeployment： *\<沒有值 >*<br /><br /> ElementManifest： *\<SharePointRoot > \Template\Features\\\<功能 >* \\<br /><br /> ElementFile： *\<SharePointRoot > \Template\Features\\\<功能 >\\*<br /><br /> TemplateFile： *\<SharePointRoot > \Template\\*<br /><br /> RootFile： *\<SharePointRoot >\\*<br /><br /> GlobalResource： *\<SharePointRoot > \Resources\\*<br /><br /> ClassResource： *\<ClassResourcePath >\\*<br /><br /> 如需詳細資訊，請參閱<xref:Microsoft.VisualStudio.SharePoint.DeploymentType>。|
|檔案名稱|項目檔案的檔案或資料夾名稱。|
|完整路徑|項目檔案的位置。 (唯讀)。|
...
- [開始&#40;在 Visual Studio 中進行 SharePoint 開發&#41;](../sharepoint/getting-started-sharepoint-development-in-visual-studio.md)
