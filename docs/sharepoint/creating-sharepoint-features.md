...
|範圍|必要。 如果功能是使用 **方案總管**所建立，則範圍預設會設定為 Web。<br /><br /> -Farm：啟動整個伺服器陣列的功能。<br /><br /> -Site：為網站集合中的所有網站啟動功能。<br /><br /> -Web：啟動特定網站的功能。<br /><br /> -WebApplication：啟用 web 應用程式中所有網站的功能。|
