...
|[使用自動程式碼 UI 測試來測試 SharePoint 2010 應用程式](../vs-2015/test/testing-sharepoint-2010-applications-with-coded-ui-tests.md?view=vs-2015&preserve-view=true)|說明如何測試 SharePoint 應用程式的使用者介面。|
