...
### <a name="localize-features"></a>當地語系化功能
 若要當地語系化功能，您必須參考已轉譯的標題和字串在當地語系化的資源檔中的運算式中取代的硬式編碼的標題和描述的功能。 您進行這項變更**功能設計工具**在[!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)]。 如需詳細資訊，請參閱[如何：當地語系化功能](../sharepoint/how-to-localize-a-feature.md)。
