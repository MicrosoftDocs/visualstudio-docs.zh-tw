...
#### <a name="to-create-an-empty-sharepoint-project"></a>若要建立空白的 SharePoint 專案  
...
#### <a name="to-add-a-web-part-to-the-project"></a>將 Web 組件加入至專案  
...
#### <a name="to-render-content-in-the-web-part"></a>以呈現 Web 組件中的內容  
...
#### <a name="to-test-the-web-part"></a>若要測試 Web 組件  
...
#### <a name="to-test-the-custom-property"></a>若要測試的自訂屬性  
...
#### <a name="to-test-the-web-part-verb"></a>若要測試的 Web 組件動詞命令  
