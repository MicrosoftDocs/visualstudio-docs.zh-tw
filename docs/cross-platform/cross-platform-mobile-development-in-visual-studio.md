...
|[使用 Xamarin 應用程式進行 DevOps](../cross-platform/application-lifecycle-management-alm-with-xamarin-apps.md) |
...
## <a name="build-a-cross-platform-game-for-android-ios-and-windows-by-using-visual-studio-tools-for-unity"></a>使用 Visual Studio Tools for Unity 建置 Android、iOS 和 Windows 的跨平台遊戲
 ...
 ![VSTU 開發環境](../cross-platform/media/vstu_overview.png "Visual Studio Tools for Unity 概觀")
...
|[了解 Visual Studio Tools for Unity 2.0 Preview 的最新增強功能](https://blogs.msdn.microsoft.com/visualstudio/2014/12/03/visual-studio-tools-for-unity-2-0-preview/) (Visual Studio 部落格)|
...
- [將 Office 365 API 新增至 Visual Studio 專案](https://docs.microsoft.com/office/developer-program/office-365-developer-program)
