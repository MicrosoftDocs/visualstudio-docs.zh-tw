...
description: 瞭解適用于 Android 的 Visual Studio 模擬器是可模擬 Android 裝置的桌面應用程式。
...
ms.locfileid: "91878900"
---
# <a name="visual-studio-emulator-for-android"></a>Visual Studio Emulator for Android

適用于 Android 的 Visual Studio 模擬器是用來模擬 Android 裝置的桌面應用程式。 它已在 Visual Studio 2015 中淘汰，Visual Studio 2017 或 Visual Studio 2019 中不支援此功能。 建議您改為使用 Google Android 模擬器。 若要查看 Visual Studio 2015 的適用于 Android 的 Visual Studio 模擬器指示，請選擇檔版本選取器中的 Visual Studio 2015。
