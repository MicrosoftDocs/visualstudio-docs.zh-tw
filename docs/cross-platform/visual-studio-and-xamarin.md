...
您可以透過[任何版本的 Visual Studio 2017](https://visualstudio.microsoft.com/vs) (Community、Professional 及 Enterprise) 來使用所有的 Xamarin 功能。 不需要個別的授權。
