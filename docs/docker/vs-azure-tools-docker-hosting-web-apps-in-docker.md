...
4. 在 [建立新的 Azure Container Registry] 中填入您想要的值。
    ...
    ![Visual Studio 的 [建立 Azure Container Registry] 對話方塊](media/vs-azure-tools-docker-hosting-web-apps-in-docker/vs-acr-provisioning-dialog.png)
