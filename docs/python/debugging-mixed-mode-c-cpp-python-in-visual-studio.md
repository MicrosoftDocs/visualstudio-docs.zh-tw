...
|   |   |
|---|---|
| ![影片的電影攝影機圖示](../install/media/video-icon.png "請觀賞影片") | 如需使用 Visual Studio 建置、測試原生 C 模組並進行偵錯的簡介，請參閱 [Deep Dive: Create Native Modules](https://youtu.be/D9RlT06a1EI) (深入探討︰建立原生模組) (youtube.com，9 分 09 秒)。 本影片適用於 Visual Studio 2015 和 Visual Studio 2017。 |
