...
1. 下載並執行最新的 Visual Studio 安裝程式。 如果您已經安裝 Visual Studio，請執行 Visual Studio 安裝程式、選取 [修改]**** 選項 (請參閱[修改 Visual Studio](../install/modify-visual-studio.md)) 並移至步驟 2。
    ...
    > [安裝視覺工作室 2019 社區](https://visualstudio.microsoft.com/thank-you-downloading-visual-studio/?sku=Community&rel=15&rid=34347&utm_source=docs&utm_medium=clickbutton&utm_campaign=python_gettingstarted)
...
1. 在安裝程式右側，視需要選擇其他選項。 跳過此步驟，以接受預設選項。
    ...
    | **Azure 雲端服務核心工具** | 提供 Python 中 Azure Cloud Services 之開發人員的其他支援。 請參閱[Azure 雲服務專案](python-azure-cloud-service-project-template.md)。 |
    ::: moniker-end
...
1. 安裝之後，安裝程式會提供選項來修改、啟動、修復或解除安裝 Visual Studio。 任何已安裝元件有 Visual Studio 的更新時，[修改]**** 按鈕會變更為 [更新]****。 （**然後，"修改"** 選項可在下拉式功能表上使用。您還可以通過在"視覺工作室"上搜索從 Windows**開始**功能表啟動視覺化工作室和安裝程式。
...
- 使用視覺化工作室安裝程式中的[**"修復**](../install/repair-visual-studio.md)"選項。
- 通過 **"設置** > **應用**"修復或重新安裝 Python & Windows 中的功能。
...
1. 選擇**程式設計語言** > **Python 工具用於視覺化工作室**，然後**下一步**：
...
1. 針對您的 Visual Studio 版本，安裝適當版本的「適用於 Visual Studio 的 Python 工具」：
    ...
    - 視覺工作室 2013： [PTVS 2.2.2 為視覺工作室 2013](https://github.com/Microsoft/PTVS/releases/v2.2.2). Visual Studio 2013 中的 **"檔** > **新專案"** 對話方塊為您提供了此過程的快捷方式。
    - 視覺工作室 2010 和 2012： [PTVS 2.1.1 用於視覺工作室 2010 和 2012](https://github.com/Microsoft/PTVS/releases/v2.1.1)
...
- &lt;PTVS_ver&gt;是版本號，如 2.2.2、2.1.1、2.0、1.5、1.1 或 1.0。
