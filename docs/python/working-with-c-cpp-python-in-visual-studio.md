...
- 找不到 *Python.h* (**E1696：無法開啟原始程式檔 "Python.h"** 及/或 **C1083：無法開啟 Include 檔："Python.h"：沒有這種檔案或目錄**)：請驗證專案屬性中 [C/C++] > [一般] > [其他 Include 目錄] 的路徑指向您 Python 安裝的 *include* 資料夾。 請參閱[建立 Core C++ 專案](#create-the-core-c-projects)下的步驟 6。
