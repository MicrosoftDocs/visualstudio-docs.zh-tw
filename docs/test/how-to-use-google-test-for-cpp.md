...
1. 在**方案總管**中，以滑鼠右鍵按一下方案節點，然後選擇 [**加入**>**新增專案**]。
...
1. 在**方案總管**中，以滑鼠右鍵按一下方案節點，然後選擇 [**加入**>**新增專案**]。
2. 在左窗格中，選擇 **[ C++ Visual** > **Test** ]，然後選擇中間窗格中的 [ **Google Test 專案**]。
3. 提供測試專案名稱，然後按一下 [確定]。
...
您現在準備好撰寫及執行 Google Test。 如需測試巨集的資訊，請參閱 [Google Test 入門](https://github.com/google/googletest/blob/master/googletest/docs/primer.md)。 如需使用[測試總管](run-unit-tests-with-test-explorer.md)探索、執行及分組測試的資訊，請參閱**使用測試總管執行單元測試**。
