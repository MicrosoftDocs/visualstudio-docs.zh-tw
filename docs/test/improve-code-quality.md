...
* [使用 Visual Studio (Lab) 的單元測試、程式碼涵蓋範圍和程式碼複製分析 ](https://azuredevopslabs.com/labs/devopsserver/liveunittesting)
...
* [使用 Visual Studio Enterprise (Lab) 的自動程式碼 UI 測試簡介 ](https://azuredevopslabs.com/labs/tfs/codedui)
