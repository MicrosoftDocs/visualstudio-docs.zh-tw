...
8. 在 [測試] 功能表上選取 [選取測試設定檔]  ，然後選擇 *TestSettingDistributedTestWalkthrough.testsettings*。

::: moniker-end

::: moniker range=">=vs-2019"

8. 在 [測試總管]  中，選取 [設定]  按鈕上的箭頭，然後選取 [選取設定檔]  。 瀏覽並選取 *TestSettingDistributedTestWalkthrough.testsettings* 檔案。
