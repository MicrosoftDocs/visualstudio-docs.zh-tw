...
| Silverlight | 不支援。<br /><br /> 不過針對 Visual Studo 2013，您可以從 Visual Studio 組件庫下載[適用於 Silverlight 的 Microsoft Visual Studio 2013 自動程式化 UI 測試外掛程式](https://marketplace.visualstudio.com/items?itemName=PrachiBoraMSFT.MicrosoftVisualStudio2013CodedUITestPluginforSilve)。 |
| Flash/Java | 不支援。 |
