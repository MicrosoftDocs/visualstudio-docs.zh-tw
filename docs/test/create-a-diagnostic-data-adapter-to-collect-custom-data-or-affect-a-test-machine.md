...
|工作|相關主題|
|-|-----------------------|
|**建立診斷資料配接器：** 您可以藉由建立類別庫來建立診斷資料配接器，然後使用診斷資料配接器 API，收集您所要資訊或影響您用來執行測試的測試系統。|-   [如何：建立診斷資料配接器](../test/how-to-create-a-diagnostic-data-adapter.md)|
