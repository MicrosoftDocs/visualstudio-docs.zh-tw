---
title: 在 Visual Studio 中使用實驗室環境進行開發
ms.date: 05/02/2017
...
## <a name="use-the-cloud-with-team-services-or-team-foundation-server-build-and-release"></a>使用雲端與 Team Services 或 Team Foundation Server 建置和發行

您可以使用 Team Foundation Server (TFS) 和 Visual Studio Team Services 的[建置和發行](/vsts/build-release/)功能，執行自動化測試以及「建置、部署、測試自動化」。 其中一些優點包括：
...
當您使用 Visual Studio 2017 Enterprise Edition 時，可以使用 Microsoft Test Manager 的 Visual Studio Lab Management 功能來建立及管理實驗室環境。
...
如需 SCVMM 的相關資訊，請參閱 [Virtual Machine Manager](/vsts/build-release/apps/cd/scvmm/configure-scvmm)。
