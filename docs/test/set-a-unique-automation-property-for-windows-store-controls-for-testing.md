...
在 Blend for Visual Studio 中，您可以選取選項，將唯一名稱指派給互動式元素，例如按鈕、清單方塊、下拉式方塊和文字方塊。 這樣能提供控制項之 **AutomationProperties.Name** 的唯一值。
...
- [使用程式碼 UI 測試來測試 UWP 應用程式](../test/test-uwp-app-with-coded-ui-test.md)
