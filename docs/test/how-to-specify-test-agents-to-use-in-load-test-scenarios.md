...
通過使用**負載測試編輯器**將**Properties****"代理更改為屬性**"視窗中的屬性來指定代理。
...
您可以在測試設定中使用角色，控制針對指定的測試回合選取的代理程式。 有關詳細資訊，請參閱[使用測試設定收集診斷資訊](../test/collect-diagnostic-information-using-test-settings.md)。
