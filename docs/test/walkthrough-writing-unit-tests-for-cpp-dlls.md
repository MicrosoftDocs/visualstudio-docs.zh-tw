...
## <a name="create-a-native-unit-test-project"></a><a name="create_test_project"></a>創建本機單元測試專案

1. 在 [檔案]**** 功能表上，依序選擇 [新增]**** 和 [專案] > ****。

     **Visual Studio 2017 及更早**版本： 展開**已安裝** > **範本** > **視覺C++** > **測試**。
     **Visual Studio 2019**： 將**語言**設置為C++，並在搜索框中鍵入"測試"。
...
## <a name="create-a-dll-project"></a><a name="create_dll_project"></a>創建 DLL 專案

::: moniker range="vs-2019"

下列步驟會示範如何在 Visual Studio 2019 中建立 DLL 專案。

1. 使用**Windows 桌面嚮導**創建C++專案：按右鍵**解決方案資源管理器**中的解決方案名稱，然後選擇"**Add** > **添加新專案**"。 將 [語言]**** 設為 C++，然後在搜尋方塊中鍵入 "windows"。 從結果清單中選擇 [Windows 傳統式精靈]****。
...
## <a name="couple-the-test-project-to-the-dll-project"></a><a name="make_functions_visible"></a>將測試專案與 DLL 專案耦合
...
## <a name="iteratively-augment-the-tests-and-make-them-pass"></a><a name="iterate"></a>反覆運算增強測試並使其通過
...
4. 生成解決方案，然後在**測試資源管理器**中，選擇 **"全部運行**"。
...
## <a name="refactor-the-code-without-changing-tests"></a><a name="refactor"></a>在不更改測試的情況下重構代碼
