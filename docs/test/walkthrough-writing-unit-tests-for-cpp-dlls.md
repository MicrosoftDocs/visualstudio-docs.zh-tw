...
1. 在 [檔案] 功能表上，選擇 [新增] > [專案]。
     ...
     **Visual Studio 2019**：將**語言**設定C++為，並在搜尋方塊中輸入 "test"。
...
1. 使用C++ **Windows 桌面 Wizard**建立專案：以滑鼠右鍵按一下**方案總管**中的方案名稱，然後選擇 [**加入** > **新增專案**]。 將 [語言] 設為 C++，然後在搜尋方塊中鍵入 "windows"。 從結果清單中選擇 [Windows 傳統式精靈]。
