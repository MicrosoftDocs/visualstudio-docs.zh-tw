...
- [COM](#com) 會列出所有可供參考的 COM 元件。

- [解決方案](#solution)，包含 [專案] 子群組。
...
## <a name="a-idsolution-solution-tab"></a><a id="solution" />[解決方案] 索引標籤
