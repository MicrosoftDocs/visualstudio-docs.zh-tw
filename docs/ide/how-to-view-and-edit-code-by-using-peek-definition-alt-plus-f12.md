...
1.  您可以從想要探索的成員的內容功能表，選擇 [查看定義] 查看定義。 在 Visual Studio 2017 15.4 版和更新版本中，如果已啟用選項，您也可以使用滑鼠查看定義，方法是按 **Ctrl** 鍵 (或其他修飾鍵)，然後按一下成員名稱。 或者，您也可以從鍵盤按 **Alt + F12**。  
...
2.  您可以將游標移至程式碼定義視窗的不同位置。 您也依然可在原始程式碼視窗中四處移動。  
