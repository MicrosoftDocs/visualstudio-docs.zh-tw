...
Visual Studio 不斷改變，以符合開發人員的需求。 在**[Microsoft Build](https://mybuild.microsoft.com/)** library 的下列影片中，加入我們的一些[最新功能](/visualstudio/releases/2019/release-notes/)的教學課程，並[搶先查看](/visualstudio/releases/2019/release-notes-preview/)內容： <br><br>*影片長度：44.58 分鐘*

> [!VIDEO https://channel9.msdn.com/Events/Build/2020/BOD111/player]

使用 Visual Studio 2019，您會獲得同類產品中最佳的工具和服務，任何開發人員、任何應用程式及任何平台均適用。 無論您是第一次使用 Visual Studio，還是已使用過數年，我們最新的版本都有很多的需要！
...
* [Visual Studio 中 C++ 的新功能](/cpp/overview/what-s-new-for-visual-cpp-in-visual-studio.md)
* [C # 8.0 的新功能](/dotnet/csharp/whats-new/csharp-8.md)
* [.NET Core 3.1 的新功能](/dotnet/core/whats-new/dotnet-core-3-1.md)
* [.NET Framework 的新功能](/dotnet/framework/whats-new.md)
