...
|-|-|
|最大化浮動視窗|**按兩下** 標題列|
|最大化/最小化視窗|**贏得** +**向上鍵**  / **贏得** +**向下箭**號|
|重新停駐浮動視窗|**Ctrl** +**按兩下**標題列|
|移動/停駐浮動視窗|**贏得** +**向左箭**  /  號**贏得** +**向右箭**號|
|關閉使用中的文件|**Ctrl** +**F4**|
|顯示開啟檔案清單|**Ctrl** +**Alt** +**向下箭**號|
...
|-|-|
|方案總管搜尋|**Ctrl** +**;**|
|將焦點放在任何工具視窗的搜尋方塊 (除了編輯器之外)|**Alt** + Alt **`** 當工具視窗有焦點時|
|搜尋 Visual Studio|**Ctrl** +**問：**|
...
|移至全部|**Ctrl** +**T**|
|前往最近使用的檔案|**Ctrl** +**T**、**R**|
|多插入號多個插入點|**Ctrl** +**Alt** +**按一下**|
|多插入號新增比對選取項目|**Shift** +**Alt** +**Ins**|
|格式化文件|**Ctrl** +**K**、**D**|
|IntelliSense 建議模式|**Ctrl** +**Alt** +**空間** (切換) |
|強制顯示 IntelliSense|**Ctrl** +**J**|
|快速動作|**Ctrl** +**.**|
|程式碼片段選擇器|**Ctrl** +**K**、**X**或 **？**、**Tab** (Visual Basic) |
|以此環繞|**Ctrl** +**K**、**S**|
|顯示快速諮詢|**Ctrl** +**K**、**I**|
|巡覽至|**Ctrl** +**,**|
|巡覽反白顯示的參考|**Ctrl** +**Shift** +**上 (上**一個) <br />**Ctrl** +**Shift** +**下一步 (下**) |
|編輯器縮放|**Ctrl** +**Shift** + Shift **>**) 中的 (<br />**Ctrl** +**Shift** + Shift **<** (出) |
|區塊選取|按住 **Alt** 並拖曳滑鼠<br />**Shift** +**Alt** +**箭號鍵**|
|向上/向下移動行|**Alt** +**向上鍵**  / **Alt** +**向下箭**號|
|重複行|**Ctrl** +**E**、**V**|
|展開選取範圍|**Shift** +**Alt**+**=**|
|縮小選取範圍|**Shift** +**Alt**+**-**|
|移至定義|**F12**|
|查看定義|**Alt** +**F12**|
|移至定義堆疊|**Ctrl** +**Shift** +**8** (回) <br />**Ctrl** +**Shift** +**7** (向前) |
|關閉 [查看定義] 視窗|**Esc**|
|將 [查看定義] 視窗升級到一般文件索引標籤|**Ctrl** +**Alt** +**首頁**|
|在多個 [查看定義] 視窗之間巡覽|**Ctrl** +**Alt** + Alt **-** 和**Ctrl** + **Alt**+**=**|
...
|尋找文字方塊命令模式|類型 **>**|
|建立新別名|**命令**視窗中的類型**別名 \<new alias> \<command> **|
