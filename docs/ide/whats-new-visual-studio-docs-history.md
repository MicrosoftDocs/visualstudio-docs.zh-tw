...
ms.locfileid: "98113576"
---
# <a name="history-of-whats-new-in-visual-studio-docs"></a>Visual Studio 文件中的新功能歷程記錄

歡迎使用 Visual Studio 檔的新功能歷程記錄。本文包含2020年12月之前的檔的重大變更 (從2020年7月) 開始。 如需最新的新功能，請參閱 [Visual Studio 檔：檔中的新功能](whats-new-visual-studio-docs.md)。
