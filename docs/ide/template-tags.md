...
* 使用 [匯出範本] 精靈來[建立新專案範本](/visualstudio/ide/how-to-create-project-templates)。
...
- [建立專案與項目範本](/visualstudio/ide/creating-project-and-item-templates)
