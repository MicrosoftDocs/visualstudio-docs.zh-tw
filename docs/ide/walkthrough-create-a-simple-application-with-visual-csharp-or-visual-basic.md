...
#### <a name="create-the-wpf-project"></a>建立 WPF 專案
...
#### <a name="clean-the-solution-files-and-build-a-release-version"></a>清除方案檔案和建置發行版本
...
恭喜您完成此逐步解說！ 您可在方案和專案目錄 (*...\HelloWPFApp\HelloWPFApp\bin\Release*) 下找到您建置的 *.exe*。 如果您想要探索更多範例，請參閱 [Visual Studio 範例](../ide/visual-studio-samples.md)。
