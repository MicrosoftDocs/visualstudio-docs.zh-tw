...
如果您使用 Visual Studio 時遇到問題&mdash;如當機、效能緩慢或非預期行為&mdash;請使用 [回報問題]**** 工具讓我們知道。 在 Visual Studio 中，選擇右上角的回饋圖示，或從功能表列中選擇 **"説明** > **發送回饋** > **報告問題**"。

![Visual Studio 2019 IDE 中的傳送意見反應圖示](./media/vs-2019/send-feedback-icon.png)

接下來，Visual Studio 將打開[開發人員社區](https://developercommunity.visualstudio.com)介面，您可以在其中登錄以報告問題。 如需詳細資訊，請參閱[如何回報 Visual Studio 的問題](how-to-report-a-problem-with-visual-studio.md)。

::: moniker-end

::: moniker range="vs-2017"

如果您使用 Visual Studio 時遇到問題&mdash;如當機、效能緩慢或非預期行為&mdash;請使用 [回報問題]**** 工具讓我們知道。 在 Visual Studio 中，選擇搜索框旁邊的回饋圖示，或從功能表列中選擇 **"説明** > **發送回饋** > **報告問題**"。
...
如果您有一個想法或建議，使視覺工作室更好，讓我們知道使用**建議功能**工具。 在 Visual Studio 中，選擇右上角的回饋圖示，或從功能表列中選擇 **"説明** > **發送回饋** > **建議功能**"。

接下來，Visual Studio 將打開[開發人員社區](https://developercommunity.visualstudio.com)介面，您可以在其中登錄以分享您的想法。 如需詳細資訊，請參閱[提出 Visual Studio 功能建議](suggest-a-feature.md)。

::: moniker-end

::: moniker range="vs-2017"

如果您有一個想法或建議，使視覺工作室更好，請告訴我們使用**提供建議**工具。 在 Visual Studio 中，選擇搜索框旁邊的回饋圖示，或從功能表列中選擇 **"説明** > **發送回饋** > **提供建議**"。

接下來，Visual Studio 將打開["開發人員社區](https://developercommunity.visualstudio.com)"頁面，您可以在該頁面登錄以分享您的想法。 如需詳細資訊，請參閱[提出 Visual Studio 功能建議](suggest-a-feature.md)。
...
* 使用 **"此頁面是否有説明？"** 任何文檔頁面右上角的回應工具。
* 使用您的 GitHub 帳戶，在 [docs.microsoft.com](/visualstudio/) 上針對任何 Visual Studio 頁面提供意見反應。 為此，請選擇任何文檔頁面底部的"**發送有關** > **此頁面**的回饋"按鈕。
...
您還可以查看其他開發人員的代碼，並在["流覽代碼示例"](/samples/browse/)頁上共用您自己的示例。
