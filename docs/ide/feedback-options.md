...
如果您使用 Visual Studio 時遇到問題&mdash;如當機、效能緩慢或非預期行為&mdash;請使用 [回報問題]**** 工具讓我們知道。 在 Visual Studio 中，選擇右上角的意見反應圖示，或從功能表列**選擇 [** 說明] [  >  **傳送意見**反應] [回報  >  **問題**]。
...
如果您使用 Visual Studio 時遇到問題&mdash;如當機、效能緩慢或非預期行為&mdash;請使用 [回報問題]**** 工具讓我們知道。 在 Visual Studio 中，選擇 [搜尋] 方塊旁邊的 [意見反應] 圖示，或從功能表列選擇 [說明] [ **Help**  >  **傳送意見**反應] [回報  >  **問題**]。
...
如果您有想法或建議讓 Visual Studio 更好，請使用**建議功能**工具讓我們知道。 在 Visual Studio 中，選擇右上角的意見反應圖示，或從功能表列**選擇 [** 說明] [  >  **傳送意見**反應] [  >  **建議功能**]。
...
如果您有想法或建議讓 Visual Studio 更好，請使用**提供建議**工具讓我們知道。 在 Visual Studio 中，選擇 [搜尋] 方塊旁的意見反應圖示，或從功能表列選擇 [說明] [傳送意見反應 **] [**  >  **Send Feedback**  >  **提供建議**]。
