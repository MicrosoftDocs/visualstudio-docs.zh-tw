---
title: "使用 C# 來擷取方法 | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="extract-a-method-in-c"></a>使用 C# 來擷取方法 #
...
1. 醒目標示的擷取的程式碼：
   ...
   ![醒目標示的程式碼](media/extractmethod-highlight-cs.png)
...
1. 接著，執行下列其中一項操作：
   ...
   * **滑鼠**
   ...
   ![重新命名方法](media/extractmethod-rename-cs.png)
