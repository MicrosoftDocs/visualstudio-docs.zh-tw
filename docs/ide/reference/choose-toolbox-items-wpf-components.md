...
[選擇工具箱項目] 對話方塊的這個索引標籤會顯示您的本機電腦上可用的 Windows Presentation Foundation (WPF) 控制項清單。 若要顯示此清單，請選取 [**工具**] 功能表中的 **[選擇工具箱專案**] 以顯示 [**選擇工具箱專案**] 對話方塊，然後選取其 [ **WPF 元件**] 索引標籤。若要排序列出的元件，請選取任何欄標題。
