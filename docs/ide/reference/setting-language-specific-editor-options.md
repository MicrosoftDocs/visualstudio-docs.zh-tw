...
Visual Studio 提供多種 [文字編輯器] 選項，可以套用至特定的程式語言。 您可以設定 [選項]**** 對話方塊中的選項，以從 [工具]**** 功能表中存取。 您還可以通過[創建 Editor Config 檔](../../ide/create-portable-custom-editor-options.md)，在專案或代碼庫的基礎上配置一些編輯器設置。

## <a name="settings-available-in-the-options-dialog-box"></a>[選項] 對話方塊中提供的設定

[選項， 文字編輯器， 基本 （視覺基本）](../../ide/reference/options-text-editor-basic-visual-basic.md)\
...
[選項， 文字編輯器， C/C++， 高級](../../ide/reference/options-text-editor-c-cpp-advanced.md)\
...
[選項， 文字編輯器， C#， 高級](../../ide/reference/options-text-editor-csharp-advanced.md)\
