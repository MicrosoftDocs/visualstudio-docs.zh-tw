...
|||
|-|-|
|**源視圖**|指定是否只有 XAML 原始碼會出現在 XAML 檢視。 載入大型文件時，這非常有用。|
...
|**預設**|XAML 文件會使用文件專案之目標平台的建議分割方向。 對於大部分的平台，這相當於 [水平]****。|
...
|**CTRL + 滑鼠滾輪**|滾動滑鼠滾輪時按**Ctrl**鍵放大 XAML 設計器。|
|**Alt + 滑鼠滾輪**|滾動滑鼠滾輪時按**Alt**鍵放大 XAML 設計器。|
...
|||
|-|-|
|**縮放方式**|通過滾動滑鼠滾輪或在滾動滑鼠滾輪時按**Ctrl**或**Alt**鍵來放大 XAML 設計器。|
