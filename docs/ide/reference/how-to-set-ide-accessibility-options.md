...
根據預設，Visual Studio 中的對話方塊和工具視窗使用與作業系統相同的字型大小和色彩。 IDE 框架、對話方塊、工具列和工具視窗的色彩設定，是以色彩配置為基礎：淡或暗。 您可以在"選項"對話方塊中更改使用中色彩主題[：環境>常規](../../ide/reference/general-environment-options-dialog-box.md)。
...
> [!TIP]
> 要對作業系統上的所有應用程式視窗使用高對比顏色，請按**左鍵**+**左移**+**PrtScn**。 若 Visual Studio 已開啟，請關閉並重新開啟它以完全實作高對比色彩。
...
1. 選擇**工具列**，然後選擇包含要為其顯示文本的按鈕的工具列名稱。
