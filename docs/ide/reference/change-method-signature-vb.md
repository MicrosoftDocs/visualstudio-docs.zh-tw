---
title: "使用 Visual Basic 來重構方法簽章 | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="change-a-method-signature-in-visual-basic"></a>使用 Visual Basic 來變更方法簽章
...
1. 醒目標示要修改的方法名稱或它的其中一個使用方式，或將文字游標放在要修改的方法名稱或它的其中一個使用方式內：
   ...
   ![醒目標示的程式碼](media/changesignature-highlight-vb.png)
...
1. 在 [變更簽章] 快顯對話方塊中，您可以使用右邊的按鈕來變更方法簽章：
   ...
   ![[變更簽章] 對話方塊](media/changesignature-dialog-vb.png)
...
1. 完成時，按 [確定] 按鈕以進行變更。
   ...
   ![「變更簽章」結果](media/changesignature-result-vb.png)
