...
---
title: "如何：自訂搜尋結果 | Microsoft Docs" ms.custom: "" ms.date: "11/04/2016" ms.reviewer: "" ms.suite: "" ms.technology: 
  - "vs-help-viewer" ms.tgt_pltfrm: "" ms.topic: "article" helpviewer_keywords: 
  - "說明檢視器，自訂搜尋結果"
  - "自訂搜尋結果 [說明檢視器]" ms.assetid: 3431ec03-0221-4be2-9936-887a1c36db89 caps.latest.revision: 6 author: "gewarren" ms.author: "gewarren" manager: ghogen
---
# <a name="how-to-customize-search-results"></a>如何：自訂搜尋結果
您可以使用數種方式自訂在 [搜尋] 索引標籤中顯示搜尋結果的方式。  
  
## <a name="change-the-number-of-topics-that-appear-on-a-search-results-page"></a>變更搜尋結果頁面上所顯示的主題數目  
 您可以指定單一搜尋結果頁面上所顯示的主題數目。  
