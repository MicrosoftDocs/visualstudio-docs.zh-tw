...
* 您必須安裝 Visual Studio 和 Node.js 開發工作負載。
    ...
    如果您尚未安裝 Visual Studio 2017，請移至 [Visual Studio 下載](https://visualstudio.microsoft.com/vs/older-downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=vs+2017+download)   頁面，免費進行安裝。
    ::: moniker-end
