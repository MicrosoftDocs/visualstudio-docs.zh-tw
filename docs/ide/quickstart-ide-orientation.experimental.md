...
![Visual Studio 的 [檔案] 功能表](media/file-menu-start-page-dark.png)
...
![Visual Studio 的功能表列](media/menu-bar-dark.png)
...
![Visual Studio 的 [傳送意見反應] 功能表](media/send-feedback-dark.png)
