...
## <a name="adding-removing-or-moving-a-menu-on-the-menu-bar"></a>加入、移除或移動功能表列上的功能表  
...
## <a name="adding-removing-or-moving-a-toolbar"></a>加入、移除或移動工具列  
...
## <a name="resetting-a-menu-or-a-toolbar"></a>重設功能表或工具列  
