...
- **啟用輕量型解決方案載入**
    ...
    在此模式中，不會啟用某些 IDE 功能。 若要判斷此選項是否有幫助，請參閱 [Shorter solution load time](https://blogs.msdn.microsoft.com/visualstudio/2016/10/11/shorter-solution-load-time-in-visual-studio-15/) (較短的方案載入時間) 和[最佳化 Visual Studio 啟動時間](https://docs.microsoft.com/en-us/visualstudio/ide/optimize-visual-studio-startup-time#speed-up-solution-load)。
