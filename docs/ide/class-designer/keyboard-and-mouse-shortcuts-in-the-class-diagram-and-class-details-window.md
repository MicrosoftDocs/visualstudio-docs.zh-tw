...
## <a name="using-the-mouse-in-class-designer"></a>在類別設計工具中使用滑鼠  
類別圖表中可支援下列滑鼠動作：  
...
## <a name="using-the-mouse-in-the-class-details-window"></a>在類別細節視窗中使用滑鼠  
...
## <a name="using-the-keyboard-in-class-designer"></a>在類別設計工具中使用鍵盤  
類別圖表中可支援下列鍵盤動作：  
...
## <a name="using-the-keyboard-in-the-class-details-window"></a>在類別細節視窗中使用鍵盤  
