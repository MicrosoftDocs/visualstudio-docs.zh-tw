...
|![列舉項目符號](../ide/media/vxenum_icon.gif)|例舉|![常數圖示](../ide/media/vxconstant_icon.gif)|持續性|
...
|![委派符號](../ide/media/vxdelegate_icon.gif)|委派|![[類別檢視] 和 [物件瀏覽器] 的錯誤圖示](../ide/media/erroricon.gif)|錯誤|
...
- [查看代碼結構](../ide/viewing-the-structure-of-code.md)
