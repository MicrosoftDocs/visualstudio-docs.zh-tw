...
從 [16.6 版](/visualstudio/releases/2019/release-notes-v16.6)開始，Visual Studio 2019 現在包含新的 git 體驗，可讓您輕鬆地從 IDE 使用 git。 Git 是最廣泛使用的新式版本控制系統，無論您是專業開發人員，或是您瞭解如何撰寫程式碼，Git 對您都很有用。

> [!TIP]
> 如果您不熟悉 Git， https://git-scm.com/ 網站是不錯的開端。 您可以在此找到熱門的線上書籍、Git 基本影片和功能提要。

## <a name="how-to-start-using-git-in-visual-studio"></a>如何開始在 Visual Studio 中使用 Git

若要切換新的 git 體驗，請移至 [**工具**  >  **選項**  >  **環境**  >  **預覽功能**]，然後選取 [**新的 git 使用者體驗**] 核取方塊。

:::image type="content" source="media/git-opt-new-user-experience.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::

在 Visual Studio 2019 中使用 Git 的方式有三種：
...
:::image type="content" source="media/git-create-repository.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-clone-repository.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-local-repositories.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-solution-explorer-views.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-changes-window.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-changes-current-branch-selector.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::

Visual Studio IDE 右下角的狀態列也有提供最新分支。

:::image type="content" source="media/git-changes-current-branch-status-bar.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-changes-create-new-branch.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-repo-drop-down-indicator.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::

指標也可作為連結，將您帶到 **Git 存放庫** 視窗中該分支的認可歷程記錄。 歷程記錄的頂端現在會顯示這些傳入和傳出認可的詳細資料。 從這裡，您也可以決定要提取或推送認可。

:::image type="content" source="media/git-branch-commit-history.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-branch-commit-details.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-merge-conflict-gold-bar.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::

[ **Git 變更** ] 視窗也會顯示「*合併正在進行中，有衝突*」訊息，並在其下方的個別區段中，將未合併的檔案顯示。

:::image type="content" source="media/git-merge-progress-conflicts-message.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-merge-conflict-gold-info-bar.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-merge-editor.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::
...
:::image type="content" source="media/git-options-settings.png" alt-text="Visual Studio 中 [選項] 對話方塊之 [預覽功能] 區段的螢幕擷取畫面 ":::

## <a name="whats-next"></a>後續步驟

持續微調;我們將會更新此頁面，因為我們會持續改善 Visual Studio 2019 中的新 Git 體驗。
