...
title: "Visual Studio IDE 文件 | Microsoft Docs"
...
---
# <a name="visual-studio-ide-documentation"></a>Visual Studio IDE 文件

了解 Visual Studio 整合式開發環境 (IDE) 如何協助您使用幾乎任何程式碼語言來開發應用程式。
教學課程、影片及其他文件示範如何使用 Visual Studio 建立程式碼和應用程式。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解在 Visual Studio 中對程式碼進行偵錯</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/visualstudio/ide/reference/visual-studio-reference">Visual Studio IDE 參考</a></p>
                        <p><a href="/visualstudio/ide/reference/visual-studio-commands">Visual Studio 命令</a></p>
                        <p><a href="/visualstudio/ide/reference/devenv-command-line-switches">Devenv 命令列參數</a></p>
                    </div>
                </div>
            </div>
        </div>
