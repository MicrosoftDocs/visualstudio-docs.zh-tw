...
[Migration](../workflow-designer/migration-activity-designers.md) <xref:System.Activities.Statements.Interop> 如果您的專案以 .NET Framework 4 (full) 或更新版本為目標，則包含活動的遷移類別只會出現在 [ **工具箱** ] 中。 如有必要，您可以變更專案的目標 framework 版本。
...
|<xref:System.Activities.Statements.Interop.ActivityType%2A>|對|指定 <xref:System.Activities.Statements.Interop> 活動所包含之活動的活動型別。 指定的型別必須衍生自 <xref:System.Workflow.ComponentModel.Activity>。|
