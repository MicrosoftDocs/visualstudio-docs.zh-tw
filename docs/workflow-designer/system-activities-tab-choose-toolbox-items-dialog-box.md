...
ms.locfileid: "66747760"
---
# <a name="systemactivities-tab-choose-toolbox-items-dialog-box"></a>選擇工具箱項目對話方塊、 System.Activities 索引標籤
...
每個索引標籤上，進行篩選，則不可以新增到工作流程活動 **.NET 元件** 索引標籤。新增透過**System.Activities**  索引標籤本身。
...
Namespace\
顯示定義的活動結構的.NET 命名空間的階層。

組件名稱
顯示名稱和包含活動的.NET 組件的版本。

Directory\
顯示包含工作流程活動的.NET 組件的位置。 所有組件的預設位置為 [全域組件快取]。
