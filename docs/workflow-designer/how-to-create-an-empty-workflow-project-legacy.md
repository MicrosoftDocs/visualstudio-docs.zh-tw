---
title: 工作流程設計工具-如何： 建立空白工作流程專案 （舊版）
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "31979434"
---
# <a name="how-to-create-an-empty-workflow-project-legacy"></a>HOW TO：建立空白的工作流程專案 (舊版)

請遵循下列步驟來建立空白的工作流程專案使用舊版 Visual Studio 2010 所提供的 Windows 工作流程設計工具。 當您需要以.NET Framework 3.5 版或 WinFX 為目標時，請使用舊版工作流程設計工具。
