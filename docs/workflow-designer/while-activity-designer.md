...
|<xref:System.Activities.Statements.While.Condition%2A>|對|包含評估的 Visual Basic 運算式，以判斷是否要執行中的活動 <xref:System.Activities.Statements.While.Body%2A> 。|
