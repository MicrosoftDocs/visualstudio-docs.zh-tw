---
title: 將參數加入 & 新增引數對話方塊
description: 瞭解工作流程設計工具中的 InvokeMethod 設計工具如何使用 [加入參數] 對話方塊的使用者介面 (UI) 元素。
...
下表描述設計工具所使用之 [ **加入參數** ] 對話方塊的使用者介面 (UI) 元素 <xref:System.Activities.Statements.InvokeMethod> ：
