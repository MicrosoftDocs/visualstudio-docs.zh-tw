...
ms.locfileid: "86876095"
---
# <a name="correlationscope-activity-designer"></a>CorrelationScope 活動設計工具

[ **CorrelationScope** ] 活動設計工具會用來建立及設定 <xref:System.ServiceModel.Activities.CorrelationScope> 活動，以使用物件來提供子訊息活動的隱含管理 <xref:System.ServiceModel.Activities.CorrelationHandle> 。
