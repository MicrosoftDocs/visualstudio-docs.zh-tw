...
|`VcxToDefaultPlatformMapping`|RemoveHandler<br /><br /> `string` 輸出參數。<br /><br /> 包含 *.vcxproj* 平台名稱與大部分類型所使用之平台名稱的對應清單 (以分號分隔)。<br /><br /> 例如：<br /><br /> `"Win32=AnyCPU;X64=X64"`|
