---
title: 特定于的C++ MSBuild 工作 |Microsoft Docs
ms.date: 03/10/2019
ms.topic: reference
dev_langs:
- VB
...
|[CL 工作](../msbuild/cl-task.md)|包裝C++編譯器工具（*cl .exe*）。|
|[CPPClean 工作](../msbuild/cppclean-task.md)|刪除 MSBuild 在建立C++專案時所建立的暫存檔案。|
...
|[Link 工作](../msbuild/link-task.md)|包裝C++連結器工具（*link .exe*）。|
