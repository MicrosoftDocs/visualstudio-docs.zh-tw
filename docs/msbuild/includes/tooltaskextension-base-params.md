...
此工作繼承<xref:Microsoft.Build.Tasks.ToolTaskExtension>自類別，它繼承自<xref:Microsoft.Build.Utilities.ToolTask>類別，它本身會繼承自<xref:Microsoft.Build.Utilities.Task>類別。 此繼承鏈結將數個參數加入至從它們衍生的工作。
