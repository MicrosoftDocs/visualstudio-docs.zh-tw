...
|方法|描述|
|------------|-----------------|
|<xref:System.GC.Collect%2A?displayProperty=fullName>|呼叫 GC。收集可能會大幅影響應用程式的效能，而且很少需要。 如需詳細資訊，請參閱 MSDN 上的多個 [Mariani 的效能甜頭](https://blogs.msdn.microsoft.com/ricom/2004/11/29/when-to-call-gc-collect/) blog 專案。|
...
|<xref:System.Reflection.Assembly.LoadFrom%2A?displayProperty=fullName><br /><br /><xref:System.Reflection.Assembly.LoadFile%2A?displayProperty=fullName><br /><br /><xref:System.Reflection.Assembly.LoadWithPartialName%2A?displayProperty=fullName>|這些方法可以從非預期的位置載入元件。 例如，請參閱 Suzanne 庫的 .NET CLR 附注 blog 文章 [LoadFile 與 LoadFrom](https://blogs.msdn.microsoft.com/suzcook/2003/09/19/loadfile-vs-loadfrom/) ，然後 [選擇](https://blogs.msdn.microsoft.com/suzcook/2003/05/29/choosing-a-binding-context/) 系結內容以取得載入元件之方法的相關資訊。|
