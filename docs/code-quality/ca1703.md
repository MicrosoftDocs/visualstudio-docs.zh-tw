...
- <xref:System.Reflection.AssemblyCultureAttribute>如果您的資源是在附屬元件中，請使用來指定文化特性。
- <xref:System.Resources.NeutralResourcesLanguageAttribute>如果您的資源與您的程式碼位於相同的元件，請使用來指定元件的*中性文化*特性。
