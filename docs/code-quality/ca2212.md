...
類型中繼承自 <xref:System.EnterpriseServices.ServicedComponent?displayProperty=fullName> 的方法會以 <xref:System.Web.Services.WebMethodAttribute?displayProperty=fullName>標記。
