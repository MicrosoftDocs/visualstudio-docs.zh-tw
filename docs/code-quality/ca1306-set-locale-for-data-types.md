...
## <a name="cause"></a>原因
方法或函式已建立一或多個 <xref:System.Data.DataTable?displayProperty=fullName> 或 @no__t 1 個實例，且未明確設定 locale 屬性（<xref:System.Data.DataTable.Locale%2A?displayProperty=fullName> 或 <xref:System.Data.DataSet.Locale%2A?displayProperty=fullName>）。
