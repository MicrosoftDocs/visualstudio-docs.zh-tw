...
| [CA1504：必須檢閱可能造成誤導的欄位名稱](../code-quality/ca1504.md) | 實例欄位的名稱是以 "s_" 開頭，或靜態的名稱（[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 中的共用）欄位是以 "m_" 開頭。 |
