...
2.  在功能表列上選擇 **建置**，**針對方案執行程式碼分析**。
    ...
    > **C6387 無效的參數值**'pInt' 可能是 '0': 這樣會違反函式 'InCallee' 的規格。
