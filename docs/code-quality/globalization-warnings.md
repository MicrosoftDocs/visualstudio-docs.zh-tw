...
|[CA1307：為清楚起見指定 StringComparison](../code-quality/ca1307.md)|字串比較作業會使用未設定 StringComparison 參數的方法多載。|
...
|[CA1310：指定 StringComparison 的正確性](../code-quality/ca1310.md)|字串比較作業會使用未設定 StringComparison 參數的方法多載，並預設使用特定文化特性的字串比較。|
