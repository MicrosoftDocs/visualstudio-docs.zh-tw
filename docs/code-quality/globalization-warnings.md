...
|[CA1303:不要將常值傳遞做為當地語系化的參數](../code-quality/ca1303-do-not-pass-literals-as-localized-parameters.md)|外部可見方法傳遞字串常值做為參數至.NET 建構函式或方法，且該字串應該是可當地語系化。|
