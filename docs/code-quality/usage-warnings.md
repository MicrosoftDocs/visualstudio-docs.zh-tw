...
|[CA2205:必須使用 Win32 API 的受控對應項](../code-quality/ca2205.md)|已定義平台叫用方法，而且可以使用具有對等功能的 .NET 方法。|
...
|[CA2212:不要以 WebMethod 標記 Serviced 元件](../code-quality/ca2212.md)|型別中繼承自 System.enterpriseservices 的方法會以 ServicedComponent 標示，以 WebMethodAttribute。 因為 WebMethodAttribute 和 ServicedComponent 方法具有衝突的內容和異動流程的行為及需求，所以方法的行為在某些情節中會是不正確的。|
...
|[CA2224:多載等號比較運算子時必須一併覆寫 Equals](../code-quality/ca2224.md)|Public 型別會執行等號比較運算子，但不會覆寫 Object.equals。|
...
|[CA2228:不要使用尚未發行版本所支援的格式建置資源](../code-quality/ca2228.md)|使用 .NET 的發行前版本所建立的資源檔，可能無法由支援的 .NET 版本使用。|
