...
ms.locfileid: "72746502"
---
# <a name="c6280"></a>C6280
警告 C6280： \<variable > 是以 \<function > 來配置，但已刪除 \<function >
 ...
 例如，如果使用 `malloc` 來配置記憶體，但使用 `GlobalFree` 或 `delete` 來釋放記憶體，就會產生這個警告。 在陣列 `new[]` 和純量 `delete` 之間不相符的特定情況下，會報告更精確的警告，而不是這種情況。
