...
這個警告會在將標記<xref:System.Security.SecurityCriticalAttribute>為的委派系結至透明或以標記<xref:System.Security.SecuritySafeCriticalAttribute>的方法時引發。 此警告也會引發將透明或安全關鍵性的委派繫結至關鍵方法的方法。
