---
title: CA1307：為清楚起見指定 StringComparison
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA1307
...
ms.locfileid: "89219578"
---
# <a name="ca1307-specify-stringcomparison-for-clarity"></a>CA1307：為清楚起見指定 StringComparison
...
每當有接受參數的多載存在時 <xref:System.StringComparison> ，就應該使用它，而不是未採用此參數的多載。 藉由明確設定此參數，您的程式碼通常更清楚且更容易維護。 請參閱 [官方 .net 檔](/dotnet/standard/base-types/best-practices-strings#specifying-string-comparisons-explicitly) 以取得進一步的指引。
...
- [在 .NET 中使用字串的最佳做法](/dotnet/standard/base-types/best-practices-strings)
- [全球化警告](globalization-warnings.md)
- [CA1310：指定 StringComparison 的正確性](ca1310.md)
