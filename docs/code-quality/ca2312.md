---
title: CA2312：確定已在還原序列化之前設定 NetDataContractSerializer
ms.date: 05/01/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809698"
---
# <a name="ca2312-ensure-netdatacontractserializerbinder-is-set-before-deserializing"></a>CA2312：確定已在還原序列化之前設定 NetDataContractSerializer
...
呼叫或參考 <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> 還原序列化方法，而且 <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> 屬性可能是 null。

此規則類似于[CA2311](ca2311.md)，但分析無法判斷 <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> 是否絕對為 null。
...
[CA2311：不先設定 NetDataContractSerializer 就不要還原序列化](ca2311.md)
