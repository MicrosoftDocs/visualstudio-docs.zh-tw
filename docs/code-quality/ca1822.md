...
## <a name="cause"></a>原因
未存取實例資料的成員不會標示為) 中共用的靜態 ([!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 。
...
將成員標記為靜態 (或在) 中共用 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] ，或在方法主體中使用 ' this '/' Me ' （如果適用的話）。
