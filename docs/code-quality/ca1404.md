...
description: 呼叫 System.runtime.interopservices.outattribute. Marshal.getlastwin32error 方法或對等的 Win32 GetLastError 函式，而緊接在之前的呼叫則不是平台叫用方法。
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
