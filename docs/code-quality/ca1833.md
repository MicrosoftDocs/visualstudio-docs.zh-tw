...
> [!TIP]
> 程式碼修正適用于 Visual Studio 中的這項規則。 若要使用它，請將游標放在陣列違規上，然後按下**Ctrl** + **。** (句點)。 從顯示的選項清單中，選擇 [ **使用 AsMemory]，而不是陣列上以範圍為基礎的索引子** 。
>
