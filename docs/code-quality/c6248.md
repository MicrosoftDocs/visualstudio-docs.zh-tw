...
```
 ...
 若要查看如何建立安全性描述元的完整範例，請參閱[建立安全性描述元中的新物件的C++ ](https://docs.microsoft.com/windows/desktop/SecAuthZ/creating-a-security-descriptor-for-a-new-object-in-c--)。 如需詳細資訊，請參閱 <<c0> [ 建立 DACL](/windows/desktop/SecBP/creating-a-dacl)。