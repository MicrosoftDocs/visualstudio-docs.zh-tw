---
title: CA2328：確保 JsonSerializerSettings 是安全的
...
ms.locfileid: "74809989"
---
# <a name="ca2328-ensure-that-jsonserializersettings-are-secure"></a>CA2328：確保 JsonSerializerSettings 是安全的
...
- [TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_TypeNameHandling.htm)屬性是 `None`以外的值。
...
- 您知道當[TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_TypeNameHandling.htm)屬性是 `None`以外的值時，一律會設定[JsonSerializerSettings. SerializationBinder](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_SerializationBinder.htm)屬性。
