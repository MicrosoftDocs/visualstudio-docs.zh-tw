...
規則集適用于[managed 程式碼分析](analyzer-rule-sets.md)、[舊版的 managed 程式碼分析](how-to-configure-code-analysis-for-a-managed-code-project.md)，以及[ C++程式碼分析](/cpp/code-quality/using-rule-sets-to-specify-the-cpp-rules-to-run)。
