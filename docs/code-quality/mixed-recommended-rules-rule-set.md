...
Microsoft 混合推薦規則側重於支援通用語言運行時C++專案中最常見和最關鍵的問題,包括潛在的安全漏洞、應用程式崩潰以及其他重要的邏輯和設計錯誤。 此規則集包括[混合最小規則](mixed-minimum-rules-rule-set.md)集中的所有規則。
...
|[CA2100](../code-quality/ca2100.md)|必須檢閱 SQL 查詢中是否有安全性弱點|
|[CA2101](../code-quality/ca2101.md)|必須指定 P/Invoke 字串引數的封送處理|
...
|[CA2141](../code-quality/ca2141.md)|透明方法不能滿足連結要求|
...
|[CA2235](../code-quality/ca2235.md)|必須標記所有不可序列化的欄位|
|[CA2236](../code-quality/ca2236.md)|必須呼叫 ISerializable 類型上的基底類別方法|
|[CA2237](../code-quality/ca2237.md)|ISerializable 類型必須標記 SerializableAttribute|
|[CA2238](../code-quality/ca2238.md)|必須正確實作序列化方法|
|[CA2240](../code-quality/ca2240.md)|必須正確實作 ISerializable|
