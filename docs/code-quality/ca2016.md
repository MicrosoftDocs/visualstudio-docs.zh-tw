---
title: CA2016：將 CancellationToken 參數轉送至接受一個的方法
ms.date: 06/18/2020
ms.topic: reference
f1_keywords:
...
ms.locfileid: "85837735"
---
# <a name="ca2016-forward-the-cancellationtoken-parameter-to-methods-that-take-one"></a>CA2016：將 CancellationToken 參數轉送至接受一個的方法
...
您也可以明確地傳入 `default` c # （ `Nothing` Visual Basic 中）或 <xref:System.Threading.CancellationToken.None> 隱藏規則違規。
