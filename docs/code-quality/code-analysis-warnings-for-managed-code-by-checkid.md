...
| CA2228 | [CA2228:不要使用尚未發行的格式建置的資源](../code-quality/ca2228-do-not-ship-unreleased-resource-formats.md) | 使用.NET 的發行前版本所建置的資源檔可能會無法使用所支援的.NET 版本。 |
