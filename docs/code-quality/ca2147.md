...
其中一個選項是在下列範例中以程式碼審核 SecurityTransparentMethod 方法，如果方法被視為安全的提高許可權，請將 SecurityTransparentMethod 標示為安全性關鍵。 這需要在方法上執行詳盡、完整和無錯誤的安全性審核，以及判斷提示下的方法內發生的任何呼叫：
