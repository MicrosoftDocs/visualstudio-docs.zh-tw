...
ms.locfileid: "72535846"
---
# <a name="how-to-customize-the-code-analysis-dictionary"></a>如何：自訂程式碼分析字典

程式碼分析會使用內建的字典來檢查程式碼中的識別碼，以瞭解拼寫、文法案例和 .NET 設計指導方針的其他命名慣例中的錯誤。 您可以建立自訂字典 Xml 檔案，以新增、移除或修改內建字典的詞彙、縮寫和縮略字。
...
- 字典/單字/複合/詞彙元素中的複合詞匯不區分大小寫。

- CompoundAlternate 屬性值會區分大小寫。 針對複合替代項使用 Pascal 大小寫。
