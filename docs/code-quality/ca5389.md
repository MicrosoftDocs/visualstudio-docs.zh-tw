---
title: CA5389:不要將封存專案的路徑新增到目的檔案系統路徑
...
ms.locfileid: "70815014"
---
# <a name="ca5389-do-not-add-archive-items-path-to-the-target-file-system-path"></a>CA5389:不要將封存專案的路徑新增到目的檔案系統路徑
