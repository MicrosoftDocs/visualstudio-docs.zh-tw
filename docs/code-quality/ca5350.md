...
- 若為 SHA1 或 RIPEMD160 雜湊函式，請使用 Sha-1 系列中的函[式](/windows/desktop/SecCrypto/hash-and-signature-algorithms)（例如、 <xref:System.Security.Cryptography.SHA512> <xref:System.Security.Cryptography.SHA384> 、 <xref:System.Security.Cryptography.SHA256> ）。
