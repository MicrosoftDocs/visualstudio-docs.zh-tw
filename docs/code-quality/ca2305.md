...
`LosFormatter`不安全，而且不能成為安全的。 如需詳細資訊，請參閱[BinaryFormatter 安全性指南](/dotnet/standard/serialization/binaryformatter-security-guide)。
