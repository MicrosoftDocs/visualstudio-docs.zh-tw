...
請注意，有一個公用欄位也違反了設計規則 [CA1051：不要宣告可見的實例欄位](../code-quality/ca1051.md)。
...
如果您選擇第二種方法，請勿以屬性取代該欄位;傳回陣列的屬性會對效能造成不良影響。 如需詳細資訊，請參閱 [CA1819：屬性不應傳回陣列](../code-quality/ca1819.md)。
