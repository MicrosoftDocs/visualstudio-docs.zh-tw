...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>違規 &mdash;document 函式和腳本執行未停用
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>解決方案 &mdash;disable 檔功能和腳本執行
