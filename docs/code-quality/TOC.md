...
### [C++ 程式碼的規則集](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
### [建立自訂規則集](how-to-create-a-custom-rule-set.md)
### [使用規則集編輯器](working-in-the-code-analysis-rule-set-editor.md)
## [簽入原則](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [使用小組簽入原則同步處理專案規則集](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
