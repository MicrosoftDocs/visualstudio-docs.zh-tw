...
在本教學課程中，您已了解如何建立 Node.js 和 React 應用程式、轉換 JSX，以及偵錯。 若要深入了解，請參閱 [GitHub 上適用於 Visual Studio 的 Node.js 工具](https://github.com/Microsoft/nodejstools)。