...
- [CodeLens](../../ide/find-code-changes-and-other-history-with-codelens.md)
   ...
   > [!NOTE]
   > CodeLens 不適用於 Visual Studio 2017 Community 版。
...
1. 開啟 Visual Studio。 在功能表列上，選擇 [檔案] > [新增專案]。
...
5. 讓我們將一些其他程式碼新增至應用程式。 在 `Console.WriteLine("Hello World!")` 行前新增下列 Visual Basic 程式碼：
