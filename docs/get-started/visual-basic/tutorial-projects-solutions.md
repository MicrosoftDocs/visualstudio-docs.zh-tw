...
1. 在左窗格中，展開 [Visual Basic]****，然後選擇 [Windows 桌面]****。 然後，在中間窗格中，選擇 [空白專案 (.NET Framework)]**** 範本。 說出項目 **"快速日期"** 的名稱，然後選擇 **"確定**"按鈕。
...
1. 展開 [一般項目]****，然後選擇 [程式碼]****。 在中間窗格中，選擇 [類別]**** 項目範本。 命名類 **"日曆**"，然後選擇"**添加**"按鈕。
...
1. 選擇 **"快速測試**"專案中的**參考**節點，然後從按右鍵或內容功能表中選擇 **"添加參考**"。
...
1. 在方案總管**** 中，選取 **QuickTest** 專案。 從右鍵功能表或操作功能表中，選擇 [屬性]****，或只按 **Alt**+**Enter** 鍵。 (您也可以在 [方案總管]**** 中按兩下 [我的專案]****。)
