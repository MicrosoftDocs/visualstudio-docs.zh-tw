...
2. 選擇 [ **能源消耗** ]，然後選擇 [ **開始**]。
    ...
    > [!NOTE]
    > 啟動**能耗**探測器時，您可能會看到**使用者帳戶控制**視窗，請求您許可權運行*VsEtwCollector.exe*。 選擇 [ **是**]。
...
## <a name="analyze-energy-profile-data"></a>分析能源分析資料
 ...
 ![能量探測器報告頁](../profiling/media/energyprof_all.png "ENERGYPROF_All")
...
## <a name="optimize-energy-use"></a>最佳化能源利用
 ...
 ![資源&#40;&#47;關閉&#41;窗格](../profiling/media/energyprof_resources.png "ENERGYPROF_Resources")
...
- [CPU 使用量]**** 工具可以協助您降低因無效率函式所造成的 CPU 負載。 請參閱[分析 CPU 使用率](../profiling/beginners-guide-to-performance-profiling.md)。
