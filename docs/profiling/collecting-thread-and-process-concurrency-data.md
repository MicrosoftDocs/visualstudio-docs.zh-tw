...
|如果您的應用程式模組使用多個版本，請在 [ **Advanced** ] 頁面上，指定要分析的 .NET Framework 執行時間的版本。 預設會分析載入的第一個版本。|- [如何：指定 .NET Framework 執行時間](../profiling/how-to-specify-the-dotnet-framework-runtime.md)|
