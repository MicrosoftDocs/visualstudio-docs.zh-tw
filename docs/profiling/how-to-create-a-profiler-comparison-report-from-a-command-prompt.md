---
title: HOW TO：從命令提示字元建立分析工具比較報表 | Microsoft Docs
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "62973938"
---
# <a name="how-to-create-a-profiler-comparison-report-from-a-command-prompt"></a>HOW TO：從命令提示字元建立分析工具比較報表
