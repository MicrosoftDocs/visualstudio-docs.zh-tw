...
## <a name="how-to-investigate-a-warning"></a>如何調查警告
 查看[.NET 記憶體資料檢視](../profiling/dotnet-memory-data-views.md)報告以瞭解應用程式的記憶體分配模式。 使用[物件存留期檢視](../profiling/object-lifetime-view.md)可判斷程式的哪些資料物件會存留到第 2 代，然後從該處回收。 使用[配置檢視](../profiling/dotnet-memory-allocations-view.md)可判斷導致這些配置的執行路徑。
