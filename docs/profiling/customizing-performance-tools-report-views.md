...
|工作|相關內容|
|----------|---------------------|
|**新增、移除和排序報表檢視中的資料行：** 您可以指定您要在表格型檢視中所顯示的資料行，而且可以指定資料行出現的順序。 您也可以依欄值排序報表表格的列。|-   [如何：自訂報表檢視資料行](../profiling/how-to-customize-report-view-columns.md)|
