---
title: 分析工具命令列：檢測動態 ASP.NET 應用程式，取得記憶體資料
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "67031984"
---
# <a name="how-to-instrument-a-dynamically-compiled-aspnet-web-application-and-collect-memory-data-by-using-the-profiler-command-line"></a>作法：使用分析工具命令列檢測動態編譯的 ASP.NET Web 應用程式並收集記憶體資料
