...
ms.locfileid: "56609159"
---
# <a name="save-and-export-performance-tools-data"></a>儲存和匯出效能工具資料
本文描述如何儲存和匯出效能資料檔案。

## <a name="how-to-save-performance-data-files-as-analyzed-report-files"></a>作法：將效能資料檔案儲存為分析的報表檔案
...
## <a name="how-to-export-profiling-tools-reports-to-an-xml-or-csv-file"></a>作法：將分析工具報表匯出為 .xml 或 .csv 檔案
