...
啟動診斷會話時，應用將啟動 **，"診斷工具"** 視窗將顯示應用記憶體使用方式的時間表圖。
...
![記憶體使用量概觀頁面](../profiling/media/memuse__reportoverview1.png "記憶體使用量概觀頁面")
...
![類型到根樹的路徑](../profiling/media/memuse_snapshotdetails_type_pathstoroottree.png "類型到根樹的路徑")
...
![實例的引用物件樹](../profiling/media/memuse_snapshotdetails_referencedobjects_instance.png "實例的引用物件樹")
...
![差異報告中的參考型別](../profiling/media/memuse_snapshotdiff_referencedtypes.png "差異報告中的參考型別")
