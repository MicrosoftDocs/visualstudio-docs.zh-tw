...
1. 開啟 DLL 專案時，選取 [立即**調試****程式]**  >  **Windows**  >  **Immediate**或按**Ctrl** + **Alt** + **I**，開啟 [即時運算] 視窗。

1. `Class1`在 [即時運算] 視窗中輸入下列 c # 程式碼**Immediate** ，然後按**enter**，以具現化類型的物件。 此 managed 程式碼適用于 c # 和 Visual Basic，並具有適當的語法變更：
