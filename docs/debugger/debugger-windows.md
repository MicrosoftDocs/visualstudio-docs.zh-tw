...
|觀看|CTRL+ALT+W, (1, 2, 3, 4)|[監看式及快速監看式視窗](../debugger/watch-and-quickwatch-windows.md)|
...
|執行緒|CTRL+ALT+H|[使用執行緒視窗進行調試](../debugger/how-to-use-the-threads-window.md)|
...
|處理序|CTRL+ALT+Z|[偵錯工具執行緒和進程](../debugger/debug-threads-and-processes.md)|
