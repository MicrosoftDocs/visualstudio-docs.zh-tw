...
|型別|新增解構函式|
|Members|修改參考內嵌 interop 類型的成員|
|Members|在已執行程式碼存取之後修改靜態成員|
...
|Iterators|修改專案中以 .NET Framework 4 和更低版本為目標的反覆運算器（請參閱[詳細資料](https://github.com/dotnet/roslyn/wiki/EnC-Supported-Edits)）|
