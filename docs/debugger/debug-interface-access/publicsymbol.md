...
ms.locfileid: "85461109"
---
# <a name="publicsymbol"></a>PublicSymbol
建立 .exe 檔案時，每個公用符號（最小為每個全域函式和資料符號）都會提供一個 `SymTagPublicSymbol` 標記。
...
|[IDiaSymbol::get_function](../../debugger/debug-interface-access/idiasymbol-get-function.md)|`BOOL`|`TRUE`如果符號為函式，則為。|
...
|[IDiaSymbol::get_managed](../../debugger/debug-interface-access/idiasymbol-get-managed.md)|`BOOL`|`TRUE`如果符號的位置是在 managed 程式碼中，則為。|
