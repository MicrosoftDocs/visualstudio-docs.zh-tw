---
description: 每個函式都是以 SymTagFunction 符號來識別。
title: 函式 () Debug 介面存取 SDK 的功能 |Microsoft 檔
ms.date: 11/04/2016
ms.topic: reference
dev_langs:
- C++
...
|[IDiaSymbol::get_hasAlloca](../../debugger/debug-interface-access/idiasymbol-get-hasalloca.md)|`BOOL`|`TRUE` 如果函式使用配置的記憶體函式 (只有 uinnder DIA SDK 8.0 版或更新版本) 。|
|[IDiaSymbol::get_hasEH](../../debugger/debug-interface-access/idiasymbol-get-haseh.md)|`BOOL`|`TRUE` 如果函式包含 c + + 樣式例外狀況處理 (僅適用于 DIA SDK 8.0 版或更新版本的) 。|
|[IDiaSymbol::get_hasEHa](../../debugger/debug-interface-access/idiasymbol-get-haseha.md)|`BOOL`|`TRUE` 如果函式只包含 DIA SDK 8.0 或更新版本中的非同步例外狀況處理 () 。|
|[IDiaSymbol::get_hasInlAsm](../../debugger/debug-interface-access/idiasymbol-get-hasinlasm.md)|`BOOL`|`TRUE` 如果函式只包含 DIA SDK 8.0 版或更新版本中的內嵌元件 () 。|
|[IDiaSymbol::get_hasLongJump](../../debugger/debug-interface-access/idiasymbol-get-haslongjump.md)|`BOOL`|`TRUE` 如果函式包含 [longjmp](/cpp/c-runtime-library/reference/longjmp) 呼叫，只 (DIA SDK 8.0 或更新版本) 。|
|[IDiaSymbol::get_hasSecurityChecks](../../debugger/debug-interface-access/idiasymbol-get-hassecuritychecks.md)|`BOOL`|`TRUE` 如果函式只包含 DIA SDK 8.0 版或更新版本中的安全性檢查 () 。|
|[IDiaSymbol::get_hasSEH](../../debugger/debug-interface-access/idiasymbol-get-hasseh.md)|`BOOL`|`TRUE` 如果函式包含 Win32 樣式的結構化例外狀況處理 (僅適用于 DIA SDK 8.0 或更新版本) 。|
|[IDiaSymbol::get_hasSetJump](../../debugger/debug-interface-access/idiasymbol-get-hassetjump.md)|`BOOL`|`TRUE` 如果函式包含 [setjmp](/cpp/c-runtime-library/reference/setjmp) 呼叫 (只有在 DIA SDK 8.0 版或更新版本中) 。|
|[IDiaSymbol::get_interruptReturn](../../debugger/debug-interface-access/idiasymbol-get-interruptreturn.md)|`BOOL`|`TRUE` 如果函式只有在 DIA SDK 8.0 版或更新版本中才會從中斷 (的) 。|
...
|[IDiaSymbol::get_isNaked](../../debugger/debug-interface-access/idiasymbol-get-isnaked.md)|`BOOL`|`TRUE` 如果函式已標記 [naked](/cpp/cpp/naked-cpp) 屬性 (只有在 DIA SDK 8.0 版或更新版本中) 。|
|[IDiaSymbol::get_isStatic](../../debugger/debug-interface-access/idiasymbol-get-isstatic.md)|`BOOL`|`TRUE` 如果函式是靜態 (只有在 DIA SDK 8.0 版或更新版本中) 。|
...
|[IDiaSymbol::get_notReached](../../debugger/debug-interface-access/idiasymbol-get-notreached.md)|`BOOL`|`TRUE` 如果無法連線到函式 (僅適用于 DIA SDK 8.0 或更新版本) 。|
|[IDiaSymbol::get_noReturn](../../debugger/debug-interface-access/idiasymbol-get-noreturn.md)|`BOOL`|`TRUE` 如果函式不會傳回值 (只有在 DIA SDK 8.0 版或更新版本中) 。|
...
|[IDiaSymbol::get_undecoratedName](../../debugger/debug-interface-access/idiasymbol-get-undecoratedname.md)|`BSTR`|只有在 DIA SDK 8.0 或更新版本中，函式名稱的未修飾形式 () |
|[IDiaSymbol::get_undecoratedNameEx](../../debugger/debug-interface-access/idiasymbol-get-undecoratednameex.md)|`BSTR`|只有在 DIA SDK 8.0 或更新版本)  (的部分或所有未裝飾形式的函式名稱。|
