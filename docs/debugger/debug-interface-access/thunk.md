...
|屬性|資料類型|描述|
|--------------|---------------|-----------------|
|[IDiaSymbol::get_access](../../debugger/debug-interface-access/idiasymbol-get-access.md)|`DWORD`|存取修飾詞屬性，CV_access_e 的其中一個[列舉](../../debugger/debug-interface-access/cv-access-e.md)值（僅限 DIA SDK 8.0 或更新版本）。|
...
|[IDiaSymbol::get_unalignedType](../../debugger/debug-interface-access/idiasymbol-get-unalignedtype.md)|`BOOL`|`TRUE`如果 Thunk 未對齊（僅在 DIA SDK 8.0 或更新版本中），|
|[IDiaSymbol::get_virtual](../../debugger/debug-interface-access/idiasymbol-get-virtual.md)|`BOOL`|`TRUE`如果 Thunk 是虛擬的（僅在 DIA SDK 8.0 或更新版本中）。|
...
|[IDiaSymbol::get_volatileType](../../debugger/debug-interface-access/idiasymbol-get-volatiletype.md)|`BOOL`|`TRUE`如果 Thunk 已標記為 volatile （僅在 DIA SDK 8.0 或更新版本中）。|
