...
## <a name="remarks"></a>備註
 ...
 `QueryInterface`針對適當的列舉值介面呼叫[IDiaTable](../../debugger/debug-interface-access/idiatable.md)介面中的方法，並使用列舉值的特定方法來存取資料表內容，是比較常見的方法。 如需範例，請參閱[IDiaEnumInjectedSources](../../debugger/debug-interface-access/idiaenuminjectedsources.md)介面。
