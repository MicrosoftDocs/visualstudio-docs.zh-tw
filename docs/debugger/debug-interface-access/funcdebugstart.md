...
ms.locfileid: "85468627"
---
# <a name="funcdebugstart"></a>FuncDebugStart
如果函式具有已定義的開始偵錯工具點，則該點是由具有標記的符號所識別 `SymTagFuncDebugStart` 。
...
|[IDiaSymbol::get_isStatic](../../debugger/debug-interface-access/idiasymbol-get-isstatic.md)|`BOOL`|`TRUE`if 函式已標記為 static （僅在 DIA SDK 8.0 或更新版本中）。|
