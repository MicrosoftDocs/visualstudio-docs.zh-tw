---
description: 如果函式有定義要結束之偵錯工具的定義點，則會以具有 SymTagFuncDebugEnd 標記的符號來識別偵錯工具起始點。
title: FuncDebugEnd |Microsoft 檔
ms.date: 11/04/2016
ms.topic: reference
dev_langs:
- C++
...
|[IDiaSymbol::get_optimizedCodeDebugInfo](../../debugger/debug-interface-access/idiasymbol-get-optimizedcodedebuginfo.md)|`BOOL`|`TRUE` 如果函式只有在 DIA SDK 8.0 版或更新版本中才有優化程式碼的 debug 資訊 () 。|
