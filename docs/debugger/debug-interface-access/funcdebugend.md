...
ms.locfileid: "72745173"
---
# <a name="funcdebugend"></a>FuncDebugEnd
如果函式具有已定義的偵錯工具結束點，則會以具有 `SymTagFuncDebugEnd` 標記的符號來識別 debug 起點。
...
|[IDiaSymbol::get_optimizedCodeDebugInfo](../../debugger/debug-interface-access/idiasymbol-get-optimizedcodedebuginfo.md)|`BOOL`|如果函式具有優化程式碼的 debug 資訊（僅在 DIA SDK 8.0 或更新版本中），則 `TRUE`。|
