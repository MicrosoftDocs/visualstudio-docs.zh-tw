---
title: 'Idiaenuminjectedsources:: Get__newenum |Microsoft 文件'
ms.custom: ''
ms.date: 11/04/2016
...
#### <a name="parameters"></a>參數  
 pRetVal  
 [out，retval]傳回`IUnknown`表示介面<xref:System.Runtime.InteropServices.ComTypes.IEnumVARIANT>這個列舉值的版本。  
