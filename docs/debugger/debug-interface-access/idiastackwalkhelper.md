...
|[IDiaStackWalkHelper::symbolForVA](../../debugger/debug-interface-access/idiastackwalkhelper-symbolforva.md)|抓取包含指定之虛擬位址的符號。 **注意：** 符號必須具有類型 `SymTagFunctionType` （來自[SymTagEnum 列舉](../../debugger/debug-interface-access/symtagenum.md)列舉的值）。|
