...
|[IDiaSymbol::findChildrenExByAddr](../../debugger/debug-interface-access/idiasymbol-findchildrenexbyaddr.md)|抓取符號的子系，這個位置在指定的位址是有效的。|
|[IDiaSymbol::findChildrenExByRVA](../../debugger/debug-interface-access/idiasymbol-findchildrenexbyrva.md)|抓取在指定的相對虛擬位址（RVA）有效之符號的子系。|
|[IDiaSymbol::findChildrenExByVA](../../debugger/debug-interface-access/idiasymbol-findchildrenexbyva.md)|抓取符號的子系，這是在指定之虛擬位址的有效位置。|
|[IDiaSymbol::findInlineFramesByAddr](../../debugger/debug-interface-access/idiasymbol-findinlineframesbyaddr.md)|抓取列舉型別，可讓用戶端逐一查看指定位址上的所有內嵌框架。|
|[IDiaSymbol::findInlineFramesByRVA](../../debugger/debug-interface-access/idiasymbol-findinlineframesbyrva.md)|抓取列舉型別，可讓用戶端逐一查看指定的相對虛擬位址（RVA）上的所有內嵌框架。|
|[IDiaSymbol::findInlineFramesByVA](../../debugger/debug-interface-access/idiasymbol-findinlineframesbyva.md)|抓取列舉型別，可讓用戶端逐一查看指定虛擬位址（VA）上的所有內嵌框架。|
|[IDiaSymbol::findInlineeLines](../../debugger/debug-interface-access/idiasymbol-findinlineelines.md)|抓取列舉型別，可讓用戶端逐一查看這個符號中，直接或間接內嵌之所有函式的行號資訊。|
|[IDiaSymbol::findInlineeLinesByAddr](../../debugger/debug-interface-access/idiasymbol-findinlineelinesbyaddr.md)|抓取列舉型別，可讓用戶端逐一查看在指定的位址範圍內，直接或間接內嵌之所有函式的行號資訊。|
...
|[IDiaSymbol::get_addressTaken](../../debugger/debug-interface-access/idiasymbol-get-addresstaken.md)|抓取表示另一個符號是否參考此位址的旗標。|
|[IDiaSymbol::get_age](../../debugger/debug-interface-access/idiasymbol-get-age.md)|抓取程式資料庫的存留期值。|
...
|[IDiaSymbol::get_baseDataSlot](../../debugger/debug-interface-access/idiasymbol-get-basedataslot.md)|抓取基底資料位置。|
|[IDiaSymbol::get_baseSymbol](../../debugger/debug-interface-access/idiasymbol-get-basesymbol.md)|抓取指標所依據的符號。|
|[IDiaSymbol::get_baseSymbolId](../../debugger/debug-interface-access/idiasymbol-get-basesymbolid.md)|抓取指標所依據的符號識別碼。|
...
|[IDiaSymbol::get_builtInKind](../../debugger/debug-interface-access/idiasymbol-get-builtinkind.md)|抓取 HLSL 類型的內建種類。|
|[IDiaSymbol::get_callingConvention](../../debugger/debug-interface-access/idiasymbol-get-callingconvention.md)|傳回方法之呼叫慣例的指標。|
...
|[IDiaSymbol::get_code](../../debugger/debug-interface-access/idiasymbol-get-code.md)|抓取表示符號是否參考程式碼位址的旗標。|
|[IDiaSymbol::get_compilerGenerated](../../debugger/debug-interface-access/idiasymbol-get-compilergenerated.md)|抓取表示符號是否為編譯器產生的旗標。|
|[IDiaSymbol::get_compilerName](../../debugger/debug-interface-access/idiasymbol-get-compilername.md)|抓取用來建立[編譯模組](../../debugger/debug-interface-access/compiland.md)的編譯器名稱。|
|[IDiaSymbol::get_constructor](../../debugger/debug-interface-access/idiasymbol-get-constructor.md)|抓取表示使用者定義資料類型是否具有函數的旗標。|
|[IDiaSymbol::get_container](../../debugger/debug-interface-access/idiasymbol-get-container.md)|抓取這個符號的包含符號。|
|[IDiaSymbol::get_constType](../../debugger/debug-interface-access/idiasymbol-get-consttype.md)|抓取表示使用者定義資料類型是否為常數的旗標。|
|[IDiaSymbol::get_count](../../debugger/debug-interface-access/idiasymbol-get-count.md)|抓取清單或陣列中的專案數。|
|[IDiaSymbol::get_countLiveRanges](../../debugger/debug-interface-access/idiasymbol-get-countliveranges.md)|抓取與本機符號相關聯的有效位址範圍數目。|
|[IDiaSymbol::get_customCallingConvention](../../debugger/debug-interface-access/idiasymbol-get-customcallingconvention.md)|抓取表示函數是否使用自訂呼叫慣例的旗標。|
|[IDiaSymbol::get_dataBytes](../../debugger/debug-interface-access/idiasymbol-get-databytes.md)|抓取 OEM 符號的資料位元組。|
|[IDiaSymbol::get_dataKind](../../debugger/debug-interface-access/idiasymbol-get-datakind.md)|抓取資料符號的變數分類。|
...
|[IDiaSymbol::get_farReturn](../../debugger/debug-interface-access/idiasymbol-get-farreturn.md)|抓取表示函數是否使用最大傳回的旗標。|
...
|[IDiaSymbol::get_hasManagedCode](../../debugger/debug-interface-access/idiasymbol-get-hasmanagedcode.md)|抓取表示模組是否包含 managed 程式碼的旗標。|
|[IDiaSymbol::get_hasNestedTypes](../../debugger/debug-interface-access/idiasymbol-get-hasnestedtypes.md)|抓取表示使用者定義資料類型是否有巢狀型別定義的旗標。|
|[IDiaSymbol::get_hasSecurityChecks](../../debugger/debug-interface-access/idiasymbol-get-hassecuritychecks.md)|抓取旗標，指出函數或編譯模組是否有在中編譯的安全性檢查（經由[/gs （緩衝區安全性檢查）](/cpp/build/reference/gs-buffer-security-check)編譯器參數）。|
|[IDiaSymbol::get_hasSEH](../../debugger/debug-interface-access/idiasymbol-get-hasseh.md)|抓取旗標，指出函數是否具有 Win32 樣式的結構化例外狀況處理。|
|[IDiaSymbol::get_hasSetJump](../../debugger/debug-interface-access/idiasymbol-get-hassetjump.md)|抓取表示函數是否包含 setjmp 命令的旗標。|
|[IDiaSymbol::get_indirectVirtualBaseClass](../../debugger/debug-interface-access/idiasymbol-get-indirectvirtualbaseclass.md)|抓取表示使用者定義資料類型是否為間接虛擬基類的旗標。|
...
|[IDiaSymbol::get_isDataAligned](../../debugger/debug-interface-access/idiasymbol-get-isdataaligned.md)|抓取表示使用者定義資料類型的元素是否對齊特定界限的旗標。|
|[IDiaSymbol::get_isHLSLData](../../debugger/debug-interface-access/idiasymbol-get-ishlsldata.md)|指定這個符號是否代表高層級的著色器語言（HLSL）資料。|
|[IDiaSymbol::get_isHotpatchable](../../debugger/debug-interface-access/idiasymbol-get-ishotpatchable.md)|抓取表示模組是否使用[/hotpatch （Create 可線上修補 Image）](/cpp/build/reference/hotpatch-create-hotpatchable-image)編譯器參數編譯的旗標。|
...
|[IDiaSymbol::get_lexicalParentId](../../debugger/debug-interface-access/idiasymbol-get-lexicalparentid.md)|抓取符號的詞法父系識別碼。|
|[IDiaSymbol::get_libraryName](../../debugger/debug-interface-access/idiasymbol-get-libraryname.md)|抓取載入物件的程式庫或物件檔案的檔案名。|
|[IDiaSymbol::get_liveRangeLength](../../debugger/debug-interface-access/idiasymbol-get-liverangelength.md)|傳回本機符號有效的位址範圍長度。|
|[IDiaSymbol::get_liveRangeStartAddressSection](../../debugger/debug-interface-access/idiasymbol-get-liverangestartaddresssection.md)|傳回開頭位址範圍的區段部分，其中的本機符號有效。|
|[IDiaSymbol::get_liveRangeStartAddressOffset](../../debugger/debug-interface-access/idiasymbol-get-liverangestartaddressoffset.md)|傳回開頭位址範圍的位移部分，其中的區域符號是有效的。|
|[IDiaSymbol::get_liveRangeStartRelativeVirtualAddress](../../debugger/debug-interface-access/idiasymbol-get-liverangestartrelativevirtualaddress.md)|傳回本機符號有效的位址範圍開頭。|
|[IDiaSymbol::get_locationType](../../debugger/debug-interface-access/idiasymbol-get-locationtype.md)|抓取資料符號的位置類型。|
|[IDiaSymbol::get_lowerBound](../../debugger/debug-interface-access/idiasymbol-get-lowerbound.md)|抓取 FORTRAN 陣列維度的下限。|
|[IDiaSymbol::get_lowerBoundId](../../debugger/debug-interface-access/idiasymbol-get-lowerboundid.md)|抓取 FORTRAN 陣列維度下限的符號識別碼。|
|[IDiaSymbol::get_machineType](../../debugger/debug-interface-access/idiasymbol-get-machinetype.md)|抓取目標 CPU 的類型。|
|[IDiaSymbol::get_managed](../../debugger/debug-interface-access/idiasymbol-get-managed.md)|抓取表示符號是否參考 managed 程式碼的旗標。|
|[IDiaSymbol::get_memorySpaceKind](../../debugger/debug-interface-access/idiasymbol-get-memoryspacekind.md)|抓取記憶體空間種類。|
|[IDiaSymbol::get_msil](../../debugger/debug-interface-access/idiasymbol-get-msil.md)|抓取表示符號是否參考 Microsoft 中繼語言（MSIL）程式碼的旗標。|
|[IDiaSymbol::get_name](../../debugger/debug-interface-access/idiasymbol-get-name.md)|抓取符號的名稱。|
|[IDiaSymbol::get_nested](../../debugger/debug-interface-access/idiasymbol-get-nested.md)|抓取表示使用者定義資料類型是否已嵌套的旗標。|
...
|[IDiaSymbol::get_numberOfColumns](../../debugger/debug-interface-access/idiasymbol-get-numberofcolumns.md)|抓取矩陣中的資料行數目。|
|[IDiaSymbol::get_objectFileName](../../debugger/debug-interface-access/idiasymbol-get-objectfilename.md)|抓取目的檔名。|
|[IDiaSymbol::get_objectPointerType](../../debugger/debug-interface-access/idiasymbol-get-objectpointertype.md)|抓取類別方法之物件指標的類型。|
...
|[IDiaSymbol::get_optimizedCodeDebugInfo](../../debugger/debug-interface-access/idiasymbol-get-optimizedcodedebuginfo.md)|抓取表示函式或標籤是否包含優化程式碼以及偵錯工具資訊的旗標。|
|[IDiaSymbol::get_overloadedOperator](../../debugger/debug-interface-access/idiasymbol-get-overloadedoperator.md)|抓取表示使用者定義資料類型是否具有多載運算子的旗標。|
|[IDiaSymbol::get_packed](../../debugger/debug-interface-access/idiasymbol-get-packed.md)|抓取表示使用者定義資料類型是否已封裝的旗標。|
|[IDiaSymbol::get_platform](../../debugger/debug-interface-access/idiasymbol-get-platform.md)|抓取已編譯器或編譯模組的平臺類型。|
|[IDiaSymbol::get_pure](../../debugger/debug-interface-access/idiasymbol-get-pure.md)|抓取表示函數是否為純虛擬的旗標。|
|[IDiaSymbol::get_rank](../../debugger/debug-interface-access/idiasymbol-get-rank.md)|抓取 FORTRAN 多維陣列的順位。|
|[IDiaSymbol::get_reference](../../debugger/debug-interface-access/idiasymbol-get-reference.md)|抓取表示指標類型是否為參考的旗標。|
...
|[IDiaSymbol::get_sizeInUdt](../../debugger/debug-interface-access/idiasymbol-get-sizeinudt.md)|抓取使用者定義類型的成員大小。|
...
|[IDiaSymbol::get_subType](../../debugger/debug-interface-access/idiasymbol-get-subtype.md)|抓取子型別。|
|[IDiaSymbol::get_subTypeId](../../debugger/debug-interface-access/idiasymbol-get-subtypeid.md)|抓取子類型識別碼。|
|[IDiaSymbol::get_symbolsFileName](../../debugger/debug-interface-access/idiasymbol-get-symbolsfilename.md)|抓取已載入符號的檔案名。|
|[IDiaSymbol::get_symIndexId](../../debugger/debug-interface-access/idiasymbol-get-symindexid.md)|抓取唯一符號識別碼。|
...
|[IDiaSymbol::get_targetRelativeVirtualAddress](../../debugger/debug-interface-access/idiasymbol-get-targetrelativevirtualaddress.md)|抓取 Thunk 目標的相對虛擬位址（RVA）。|
|[IDiaSymbol::get_targetSection](../../debugger/debug-interface-access/idiasymbol-get-targetsection.md)|抓取 Thunk 目標的 address 區段。|
|[IDiaSymbol::get_targetVirtualAddress](../../debugger/debug-interface-access/idiasymbol-get-targetvirtualaddress.md)|抓取 Thunk 目標的虛擬位址（VA）。|
...
|[IDiaSymbol::get_thunkOrdinal](../../debugger/debug-interface-access/idiasymbol-get-thunkordinal.md)|捕獲函數的 Thunk 類型。|
|[IDiaSymbol::get_timeStamp](../../debugger/debug-interface-access/idiasymbol-get-timestamp.md)|抓取基礎可執行檔的時間戳記。|
|[IDiaSymbol::get_token](../../debugger/debug-interface-access/idiasymbol-get-token.md)|抓取 managed 函數或變數的元資料標記。|
|[IDiaSymbol::get_type](../../debugger/debug-interface-access/idiasymbol-get-type.md)|抓取函數簽名碼的參考。|
...
|[IDiaSymbol::get_value](../../debugger/debug-interface-access/idiasymbol-get-value.md)|抓取常數的值。|
|[IDiaSymbol::get_virtual](../../debugger/debug-interface-access/idiasymbol-get-virtual.md)|抓取表示函數是否為虛擬的旗標。|
|[IDiaSymbol::get_virtualAddress](../../debugger/debug-interface-access/idiasymbol-get-virtualaddress.md)|抓取位置的虛擬位址（VA）。|
|[IDiaSymbol::get_virtualBaseClass](../../debugger/debug-interface-access/idiasymbol-get-virtualbaseclass.md)|抓取表示使用者定義資料類型是否為虛擬基類的旗標。|
...
|[IDiaSymbol::get_virtualBaseOffset](../../debugger/debug-interface-access/idiasymbol-get-virtualbaseoffset.md)|抓取虛擬函數之虛擬函式資料表中的位移。|
|[IDiaSymbol::get_virtualBasePointerOffset](../../debugger/debug-interface-access/idiasymbol-get-virtualbasepointeroffset.md)|抓取虛擬基底指標的位移。|
...
|[IDiaSymbol::get_virtualTableShape](../../debugger/debug-interface-access/idiasymbol-get-virtualtableshape.md)|針對使用者定義型別，抓取虛擬資料表之型別的符號介面。|
|[IDiaSymbol::get_virtualTableShapeId](../../debugger/debug-interface-access/idiasymbol-get-virtualtableshapeid.md)|抓取符號的虛擬資料表圖形識別碼。|
|[IDiaSymbol::get_volatileType](../../debugger/debug-interface-access/idiasymbol-get-volatiletype.md)|抓取表示使用者定義資料類型是否為 volatile 的旗標。|
