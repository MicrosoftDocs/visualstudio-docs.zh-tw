...
## <a name="self-hosting"></a>自我裝載
 「自我裝載服務」** 是一項不會在 IIS、WCF 服務主機或 [!INCLUDE[vstecasp](../code-quality/includes/vstecasp_md.md)] 程式開發伺服器內部執行的 WCF 服務。 如需有關如何將自我裝載服務進行偵錯工具的詳細資訊，請參閱 [如何：調試自我裝載的 WCF 服務](../debugger/how-to-debug-a-self-hosted-wcf-service.md)。
