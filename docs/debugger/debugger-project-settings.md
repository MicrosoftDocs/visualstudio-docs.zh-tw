...
## <a name="in-this-section"></a>本節內容
 ...
 [Web 專案的屬性頁設定](../debugger/property-pages-settings-for-web-projects.md)清單中可用的屬性**屬性頁**web 專案 對話方塊。

 [專案 Visual Basic 偵錯組態設定](../debugger/project-settings-for-a-visual-basic-debug-configuration.md)清單中可用的屬性**屬性頁**對話方塊的 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]專案。

## <a name="related-sections"></a>相關章節
 [指定符號 (.pdb) 和原始程式檔](../debugger/specify-symbol-dot-pdb-and-source-files-in-the-visual-studio-debugger.md)說明偵錯工具如何使用符號檔和原始程式檔來顯示偵錯資訊。

 [在 Visual Studio 中的應用程式進行偵錯](/visualstudio/debugger/debugging-windows-store-and-windows-universal-apps)描述如何偵錯 UWP 應用程式。 (Windows 開發人員中心)
