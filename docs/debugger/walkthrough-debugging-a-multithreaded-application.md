...
## <a name="display-flagged-threads"></a>顯示已標幟的執行緒
 您可以在 [執行緒] 視窗中以圖示來標記您想要特別注意的執行緒。 如需詳細資訊，請參閱 <<c0> [ 如何： 將執行緒加上旗標和取消](../debugger/how-to-flag-and-unflag-threads.md)。 在 [執行緒] 視窗中，您可以選擇顯示所有執行緒或僅顯示加上旗標的執行緒。
