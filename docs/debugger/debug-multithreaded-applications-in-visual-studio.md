...
ms.locfileid: "51349526"
---
# <a name="debug-multithreaded-applications-in-visual-studio"></a>偵錯在 Visual Studio 中的多執行緒應用程式
...
[多執行緒支援較舊的程式碼 （Visual c + +）](/cpp/parallel/multithreading-support-for-older-code-visual-cpp)  
