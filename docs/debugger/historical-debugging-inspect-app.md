...
ms.locfileid: "62848200"
---
# <a name="inspect-your-app-with-intellitrace-historical-debugging-in-visual-studio-c-visual-basic-c"></a>檢查您的應用程式與 IntelliTrace 歷程偵錯在 Visual Studio 中 (C#，Visual Basic 中， C++)
