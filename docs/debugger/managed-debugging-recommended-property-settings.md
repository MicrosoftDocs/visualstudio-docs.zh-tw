---
title: 建議的C#偵錯工具屬性設定，VB |Microsoft Docs
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
...
|**屬性名稱**|**設定**|
|-----------------------|-----------------|
|**啟用最佳化**|針對上表中的 [**優化程式碼**] 選項所指定的原因，設定為 false。|
