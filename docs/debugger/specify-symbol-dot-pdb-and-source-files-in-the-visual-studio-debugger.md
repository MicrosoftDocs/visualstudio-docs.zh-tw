...
2. 在 **符號檔 ( .pdb) 位置**，
   ...
   - 若要變更符號位置的載入順序，請使用**ctrl** + **向上**和**Ctrl**向 + **下**ctrl，或**向上**鍵和**向下**箭號圖示。
...
您可以在 [**工具**  >  **選項**] 的  >  **Debugging**  >  **[一般**] (或**Debug**  >  **Options**  >  **[一般**) 的 Debug 選項中選取其他符號選項：
...
1. 若要開啟 [**模組**] 視窗，在進行調試時，請選取 [ **Debug**  >  **Windows**  >  **模組**]。
