...
- [區塊類型](https://msdn.microsoft.com/library/e2f42faf-0687-49e7-aa1f-916038354f97)，在此範例中為 `normal` 。  
...
4. 請按 **RETURN**。  
    ...
    偵錯工具會評估呼叫，並將結果放在 [值]  欄中。 如果您還沒有設定任何中斷點上的記憶體配置，這個值會是-1。  
