...
2. 將*newText*字串指派給 <xref:Microsoft.Office.Interop.Word.Range.Text%2A> 書簽的屬性，這會自動刪除書簽。 然後重新將書籤加入 <xref:Microsoft.Office.Interop.Word.Bookmarks> 集合。
