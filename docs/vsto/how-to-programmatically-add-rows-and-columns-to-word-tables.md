...
> - Word 2010 範本
>
>   如果您想要執行這項工作中任何其他類型的專案，您必須加入參考**Microsoft.Office.Interop.Word**組件，然後您必須使用該組件中的類別來加入資料表中的資料列和資料行。 如需詳細資訊，請參閱[如何：透過主要 interop 組件的 Office 應用程式為目標](../vsto/how-to-target-office-applications-through-primary-interop-assemblies.md)並[Word 2010 主要 interop 組件參考](http://go.microsoft.com/fwlink/?LinkId=189588)。
