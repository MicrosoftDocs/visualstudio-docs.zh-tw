...
## <a name="automate-infopath-by-using-an-add-in"></a>使用增益集自動化 InfoPath
 ...
 當您從 VSTO 增益集呼叫 InfoPath 物件模型時，您會使用在 InfoPath 的主要 interop 元件中提供的類型。 主要 Interop 組件的作用，如同 VSTO 增益集中 Managed 程式碼與 InfoPath 中 COM 物件模型之間的橋樑。 InfoPath 主要 Interop 組件中的所有類型，都是在 <xref:Microsoft.Office.Interop.InfoPath> 命名空間中定義。 如需 InfoPath 主要 interop 元件的詳細資訊，請參閱 [關於 Microsoft Office infopath 主要 interop 元件](https://msdn.microsoft.com/1b3ae03c-6951-49e4-a489-4712d3f7ba72)。 如需主要 interop 元件的一般詳細資訊，請參閱 [office 方案開發總覽 &#40;VSTO&#41;](../vsto/office-solutions-development-overview-vsto.md) 和 [office 主要 interop 元件](../vsto/office-primary-interop-assemblies.md)。
