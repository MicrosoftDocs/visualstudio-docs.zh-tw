...
## <a name="create-the-control"></a>建立控制項
 ...
 在 VSTO 增益集中，您可以在執行階段將 <xref:Microsoft.Office.Tools.Excel.Chart> 控制項加入工作表。 如需詳細資訊，請參閱[如何：將圖表控制項加入至](../vsto/how-to-add-chart-controls-to-worksheets.md)工作表。
