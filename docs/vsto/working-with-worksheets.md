...
|工作|程序|  
|----------|---------------|  
|在活頁簿中加入新的工作表。|[如何：以程式設計方式在活頁簿中新增工作表](../vsto/how-to-programmatically-add-new-worksheets-to-workbooks.md)|  
...
|加入與刪除註解。|[如何：以程式設計方式新增及刪除工作表註解](../vsto/how-to-programmatically-add-and-delete-worksheet-comments.md)|  
