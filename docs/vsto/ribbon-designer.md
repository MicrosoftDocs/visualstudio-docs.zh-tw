...
## <a name="adding-a-ribbon-visual-designer-item-to-a-project"></a>將功能區 （視覺化設計工具） 項目加入至專案  
 若要使用功能區設計工具，加入新**功能區 （視覺化設計工具）**至您的專案項目。 如需詳細資訊，請參閱 [如何：開始自定義功能區](../vsto/how-to-get-started-customizing-the-ribbon.md)。  
...
#### <a name="removing-custom-tabs-from-the-ribbon"></a>從功能區中移除自訂索引標籤  
 有三種方式可移除自訂索引標籤，從功能區：  
...
#### <a name="changing-the-position-of-a-tab-on-the-ribbon"></a>變更的功能區上的索引標籤的位置  
...
#### <a name="customizing-built-in-tabs-on-the-ribbon"></a>自訂功能區上的內建索引標籤  
...
|動作|鍵盤快速鍵|  
|------------|-----------------------|  
|您可以將前一個控制項的控制項清單中。|CTRL + 向上鍵<br /><br /> CTRL + 向|  
|在清單中的下一個控制項後移動控制項。|CTRL + 向下鍵<br /><br /> CTRL + 向右|  
...
|動作|鍵盤快速鍵|  
|------------|-----------------------|  
|如果下拉式面板為開啟，且沒有下拉式面板上選取了控制項，請選取父控制項。|LEFT|  
|如果下拉式面板為開啟，且已選取父控制項，請關閉下拉式面板。|LEFT|  
|開啟下拉式面板。|RIGHT|  
