---
title: 使用範圍
description: 瞭解 NamedRange 和範圍類別包含您用來執行範圍之工作的方法和屬性。
...
|在儲存格中取得及設定日期值。|[如何：以程式設計方式在 Excel 範圍中儲存和取出日期值](../vsto/how-to-programmatically-store-and-retrieve-date-values-in-excel-ranges.md)|
