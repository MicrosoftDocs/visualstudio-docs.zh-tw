...
## <a name="program-different-types-of-office-solutions"></a>方案不同類型的 Office 方案
...
- [OFFICE UI 自訂](../vsto/office-ui-customization.md)。
  ...
  如需可協助您規劃 Office 方案和程式以協助您建立專案的背景資訊, 請參閱[設計和建立 office 方案](../vsto/designing-and-creating-office-solutions.md)。
...
|[自動儲存如何影響 Office 方案](./how-autosave-impacts-office-solutions.md)|描述當自動儲存啟用時, 您可能需要對 Office 方案進行的調整。|
