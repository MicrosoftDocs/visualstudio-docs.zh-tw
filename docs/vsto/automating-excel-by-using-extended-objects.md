...
---
# <a name="automate-excel-by-using-etended-objects"></a>使用 etended 物件自動化 Excel
...
-   <xref:Microsoft.Office.Tools.Excel.Worksheet>. 這個主項目表示專案中的工作表。 它還可當成 Managed 控制項 (包括主控制項與 Windows Form 控制項) 的容器使用，而且會在其介面維護控制項的相關資訊。 如需詳細資訊，請參閱[工作表主項目](../vsto/worksheet-host-item.md)。  
