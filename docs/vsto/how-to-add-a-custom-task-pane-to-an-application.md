...
## <a name="add-a-custom-task-pane-to-an-application"></a>將自訂工作窗格新增至應用程式
...
3. 在 [**加入新專案**] 對話方塊中，將新使用者控制項的名稱變更為**MyUserControl**，**然後按一下 [新增]**。

     使用者控制項隨即在設計工具中開啟。

4. 將一個或多個 Windows Forms 控制項從 [**工具箱**] 加入至使用者控制項。
