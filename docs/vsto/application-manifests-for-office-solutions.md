...
|[&#60;entryPoint&#62;元素&#40;Visual Studio 中的 Office 程式開發&#41;](../vsto/entrypoint-element-office-development-in-visual-studio.md)|必要。 識別要在 Office 方案中執行的組件。|`class`<br /><br /> `contract`|  
|[&#60;更新&#62;元素&#40;Visual Studio 中的 Office 程式開發&#41;](../vsto/update-element-office-development-in-visual-studio.md)|必要。 設定方案的更新。|`enabled`<br /><br /> `expiration`|  
