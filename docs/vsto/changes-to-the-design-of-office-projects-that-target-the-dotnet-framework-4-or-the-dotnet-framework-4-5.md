...
|[功能區 (視覺化設計工具)]  專案項目的程式設計模型已變更。|專案中所有功能區項目的程式碼後置檔案都必須修改。 您也必須修改任何程式碼會具現化在執行階段的功能區控制項、 處理功能區事件，或以程式設計方式設定功能區元件的位置。 如需詳細資訊，請參閱 <<c0> [ 在您移轉至.NET Framework 4 或.NET Framework 4.5 的 Office 專案中的更新功能區自訂](../vsto/updating-ribbon-customizations-in-office-projects-that-you-migrate-to-the-dotnet-framework-4-or-the-dotnet-framework-4-5.md)。|  
...
## <a name="see-also"></a>另請參閱  
 ...
 [中的 Office 程式開發最新消息](http://msdn.microsoft.com/bf054af2-c896-4723-aa15-6381145b14bb)   
