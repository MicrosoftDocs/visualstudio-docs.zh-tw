...
ms.locfileid: "34263209"
---
# <a name="access-the-ribbon-at-runtime"></a>存取在執行階段的功能區
...
## <a name="access-a-collection-of-ribbons-that-appear-in-a-specific-outlook-inspector-window"></a>存取出現在特定 Outlook 偵測器視窗中的功能區集合  
...
## <a name="access-a-collection-of-ribbons-that-appear-for-a-specific-outlook-explorer"></a>存取出現在特定 Outlook 總管 的功能區集合  
