---
title: 如何： 將結構描述對應至 Visual Studio 中的 Word 文件
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "35255427"
---
# <a name="how-to-map-schemas-to-word-documents-inside-visual-studio"></a>如何： 將結構描述對應至 Visual Studio 中的 Word 文件
