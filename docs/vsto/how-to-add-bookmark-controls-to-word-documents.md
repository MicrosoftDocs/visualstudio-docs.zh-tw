...
ms.locfileid: "71255989"
---
# <a name="how-to-add-bookmark-controls-to-word-documents"></a>作法：將書簽控制項新增至 Word 檔
...
- [在 VSTO 增益集專案中，于執行時間加入書簽控制項](#runtimeaddin)
  ...
  如需<xref:Microsoft.Office.Tools.Word.Bookmark>控制項的詳細資訊，請參閱[書簽控制項](../vsto/bookmark-control.md)。

## <a name="designtime"></a>在設計階段加入書簽控制項
...
## <a name="runtimedoclevel"></a>在檔層級專案中，于執行時間加入書簽控制項
...
## <a name="runtimeaddin"></a>在 VSTO 增益集專案中，于執行時間加入書簽控制項
