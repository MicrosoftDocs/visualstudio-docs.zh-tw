...
## <a name="caching-data-in-document-level-solutions"></a>快取文件層級方案中的資料  
 ...
 [逐步解說：擷取伺服器上的活頁簿快取資料](../vsto/walkthrough-retrieving-cached-data-from-a-workbook-on-a-server.md)  
