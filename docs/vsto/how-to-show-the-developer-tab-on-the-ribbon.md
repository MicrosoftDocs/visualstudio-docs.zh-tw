...
---
# <a name="how-to-show-the-developer-tab-on-the-ribbon"></a>如何：在功能區顯示 [開發人員] 索引標籤
...
> [!NOTE]
> 本指導僅適用於 Office 2010 或更新版應用程式。 如果您想要在 2007 Microsoft Office 系統中顯示此索引標籤，請參閱本主題的下列版本[如何：在功能區顯示開發人員](https://web.archive.org/web/20140303033431/msdn.microsoft.com/library/bb608625(v=vs.90).aspx
)索引標籤。
