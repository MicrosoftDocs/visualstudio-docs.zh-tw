---
title: HOW TO：將 ListObject 控制項新增至工作表
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "71254696"
---
# <a name="how-to-add-listobject-controls-to-worksheets"></a>作法：將 ListObject 控制項新增至工作表
...
## <a name="designtime"></a>在設計階段加入 ListObject 控制項
 有數種方式可在<xref:Microsoft.Office.Tools.Excel.ListObject>檔層級專案中，于設計階段將控制項加入工作表：從 Excel 中，從 [Visual Studio**工具箱**] 和 [**資料來源**] 視窗。
...
2. 將資料表從 [資料來源] 視窗拖曳至您的工作表。
     ...
     繫結至資料的 <xref:Microsoft.Office.Tools.Excel.ListObject> 控制項隨即加入工作表。 如需詳細資訊，請參閱資料系結[和 Windows Forms](/dotnet/framework/winforms/data-binding-and-windows-forms)。

## <a name="runtimedoclevel"></a>在檔層級專案中，于執行時間加入 ListObject 控制項
...
## <a name="runtimeaddin"></a>在 VSTO 增益集專案中，于執行時間加入 ListObject 控制項
