---
title: "如何： 以程式設計方式建立電子郵件項目 |Microsoft 文件"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-to-programmatically-create-an-e-mail-item"></a>如何：以程式設計方式建立電子郵件項目
  本範例會在 Microsoft Office Outlook 中建立電子郵件訊息。  
