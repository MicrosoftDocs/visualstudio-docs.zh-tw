...
- [Visual Studio Tools for Office 技術文件和 Visual How To](http://go.microsoft.com/fwlink/?LinkID=106640)包含連結至影片及有關使用 Visual Studio 建立 Office 方案的技術文件。
