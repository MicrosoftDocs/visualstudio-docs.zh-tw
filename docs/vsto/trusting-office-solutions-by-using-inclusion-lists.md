...
ms.locfileid: "72985540"
---
# <a name="trust-office-solutions-by-using-inclusion-lists"></a>使用包含清單信任 Office 方案
...
## <a name="clickonce-trust-prompt"></a>ClickOnce 信任提示
 ...
 如需詳細資訊，請參閱[設定 ClickOnce 信任的發行者](/previous-versions/dotnet/articles/ms996418(v=msdn.10))中的[如何：設定包含清單安全性](../vsto/how-to-configure-inclusion-list-security.md)和表2，其標題為提示層級登錄機碼值啟動效果。
