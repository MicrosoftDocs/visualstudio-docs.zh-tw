...
ms.locfileid: "81389993"
---
借助 Visual Studio,可以輕鬆地構建、調試和運行容器化ASP.NET核心應用,並將它們發布到 Azure 容器註冊表 (ACR)、Docker Hub、Azure 應用服務或您自己的容器註冊表。 在本文中，我們將發佈到 ACR。
...
1. 選擇**ASP.NET 核心 Web 應用程式**,或者如果要使用 .NET 架構而不是 .NET 核心,請選擇 ASP.NET Web**應用程式**。
