...
1. 請確定您已經安裝處理圖形所需的 Visual Studio 元件。 該元件稱為**影像與 3D 模型編輯器**。
   ...
   要安裝它，請通過從功能表列中選擇 **"工具** > **獲取工具和功能**"打開視覺化工作室安裝程式，然後選擇 **"單個元件**"選項卡。在 **"遊戲和圖形**"類別下選擇 **"圖像"和 3D 模型編輯器**元件，然後選擇"**修改**"。
...
|**移動瀏覽**|讓 3D 場景相對於視窗框架進行移動。 若要移動瀏覽，請選取場景中的點並四處移動它。<br /><br /> 在 **"選擇"** 模式下，您可以按住**Ctrl**以暫時啟動**平移**模式。|
|**縮放**|使其相對於視窗框架顯示或多或少的場景細節。 在 [縮放]**** 模式中，選取場景中的一點，然後左右移動進行放大，或上下移動進行縮小。<br /><br /> 在 **"選擇"** 模式下，您可以按住**Ctrl**時使用滑鼠滾輪放大或縮小。|
|**軌跡**|將檢視放置在所選物件周圍的圓形路徑。 如果沒有選取任何物件，路徑會置中在場景的原點。 **注意：** 啟用 [正視]**** 投影時，此模式沒有作用。|
|**世界區域**|啟用這個項目時，所選物件的轉換會在世界空間發生。 否則，所選物件上的轉換會在區域空間發生。|
|**樞軸模式**|啟用此項後，轉換會影響所選物件的*樞軸點*的位置和方向（樞軸點定義平移、縮放和旋轉操作的中心）。否則，變換會影響物件幾何體相對於樞軸點的位置和方向。|
...
|**檢視**|設定檢視方向。 以下是可用的方向：<br /><br /> **Front**<br /> 將檢視放置在場景前方。<br /><br /> **上一步**<br /> 將檢視放置在場景後方。<br /><br /> **離開**<br /> 將檢視放置在場景左方。<br /><br /> **Right**<br /> 將檢視放置在場景右方。<br /><br /> **返回頁首**<br /> 將檢視放置在場景上方。<br /><br /> **底部**<br /> 將檢視放置在場景下方。 **注意：** 這是在啟用 [正視]**** 投影時變更檢視方向的唯一方法。|
...
|**選擇邊**|設定 [選取模式]**** 以選取物件上的邊緣 (兩個頂點之間的線條)。|
...
|刪除目前選取範圍|**刪除**|
|取消目前的選取範圍|**逸出** (**Esc**)|
|放大|**滑鼠滾輪往前捲動**<br /><br /> **Ctrl**+**滑鼠滾輪向前**<br /><br /> **向前移動**+**滑鼠滾輪**<br /><br /> **Ctrl**+**頁面向上**<br /><br /> 加號**+**（ ）|
|縮小|**滑鼠滾輪往後捲動**<br /><br /> **Ctrl**+**滑鼠輪向後**<br /><br /> **向後移動**+**滑鼠滾輪**<br /><br /> **Ctrl**+**頁面向下**<br /><br /> 減號**-**（ ）|
|向上平移觀景窗|**PageDown**|
|向下平移觀景窗|**PageUp**|
|向左平移觀景窗|**滑鼠滾輪向左捲動**<br /><br /> **Ctrl**+**頁面向下**|
|向右平移觀景窗|**滑鼠滾輪向右捲動**<br /><br /> **Ctrl**+**頁面向下**|
