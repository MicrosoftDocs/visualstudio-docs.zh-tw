...
ms.locfileid: "54966029"
---
# <a name="model-editor"></a>模型編輯器

本文件描述如何使用 Visual Studio [模型編輯器] 來檢視、建立和修改 3D 模型。
...
|**縮放**|使其相對於視窗框架顯示或多或少的場景細節。 在 [縮放] 模式中，選取場景中的一點，然後左右移動進行放大，或上下移動進行縮小。<br /><br /> 在 [選取] 模式中，您可以在長按 **Ctrl** 時使用滑鼠滾輪來縮放。|
...
### 建立並匯入 3D 物件 <a name="Adding3DObjects"></a>
...
### 修改物件 <a name="ModifyingObjects"></a>
...
|刪除目前選取範圍|**刪除**|
|取消目前的選取範圍|**逸出** (**Esc**)|
|放大|**滑鼠滾輪向前捲動**<br /><br /> **Ctrl**+**滑鼠滾輪向前捲動**<br /><br /> **Shift**+**滑鼠滾輪向前捲動**<br /><br /> **Ctrl**+**PageUp**<br /><br /> 加號 (**+**)|
|縮小|**滑鼠滾輪向後捲動**<br /><br /> **Ctrl**+**滑鼠滾輪向後捲動**<br /><br /> **Shift**+**滑鼠滾輪向後捲動**<br /><br /> **Ctrl**+**PageDown**<br /><br /> 減號 (**-**)|
|向上平移觀景窗|**PageDown**|
|向下平移觀景窗|**PageUp**|
