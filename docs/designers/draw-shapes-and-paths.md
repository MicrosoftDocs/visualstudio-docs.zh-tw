...
![[資產] 視窗上的 [圖形] 分類](../designers/media/blend-shapes.png)
...
|||||
|-|-|-|-|
|![合併前的兩個圖形](../designers/media/b1_1.png)|合併前的兩個圖形|![Intersect](../designers/media/b1_4.png)|Intersect|
