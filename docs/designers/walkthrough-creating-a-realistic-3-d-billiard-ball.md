...
4. 將您為紋理立方體面建立的紋理載入到立方體面。 在主功能表上 **，選擇 [** 檔案] [  >  **開啟到這個立方體貼圖臉部**]，選取您為 cube 側邊建立的材質，然後選擇 [**開啟**]。

5. 對 **負 X**、**正 Z** 和**負 Z** 立方體面重複步驟 4。 若要這樣做，您必須檢視想要載入的立方體面。 若要查看不同的 cube 對應臉部，請在主功能表上，選擇 [**視圖**] [  >  **cube 地圖臉部**]，然後選取您想要查看的臉部。
