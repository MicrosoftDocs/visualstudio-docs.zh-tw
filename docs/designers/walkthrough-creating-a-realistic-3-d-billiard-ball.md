...
1. 在"DirectX 紋理工具"中，在主功能表上，選擇 > **"檔新紋理**"。 **File** [New Texture]\(新增紋理)**** 對話方塊隨即出現。
...
4. 將您為紋理立方體面建立的紋理載入到立方體面。 在主功能表上，選擇"**打開檔** > **到此立方體貼圖面**"，選擇為立方體一側創建的紋理，然後選擇 **"打開**"。

5. 對 **負 X**、**正 Z** 和**負 Z** 立方體面重複步驟 4。 若要這樣做，您必須檢視想要載入的立方體面。 要查看其他立方體地圖面，請在主功能表上選擇 **"查看** > **立方體貼圖面**"，然後選擇要查看的面。
