...
|**移動瀏覽**|可讓著色器圖形相對於視窗框架移動。 若要移動瀏覽，請選取設計介面上的一點並予以四處移動。<br /><br /> 在 **"選擇"** 模式下，您可以按住**Ctrl**以暫時啟動**平移**模式。|
|**縮放**|可讓著色器圖形相對於視窗框架顯示更多或更少的細節。 在 [縮放]**** 模式中，選取設計介面上的一點，然後往右或往下移動以放大，或是往左或往下移動以縮小。<br /><br /> 在 **"選擇"** 模式下，您可以按住**Ctrl**以使用滑鼠滾輪放大或縮小。|
|**縮放至適合**|在視窗框架中顯示完整的著色器圖形。|
...
|**工具箱**|交替顯示或隱藏 [工具箱]****。|
|**屬性**|交替顯示或隱藏 [屬性]**** 視窗。|
|**進階**|包含進階命令和選項。<br /><br /> **匯出**︰能以數種格式匯出著色器。<br /><br /> **匯出成**︰將著色器匯出為 HLSL 原始程式碼或編譯過的著色器位元組程式碼。 有關如何匯出掃描器的詳細資訊，請參閱[如何匯出掃描器](../designers/how-to-export-a-shader.md)。<br /><br /> **圖形引擎**︰可讓您選擇的轉譯器，用於顯示設計介面。<br /><br /> **以 D3D11 顯示**︰使用 Direct3D 11 轉譯著色器設計工具設計介面。<br /><br /> **以 D3D11WARP 顯示**：使用 Direct3D 11 Windows Advanced Rasterization Platform (WARP) 轉譯著色器設計工具設計介面。<br /><br /> **檢視**︰可讓您選擇著色器設計工具的其他資訊。<br /><br /> **畫面播放速率**：啟用時，會在設計介面的右上角顯示目前的畫面播放速率。 畫面播放速率是每秒繪製的畫面數目。 當您啟用 [即時轉譯模式]**** 選項時，這個選項很有用。|
...
|參數|屬性|
|---------------|----------------|
|**紋理 1** - **紋理 8**|**訪問**：**公共**以允許從模型編輯器設置屬性;否則，**私人**。<br /><br /> **檔名**：與這個材質暫存器相關聯的材質檔案完整路徑。|
|**材質環境**|**訪問**：**公共**以允許從模型編輯器設置屬性;否則，**私人**。<br /><br /> **值**：由於間接或環境照明而導致的當前圖元的漫反射顏色.|
|**材質擴散**|**存取權**：[公用]**** 允許從模型編輯器設定此屬性，否則為 [私用]****。<br /><br /> **值**：色彩，描述目前像素如何使直接光源擴散。|
|**材質放射**|**訪問**：**公共**以允許從模型編輯器設置屬性;否則，**私人**。<br /><br /> **值**：目前像素的色彩比重，由自行提供的光源造成。|
|**材質反射**|**訪問**：**公共**以允許從模型編輯器設置屬性;否則，**私人**。<br /><br /> **值**：色彩，描述目前像素如何使直接光源反射。|
|**材質光澤度**|**訪問**：**公共**以允許從模型編輯器設置屬性;否則，**私人**。<br /><br /> **值**：指數，定義目前像素上反射亮部的濃度。|
...
您可以將著色器匯出為 HLSL 原始程式碼或編譯過的位元組程式碼。 HLSL 原始程式碼匯出到具有 *.hlsl*檔案名副檔名的文字檔。 可以匯出 shader 位元組碼，也可以匯出到具有 *.cso*檔案名副檔名的原始二進位檔案，也可以匯出到將底數位節編碼為數組C++標頭 *（.h*） 檔。

有關如何匯出掃描器的詳細資訊，請參閱[如何匯出掃描器](../designers/how-to-export-a-shader.md)。
...
|刪除目前選取範圍|**刪除**|
|取消目前的選取範圍|**逸出** (**Esc**)|
|放大|**Ctrl**+**滑鼠滾輪向前**<br /><br /> 加號**+**（ ）|
|縮小|**Ctrl**+**滑鼠輪向後**<br /><br /> 減號**-**（ ）|
|向上移動瀏覽設計介面|**滑鼠滾輪往後捲動**<br /><br /> **PageDown**|
|向下移動瀏覽設計介面|**滑鼠滾輪往前捲動**<br /><br /> **PageUp**|
|向左移動瀏覽設計介面|**向後移動**+**滑鼠滾輪**<br /><br /> **滑鼠滾輪向左捲動**<br /><br /> **移位**+**頁面向下**|
|向右移動瀏覽設計介面|**向前移動**+**滑鼠滾輪**<br /><br /> **滑鼠滾輪向右捲動**<br /><br /> **移位**+**頁面向上**|
|將鍵盤焦點移至另一個節點|**方向**鍵|
|選取具有鍵盤焦點的節點 (將節點加入選取群組)|**移位**+**空格鍵**|
|切換選擇具有鍵盤焦點的節點|**Ctrl**+**空格鍵**|
|切換目前的選取範圍 (如果不選取任何節點，選取具有鍵盤焦點的節點)|**空白鍵**|
|向上移動目前的選取範圍|**向上移動**+**箭頭**|
|向下移動目前的選取範圍|**向下移**+**位箭頭**|
|向左移動目前的選取範圍|**向左箭頭移位**+ ** **|
|向右移動目前的選取範圍|**向右箭頭移位**+**Right Arrow**。|

## <a name="related-topics"></a>相關主題

|Title|描述|
|-----------|-----------------|
|[使用遊戲和應用程式的 3D 資產](../designers/working-with-3-d-assets-for-games-and-apps.md)|提供 Visual Studio 工具的概觀，您可用來處理紋理及影像、3D 模型和著色器效果。|
