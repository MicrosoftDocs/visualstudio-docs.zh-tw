...
|[在遊戲或應用程式中使用 3D 資產](../designers/using-3-d-assets-in-your-game-or-app.md)|描述如何在建置專案或方案時使用 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 處理 3D 資產，使其可用於您的應用程式。 也會討論將不同類型資產載入應用程式的策略。|
