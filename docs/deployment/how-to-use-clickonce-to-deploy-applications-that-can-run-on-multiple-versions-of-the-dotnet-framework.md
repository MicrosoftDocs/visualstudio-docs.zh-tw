...
ms.locfileid: "66263196"
---
# <a name="how-to-use-clickonce-to-deploy-applications-that-can-run-on-multiple-versions-of-the-net-framework"></a>作法：使用 ClickOnce 部署可在多個 .NET Framework 版本上執行的應用程式
