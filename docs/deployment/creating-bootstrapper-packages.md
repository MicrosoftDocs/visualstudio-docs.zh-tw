...
接下來，將可轉散發檔案複製到啟動載入器資料夾位置中。 如需詳細資訊，請參閱 [How to: Create a localized bootstrapper package](../deployment/how-to-create-a-localized-bootstrapper-package.md) (如何：建立當地語系化的啟動載入器套件)。
