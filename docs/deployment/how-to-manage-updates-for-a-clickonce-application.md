...
- [How to: Check for application updates programmatically using the ClickOnce deployment AP](../deployment/how-to-check-for-application-updates-programmatically-using-the-clickonce-deployment-api.md) (如何：使用 ClickOnce 部署 API 以程式設計方式檢查應用程式更新)