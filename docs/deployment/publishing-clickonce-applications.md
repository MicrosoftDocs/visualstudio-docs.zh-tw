...
|[逐步解說：讓 ClickOnce 應用程式可在多個 .NET Framework 版本上執行](https://msdn.microsoft.com/library/7f4383af-ed87-4853-b4d4-02a3967a5fd9)|說明如何啟用 ClickOnce 應用程式，在 NET Framework 的多個版本上安裝及執行。|
