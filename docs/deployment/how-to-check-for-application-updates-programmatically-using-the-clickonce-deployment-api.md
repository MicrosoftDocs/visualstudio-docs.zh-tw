...
> [!NOTE]
>  您也可以使用如下所述來部署您的應用程式，從一個位置，但從另一個更新它的技術。 如需詳細資訊，請參閱[＜How to：指定部署更新的替代位置](../deployment/how-to-specify-an-alternate-location-for-deployment-updates.md)。  
