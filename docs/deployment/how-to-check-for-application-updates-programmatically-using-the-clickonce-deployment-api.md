---
title: 使用 ClickOnce 部署 API 的應用程式自動更新
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "66260825"
---
# <a name="how-to-check-for-application-updates-programmatically-using-the-clickonce-deployment-api"></a>作法：使用 ClickOnce 部署 API 以程式檢查應用程式更新
