---
title: 以受限制的許可權對 ClickOnce 應用程式進行 Debug
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "72727956"
---
# <a name="how-to-debug-a-clickonce-application-with-restricted-permissions"></a>How to: Debug a ClickOnce application with restricted permissions (如何：以限制的權限對 ClickOnce 應用程式進行偵錯)
