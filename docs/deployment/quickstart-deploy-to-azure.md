...
- [ASP.NET Core 應用程式部署至 Azure](https://docs.microsoft.com/en-us/aspnet/core/tutorials/publish-to-azure-webapp-using-vs)
- [ASP.NET Core 使用 Git 連續部署](https://docs.microsoft.com/en-us/aspnet/core/publishing/azure-continuous-deployment)
