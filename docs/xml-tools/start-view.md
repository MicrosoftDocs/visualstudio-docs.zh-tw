...
[開始] 視圖包含兩個主要區段： [ *浮水印* ] 和 [ **架構設定詳細資料** ] 窗格。 其中也包含工具列，所有的 XSD 設計工具檢視皆提供此工具列。
...
[ **架構設定詳細資料** ] 窗格會列出全域架構節點類型，並顯示架構中有多少類型的實例。 您可以使用節點類型旁的 [ **新增** ] 連結，將新的節點新增至工作區。

## <a name="toolbar"></a>工具列

您可以從 [XML 架構設計工具] 工具列，在 [開始] 視圖、 [內容模型視圖](../xml-tools/content-model-view.md) 和 [圖形視圖](../xml-tools/graph-view.md) 之間流覽。
