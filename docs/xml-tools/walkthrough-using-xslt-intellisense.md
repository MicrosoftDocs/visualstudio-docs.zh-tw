...
2. 在 `<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:alt="http://www.w3.org/1999/XSL/Transform-alternate" version="1.0">` 之後插入游標，然後按**enter**。 接著開始輸入下列 `xsl:namespace-alias` 項目：
