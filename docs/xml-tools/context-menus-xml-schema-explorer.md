...
|**顯示所有輸出參考**|針對選取之命名空間內的每個檔案，尋找並反白顯示下列項目：<br /><br /> -不含 `schemaLocation` 屬性的 import 語句中所參考的所有命名空間。<br />-在 import 和 include 語句的 `schemaLocation` 屬性中所指定的命名空間以外的所有檔案。|
...
|**顯示所有輸出參考**|尋找並反白顯示下列項目：<br /><br /> -所有不具有 `schemaLocation` 屬性的 import 語句之 namespace 屬性中指定的所有命名空間。<br />-所有 import 和 include 語句的 `schemaLocation` 屬性中所指定的所有檔案。|
