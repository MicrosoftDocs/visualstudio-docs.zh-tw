...
## <a name="workspace-panel"></a>工作區面板
 ...
 您將節點加入工作空間之後，節點的清單會出現在**工作區**面板的內容模型檢視。 當您選取中的節點**工作區** 面板中，它們會出現在內容模型檢視設計介面上。 若要從工作區中刪除節點，請使用 XSD 設計工具 工具列中，**工作區** 面板操作功能表，或有**刪除**索引鍵。
...
## <a name="xml-editor-integration"></a>XML 編輯器整合
 ...
 您可以在之間來回切換**XSD 設計工具**和 XML 編輯器中使用操作功能表。
