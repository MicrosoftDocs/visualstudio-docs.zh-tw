...
|資料|-   **伺服器總管**(簡體： 僅限資料)。 請參閱「注意 1」。<br />-   **資料來源**視窗<br />-的整組資料控制項<br />XML 編輯器<br />資料繫結至本機資料來源 (。MDF 或。MDB)<br />資料繫結至物件<br />資料繫結至 Web 服務<br />資料繫結到本機資料庫伺服器<br />資料繫結到遠端資料庫伺服器<br />-DDL 工具的遠端資料<br />-   **伺服器總管**擴充性 ([!INCLUDE[vsipsdk](../includes/vsipsdk_md.md)]範例)|  
