...
ms.locfileid: "80697967"
---
# <a name="visual-studio-template-schema-reference"></a>視覺化工作室範本架構參考
本節包含有關 *.vstemplate*檔中的 XML 元素的資訊,這些元素是存儲專案範本、專案範本和初學者工具組級資料的檔。

 您可以使用*vstemplate.xsd*來驗證自訂 *.vstemplate*檔案。 此檔案在 . . *視覺化\\安裝資料夾>\Xml_Schemas_1033_vstemplate.xsd \< *。

|元素|子元素|屬性|
|-------------|--------------------|----------------|
|[適用於](../extensibility/appliesto-element-visual-studio-templates.md)|None|None|
...
|[預設名稱](../extensibility/defaultname-element-visual-studio-templates.md)|--|--|
|[說明](../extensibility/description-element-visual-studio-templates.md)|--|Package<br /><br /> ID|
...
|[TemplateContent](../extensibility/templatecontent-element-visual-studio-templates.md)|ProjectCollection<br /><br /> 隨附此逐步解說的專案<br /><br /> 參考<br /><br /> ProjectItem<br /><br /> CustomParameters|[BuildOnLoad](../extensibility/buildonload-visual-studio-templates.md)|
