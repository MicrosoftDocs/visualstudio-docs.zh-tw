...
> [!NOTE]
> 除了使用語言服務的著色器之外，VSPackage 也可以選擇使用一般用途 Visual Studio 環境 SDK 文字著色機制。 如需此機制的詳細資訊，請參閱 [使用字型和色彩](/visualstudio/extensibility/using-fonts-and-colors?view=vs-2015)。
