...
# [建立您的第一個擴充功能：Hello World](extensibility-hello-world.md)
...
# [語言伺服器通訊協定](language-server-protocol.md)
##[新增語言伺服器通訊協定擴充功能](adding-an-lsp-extension.md)
#[開啟資料夾](open-folder.md)
##[工作區](workspaces.md)
##[檔案內容](workspace-file-contexts.md)
##[索引](workspace-indexing.md)
##[語言服務](workspace-language-services.md)
##[建置](workspace-build.md)
