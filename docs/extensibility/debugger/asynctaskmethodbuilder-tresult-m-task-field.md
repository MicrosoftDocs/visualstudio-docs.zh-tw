---
title: AsyncTaskMethodBuilder&lt;TResult&gt;.m_task 欄位 |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
ms.locfileid: "31097659"
---
# <a name="asynctaskmethodbuilderlttresultgtmtask-field"></a>AsyncTaskMethodBuilder&lt;TResult&gt;.m_task 欄位
表示延遲初始化建置工作。  
