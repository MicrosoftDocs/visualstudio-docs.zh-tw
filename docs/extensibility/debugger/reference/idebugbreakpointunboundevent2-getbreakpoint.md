---
title: IDebugBreakpointUnboundEvent2::GetBreakpoint |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>參數  
 `ppBP`  
 [out]傳回[IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md)表示變成解除繫結的中斷點物件。  
