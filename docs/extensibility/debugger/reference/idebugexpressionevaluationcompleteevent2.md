---
description: 當非同步運算式評估完成時，debug engine 會將這個介面傳送 (DE) 至會話 debug manager (SDM) 。
title: IDebugExpressionEvaluationCompleteEvent2 |Microsoft 檔
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
