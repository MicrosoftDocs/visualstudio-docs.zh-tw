---
title: IDebugBreakpointRequest2::GetRequestInfo |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>參數  
 `dwFields`  
 [in]從旗標的組合[BPREQI_FIELDS](../../../extensibility/debugger/reference/bpreqi-fields.md)列舉，可判斷哪些欄位`pBPRequestInfo`參數會填入。  
