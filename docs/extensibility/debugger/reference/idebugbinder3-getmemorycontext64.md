---
title: IDebugBinder3::GetMemoryContext64 |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
## <a name="example"></a>範例  
 下列範例會建立該物件會實作[IDebugBinder3](../../../extensibility/debugger/reference/idebugbinder3.md)介面，並使用此方法來擷取記憶體內容。  
