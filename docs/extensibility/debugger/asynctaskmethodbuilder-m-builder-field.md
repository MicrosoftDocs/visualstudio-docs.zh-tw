---
title: AsyncTaskMethodBuilder. m_builder 欄位 |Microsoft Docs
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "80739399"
---
# <a name="asynctaskmethodbuilderm_builder-field"></a>AsyncTaskMethodBuilder，m_builder 欄位
表示這個非泛型實例所委派的一般 builder 物件。
