...
ms.locfileid: "80699055"
---
# <a name="images-and-icons-for-visual-studio"></a>適用於 Visual Studio 的影像和圖示
## <a name="image-use-in-visual-studio"></a><a name="BKMK_ImageUseInVisualStudio"></a>視覺工作室中的影像使用
...
- **縮略 圖。** 對話框的預覽區域(如"新項目"對話框)中使用的圖像。

- **對話框圖像。** 以描述性圖形或消息指示器顯示在對話框或嚮導中的圖像。 很少使用,且僅在必要時才用於說明一個困難的概念或引起使用者的注意(警報、警告)。
...
- **上下文:** 在概念開發過程中考慮圖示角色的所有方面,這在決定哪些元素構成圖示的核心隱喻時至關重要。

  使用圖示,有許多設計點需要避免:

- 除非適用,否則不要使用表示 UI 元素的圖示。 當 UI 元素既不常見、明顯也不唯一時,請選擇更抽象或符號化的方法。

- 不要過度使用文檔、資料夾、箭頭和放大鏡等常見元素。 僅當圖示的含義至關重要時,才使用這些元素。 例如,右側的放大鏡應僅指示搜索、瀏覽和查找。
...
#### <a name="concept-development"></a>概念開發
 Visual Studio 在其 UI 中具有多種圖示類型。 在開發過程中仔細考慮圖標類型。 不要對圖示元素使用不明確或不常見的 UI 物件。 在這些情況下,例如使用智慧標記圖示,請選擇符號。 請注意,左側抽象標記的含義比右側模糊的基於 UI 的版本更明顯:
...
|![正確的智慧標籤圖示](../../extensibility/ux-guidelines/media/0404-01_smarttagcorrect.png "0404-01_SmartTagCorrect")|![不正確的智慧標籤圖示](../../extensibility/ux-guidelines/media/0404-02_smarttagincorrect.png "0404-02_SmartTagIncorrect")|
 ...
 在某些情況下,標準、易於識別的 UI 元素對圖示工作良好。 新增視窗就是一個範例:

|||
|-|-|
|**圖示中更正 UI 元素**|**圖示的 UI 元素不正確**|
|![正確的加入視窗圖示](../../extensibility/ux-guidelines/media/0404-03_addwindowcorrect.png "0404-03_AddWindowCorrect")|![不正確的加入視窗圖示](../../extensibility/ux-guidelines/media/0404-04_addwindowincorrect.png "0404-04_AddWindowIncorrect")|
 ...
 不要將文檔用作基本元素,除非文檔對圖示的含義至關重要。 如果沒有 Add Document 上的文檔元素(下圖),含義將丟失,而使用"刷新"時,文檔元素就不必傳達含義。
...
|![正確的文件圖示](../../extensibility/ux-guidelines/media/0404-05_documenticoncorrect.png "0404-05_DocumentIconCorrect")|![不正確的文件圖示](../../extensibility/ux-guidelines/media/0404-06_documenticonincorrect.png "0404-06_DocumentIconIncorrect")|
 ...
 "show"的概念應該由最能說明顯示內容的圖示表示,例如使用"顯示所有檔"範例。 如有必要,可以使用鏡頭隱喻來指示"視圖"的概念,例如使用資源視圖示例。
...
|![搜尋圖示](../../extensibility/ux-guidelines/media/0404-09_search.png "0404-09_Search")|![[縮放] 圖示](../../extensibility/ux-guidelines/media/0404-10_zoom.png "0404-10_Zoom")|
 ...
 在樹檢視中,不要同時使用資料夾圖示和修改器。 如果可用,則僅使用修改器。

|||
|-|-|
|**正確的樹檢視圖示**|**樹狀圖示不正確**|
|![正確樹檢視圖示&#40;1&#41;](../../extensibility/ux-guidelines/media/0404-11_treeviewcorrect1.png "0404-11_TreeViewCorrect1") ![正確樹視圖圖示&#40;2&#41;](../../extensibility/ux-guidelines/media/0404-12_treeviewcorrect2.png "0404-12_TreeViewCorrect2")|![樹視圖示&#40;1&#41;](../../extensibility/ux-guidelines/media/0404-13_treeviewincorrect1.png "0404-13_TreeViewIncorrect1") ![不正確的樹視圖圖示&#40;2&#41;](../../extensibility/ux-guidelines/media/0404-14_treeviewincorrect2.png "0404-14_TreeViewIncorrect2")|
...
#### <a name="layout"></a>配置
 ...
 將圖示居其像素幀中居中。 如果無法這樣做,則將圖示對齊到框架的頂部和/或右側。
 ...
 ![圖示位於像素框架的中央並靠上對齊](../../extensibility/ux-guidelines/media/0404-21_icontopalign.png "0404-21_IconTopAlign")<br />圖示中並對齊到框架頂部

 要實現理想的對齊和平衡,請避免用動作字形阻擋圖示的基本元素。 將字形放在基元素左上角附近。 新增附加元素時,請考慮圖示的對齊和平衡。
...
|![正確的圖示平衡和對齊方式](../../extensibility/ux-guidelines/media/0404-22_alignbalancecorrect.png "0404-22_AlignBalanceCorrect")|![不正確的圖示平衡和對齊方式](../../extensibility/ux-guidelines/media/0404-23_alignbalanceincorrect.png "0404-23_AlignBalanceIncorrect")|
 ...
 確保共用元素並在集中使用的圖示的大小奇偶校驗。 請注意,在不正確的配對中,圓圈和箭頭大小過大且不匹配。
...
|-|-|
|**正確的負正比率**|**不正確的負正比率**|
|![&#40;1&#41;图标的正确视觉权重](../../extensibility/ux-guidelines/media/0404-26_visualweightcorrect1.png "0404-26_VisualWeightCorrect1")<br /><br /> ![圖示&#40;2&#41;的正确视觉权重](../../extensibility/ux-guidelines/media/0404-27_visualweightcorrect2.png "0404-27_VisualWeightCorrect2")<br /><br /> ![&#40;3&#41;图标的正确视觉权重](../../extensibility/ux-guidelines/media/0404-28_visualweightcorrect3.png "0404-28_VisualWeightCorrect3")|![不正確的圖示視覺加權](../../extensibility/ux-guidelines/media/0404-29_visualweightincorrect.png "0404-29_VisualWeightIncorrect")|
 ...
 **命令程式單圖示**由以下三個元素組成:一個基、一個修改器、一個操作或一個狀態。
 ...
 ![外殼和指令列圖示的範例](../../extensibility/ux-guidelines/media/0404-38_shellicons.png "0404-38_ShellIcons")<br />外殼和指令列圖示的範例
 ...
 **樹視圖消除歧義圖示**由以下元素中的三個組成:一個基、一個修改器、一個操作或一個狀態。

 ![樹狀圖消除歧義圖示的範例](../../extensibility/ux-guidelines/media/0404-40_treeviewicons.png "0404-40_TreeViewIcons")<br />樹狀圖消除歧義圖示的範例

 **基於狀態的值分類**圖示存在以下狀態:活動、活動禁用和非活動禁用。

 ![基於狀態的值類別圖示範例](../../extensibility/ux-guidelines/media/0404-41_statebasedtaxonomy.png "0404-41_StateBasedTaxonomy")<br />基於狀態的值類別圖示範例

 **IntelliSense**圖示包含以下元素中的三個:一個基體、一個修改器和一個狀態。

 ![IntelliSense 圖示範例](../../extensibility/ux-guidelines/media/0404-42_intellisenseicons.png "0404-42_IntelliSenseIcons")<br />IntelliSense 圖示範例
 ...
 **大型 (32x32) 專案**圖示由以下元素中的四個組成:一個基體、一個到兩個修飾符和一個語言疊加。
 ...
 ![大型 (32x32) 專案圖示例](../../extensibility/ux-guidelines/media/0404-46_32x32project.png "0404-46_32x32Project")<br />大型 (32x32) 專案圖示例
...
- **32 位元 PNG:** 圖示的首選格式。 可儲存單個柵格(圖元)圖像的無損數據壓縮檔案格式。 32 位元 PNG 檔案支援 Alpha 通道透明度、伽馬校正和隔行掃描。

- **32 位元 BMP:** 用於非 WPF 控制項。 32 位元 BMP 也稱為 XP 或高顏色,是 RGB/A 圖像格式,是具有 Alpha 通道透明度的真實彩色圖像。 Alpha 通道是在 Adobe Photoshop 中指定的一層透明度,然後作為附加(第四個)顏色通道保存在位圖中。 在圖稿製作期間,黑色背景將添加到所有 32 位 BMP 檔中,以提供有關顏色深度的快速視覺提示。 此黑色背景表示要在 UI 中遮罩的區域。

- **32 位 ICO:** 用於專案圖示和添加專案。 所有 ICO 檔都是具有 alpha 通道透明度 (RGB/A) 的 32 位元真顏色。 由於 ICO 檔案可以儲存多種尺寸和顏色深度,Vista 圖示通常採用 ICO 格式,包含 16x16、32x32、48x48 和 256x256 圖像大小。 為了在 Windows 資源管理器中正確顯示,ICO 檔必須為每個圖像大小保存為 24 位元和 8 位元顏色深度。

- **XAML:** 用於設計曲面和 Windows 裝飾器。 XAML 圖示是基於向量的圖像檔,支援縮放、旋轉、歸檔和透明度。 它們在視覺工作室中並不常見,但由於它們的靈活性而越來越受歡迎。

- **SVG**

- **24 位 BMP:** 用於可視化工作室命令列。 24 位 BMP 是一種真實彩色 RGB 圖像格式,它是一種圖示約定,它使用洋紅色 (R=255、G=0、 B=255) 作為仿冒透明度圖層的顏色鍵來創建透明度層。 在 24 位 BMP 中,所有洋紅色曲面都使用背景顏色顯示。

- **24 位 GIF:** 用於可視化工作室命令欄。 支援透明度的真彩色 RGB 圖像格式。 GIF 檔通常用於嚮導圖稿和 GIF 動畫。
...
- 專案圖示通常是包含多個大小的 .ico 檔。 僅更新 16x16、24x24 和 32x32 圖示。 大多數16x16和24x24圖示將包含相同的元素。 32x32 圖示包含更多詳細資訊,包括專案語言類型(如果適用)。

- 對於 32x32 圖示,基本元素通常具有 2 像素的線粗。 1 圖元或2 像素的線粗可用於細節元素。 用你最好的判斷來確定哪個更合適。

- 元素之間至少有 1 像素間距,用於 16x16 和 24x24 圖示。 對於 32x32 圖示,在元素之間以及修改器和基本元素之間使用 2 像素間距。
...
#### <a name="color-and-accessibility"></a>顏色與可存取性
 Visual Studio 合規性準則要求產品中的所有圖示都通過顏色和對比度的輔助功能要求。 這是通過圖示反轉實現的,當您正在設計時,您應該意識到它們將在產品中以程式設計方式反轉。

 有關在視覺工作室圖示中使用顏色的詳細資訊,請參閱[在影像中使用顏色](../../extensibility/ux-guidelines/images-and-icons-for-visual-studio.md#BKMK_UsingColorInImages)。

## <a name="using-color-in-images"></a><a name="BKMK_UsingColorInImages"></a>使用顏色
...
### <a name="accessibility"></a>Accessibility
 Visual Studio 合規性準則要求所有簽入產品的圖示都通過顏色和對比度的輔助功能要求。 視覺語言調色板中的顏色已經過測試並滿足這些要求。

#### <a name="color-inversion-for-dark-themes"></a>深色主題的顏色反向
 為了使圖示在 Visual Studio 黑暗主題中以正確的對比度顯示,以程式設計方式應用反轉。 本指南中的顏色部分被選中,以便它們正確反轉。 將顏色的使用限制為此調色板,否則在應用反轉時,您將獲得不可預知的結果。

 ![色彩反轉的圖示範例](../../extensibility/ux-guidelines/media/0405-01_darkthemeinversion.png "0405-01_DarkThemeInversion")<br />色彩反轉的圖示範例

### <a name="base-palette"></a>基本調色盤
 所有標準圖示包含三種基本顏色。 圖示不包含漸變或陰影,3D 工具圖示有一個或兩個例外。

|使用量|名稱|數值 (淺色佈景主題)|樣本|範例|
|-----------|----------|---------------------------|------------|-------------|
...
### <a name="extended-palette"></a>延伸調色盤

#### <a name="action-modifiers"></a>操作變更器
 以下四種顏色指示操作變更器所需的操作類型:
...
|![刪除關聯性圖示](../../extensibility/ux-guidelines/media/0405-07_deleterelationship.png "0405-07_DeleteRelationship")<br />刪除關聯性|![刪除資料行圖示](../../extensibility/ux-guidelines/media/0405-08_deletecolumn.png "0405-08_DeleteColumn")<br />刪除欄|![停止查詢圖示](../../extensibility/ux-guidelines/media/0405-09_stopquery.png "0405-09_StopQuery")<br />停止查詢|![連接離線圖示](../../extensibility/ux-guidelines/media/0405-10_connectionoffline.png "0405-10_ConnectionOffline")<br />連接離線|
 ...
 藍色應用於最常表示為箭頭的中性動作修改器,如"打開"、"下一步"、"上一個"、"導入"和"導出"。

|||||
|-|-|-|-|
|![移至欄位圖示](../../extensibility/ux-guidelines/media/0405-11_gotofield.png "0405-11_GoToField")<br />移至欄位|![&#45;图标中批量检查](../../extensibility/ux-guidelines/media/0405-12_batchedcheckin.png "0405-12_BatchedCheckIn")<br />批次簽入|![地址編輯器圖示](../../extensibility/ux-guidelines/media/0405-13_addresseditor.png "0405-13_AddressEditor")<br />位址編輯器|![關聯編輯器圖示](../../extensibility/ux-guidelines/media/0405-14_associationeditor.png "0405-14_AssociationEditor")<br />關聯編輯器|

 深色主要用於"新建"修改器。

|||||
|-|-|-|-|
|![新增專案圖示](../../extensibility/ux-guidelines/media/0405-15_newproject.png "0405-15_NewProject")<br />新增專案|![建立新的圖形圖示](../../extensibility/ux-guidelines/media/0405-16_createnewgraph.png "0405-16_CreateNewGraph")<br />建立新圖形|![新增單元測試圖示](../../extensibility/ux-guidelines/media/0405-17_newunittest.png "0405-17_NewUnitTest")<br />新儲存表元測試|![新增清單項目圖示](../../extensibility/ux-guidelines/media/0405-18_newlistitem.png "0405-18_NewListItem")<br />新增清單項目|
...
### <a name="code-hierarchy-palette"></a>程式碼層次結構調色盤

#### <a name="folder"></a>資料夾

|使用量|名稱|數值(所有主題)|樣本|範例|
|-----------|----------|--------------------------|------------|-------------|
...
##### <a name="examples-of-icons-with-language-modifiers"></a>有語言修飾符的圖示例

|||||||
|-|-|-|-|-|-|
|![Visual Basic 圖示](../../extensibility/ux-guidelines/media/0405-25_vb.png "0405-25_VB")<br />VB|![C&#35;图标](../../extensibility/ux-guidelines/media/0405-26_csharp.png "0405-26_CSharp")<br />C#|![C&#43;&#43; 图标](../../extensibility/ux-guidelines/media/0405-27_cplusplus.png "0405-27_CPlusPlus")<br />C++|![F&#35;图标](../../extensibility/ux-guidelines/media/0405-28_fsharp.png "0405-28_FSharp")<br />F#|![JavaScript 圖示](../../extensibility/ux-guidelines/media/0405-29_javascript.png "0405-29_JavaScript")<br />JavaScript|![Python 圖示](../../extensibility/ux-guidelines/media/0405-30_python.png "0405-30_Python")<br />Python|
...
#### <a name="intellisense"></a>IntelliSense
 IntelliSense 圖示使用獨占調色板。 這些顏色用於幫助使用者快速區分 IntelliSense 彈出視窗中的不同項。

|使用量|名稱|數值(所有主題)|樣本|
|-----------|----------|--------------------------|------------|
|類別, 事件|VS 動作橙色|C27D1A / 194,125,26|![樣本 C27D1A](../../extensibility/ux-guidelines/media/0405_c27d1a.png "0405_C27D1A")|
|擴充方法、方法、模組、委託|VS 動作紫色|652D90 / 101,45,144|![樣本 652D90](../../extensibility/ux-guidelines/media/0405_652d90.png "0405_652D90")|
|欄位, Entle, 巨集, 結構, 以比值類型, 運算子, 介面|VS 動作藍色|00539C / 0,83,156|![樣本 00539C](../../extensibility/ux-guidelines/media/0405_00539c.png "0405_00539C")|
|Object|VS 動作綠色|388A34 / 56,138,52|![樣本 388A34](../../extensibility/ux-guidelines/media/0405_388a34.png "0405_388A34")|
|常量、 例外、 枚舉項、 映射、 地圖項目、 命名空間、 樣本、 類型定義|背景 (VS BG)|424242 / 66,66,66|![樣本 424242](../../extensibility/ux-guidelines/media/0405_424242.png "0405_424242")|

##### <a name="examples-of-intellisense-icons"></a>IntelliSense 圖示範例
...
### <a name="notifications"></a>通知
 可視化工作室中的通知用於指示狀態。 通知調色板使用以下四種顏色以及黑色或白色前景填充選項來定義具有以下狀態級別的通知。
...
#### <a name="examples-of-notification-icons"></a>通知圖示例
...
### <a name="visual-studio-online"></a>Visual Studio Online
 通常,可視化工作室連線功能由託管在瀏覽器中的功能組成。 顏色在不同的環境中不同,但樣式保持不變。

|群組|使用量|名稱|數值(所有主題)|樣本|
|-----------|-----------|----------|--------------------------|------------|
...
#### <a name="examples-of-visual-studio-online-icons"></a>視覺工作室線上圖示例
...
|F12|||
|---------|-|-|
|![F12 美化程式碼圖示](../../extensibility/ux-guidelines/media/0405-61_f12prettycode.png "0405-61_F12PrettyCode")<br />漂亮的代碼|![F12 警告圖示](../../extensibility/ux-guidelines/media/0405-62_f12warning.png "0405-62_F12Warning")<br />警告|![F12 模擬圖示](../../extensibility/ux-guidelines/media/0405-63_f12emulate.png "0405-63_F12Emulate")<br />模擬|
