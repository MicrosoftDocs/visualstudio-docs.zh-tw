...
- Visual Studio 2015 的最小解析為**1280 x 720**。 這表示它是*可能*雖然它可能不是理想的使用者經驗，使用 Visual Studio 這個解析度。 沒有保證所有層面，都是使用賹槲 1280 x 720。
...
這種情況下正確的設計是要遵循一般模式 Internet Explorer、 Office 和 Visual Studio： 暫留時，使用者可以看到工具提示描述，並按一下隱藏 UI。
