 ...
 **錯誤：**![加底線的文字不是超連結是 Visual Studio 反模式。](../../extensibility/ux-guidelines/media/0102-g_grouplabelincorrect.png "0102 g_GroupLabelIncorrect")<br />加底線的文字不是超連結是 Visual Studio 反模式。

 **良好：**![正確地套用樣式，非超連結文字會顯示未修飾環境字型。](../../extensibility/ux-guidelines/media/0102-h_grouplabelcorrect.png "0102 h_GroupLabelCorrect")<br />正確地套用樣式，非超連結文字會顯示未修飾環境字型。
