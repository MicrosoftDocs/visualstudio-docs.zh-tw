...
- 大綱
     ...
     有數個選項，以支援大綱。 例如，您可以支援**摺疊至定義**命令，請提供編輯器控制項的大綱區域，或支援用戶端控制的區域。 如需詳細資訊，請參閱[如何：提供展開大綱的支援，在舊版語言服務中](../../extensibility/internals/how-to-provide-expanded-outlining-support-in-a-legacy-language-service.md)。
