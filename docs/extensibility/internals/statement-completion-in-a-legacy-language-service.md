...
## <a name="implementing-statement-completion"></a>實作的陳述式完成  
 ...
 若要實作陳述式完成，您的語言都必須有陳述式完成觸發程序，可加以剖析。 例如，[!INCLUDE[vbprvb](../../code-quality/includes/vbprvb_md.md)]會使用點 （.） 運算子，而[!INCLUDE[vcprvc](../../code-quality/includes/vcprvc_md.md)]使用箭號 (->) 運算子。 語言服務可以使用一個以上的觸發程序，來起始陳述式完成。 這些觸發程序被撰寫命令篩選器。  
