...
ms.locfileid: "39512588"
---
# <a name="how-to-create-a-vsct-file"></a>如何： 建立.vsct 檔  
...
您可以建立以 XML 為基礎 *.vsct*現有命令資料表中的檔案 *.ctc*原始程式檔。 如此一來，您可以利用新的 XML 架構[!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)]命令資料表 (VSCT) 編譯器格式。  
