...
您可以使用*vsct.exe*編譯器来轉換的現有 *.cto*檔案載入 *.vsct*檔案。 如需詳細資訊，請參閱[如何：從現有的.cto 檔建立.vsct 檔](../../extensibility/internals/how-to-create-a-dot-vsct-file.md#how-to-create-a-dot-vsct-file-from-an-existing-dot-cto-file)。
