...
|**屬性**|**[定義]**|
|-|-|
|Uri|具備定義可從中載入影像之位置的 URI。 可以是下列其中一項：<br /><br /> -使用 application:///授權單位的[PACK URI](/dotnet/framework/wpf/app-development/pack-uris-in-wpf)<br /><br /> -絕對元件資源參考<br /><br /> -包含原生資源之檔案的路徑|
 ...
 **驗證自訂映射資訊清單**
 ...
 按一下 [新增] 以選取**新的搜尋**目錄，以搜尋資訊清單及其對應的 dll。 此工具會記住這些搜尋目錄，而且可以藉由檢查或取消選取目錄來開啟或關閉它們。
