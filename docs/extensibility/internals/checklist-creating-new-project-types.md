...
5. 撰寫下列專案類型元件的程式碼：
    ...
    - 專案階層架構和命令處理。 如需詳細資訊，請參閱 <<c0> [ 使用 HierUtil7 專案類別以實作專案類型 (C++)](https://msdn.microsoft.com/library/a5c16a09-94a2-46ef-87b5-35b815e2f346)，[專案模型的項目](../../extensibility/internals/elements-of-a-project-model.md)，[專案模型的核心元件](../../extensibility/internals/project-model-core-components.md)，及[Menucommand 對比。</c0>OleMenuCommands](../../extensibility/menucommands-vs-olemenucommands.md)。
