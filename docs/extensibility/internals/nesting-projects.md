...
## <a name="nested-projects-example"></a>巢狀的專案範例
 ![巢狀專案方案](../../extensibility/internals/media/vsnestedprojects.gif "vsNestedProjects")巢狀專案範例

## <a name="see-also"></a>另請參閱
- [如何：實作巢狀專案](../../extensibility/internals/how-to-implement-nested-projects.md)
