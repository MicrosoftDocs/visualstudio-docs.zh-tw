...
2.  加入新的 VSIX 專案 (**檔案 / 新增 / 專案 / Visual C# / 擴充性 / VSIX 專案**) 和專案範本專案相同的方案中 (在**方案總管 中**，選取方案節點，按一下滑鼠右鍵，然後選取**新增 / 新增專案**)。 命名**MyProjectWizard。**  
...
8.  在 Visual Studio 的第二個執行個體，嘗試與您的新範本建立新的專案。 (**檔案 / 新增 / 專案 / Visual C# / MyProject 範本**)。 新的專案應該會出現名為的類別**Class1**。 您現在已建立自訂專案範本 ！ 現在停止偵錯。  
