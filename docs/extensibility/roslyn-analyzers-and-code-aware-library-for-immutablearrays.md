...
從主功能表中選擇**檔案** > **新增** > **專案**。  中**新的專案**] 對話方塊底下**C#** 專案，在左側的導覽列中，選擇**擴充性**，，然後在右窗格中選擇 [**與分析器程式碼修正**專案範本。  輸入名稱，然後確認對話方塊。
...
## <a name="initalize-the-analyzer"></a>用來初始化 「 分析器 」
