---
title: " (Visual Studio 範本的 Description 元素) |Microsoft Docs"
description: 瞭解 Description 元素，以及它如何指定範本在 [新增專案] 或 [加入新專案] 對話方塊中顯示的描述。
...
## <a name="remarks"></a>備註
 `Description` 是元素的必要子項目 `TemplateData` 。
