...
ms.locfileid: "66747640"
---
# <a name="manage-undo-and-redo-by-using-the-legacy-api"></a>管理復原和取消復原使用舊版的 API
編輯器必須支援可讓使用者反轉其最近的變更，它們就會修改程式碼時的復原作業。 大多數編輯器下實作[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]且.NET Framework 可以自動提供整合式的開發環境 (IDE) 的復原支援。
