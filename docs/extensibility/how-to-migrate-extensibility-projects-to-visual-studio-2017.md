...
>**注意：** 如果您的解決方案未參考 Microsoft.VSSDK.BuildTools NuGet 套件，您可以略過此步驟。
...
>**注意：** 這些程序將不會自動關閉 Visual Studio 執行個體正在執行時。 請確認您已關閉的機器-包括其他使用者，在 Visual Studio 的所有執行個體，然後繼續重試。
