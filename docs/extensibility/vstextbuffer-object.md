...
## <a name="remarks"></a>備註
 `VSTextBuffer`通常是透過呼叫來找到 `QueryInterface` `IVsTextBuffer` 。 如需詳細資訊，請參閱 [文字緩衝區](/visualstudio/extensibility/accessing-the-text-buffer-by-using-the-legacy-api?view=vs-2015)。
