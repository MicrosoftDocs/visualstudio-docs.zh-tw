...
* 請定期執行您在步驟1中使用的命令，將[您的網路位置](update-a-network-installation-of-visual-studio.md?view=vs-2019)重新整理為 Visual Studio 的最新更新，以新增更新的元件。
...
登錄位於您的私用登錄 hive 的 * Software\Microsoft\VisualStudio\16.0_ {InstanceId} \ Roslyn\Internal\Diagnostics \* 目錄中。 如需如何開啟登錄 hive 的指示，請參閱[編輯 Visual Studio 實例的](tools-for-managing-visual-studio-instances.md?view=vs-2019#editing-the-registry-for-a-visual-studio-instance)登錄。
...
* 請定期執行您在步驟1中使用的命令，將[您的網路位置](update-a-network-installation-of-visual-studio.md?view=vs-2017)重新整理為 Visual Studio 的最新更新，以新增更新的元件。
...
登錄位於您的私用登錄 hive 的 * Software\Microsoft\VisualStudio\15.0_ {InstanceId} \ Roslyn\Internal\Diagnostics \* 目錄中。 如需如何開啟登錄 hive 的指示，請參閱[編輯 Visual Studio 實例的](tools-for-managing-visual-studio-instances.md?view=vs-2017#editing-the-registry-for-a-visual-studio-instance)登錄。
