...
| 擴充功能 <br>更新檢查 | visualstudiogallery.msdn.microsoft.com<br><br>&#42;.windows.net <br>&#42;.microsoftonline.com <br>&#42;.live.com  | | 443 | 用來於已安裝的擴充功能有可用更新時提供通知 <br><br> 以登入位置的形式使用|
...
|實驗性 <br>功能啟用  | visualstudio-devdiv-c2s.msedge.net | |80 | 用來啟用實驗性的新功能或功能變更 |
...
| Office Web <br>增益集 <br> file:/// <br>驗證 <br>服務 | verificationservice.osi.office.net | https | 443 | 用來驗證針對 Office Web 增益集的資訊清單 |
