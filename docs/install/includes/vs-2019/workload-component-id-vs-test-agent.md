---
title: Visual Studio Test Agent 2019 工作負載和元件識別碼
titleSuffix: ''
...
元件識別碼 | 名稱 | 版本 | 相依性類型
--- | --- | --- | ---
Microsoft.VisualStudio.ComponentGroup.TestTools.TestAgent | Test Agent 核心功能 | 16.0.28315.86 | 必要
