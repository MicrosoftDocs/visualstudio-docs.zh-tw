...
ComponentGroup。發佈 | .NET Core 的 ClickOnce 發行 | 16.8.30622.256 | 必要
...
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 目標套件 | 16.8.30509.167 | 必要
...
NetCore. DevelopmentTools | .NET Core 開發工具 | 16.8.30607.99 | 必要
NetCore. 3.1 版 | .NET Core 3.1 執行時間 (LTS)  | 16.8.30703.189 | 必要
NetCore. 5.0 版 | .NET 5.0 執行時間 | 16.8.30703.189 | 必要
NetCore。 | .NET SDK | 16.8.30703.189 | 必要
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 計算模擬器 | 16.8.30509.167 | 必要
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.3 | 必要
Microsoft.VisualStudio.Component.JavaScript.Diagnostics | JavaScript 診斷 | 16.0.28517.75 | 必要
Microsoft.VisualStudio.Component.JavaScript.TypeScript | JavaScript 與 TypeScript 語言支援 | 16.8.30509.167 | 必要
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.8.30509.167 | 必要
...
VisualStudio... a. 4。0 | TypeScript 4.0 SDK | 16.0.30509.167 | 必要
Microsoft.VisualStudio.Component.Web | ASP.NET 與網頁程式開發工具 | 16.0.28517.75 | 必要
Microsoft.VisualStudio.ComponentGroup.Azure.Prerequisites | Azure 開發必要條件 | 16.8.30509.167 | 必要
...
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.8.30509.167 | 必要
Microsoft.Component.Azure.DataLake.Tools | Azure Data Lake 與串流分析工具 | 16.8.30509.167 | 建議
...
Microsoft.Net.Core.Component.SDK.2.1 | .NET Core 2.1 執行時間 (LTS)  | 16.8.30703.189 | 建議
Microsoft.VisualStudio.Component.AspNet45 | 進階的 ASP.NET 功能 | 16.0.28315.86 | 建議
Microsoft.VisualStudio.Component.Azure.Kubernetes.Tools | 適用於 Kubernetes 的 Visual Studio Tools | 16.8.30509.167 | 建議
...
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 分析工具 | 16.8.30509.167 | 建議
...
Microsoft.Net.Component.4.7.1.TargetingPack | .NET Framework 4.7.1 目標套件 | 16.8.30509.167 | 選擇性
Microsoft.Net.Component.4.7.TargetingPack | .NET Framework 4.7 目標套件 | 16.8.30509.167 | 選擇性
...
Microsoft.Net.Component.4.6.TargetingPack | .NET Framework 4.6 目標套件 | 16.0.28517.75 | 建議
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 目標套件 | 16.8.30509.167 | 建議
...
Microsoft.Net.ComponentGroup.TargetingPacks.Common | .NET Framework 4 – 4.6 開發工具 | 16.0.28516.191 | 建議
NetCore. 3.1 版 | .NET Core 3.1 執行時間 (LTS)  | 16.8.30703.189 | 建議
NetCore. 5.0 版 | .NET 5.0 執行時間 | 16.8.30703.189 | 建議
NetCore。 | .NET SDK | 16.8.30703.189 | 建議
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 計算模擬器 | 16.8.30509.167 | 建議
...
Microsoft.VisualStudio.Component.JavaScript.TypeScript | JavaScript 與 TypeScript 語言支援 | 16.8.30509.167 | 建議
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.8.30509.167 | 建議
...
VisualStudio... a. 4。0 | TypeScript 4.0 SDK | 16.0.30509.167 | 建議
...
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.8.30509.167 | 建議
...
Microsoft.VisualStudio.Component.WebDeploy | Web Deploy | 16.0.28517.75 | 建議
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.8.30509.167 | 建議
Microsoft.ComponentGroup.PythonTools.NativeDevelopment | Python 原生開發工具 | 16.8.30607.99 | 選擇性
Microsoft.VisualStudio.Component.Graphics.Tools | 適用於 DirectX 的圖形偵錯工具與 GPU 分析工具 | 16.0.28625.61 | 選擇性
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.DiagnosticTools | C++ 分析工具 | 16.5.29515.121 | 選擇性
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.28)  | 16.8.30509.167 | 選擇性
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.3 | 必要
Microsoft.VisualStudio.Component.ManagedDesktop.Core | Managed 桌面工作負載核心 | 16.4.29318.151 | 必要
Microsoft.VisualStudio.Component.ManagedDesktop.Prerequisites | .NET 桌面開發工具 | 16.8.30607.99 | 必要
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 與 Visual Basic Roslyn 編譯程式 | 16.0.28714.129 | 必要
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.8.30509.167 | 必要
Microsoft.VisualStudio.Component.SQL.CLR | SQL Server 的 CLR 資料類型 | 16.0.28315.86 | 必要
Microsoft.VisualStudio.Component.TextTemplating | 文字範本轉換 | 16.0.28625.61 | 必要
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.2876 | 建議
Microsoft.ComponentGroup.Blend | Blend for Visual Studio | 16.0.28315.86 | 建議
ComponentGroup。發佈 | .NET Core 的 ClickOnce 發行 | 16.8.30622.256 | 建議
Microsoft.Net.Component.4.5.1.TargetingPack | .NET Framework 4.5.1 目標套件 | 16.0.28517.75 | 建議
Microsoft.Net.Component.4.5.2.TargetingPack | .NET Framework 4.5.2 目標套件 | 16.0.28517.75 | 建議
Microsoft.Net.Component.4.5.TargetingPack | .NET Framework 4.5 目標套件 | 16.0.28517.75 | 建議
Microsoft.Net.Component.4.6.1.TargetingPack | .NET Framework 4.6.1 目標套件 | 16.0.28517.75 | 建議
...
Microsoft.Net.ComponentGroup.TargetingPacks.Common | .NET Framework 4 – 4.6 開發工具 | 16.0.28516.191 | 建議
Microsoft.Net.Core.Component.SDK.2.1 | .NET Core 2.1 執行時間 (LTS)  | 16.8.30703.189 | 建議
NetCore. DevelopmentTools | .NET Core 開發工具 | 16.8.30607.99 | 建議
Microsoft.VisualStudio.Component.Common.Azure.Tools | 連接與發行工具 | 16.4.29409.204 | 建議
Microsoft.VisualStudio.Component.Debugger.JustInTime | Just-in-Time 偵錯工具 | 16.0.28517.75 | 建議
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 分析工具 | 16.8.30509.167 | 建議
VisualStudio. DotNetModelBuilder | ML.NET Model Builder (Preview)  | 16.8.30509.167 | 建議
...
Microsoft.VisualStudio.Component.IntelliTrace.FrontEnd | IntelliTrace | 16.5.29515.121 | 建議
Microsoft.VisualStudio.Component.LiveUnitTesting | Live Unit Testing | 16.8.30509.167 | 建議
Microsoft.VisualStudio.Component.NuGet | NuGet 套件管理員 | 16.1.28829.92 | 建議
...
Microsoft.VisualStudio.Component.JavaScript.TypeScript | JavaScript 與 TypeScript 語言支援 | 16.8.30509.167 | 選擇性
...
Microsoft.VisualStudio.Component.PortableLibrary | .NET 可攜式程式庫目標套件 | 16.8.30509.167 | 選擇性
...
VisualStudio... a. 4。0 | TypeScript 4.0 SDK | 16.0.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Wcf.Tooling | Windows Communication Foundation | 16.0.28625.61 | 選擇性
...
Microsoft.VisualStudio.ComponentGroup.MSIX. 封裝 | MSIX 封裝工具 | 16.8.30607.99 | 選擇性
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 和 Web 開發工具的必要條件 | 16.4.29318.151 | 選擇性
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.8.30509.167 | 選擇性
...
Microsoft.Net.Component.4.7.1.TargetingPack | .NET Framework 4.7.1 目標套件 | 16.8.30509.167 | 必要
Microsoft.VisualStudio.Component.NuGet | NuGet 套件管理員 | 16.1.28829.92 | 必要
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 與 Visual Basic Roslyn 編譯程式 | 16.0.28714.129 | 必要
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.8.30509.167 | 必要
Microsoft.VisualStudio.Component.Unity | Visual Studio Tools for Unity | 16.0.28315.86 | 必要
Component.UnityEngine.x64 | Unity 中樞 | 16.8.30509.167 | 建議
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.3 | 必要
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.8.30509.167 | 必要
...
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.28)  | 16.8.30509.167 | 建議
...
Microsoft.VisualStudio.Component.JavaScript.Diagnostics | JavaScript 診斷 | 16.0.28517.75 | 選擇性
Microsoft.VisualStudio.Component.VC.140 | MSVC v140 - VS 2015 C++ 建置工具 (v14.00) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.ATLMFC | 適用于最新適用于 v142 build tools (x86 & x64) 的 c + + MFC | 16.4.29313.120 | 選擇性
Microsoft.VisualStudio.Component.VC.CLI.Support | 適用于 v142 build tools (14.28) 的 c + +/CLI 支援 | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.Llvm.Clang | 適用于 Windows (10.0.0) 的 c + + Clang 編譯器 | 16.8.30509.167 | 選擇性
...
Microsoft.VisualStudio.Component.VC.v141.x86.x64 | MSVC v141 - VS 2017 C++ x64/x86 建置工具 (v14.16) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選擇性
Microsoft.VisualStudio.ComponentGroup.NativeDesktop.Llvm.Clang | 適用于 Windows (10.0.0-x64/x86) 的 c + + Clang 工具 | 16.8.30509.167 | 選擇性
...
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.8.30509.167 | 必要
Microsoft.VisualStudio.Component.VC.Redist.14.Latest | C++ 2019 可轉散發更新 | 16.5.29515.121 | 必要
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.28)  | 16.8.30509.167 | 必要
...
Microsoft.VisualStudio.Component.VC.DiagnosticTools | C++ 分析工具 | 16.5.29515.121 | 建議
Microsoft.VisualStudio.Component.Windows10SDK.18362 | Windows 10 SDK (10.0.18362.0) | 16.1.28829.92 | 建議
Component.Android.NDK.R16B | Android NDK (R16B) | 16.8.30629.96 | 選擇性
...
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 目標套件 | 16.8.30509.167 | 選擇性
Net.tcp. 4.8。 | .NET Framework 4.8 SDK | 16.4.29313.120 | 選擇性
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選擇性
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.3 | 必要
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.8.30509.167 | 必要
Component.Android.NDK.R16B | Android NDK (R16B) | 16.8.30629.96 | 建議
Component.Ant | Apache Ant (1.9.3) | 1.9.3.8 | 建議
Component.MDD.Android | C++ Android 開發工具 | 16.0.28517.75 | 建議
Component.Android.NDK.R16B_3264 | Android NDK (R16B) (32 位元) | 16.8.30629.96 | 選擇性
...
--- | --- | --- | ---
Component.OpenJDK | OpenJDK (Microsoft 散發) | 16.1.28811.260 | 必要
Component.Xamarin | Xamarin | 16.8.30509.167 | 必要
Component.Xamarin.RemotedSimulator | Xamarin Remoted Simulator | 16.8.30509.167 | 必要
Microsoft.Component.MSBuild | MSBuild | 16.5.29515.121 | 必要
ComponentGroup。發佈 | .NET Core 的 ClickOnce 發行 | 16.8.30622.256 | 必要
Microsoft.Net.Component.4.6.1.TargetingPack | .NET Framework 4.6.1 目標套件 | 16.0.28517.75 | 必要
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 目標套件 | 16.8.30509.167 | 必要
...
Microsoft.VisualStudio.Component.Web | ASP.NET 與網頁程式開發工具 | 16.0.28517.75 | 必要
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 和 Web 開發工具的必要條件 | 16.4.29318.151 | 必要
VisualStudio. ComponentGroup. 用戶端 | ASP.NET 與網頁程式開發工具 | 16.8.30607.99 | 必要
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.8.30509.167 | 必要
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.2876 | 建議
Component.Microsoft.VisualStudio.Web.AzureFunctions | Azure WebJobs 工具 | 16.0.28714.129 | 建議
Microsoft.Net.Component.4.5.1.TargetingPack | .NET Framework 4.5.1 目標套件 | 16.0.28517.75 | 建議
...
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.8.30509.167 | 必要
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.2876 | 建議
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.3 | 建議
Microsoft.VisualStudio.Component.WebDeploy | Web Deploy | 16.0.28517.75 | 建議
...
Microsoft.VisualStudio.Component.WebDeploy | Web Deploy | 16.0.28517.75 | 建議
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.8.30509.167 | 建議
Component.CPython2.x64 | Python 2 64 位 (2.7.18)  | 2.7.18 | 選擇性
Component.CPython2.x86 | Python 2 32 位 (2.7.18)  | 2.7.18 | 選擇性
...
Net.tcp. 4.8。 | .NET Framework 4.8 SDK | 16.4.29313.120 | 選擇性
Microsoft.Net.ComponentGroup.DevelopmentPrerequisites | .NET Framework 4.7.2 開發工具 | 16.3.29207.166 | 選擇性
NetCore. 3.1 版 | .NET Core 3.1 執行時間 (LTS)  | 16.8.30703.189 | 選擇性
NetCore. 5.0 版 | .NET 5.0 執行時間 | 16.8.30703.189 | 選擇性
NetCore。 | .NET SDK | 16.8.30703.189 | 選擇性
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 計算模擬器 | 16.8.30509.167 | 選擇性
...
NetCore。 | .NET SDK | 16.8.30703.189 | 必要
Microsoft.VisualStudio.Component.AppInsights.Tools | 開發人員分析工具 | 16.5.29515.121 | 必要
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 分析工具 | 16.8.30509.167 | 必要
...
Microsoft.VisualStudio.ComponentGroup.MSIX. 封裝 | MSIX 封裝工具 | 16.8.30607.99 | 必要
...
Microsoft.VisualStudio.ComponentGroup.UWP.Xamarin | 適用於 Xamarin 的通用 Windows 平台工具 | 16.8.30607.99 | 必要
Microsoft.VisualStudio.Component.IntelliTrace.FrontEnd | IntelliTrace | 16.5.29515.121 | 建議
Net.tcp. 4.8。 | .NET Framework 4.8 SDK | 16.4.29313.120 | 選擇性
Microsoft.VisualStudio.Component.ClassDesigner | 類別設計工具 | 16.0.28528.71 | 選擇性
Microsoft.VisualStudio.Component.CodeClone | 重複程式碼 | 16.4.29409.204 | 選擇性
...
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.Tools.ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools (v 14.28)  | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.Tools.ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools (v 14.28)  | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.28)  | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.v141.ARM | MSVC v141 - VS 2017 C++ ARM 建置工具 (v14.16) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.v141.ARM64 | MSVC v141 - VS 2017 C++ ARM64 建置工具 (v14.16) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.VC.v141.x86.x64 | MSVC v141 - VS 2017 C++ x64/x86 建置工具 (v14.16) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選擇性
VisualStudio. Windows10SDK. 19041 | Windows 10 SDK (10.0.19041.0)  | 16.8.30509.167 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.IpOverUsb | USB 裝置連線 | 16.8.30607.99 | 選擇性
Microsoft.VisualStudio.ComponentGroup.ArchitectureTools.Managed | 架構與分析工具 | 16.5.29514.35 | 選擇性
Microsoft.VisualStudio.ComponentGroup.UWP.VC | C++ (v142) 通用 Windows 平台工具 | 16.8.30607.99 | 選擇性
...
Microsoft.Net.Core.Component.SDK.2.2 | .NET Core 2.2 執行時間 (不支援)  | 16.8.30509.167
Net.tcp. SDK. 3。0 | .NET Core 3.0 執行時間 (不支援)  | 16.8.30703.189
...
VisualStudio. VSOnline。 | Visual Studio Codespaces 的偵錯工具 | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.14.20.ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.20) | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.14.20.ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.20) | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.14.20.CLI.Support | 適用於 v142 建置工具的 C++/CLI 支援 (14.20) | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.14.20.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.20) | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.14.21.ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.21) | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.14.21.ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.21) | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.14.21.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.21) | 16.8.30509.167
...
VisualStudio. 14.22. ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.22) | 16.8.30509.167
VisualStudio. 14.22. Spectre。 | MSVC v142 - VS 2019 C++ ARM 已開啟 Spectre 風險降低功能的程式庫 (v14.22) | 16.5.29515.121
VisualStudio. 14.22. ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.22) | 16.8.30509.167
...
VisualStudio. 14.22. 支援服務 | 適用於 v142 建置工具的 C++/CLI 支援 (14.22) | 16.8.30509.167
...
VisualStudio. 14.22. x86。 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.22) | 16.8.30509.167
VisualStudio. 14.22. Spectre <。 | MSVC v142 - VS 2019 C++ x64/x86 已開啟 Spectre 風險降低功能的程式庫 (v14.22) | 16.5.29515.121
VisualStudio. v14.23. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools (v v14.23)  | 16.8.30509.167
VisualStudio. v14.23. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-降低的程式庫 (v v14.23)  | 16.5.29515.121
VisualStudio. v14.23. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools (v v14.23)  | 16.8.30509.167
...
VisualStudio. v14.23. 支援服務 | 適用于 v142 build tools (14.23) 的 c + +/CLI 支援 | 16.8.30509.167
...
VisualStudio. v14.23. x86。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v v14.23)  | 16.8.30509.167
VisualStudio. v14.23. Spectre <。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-降低的程式庫 (v v14.23)  | 16.5.29515.121
VisualStudio. 14.24. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools (v 14.24)  | 16.8.30509.167
VisualStudio. 14.24. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-降低的程式庫 (v 14.24)  | 16.5.29721.120
VisualStudio. 14.24. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools (v 14.24)  | 16.8.30509.167
...
VisualStudio. 14.24. Spectre。 | C + + v 14.24 ATL for 適用于 v142 build tools (x86 & x64)  | 16.8.30509.167
VisualStudio. 14.24. 支援服務 | 適用于 v142 build tools (14.24) 的 c + +/CLI 支援 | 16.8.30509.167
...
VisualStudio. 14.24. ARM64.. Spectre | C + + v 14.24 MFC for 適用于 v142 build tools with Spectre 緩和措施 (ARM64)  | 16.8.30509.167
VisualStudio. 14.24. Spectre。 | C + + v 14.24 MFC for 適用于 v142 build tools with Spectre 緩和 (x86 & x64)  | 16.8.30509.167
VisualStudio. 14.24. x86。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.24)  | 16.8.30509.167
VisualStudio. 14.24. Spectre <。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-降低的程式庫 (v 14.24)  | 16.5.29721.120
VisualStudio. v14.25. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools (v v14.25)  | 16.8.30509.167
VisualStudio. v14.25. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-降低的程式庫 (v v14.25)  | 16.8.30509.167
VisualStudio. v14.25. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools (v v14.25)  | 16.8.30509.167
VisualStudio. v14.25. ARM64. Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-降低的程式庫 (v v14.25)  | 16.8.30509.167
VisualStudio. v14.25。 | 適用于適用于 v142 build tools (x86 & x64) 的 c + + v v14.25 ATL | 16.8.30509.167
VisualStudio. v14.25. ARM。 | 適用于適用于 v142 build tools (ARM) 的 c + + v v14.25 ATL | 16.8.30509.167
VisualStudio. v14.25. Spectre （） | 適用于適用于 v142 組建工具的 c + + v v14.25 ATL， (ARM) 的 Spectre 緩和措施 | 16.8.30509.167
VisualStudio. v14.25. ARM64。 | C + + v v14.25 ATL for 適用于 v142 build tools (ARM64)  | 16.8.30509.167
VisualStudio. v14.25. ARM64.. Spectre | C + + v v14.25 ATL for 適用于 v142 build tools with Spectre 緩和措施 (ARM64)  | 16.8.30509.167
VisualStudio. v14.25. Spectre。 | C + + v v14.25 ATL for 適用于 v142 build tools (x86 & x64)  | 16.8.30509.167
VisualStudio. v14.25. 支援服務 | 適用于 v142 build tools (14.25) 的 c + +/CLI 支援 | 16.8.30509.167
VisualStudio. v14.25. MFC | C + + v v14.25 MFC for 適用于 v142 build tools (x86 & x64)  | 16.8.30509.167
VisualStudio. v14.25. a.. ARM | C + + v v14.25 MFC for 適用于 v142 build tools (ARM)  | 16.8.30509.167
VisualStudio. v14.25. Spectre （） | 適用于適用于 v142 的 c + + v v14.25 適用于 Spectre 緩和 (ARM) 的組建工具 | 16.8.30509.167
VisualStudio. v14.25. ARM64。 | C + + v v14.25 MFC for 適用于 v142 build tools (ARM64)  | 16.8.30509.167
VisualStudio. v14.25. ARM64.. Spectre | C + + v v14.25 MFC for 適用于 v142 build tools with Spectre 緩和措施 (ARM64)  | 16.8.30509.167
VisualStudio. v14.25. Spectre。 | C + + v v14.25 MFC for 適用于 v142 build tools with Spectre 緩和 (x86 & x64)  | 16.8.30509.167
VisualStudio. v14.25. x86。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v v14.25)  | 16.8.30509.167
VisualStudio. v14.25. Spectre <。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-降低的程式庫 (v v14.25)  | 16.8.30509.167
VisualStudio. v14.26. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools (v v14.26)  | 16.8.30509.167
VisualStudio. v14.26. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-降低的程式庫 (v v14.26)  | 16.8.30509.167
VisualStudio. v14.26. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools (v v14.26)  | 16.8.30509.167
VisualStudio. v14.26. ARM64. Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-降低的程式庫 (v v14.26)  | 16.8.30509.167
VisualStudio. v14.26。 | 適用于適用于 v142 build tools (x86 & x64) 的 c + + v v14.26 ATL | 16.8.30509.167
VisualStudio. v14.26. ARM。 | 適用于適用于 v142 build tools (ARM) 的 c + + v v14.26 ATL | 16.8.30509.167
VisualStudio. v14.26. Spectre （） | 適用于適用于 v142 組建工具的 c + + v v14.26 ATL， (ARM) 的 Spectre 緩和措施 | 16.8.30509.167
VisualStudio. v14.26. ARM64。 | C + + v v14.26 ATL for 適用于 v142 build tools (ARM64)  | 16.8.30509.167
VisualStudio. v14.26. ARM64.. Spectre | C + + v v14.26 ATL for 適用于 v142 build tools with Spectre 緩和措施 (ARM64)  | 16.8.30509.167
VisualStudio. v14.26. Spectre。 | C + + v v14.26 ATL for 適用于 v142 build tools (x86 & x64)  | 16.8.30509.167
VisualStudio. v14.26. 支援服務 | 適用于 v142 build tools (14.26) 的 c + +/CLI 支援 | 16.8.30509.167
VisualStudio. v14.26. MFC | C + + v v14.26 MFC for 適用于 v142 build tools (x86 & x64)  | 16.8.30509.167
VisualStudio. v14.26. a.. ARM | C + + v v14.26 MFC for 適用于 v142 build tools (ARM)  | 16.8.30509.167
VisualStudio. v14.26. Spectre （） | 適用于適用于 v142 的 c + + v v14.26 適用于 Spectre 緩和 (ARM) 的組建工具 | 16.8.30509.167
VisualStudio. v14.26. ARM64。 | C + + v v14.26 MFC for 適用于 v142 build tools (ARM64)  | 16.8.30509.167
VisualStudio. v14.26. ARM64.. Spectre | C + + v v14.26 MFC for 適用于 v142 build tools with Spectre 緩和措施 (ARM64)  | 16.8.30509.167
VisualStudio. v14.26. Spectre。 | C + + v v14.26 MFC for 適用于 v142 build tools with Spectre 緩和 (x86 & x64)  | 16.8.30509.167
VisualStudio. v14.26. x86。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v v14.26)  | 16.8.30509.167
VisualStudio. v14.26. Spectre <。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-降低的程式庫 (v v14.26)  | 16.8.30509.167
VisualStudio. 14.27. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools (v 14.27)  | 16.8.30509.167
VisualStudio. 14.27. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-降低的程式庫 (v 14.27)  | 16.8.30509.167
VisualStudio. 14.27. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools (v 14.27)  | 16.8.30509.167
VisualStudio. 14.27. ARM64. Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-降低的程式庫 (v 14.27)  | 16.8.30509.167
VisualStudio. 14.27。 | 適用于適用于 v142 build tools (x86 & x64) 的 c + + v 14.27 ATL | 16.8.30509.167
VisualStudio. 14.27. ARM。 | 適用于適用于 v142 build tools (ARM) 的 c + + v 14.27 ATL | 16.8.30509.167
VisualStudio. 14.27. Spectre （） | 適用于適用于 v142 組建工具的 c + + v 14.27 ATL， (ARM) 的 Spectre 緩和措施 | 16.8.30509.167
VisualStudio. 14.27. ARM64。 | C + + v 14.27 ATL for 適用于 v142 build tools (ARM64)  | 16.8.30509.167
VisualStudio. 14.27. ARM64.. Spectre | C + + v 14.27 ATL for 適用于 v142 build tools with Spectre 緩和措施 (ARM64)  | 16.8.30509.167
VisualStudio. 14.27. Spectre。 | C + + v 14.27 ATL for 適用于 v142 build tools (x86 & x64)  | 16.8.30509.167
VisualStudio. 14.27. 支援服務 | 適用于 v142 build tools (14.27) 的 c + +/CLI 支援 | 16.8.30509.167
VisualStudio. 14.27. MFC | C + + v 14.27 MFC for 適用于 v142 build tools (x86 & x64)  | 16.8.30509.167
VisualStudio. 14.27. a.. ARM | C + + v 14.27 MFC for 適用于 v142 build tools (ARM)  | 16.8.30509.167
VisualStudio. 14.27. Spectre （） | 適用于適用于 v142 的 c + + v 14.27 適用于 Spectre 緩和 (ARM) 的組建工具 | 16.8.30509.167
VisualStudio. 14.27. ARM64。 | C + + v 14.27 MFC for 適用于 v142 build tools (ARM64)  | 16.8.30509.167
VisualStudio. 14.27. ARM64.. Spectre | C + + v 14.27 MFC for 適用于 v142 build tools with Spectre 緩和措施 (ARM64)  | 16.8.30509.167
VisualStudio. 14.27. Spectre。 | C + + v 14.27 MFC for 適用于 v142 build tools with Spectre 緩和 (x86 & x64)  | 16.8.30509.167
VisualStudio. 14.27. x86。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.27)  | 16.8.30509.167
VisualStudio. 14.27. Spectre <。 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-降低的程式庫 (v 14.27)  | 16.8.30509.167
...
Microsoft.VisualStudio.Component.VC.Runtimes.ARM.Spectre | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-降低的程式庫 (v 14.28)  | 16.8.30509.167
Microsoft.VisualStudio.Component.VC.Runtimes.ARM64.Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-降低的程式庫 (v 14.28)  | 16.8.30509.167
Microsoft.VisualStudio.Component.VC.Runtimes.x86.x64.Spectre | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-降低的程式庫 (v 14.28)   | 16.8.30509.167
