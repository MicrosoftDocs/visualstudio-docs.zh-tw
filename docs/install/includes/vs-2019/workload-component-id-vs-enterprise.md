...
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 目標套件 | 16.6.30027.131 | 必要
...
NetCore. Component. 3。1 | .NET Core 3.1 LTS 執行時間 | 16.6.30107.105 | 必要
NetCore. Component SDK | .NET Core SDK | 16.6.30107.105 | 必要
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 計算模擬器 | 16.6.30013.169 | 必要
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.6.30013.169 | 必要
...
VisualStudio. Component. 3。8 | TypeScript 3.8 SDK | 16.0.29813.82 | 必要
...
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.6.30013.169 | 必要
Microsoft.Component.Azure.DataLake.Tools | Azure Data Lake 與串流分析工具 | 16.6.30013.169 | 建議
...
Microsoft.Net.Core.Component.SDK.2.1 | .NET Core 2.1 LTS 執行時間 | 16.6.30107.105 | 建議
...
Microsoft.Net.Component.4.7.1.TargetingPack | .NET Framework 4.7.1 目標套件 | 16.6.30027.131 | 選用
Microsoft.Net.Component.4.7.TargetingPack | .NET Framework 4.7 目標套件 | 16.6.30027.131 | 選用
Microsoft.Net. TargetingPack | .NET Framework 4.8 目標套件 | 16.4.29313.120 | 選用
...
Microsoft.Net. ComponentGroup. DeveloperTools | .NET Framework 4.8 開發工具 | 16.4.29318.151 | 選用
...
Microsoft.Net.Component.4.6.TargetingPack | .NET Framework 4.6 目標套件 | 16.0.28517.75 | 建議
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 目標套件 | 16.6.30027.131 | 建議
...
Microsoft.Net.ComponentGroup.TargetingPacks.Common | .NET Framework 4 – 4.6 開發工具 | 16.0.28516.191 | 建議
NetCore. Component. 3。1 | .NET Core 3.1 LTS 執行時間 | 16.6.30107.105 | 建議
NetCore. Component SDK | .NET Core SDK | 16.6.30107.105 | 建議
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 計算模擬器 | 16.6.30013.169 | 建議
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.6.30013.169 | 建議
...
VisualStudio. Component. 3。8 | TypeScript 3.8 SDK | 16.0.29813.82 | 建議
...
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.6.30013.169 | 建議
...
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools （v 14.26） | 16.6.30013.169 | 選用
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.2 | 必要
Microsoft.VisualStudio.Component.ManagedDesktop.Core | Managed 桌面工作負載核心 | 16.4.29318.151 | 必要
Microsoft.VisualStudio.Component.ManagedDesktop.Prerequisites | .NET 桌面開發工具 | 16.6.30013.169 | 必要
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 與 Visual Basic Roslyn 編譯程式 | 16.0.28714.129 | 必要
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.6.30013.169 | 必要
Microsoft.VisualStudio.Component.SQL.CLR | SQL Server 的 CLR 資料類型 | 16.0.28315.86 | 必要
Microsoft.VisualStudio.Component.TextTemplating | 文字範本轉換 | 16.0.28625.61 | 必要
Component.Microsoft.VisualStudio.LiveShare | Live Share | 1.0.1998 | 建議
...
Microsoft.VisualStudio.Component.DiagnosticTools | .NET 分析工具 | 16.5.29515.121 | 建議
VisualStudio. Component. DotNetModelBuilder | ML.NET 模型產生器（預覽） | 16.6.30013.169 | 建議
...
VisualStudio. Component. 3。8 | TypeScript 3.8 SDK | 16.0.29813.82 | 選用
Microsoft.VisualStudio.Component.Wcf.Tooling | Windows Communication Foundation | 16.0.28625.61 | 選用
...
VisualStudio. ComponentGroup. MSIX. 封裝 | MSIX 封裝工具 | 16.4.29409.204 | 選用
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 和 Web 開發工具的必要條件 | 16.4.29318.151 | 選用
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.6.30013.169 | 選用
...
Microsoft.Net.Component.4.7.1.TargetingPack | .NET Framework 4.7.1 目標套件 | 16.6.30027.131 | 必要
Microsoft.VisualStudio.Component.NuGet | NuGet 套件管理員 | 16.1.28829.92 | 必要
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 與 Visual Basic Roslyn 編譯程式 | 16.0.28714.129 | 必要
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.6.30013.169 | 必要
...
Microsoft.VisualStudio.Component.VC.ATL | 最新適用于 v142 build 工具的 c + + ATL （x86 & x64） | 16.4.29313.120 | 建議
...
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools （v 14.26） | 16.6.30013.169 | 建議
...
Microsoft.Net.Component.4.6.1.TargetingPack | .NET Framework 4.6.1 目標套件 | 16.0.28517.75 | 選用
Net.tcp. node.js SDK | .NET Framework 4.8 SDK | 16.4.29313.120 | 選用
Microsoft.VisualStudio.Component.JavaScript.Diagnostics | JavaScript 診斷 | 16.0.28517.75 | 選用
Microsoft.VisualStudio.Component.VC.140 | MSVC v140 - VS 2015 C++ 建置工具 (v14.00) | 16.0.28625.61 | 選用
Microsoft.VisualStudio.Component.VC.ATLMFC | 最新適用于 v142 build 工具的 c + + MFC （x86 & x64） | 16.4.29313.120 | 選用
Microsoft.VisualStudio.Component.VC.CLI.Support | 適用于 v142 build tools （14.26）的 c + +/CLI 支援 | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.VC.Llvm.Clang | 適用于 Windows 的 c + + Clang 編譯器（10.0.0） | 16.6.30027.131 | 選用
...
Microsoft.VisualStudio.Component.VC.v141.x86.x64 | MSVC v141 - VS 2017 C++ x64/x86 建置工具 (v14.16) | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.6.30027.131 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.6.30027.131 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選用
Microsoft.VisualStudio.ComponentGroup.NativeDesktop.Llvm.Clang | 適用于 Windows 的 c + + Clang 工具（10.0.0-x64/x86） | 16.6.30027.131 | 選用
...
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.0.28625.61 | 必要
Microsoft.VisualStudio.Component.VC.Redist.14.Latest | C++ 2019 可轉散發更新 | 16.5.29515.121 | 必要
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools （v 14.26） | 16.6.30013.169 | 必要
...
Microsoft.VisualStudio.Component.VC.DiagnosticTools | C++ 分析工具 | 16.5.29515.121 | 建議
Microsoft.VisualStudio.Component.Windows10SDK.18362 | Windows 10 SDK (10.0.18362.0) | 16.1.28829.92 | 建議
Component.Android.NDK.R16B | Android NDK (R16B) | 16.6.30107.105 | 選用
...
Microsoft.Net.Component.4.7.2.TargetingPack | .NET Framework 4.7.2 目標套件 | 16.6.30027.131 | 選用
Net.tcp. node.js SDK | .NET Framework 4.8 SDK | 16.4.29313.120 | 選用
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.6.30027.131 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.6.30027.131 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選用
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.2 | 必要
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.0.28625.61 | 必要
Component.Android.NDK.R16B | Android NDK (R16B) | 16.6.30107.105 | 建議
Component.Ant | Apache Ant (1.9.3) | 1.9.3.8 | 建議
Component.MDD.Android | C++ Android 開發工具 | 16.0.28517.75 | 建議
Component.Android.NDK.R16B_3264 | Android NDK (R16B) (32 位元) | 16.6.30107.105 | 選用
...
--- | --- | --- | ---
Component.OpenJDK | OpenJDK (Microsoft 散發) | 16.1.28811.260 | 必要
Component.Xamarin | Xamarin | 16.6.30013.169 | 必要
...
Component.CPython3.x86 | Python 3 32 位（3.7.5） | 3.7.5 | 選用
Component.Microsoft.VisualStudio.RazorExtension | Razor 語言服務 | 16.0.28714.129 | 選用
Component.Microsoft.Web.LibraryManager | 程式庫管理員 | 16.0.28315.86 | 選用
...
Net.tcp. node.js SDK | .NET Framework 4.8 SDK | 16.4.29313.120 | 選用
Microsoft.Net.ComponentGroup.DevelopmentPrerequisites | .NET Framework 4.7.2 開發工具 | 16.3.29207.166 | 選用
NetCore. Component. 3。1 | .NET Core 3.1 LTS 執行時間 | 16.6.30107.105 | 選用
NetCore. Component SDK | .NET Core SDK | 16.6.30107.105 | 選用
...
Microsoft.VisualStudio.Component.Azure.Compute.Emulator | Azure 計算模擬器 | 16.6.30013.169 | 選用
...
VisualStudio. ComponentGroup. MSIX. 封裝 | MSIX 封裝工具 | 16.4.29409.204 | 必要
...
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.0.28625.61 | 選用
Microsoft.VisualStudio.Component.VC.Tools.ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools （v 14.26） | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.VC.Tools.ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools （v 14.26） | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools （v 14.26） | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.VC.v141.ARM | MSVC v141 - VS 2017 C++ ARM 建置工具 (v14.16) | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.VC.v141.ARM64 | MSVC v141 - VS 2017 C++ ARM64 建置工具 (v14.16) | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.VC.v141.x86.x64 | MSVC v141 - VS 2017 C++ x64/x86 建置工具 (v14.16) | 16.6.30013.169 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.6.30027.131 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.6.30027.131 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選用
VisualStudio. Windows10SDK. 19041 | Windows 10 SDK （10.0.19041.0） | 16.6.30107.105 | 選用
Microsoft.VisualStudio.Component.Windows10SDK.IpOverUsb | USB 裝置連線 | 16.5.29515.121 | 選用
Microsoft.VisualStudio.ComponentGroup.ArchitectureTools.Managed | 架構與分析工具 | 16.5.29514.35 | 選用
Microsoft.VisualStudio.ComponentGroup.UWP.VC | C++ (v142) 通用 Windows 平台工具 | 16.6.30013.169 | 選用
...
Microsoft.Net.Core.Component.SDK.2.2 | .NET Core 2.2 執行時間（EOL） | 16.6.30013.169
Net.tcp. Core SDK 3。0 | .NET Core 3.0 執行時間（EOL） | 16.6.30107.105
...
VisualStudio 元件。 VSOnline | Visual Studio 線上環境的偵錯工具 | 16.6.30013.169
...
Microsoft.VisualStudio.Component.VC.14.20.ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.20) | 16.6.30013.169
...
Microsoft.VisualStudio.Component.VC.14.20.ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.20) | 16.6.30013.169
...
Microsoft.VisualStudio.Component.VC.14.20.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.20) | 16.6.30013.169
...
Microsoft.VisualStudio.Component.VC.14.21.ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.21) | 16.6.30013.169
...
Microsoft.VisualStudio.Component.VC.14.21.ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.21) | 16.6.30013.169
...
Microsoft.VisualStudio.Component.VC.14.21.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.21) | 16.6.30013.169
...
VisualStudio. 14.22. ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.22) | 16.6.30013.169
VisualStudio. 14.22. Spectre。 | MSVC v142 - VS 2019 C++ ARM 已開啟 Spectre 風險降低功能的程式庫 (v14.22) | 16.5.29515.121
VisualStudio. 14.22. ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.22) | 16.6.30013.169
...
VisualStudio. 14.22 （ARM） | 適用于 v142 build tools （ARM）的 c + + v 14.22 ATL | 16.4.29313.120
VisualStudio. 14.22. Spectre （） | 具有 Spectre 緩和措施（ARM）之適用于 v142 build 工具的 c + + v 14.22 ATL | 16.5.29721.120
VisualStudio. 14.22. ARM64 的 | 適用于 v142 build tools （ARM64）的 c + + v 14.22 ATL | 16.4.29313.120
VisualStudio. 14.22. ARM64.. Spectre | 具有 Spectre 緩和措施之適用于 v142 build tools 的 c + + v 14.22 ATL （ARM64） | 16.5.29515.121
VisualStudio. 14.22. Spectre 的 | C + + v 14.22 ATL for 適用于 v142 build tools with Spectre 緩和（x86 & x64） | 16.5.29515.121
VisualStudio. 14.22. CLI. 支援 | 適用於 v142 建置工具的 C++/CLI 支援 (14.22) | 16.6.30020.68
VisualStudio. 14.22. MFC | 適用于適用于 v142 組建工具的 c + + v 14.22 MFC （x86 & x64） | 16.4.29313.120
...
VisualStudio. 14.22. ARM64。 | 適用于適用于 v142 build tools （ARM64）的 c + + v 14.22 MFC | 16.4.29313.120
...
VisualStudio. 14.22. x86 x64 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.22) | 16.6.30013.169
VisualStudio. 14.22. x86. Spectre 的 | MSVC v142 - VS 2019 C++ x64/x86 已開啟 Spectre 風險降低功能的程式庫 (v14.22) | 16.5.29515.121
VisualStudio. 14.23. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools （v 14.23） | 16.6.30013.169
VisualStudio. 14.23. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-緩和程式庫（v 14.23） | 16.5.29515.121
VisualStudio. 14.23. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools （v 14.23） | 16.6.30013.169
VisualStudio. 14.23. ARM64. Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-緩和程式庫（v 14.23） | 16.5.29515.121
VisualStudio. 14.23. ATL | 適用于適用于 v142 組建工具的 c + + v 14.23 ATL （x86 & x64） | 16.5.29515.121
VisualStudio. 14.23 （ARM） | 適用于 v142 build tools （ARM）的 c + + v 14.23 ATL | 16.5.29515.121
VisualStudio. 14.23. Spectre （） | 具有 Spectre 緩和措施（ARM）之適用于 v142 build 工具的 c + + v 14.23 ATL | 16.5.29721.120
VisualStudio. 14.23. ARM64 的 | 適用于 v142 build tools （ARM64）的 c + + v 14.23 ATL | 16.5.29515.121
VisualStudio. 14.23. ARM64.. Spectre | 具有 Spectre 緩和措施之適用于 v142 build tools 的 c + + v 14.23 ATL （ARM64） | 16.5.29515.121
VisualStudio. 14.23. Spectre 的 | C + + v 14.23 ATL for 適用于 v142 build tools with Spectre 緩和（x86 & x64） | 16.5.29515.121
VisualStudio. 14.23. CLI. 支援 | 適用于 v142 build tools （14.23）的 c + +/CLI 支援 | 16.6.30020.68
VisualStudio. 14.23. MFC | 適用于適用于 v142 組建工具的 c + + v 14.23 MFC （x86 & x64） | 16.5.29515.121
...
VisualStudio. 14.23. ARM64。 | 適用于適用于 v142 build tools （ARM64）的 c + + v 14.23 MFC | 16.5.29515.121
...
VisualStudio. 14.23. x86 x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools （v 14.23） | 16.6.30013.169
VisualStudio. 14.23. x86. Spectre 的 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-緩和程式庫（v 14.23） | 16.5.29515.121
VisualStudio. 14.24. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools （v 14.24） | 16.6.30013.169
VisualStudio. 14.24. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-緩和程式庫（v 14.24） | 16.5.29721.120
VisualStudio. 14.24. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools （v 14.24） | 16.6.30013.169
VisualStudio. 14.24. ARM64. Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-緩和程式庫（v 14.24） | 16.5.29721.120
VisualStudio. 14.24. ATL | 適用于適用于 v142 組建工具的 c + + v 14.24 ATL （x86 & x64） | 16.5.29721.120
VisualStudio. 14.24 （ARM） | 適用于 v142 build tools （ARM）的 c + + v 14.24 ATL | 16.5.29721.120
VisualStudio. 14.24. Spectre （） | 具有 Spectre 緩和措施（ARM）之適用于 v142 build 工具的 c + + v 14.24 ATL | 16.5.29721.120
VisualStudio. 14.24. ARM64 的 | 適用于 v142 build tools （ARM64）的 c + + v 14.24 ATL | 16.5.29721.120
VisualStudio. 14.24. ARM64.. Spectre | 具有 Spectre 緩和措施之適用于 v142 build tools 的 c + + v 14.24 ATL （ARM64） | 16.5.29721.120
VisualStudio. 14.24. Spectre 的 | C + + v 14.24 ATL for 適用于 v142 build tools with Spectre 緩和（x86 & x64） | 16.5.29721.120
VisualStudio. 14.24. CLI. 支援 | 適用于 v142 build tools （14.24）的 c + +/CLI 支援 | 16.6.30020.68
VisualStudio. 14.24. MFC | 適用于適用于 v142 組建工具的 c + + v 14.24 MFC （x86 & x64） | 16.5.29721.120
...
VisualStudio. 14.24. ARM64。 | 適用于適用于 v142 build tools （ARM64）的 c + + v 14.24 MFC | 16.5.29721.120
...
VisualStudio. 14.24. x86 x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools （v 14.24） | 16.6.30013.169
VisualStudio. 14.24. x86. Spectre 的 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-緩和程式庫（v 14.24） | 16.5.29721.120
VisualStudio. 14.25. ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools （v 14.25） | 16.6.30013.169
VisualStudio. 14.25. Spectre。 | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-緩和程式庫（v 14.25） | 16.6.30013.169
VisualStudio. 14.25. ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools （v 14.25） | 16.6.30013.169
VisualStudio. 14.25. ARM64. Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-緩和程式庫（v 14.25） | 16.6.30013.169
VisualStudio. 14.25. ATL | 適用于適用于 v142 組建工具的 c + + v 14.25 ATL （x86 & x64） | 16.6.30013.169
VisualStudio. 14.25 （ARM） | 適用于 v142 build tools （ARM）的 c + + v 14.25 ATL | 16.6.30013.169
VisualStudio. 14.25. Spectre （） | 具有 Spectre 緩和措施（ARM）之適用于 v142 build 工具的 c + + v 14.25 ATL | 16.6.30013.169
VisualStudio. 14.25. ARM64 的 | 適用于 v142 build tools （ARM64）的 c + + v 14.25 ATL | 16.6.30013.169
VisualStudio. 14.25. ARM64.. Spectre | 具有 Spectre 緩和措施之適用于 v142 build tools 的 c + + v 14.25 ATL （ARM64） | 16.6.30013.169
VisualStudio. 14.25. Spectre 的 | C + + v 14.25 ATL for 適用于 v142 build tools with Spectre 緩和（x86 & x64） | 16.6.30013.169
VisualStudio. 14.25. CLI. 支援 | 適用于 v142 build tools （14.25）的 c + +/CLI 支援 | 16.6.30013.169
VisualStudio. 14.25. MFC | 適用于適用于 v142 組建工具的 c + + v 14.25 MFC （x86 & x64） | 16.6.30013.169
VisualStudio. 14.25. ARM。 | C + + v 14.25 MFC for 適用于 v142 build tools （ARM） | 16.6.30013.169
VisualStudio. 14.25. Spectre （）。 | C + + v 14.25 MFC for 適用于 v142 build tools with Spectre 緩和（ARM） | 16.6.30013.169
VisualStudio. 14.25. ARM64。 | 適用于適用于 v142 build tools （ARM64）的 c + + v 14.25 MFC | 16.6.30013.169
VisualStudio. 14.25. ARM64.. Spectre | C + + v 14.25 MFC for 適用于 v142 build tools with Spectre 緩和（ARM64） | 16.6.30013.169
VisualStudio. 14.25. Spectre。 | C + + v 14.25 MFC for 適用于 v142 build tools with Spectre 緩和（x86 & x64） | 16.6.30013.169
VisualStudio. 14.25. x86 x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools （v 14.25） | 16.6.30013.169
VisualStudio. 14.25. x86. Spectre 的 | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-緩和程式庫（v 14.25） | 16.6.30013.169
Microsoft.VisualStudio.Component.VC.ATL.ARM | 最新適用于 v142 build tools （ARM）的 c + + ATL | 16.4.29313.120
Microsoft.VisualStudio.Component.VC.ATL.ARM.Spectre | 使用 Spectre 緩和功能（ARM）的最新適用于 v142 build 工具的 c + + ATL | 16.5.29721.120
Microsoft.VisualStudio.Component.VC.ATL.ARM64 | 最新適用于 v142 build tools （ARM64）的 c + + ATL | 16.4.29313.120
Microsoft.VisualStudio.Component.VC.ATL.ARM64.Spectre | 使用 Spectre 緩和功能的最新適用于 v142 build 工具的 c + + ATL （ARM64） | 16.5.29515.121
Microsoft.VisualStudio.Component.VC.ATL.Spectre | 適用于最新適用于 v142 build 工具並具有 Spectre 防護功能（x86 & x64）的 c + + ATL | 16.5.29515.121
Microsoft.VisualStudio.Component.VC.ATLMFC.Spectre | 適用于最新適用于 v142 build 工具並具有 Spectre 防護功能（x86 & x64）的 c + + MFC | 16.5.29721.120
Microsoft.VisualStudio.Component.VC.MFC.ARM | 最新適用于 v142 build tools （ARM）的 c + + MFC | 16.4.29313.120
Microsoft.VisualStudio.Component.VC.MFC.ARM.Spectre | 適用于具有 Spectre 防護功能（ARM）之最新適用于 v142 build 工具的 c + + MFC | 16.5.29721.120
Microsoft.VisualStudio.Component.VC.MFC.ARM64 | 最新適用于 v142 build tools （ARM64）的 c + + MFC | 16.4.29313.120
Microsoft.VisualStudio.Component.VC.MFC.ARM64.Spectre | 適用于最新適用于 v142 build 工具的 c + + MFC （具有 Spectre 防護功能）（ARM64） | 16.5.29721.120
Microsoft.VisualStudio.Component.VC.Redist.MSM | C++ 2019 可轉散發 MSM | 16.5.29515.121
Microsoft.VisualStudio.Component.VC.Runtimes.ARM.Spectre | MSVC 適用于 v142-VS 2019 c + + ARM Spectre-緩和程式庫（v 14.26） | 16.6.30013.169
Microsoft.VisualStudio.Component.VC.Runtimes.ARM64.Spectre | MSVC 適用于 v142-VS 2019 c + + ARM64 Spectre-緩和程式庫（v 14.26） | 16.6.30013.169
Microsoft.VisualStudio.Component.VC.Runtimes.x86.x64.Spectre | MSVC 適用于 v142-VS 2019 c + + x64/x86 Spectre-緩和程式庫（v 14.26）  | 16.6.30013.169
