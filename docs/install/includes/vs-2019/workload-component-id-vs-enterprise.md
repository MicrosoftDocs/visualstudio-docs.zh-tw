...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.7.30310.162 | 必要
...
Microsoft.Component.Azure.DataLake.Tools | Azure Data Lake 與串流分析工具 | 16.7.30310.162 | 建議
...
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.27)  | 16.7.30310.162 | 選擇性
...
Microsoft.VisualStudio.Component.JavaScript.TypeScript | JavaScript 與 TypeScript 語言支援 | 16.7.30310.162 | 選擇性
...
Microsoft.VisualStudio.Component.PortableLibrary | .NET 可攜式程式庫目標套件 | 16.7.30310.162 | 選擇性
...
Microsoft.VisualStudio.ComponentGroup.MSIX. 封裝 | MSIX 封裝工具 | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.ComponentGroup.Web | ASP.NET 和 Web 開發工具的必要條件 | 16.4.29318.151 | 選擇性
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 開發 | 16.7.30310.162 | 選擇性
...
Microsoft.Net.Component.4.7.1.TargetingPack | .NET Framework 4.7.1 目標套件 | 16.7.30310.162 | 必要
Microsoft.VisualStudio.Component.NuGet | NuGet 套件管理員 | 16.1.28829.92 | 必要
Microsoft.VisualStudio.Component.Roslyn.Compiler | C# 與 Visual Basic Roslyn 編譯程式 | 16.0.28714.129 | 必要
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.7.30310.162 | 必要
Microsoft.VisualStudio.Component.Unity | Visual Studio Tools for Unity | 16.0.28315.86 | 必要
Component.UnityEngine.x64 | Unity 中樞 | 16.7.30310.162 | 建議
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.2 | 必要
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.7.30310.162 | 必要
...
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.27)  | 16.7.30310.162 | 建議
...
Microsoft.VisualStudio.Component.VC.v141.x86.x64 | MSVC v141 - VS 2017 C++ x64/x86 建置工具 (v14.16) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選擇性
Microsoft.VisualStudio.ComponentGroup.NativeDesktop.Llvm.Clang | 適用于 Windows (10.0.0-x64/x86) 的 c + + Clang 工具 | 16.7.30310.162 | 選擇性
...
Microsoft.VisualStudio.Component.Roslyn.LanguageServices | C# 和 Visual Basic | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選擇性
...
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 0.2 | 必要
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.7.30310.162 | 必要
Component.Android.NDK.R16B | Android NDK (R16B) | 16.7.30316.201 | 建議
Component.Ant | Apache Ant (1.9.3) | 1.9.3.8 | 建議
Component.MDD.Android | C++ Android 開發工具 | 16.0.28517.75 | 建議
Component.Android.NDK.R16B_3264 | Android NDK (R16B) (32 位元) | 16.7.30316.201 | 選擇性
...
--- | --- | --- | ---
Component.OpenJDK | OpenJDK (Microsoft 散發) | 16.1.28811.260 | 必要
Component.Xamarin | Xamarin | 16.7.30310.162 | 必要
...
Microsoft.VisualStudio.ComponentGroup.MSIX. 封裝 | MSIX 封裝工具 | 16.7.30310.162 | 必要
...
Microsoft.VisualStudio.Component.VC.CoreIde | C++ 核心功能 | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.VC.Tools.ARM | MSVC 適用于 v142-VS 2019 c + + ARM build tools (v 14.27)  | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.VC.Tools.ARM64 | MSVC 適用于 v142-VS 2019 c + + ARM64 build tools (v 14.27)  | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.VC.Tools.x86.x64 | MSVC 適用于 v142-VS 2019 c + + x64/x86 build tools (v 14.27)  | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.VC.v141.ARM | MSVC v141 - VS 2017 C++ ARM 建置工具 (v14.16) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.VC.v141.ARM64 | MSVC v141 - VS 2017 C++ ARM64 建置工具 (v14.16) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.VC.v141.x86.x64 | MSVC v141 - VS 2017 C++ x64/x86 建置工具 (v14.16) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.16299 | Windows 10 SDK (10.0.16299.0) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17134 | Windows 10 SDK (10.0.17134.0) | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.17763 | Windows 10 SDK (10.0.17763.0) | 16.0.28517.75 | 選擇性
VisualStudio. Windows10SDK. 19041 | Windows 10 SDK (10.0.19041.0)  | 16.7.30310.162 | 選擇性
Microsoft.VisualStudio.Component.Windows10SDK.IpOverUsb | USB 裝置連線 | 16.5.29515.121 | 選擇性
Microsoft.VisualStudio.ComponentGroup.ArchitectureTools.Managed | 架構與分析工具 | 16.5.29514.35 | 選擇性
Microsoft.VisualStudio.ComponentGroup.UWP.VC | C++ (v142) 通用 Windows 平台工具 | 16.7.30310.162 | 選擇性
...
VisualStudio 元件。 VSOnline | Visual Studio Codespaces 的偵錯工具 | 16.7.30310.162
...
Microsoft.VisualStudio.Component.VC.14.20.ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.20) | 16.7.30310.162
...
Microsoft.VisualStudio.Component.VC.14.20.ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.20) | 16.7.30310.162
...
Microsoft.VisualStudio.Component.VC.14.20.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.20) | 16.7.30310.162
...
Microsoft.VisualStudio.Component.VC.14.21.ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.21) | 16.7.30310.162
...
Microsoft.VisualStudio.Component.VC.14.21.ARM64 | MSVC v142 - VS 2019 C++ ARM64 建置工具 (v14.21) | 16.7.30310.162
...
Microsoft.VisualStudio.Component.VC.14.21.x86.x64 | MSVC v142 - VS 2019 C++ x64/x86 建置工具 (v14.21) | 16.7.30310.162
...
VisualStudio. 14.22. ARM | MSVC v142 - VS 2019 C++ ARM 建置工具 (v14.22) | 16.7.30310.162
