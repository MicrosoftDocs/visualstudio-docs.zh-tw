...
ms.locfileid: "113046101"
---
# <a name="visual-studio-build-numbers-and-release-dates"></a>Visual Studio 組建編號和發行日期

::: moniker range="vs-2022"

## <a name="visual-studio-2022-preview"></a>Visual Studio 2022 預覽

下表列出 Visual Studio 2022 Preview 至今的組建編號和發行日期。

| **版本**| **通道** | **發行日期** | **組建版本** |
| ---------------------- | ----------- | ---------------- | ----------------- |
| 17.0.0 | Preview 1.1 | 2021年6月24日 | 17.0.31423.177 |
| 17.0.0 | Preview 1 | 2021年6月17日 | 17.0.31410.414 |

> [!NOTE]
> 若要查看先前版本的資料，請參閱 [Visual Studio 2019 組建編號和發行日期](visual-studio-build-numbers-and-release-dates.md?view=vs-2019&preserve-view=true)。
...
| **版本**| **通道** | **發行日期** | **組建版本** |
| ---------------------- | ----------- | ---------------- | ----------------- |
| 16.10.3 | 版本 | 2021年6月29日 | 16.10.31424.327 |
...
> [!NOTE]
> 若要查看 *先前* 版本的資料，請參閱 [Visual Studio 2017 組建編號和發行日期](visual-studio-build-numbers-and-release-dates.md?view=vs-2017&preserve-view=true)。
>
>若要查看 *下一個* 版本的資料，請參閱 [Visual Studio 2022 組建編號和發行日期](visual-studio-build-numbers-and-release-dates.md?view=vs-2022&preserve-view=true)。
...
> [!NOTE]
> 若要查看較新版本的資料，請參閱 [Visual Studio 2019 組建編號和發行日期](?preserve-view=true&view=vs-2019) ，或 [Visual Studio 2022 組建編號和發行日期](?preserve-view=true&view=vs-2022)。
