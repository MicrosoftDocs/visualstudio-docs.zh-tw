...
1. 請在安裝程式中尋找您安裝的 Visual Studio 版本。 接著，選擇 [更多]，然後選擇 [解除安裝]。
     ...
     ![解除安裝 Visual Studio 2019](media/vs-2019/vs-installer-uninstall.png "解除安裝 Visual Studio 2019")

1. 按一下 [確定] 確認您的選擇。

     ![解除安裝 Visual Studio 確認](media/vs-2019/uninstall-visualstudio-confirm.png "確認您想要解除安裝 Visual Studio 2019")

如果稍後改變心意並想要重新安裝 Visual Studio 2019，請再次啟動 Visual Studio 安裝程式，選擇 [可用] 索引標籤，選擇您想要安裝的 Visual Studio 版本，然後選取 [安裝]。

## <a name="uninstall-visual-studio-installer"></a>解除安裝 Visual Studio 安裝程式

若要移除電腦中 Visual Studio 2019 的所有安裝和 Visual Studio 安裝程式，請在 [應用程式與功能] 中解除安裝。
