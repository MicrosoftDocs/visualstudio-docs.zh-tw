...
|將正切函數結束點繞著新的點移動 15 度角|點擊以建立新點,然後按住**Shift**+**Alt**並拖曳,然後釋放滑鼠按鈕|![將正切函數結束點繞著新的點移動 15 度角](../designers/media/317e5475-b70c-489f-9477-110a98639ade.png)<br /><br /> 畫筆調整指標|
