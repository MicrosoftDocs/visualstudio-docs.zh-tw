---
title: 同步 XCode 與 Visual Studio 2015 之間的變更 |Microsoft Docs
titleSuffix: ''
ms.date: 11/15/2016
ms.topic: conceptual
...
## <a name="the-remote-machine-menu"></a>遠端電腦功能表
 ...
 ![方案總管中的 [遠端電腦] 功能表項目](../cross-platform/media/cppmdd-u2-remotemachine-menu.jpg "CPPMDD_U2_RemoteMachine_Menu")
...
### <a name="open-in-xcode"></a>在 XCode 中開啟
 ...
 ![[輸出] 視窗會顯示遠端電腦動作。](../cross-platform/media/cppmdd-u2-remotemachine-output.png "CPPMDD_U2_RemoteMachine_Output")
