...
> [!NOTE]
> 如果您要尋找以 HTML 和 CSS 為基礎的跨平臺開發解決方案，請查看 Apache Cordova 的 Visual Studio Tools，如 [Visual Studio 的跨平臺開發](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#HTML)所述。
