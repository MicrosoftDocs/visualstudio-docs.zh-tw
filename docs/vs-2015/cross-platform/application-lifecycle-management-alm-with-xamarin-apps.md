...
|功能|支援 Xamarin|其他註解|  
|-------------|----------------------------|-------------------------|  
|內部部署 TFS 伺服器|[是]|組建電腦必須安裝 Xamarin，而且必須可連結到 OSX 電腦，以便為 iOS 進行建置。 請參閱 [為 Xamarin 設定 TFS](https://docs.microsoft.com/azure/devops/repos/tfvc/overview?view=azure-devops) (Xamarin 網站)|  
...
|程式碼涵蓋範圍|n/a||  
|[對程式碼進行單元測試](../test/unit-test-your-code.md)|[是]|對於 Windows 和 Android 的目標，可以使用內建的 MSTest 工具。 若要在 Windows、Android 和 iOS 上執行單元測試，Xamarin 會建議使用 NUnit。 請參閱 [為 Xamarin 設定 TFS](https://docs.microsoft.com/azure/devops/repos/tfvc/overview?view=azure-devops) (Xamarin 網站)。|  
...
|[效能總管](../profiling/performance-explorer.md)|否|請改為透過 Xamarin Studio 來使用 [Xamarin 分析工具](https://docs.microsoft.com/xamarin/cross-platform/deploy-test/) 。 請注意 Xamarin 分析工具目前為預覽狀態，而且尚未適用於 Windows 目標。|  
