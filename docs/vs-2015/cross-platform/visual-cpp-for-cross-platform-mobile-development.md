...
## <a name="get-the-tools"></a>取得工具  
 適用於跨平台行動裝置開發的 Visual C++ 是隨附於 Visual Studio 2015 的可安裝選項。 如需必要條件和安裝指示，請參閱 [安裝適用於跨平臺行動裝置應用程式開發的 Visual C++](../cross-platform/install-visual-cpp-for-cross-platform-mobile-development.md)。 若要建置 iOS 程式碼，您也需要 Mac 電腦和 Apple iOS 開發人員帳戶。 如需詳細資訊，請參閱 [安裝和設定工具以使用 IOS 建立](../cross-platform/install-and-configure-tools-to-build-using-ios.md)。  
...
## <a name="try-out-sample-code"></a>試驗範例程式碼  
 下載範例，示範如何建立可用在 Windows、Android 和 iOS 應用程式中的共用程式碼程式庫，以及如何建立完整的 Android Native Activity 應用程式。 若要開始使用，請參閱 [跨平臺行動開發範例](../cross-platform/cross-platform-mobile-development-examples.md)。  
  
## <a name="in-this-section"></a>本節內容  
  
1. [安裝適用於跨平臺行動裝置應用程式開發的 Visual C++](../cross-platform/install-visual-cpp-for-cross-platform-mobile-development.md)  
  
2. [安裝和設定工具以使用 iOS 建立](../cross-platform/install-and-configure-tools-to-build-using-ios.md)  
  
3. [建立 Android Native Activity 應用程式](../cross-platform/create-an-android-native-activity-app.md)  
  
4. [在 Android 和 iOS 上建立 OpenGL ES 應用程式](../cross-platform/build-an-opengl-es-application-on-android-and-ios.md)  
  
5. [跨平臺行動開發範例](../cross-platform/cross-platform-mobile-development-examples.md)
