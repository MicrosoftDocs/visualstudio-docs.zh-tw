...
>  按一下這裡以取得 [Visual Studio 2017](https://www.visualstudio.com/news/releasenotes/vs2017-relnotes) 版本資訊。  
 ...
 您可以直接建立新的專案，並開始撰寫程式碼； 選擇您要建立的應用程式類型； 或者您也可以[瀏覽](./ide/visual-studio-ide.md)的 Visual Studio IDE 以熟悉工具。  
...
1.  [適用於 Visual Studio 的 Xamarin](./cross-platform/build-apps-with-native-ui-using-xamarin-in-visual-studio.md)： 在 C# 中的所有裝置基底的通用程式碼  
  
2.  [使用 Visual Studio Apache Cordova](http://msdn.microsoft.com/library/db446f2c-6ba4-4c76-aac5-4c66f43b8c42)： 基底的 HTML、 CSS 和 JavaScript 或 Typescript 的通用程式碼  
  
3.  [Visual Studio Tools for Unity](./cross-platform/visual-studio-tools-for-unity.md)： 以 C# 的 2d/3d 遊戲開發  
  
4.  [C + + for Cross-platform Development](./cross-platform/visual-cpp-for-cross-platform-mobile-development.md)： 共用程式碼程式庫和 c + + 中的應用程式  
...
|||||  
|-|-|-|-|  
|[在 Visual Studio 2015 最新消息](./what-s-new-in-visual-studio-2015.md)|[Visual C# 的新功能](http://msdn.microsoft.com/library/9f18dc26-27fa-4603-a639-b573f07a117b)|[什麼是.NET Framework 4.6 的新功能](http://msdn.microsoft.com/library/1d971dd7-10fc-4692-8dac-30ca308fc0fa)|[ALM 的最新消息](http://msdn.microsoft.com/en-us/54b98a53-6083-4303-869a-8063d8fae938)|  
|[有關 c + + 的新功能](http://msdn.microsoft.com/library/1cc09fad-85a2-43c2-b022-bb99f5fe0ad7)|[Visual Basic 的新功能](http://msdn.microsoft.com/library/d7e97396-7f42-4873-a81c-4ebcc4b6ca02)|[什麼是 JavaScript 的新功能](~/E:/Repos/visualstudio-docs-pr/scripting-docs/javascript/what-s-new-in-javascript.md)||  
