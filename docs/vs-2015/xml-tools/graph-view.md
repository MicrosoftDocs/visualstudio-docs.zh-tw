...
圖表檢視會以圖形表示全域結構描述節點以及節點之間的關聯性。 請注意，圖表檢視無法讓您在設計介面上改變結構描述集的配置。 圖表檢視還包含 XML 結構描述設計工具工具列和階層連結列。
 ...
 ![XML 結構描述設計工具圖形檢視](../xml-tools/media/xsddesigner-graphview.gif "XSDDesigner_GraphView")
...
## <a name="design-surface"></a>設計介面
 ...
 如果設計介面空白，則會顯示 XML 編輯器、XML 結構描述總管和浮水印。 *水位線*是所有 XSD 設計工具視圖的連結清單。
...
## <a name="properties-window"></a>屬性視窗
 使用內容功能表一開始開啟 [ **屬性** ] 視窗。 依預設，[ **屬性** ] 視窗會出現在 Visual Studio 的右下角。 當您按一下在內容模型視圖中轉譯的節點時，該節點的屬性會顯示在 [ **屬性** ] 視窗中。
...
|**由左至右**|將圖表檢視中的配置變更為從左至右以階層表示節點。 您可以使用鍵盤快速鍵來存取此選項： **Alt + 向右鍵**。|
|**由右至左**|將圖表檢視中的配置變更為從右至左以階層表示節點。 您可以使用鍵盤快速鍵來存取此選項： **Alt + 向左鍵**。|
|**上到下**|將圖表檢視中的配置變更為從上至下以階層表示節點。 您可以使用鍵盤快速鍵來存取此選項： **Alt + 向下鍵**。|
|**從下到上**|將圖表檢視中的配置變更為從下至上以階層表示節點。 您可以使用鍵盤快速鍵來存取此選項： **Alt + 向上鍵**。|
