---
title: 如何：從 XML 架構瀏覽器將節點加入至工作區 |Microsoft Docs
ms.date: 11/15/2016
...
2. 以滑鼠右鍵按一下 XSD 總管中的 `PurchaseOrderType` 節點。 選取 [ **在圖形視圖中顯示]**。
...
2. 在 `PurchaseOrderType` XML 架構瀏覽器中，以滑鼠右鍵按一下節點，然後選取 [ **顯示所有參考**]。
