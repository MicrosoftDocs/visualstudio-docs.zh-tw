...
ms.locfileid: "75849873"
---
# <a name="analyzing-application-quality-by-using-code-analysis-tools"></a>{2&gt;使用程式碼分析工具來分析應用程式品質&lt;2}
...
### <a name="code-analysis-for-drivers"></a>驅動程式程式碼分析
 ...
 [驅動程式的程式碼分析警告](https://msdn.microsoft.com/library/windows/hardware/ff550572(v=VS.85).aspx)描述當驅動程式在偵測到驅動程式代碼中可能發生的錯誤時，所報告的程式碼分析警告。
