...
本主題的最新的版本可從[CA1824： 以 NeutralResourcesLanguageAttribute 標記組件](https://docs.microsoft.com/visualstudio/code-quality/ca1824-mark-assemblies-with-neutralresourceslanguageattribute)。
