...
## <a name="how-to-fix-violations"></a>如何修正違規
 若要修正此規則的違規情形，請移除透明方法的連結要求，或使用屬性來標記方法（ <xref:System.Security.SecuritySafeCriticalAttribute> 如果它正在執行安全性檢查，例如安全性需求）。

## <a name="when-to-suppress-warnings"></a>隱藏警告的時機
 請勿隱藏此規則的警告。

## <a name="example"></a>範例
 在下列範例中，規則會在方法上引發，因為方法是透明的，而且會以包含的 LinkDemand 標記 <xref:System.Security.PermissionSet> <xref:System.Security.Permissions.SecurityAction> 。
