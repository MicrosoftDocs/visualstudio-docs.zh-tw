...
```  
 ...
 如需詳細資訊，請參閱[CreateProcess 函數](https://go.microsoft.com/fwlink/?LinkId=181206)和[CloseHandle 函數](https://go.microsoft.com/fwlink/?LinkId=181207)。
