...
警告 C6242：跳出此 try 區塊會強制執行本機回溯。 會產生嚴重的效能負面影響  
 ...
 此警告表示跳躍陳述式會使控制流程離開 try-finally 以外的受保護區塊。  
  
 離開最後一個語句的受保護區塊，而不是從最後一個語句開始，則需要進行本機回溯。 本機回溯通常需要大約1000的機器指示;因此，效能會對效能造成不利。  
  
 用 `_leave` 來結束 try-finally 的受保護區塊。  
...
## <a name="see-also"></a>另請參閱  
 [try-finally 語句](https://msdn.microsoft.com/library/826e0347-ddfe-4f6e-a7bc-0398e0edc7c2)
