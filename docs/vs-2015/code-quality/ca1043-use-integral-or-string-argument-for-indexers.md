...
## <a name="cause"></a>原因
 公用或受保護的型別包含公用或受保護的索引子，它會使用 <xref:System.Int32?displayProperty=fullName> 、 <xref:System.Int64?displayProperty=fullName> 、或以外的索引類型 <xref:System.Object?displayProperty=fullName> <xref:System.String?displayProperty=fullName> 。
