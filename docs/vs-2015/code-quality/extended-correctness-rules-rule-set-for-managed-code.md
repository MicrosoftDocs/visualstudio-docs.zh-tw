...
ms.locfileid: "47497750"
---
# <a name="extended-correctness-rules-rule-set-for-managed-code"></a>適用於 Managed 程式碼的擴充正確性規則規則集
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主題的最新的版本可從[managed 程式碼的擴充正確性規則規則集](https://docs.microsoft.com/visualstudio/code-quality/extended-correctness-rules-rule-set-for-managed-code)。  
...
|[CA1414](../code-quality/ca1414-mark-boolean-p-invoke-arguments-with-marshalas.md)|標記布林 P/Invoke 引數，以 MarshalAs|  
...
|[CA2218](../code-quality/ca2218-override-gethashcode-on-overriding-equals.md)|Equals 覆寫 GetHashCode|  
...
|[CA2228](../code-quality/ca2228-do-not-ship-unreleased-resource-formats.md)|不要使用尚未發行的格式建置的資源|  
