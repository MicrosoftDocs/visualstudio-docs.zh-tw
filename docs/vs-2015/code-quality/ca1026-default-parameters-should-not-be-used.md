...
## <a name="rule-description"></a>規則描述
 ...
 編譯器會在存取 managed 程式碼時，忽略 c + + Managed 擴充功能的預設參數值。 Visual Basic 編譯器支援具有使用[選擇性](https://msdn.microsoft.com/library/4571ce88-a539-4115-b230-54eb277c6aa7)關鍵字之預設參數的方法。
