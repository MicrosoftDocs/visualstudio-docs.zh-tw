# [分析應用程式品質](analyzing-application-quality-by-using-code-analysis-tools.md)
## [分析 Managed 程式碼品質](analyzing-managed-code-quality-by-using-code-analysis.md)
### [Managed 程式碼的程式碼分析概觀](code-analysis-for-managed-code-overview.md)
### [如何：啟用和停用自動程式碼分析](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [如何：啟用和停用完整解決方案分析](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [自動功能暫停](automatic-feature-suspension.md)
### [如何：手動執行程式碼分析](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [如何：隱藏所產生程式碼的警告](how-to-suppress-code-analysis-warnings-for-generated-code.md)
...
#### [依 CheckId 分類的警告](code-analysis-warnings-for-managed-code-by-checkid.md)
...
##### [CA1060：將 P/Invokes 移到 NativeMethods 類別](ca1060-move-p-invokes-to-nativemethods-class.md)
...
##### [CA2101：指定 P/Invoke 字串引數的封送處理](ca2101-specify-marshaling-for-p-invoke-string-arguments.md)
#### [互通性警告](interoperability-warnings.md)
##### [CA1400：P/Invoke 進入點應該存在](ca1400-p-invoke-entry-points-should-exist.md)
##### [CA1401：不應顯示 P/Invokes](ca1401-p-invokes-should-not-be-visible.md)
...
##### [CA1404：在 P/Invoke 之後立即呼叫 GetLastError](ca1404-call-getlasterror-immediately-after-p-invoke.md)
...
##### [CA1415：正確宣告 P/Invokes](ca1415-declare-p-invokes-correctly.md)
...
##### [CA1901：P/Invoke 宣告應該為可移植](ca1901-p-invoke-declarations-should-be-portable.md)
...
##### [CA5122 P-Invoke 宣告不應為安全關鍵](ca5122-p-invoke-declarations-should-not-be-safe-critical.md)
...
## [分析 C/C++ 程式碼品質](analyzing-c-cpp-code-quality-by-using-code-analysis.md)
...
#### [最佳做法和範例](best-practices-and-examples-sal.md)
...
### [如何：對解決方案中的多個專案指定規則集](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [建立自訂規則集](creating-custom-code-analysis-rule-sets.md)
#### [如何：建立自訂規則集](how-to-create-a-custom-rule-set.md)
#### [在規則集編輯器中執行作業](working-in-the-code-analysis-rule-set-editor.md)
...
#### [為受控程式碼實作自訂簽入原則](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
