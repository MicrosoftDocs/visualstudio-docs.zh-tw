...
```  
 ...
 若要查看如何建立安全性描述元的完整範例，請參閱[建立安全性描述元中的新物件的C++ ](https://msdn.microsoft.com/library/aa446595.aspx)。 如需詳細資訊，請參閱 <<c0> [ 建立 DACL](https://msdn.microsoft.com/library/ms717798.aspx)。
