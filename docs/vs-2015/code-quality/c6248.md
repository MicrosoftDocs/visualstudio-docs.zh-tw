...
```  
 ...
 若要查看如何建立安全描述項的完整範例，請參閱[在中C++建立新物件的安全描述項](https://msdn.microsoft.com/library/aa446595.aspx)。 如需詳細資訊，請參閱[建立 DACL](https://msdn.microsoft.com/library/ms717798.aspx)。
