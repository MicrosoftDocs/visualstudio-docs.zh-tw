...
本主題的最新的版本可從[ca2237 必須： serializableattribute 標記 ISerializable 類型](https://docs.microsoft.com/visualstudio/code-quality/ca2237-mark-iserializable-types-with-serializableattribute)。
