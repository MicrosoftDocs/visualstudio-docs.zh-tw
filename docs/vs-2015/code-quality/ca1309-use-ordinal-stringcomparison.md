...
## <a name="rule-description"></a>規則描述
 許多字串作業（最重要的 <xref:System.String.Compare%2A?displayProperty=fullName> 和 <xref:System.String.Equals%2A?displayProperty=fullName> 方法）現在提供可接受 <xref:System.StringComparison?displayProperty=fullName> 列舉值做為參數的多載。
