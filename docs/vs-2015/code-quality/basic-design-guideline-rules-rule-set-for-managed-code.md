---
title: 適用于 managed 程式碼的基本設計指導方針規則規則集 |Microsoft Docs
ms.date: 11/15/2016
...
您可以使用 Microsoft 基本設計指導方針規則規則集，專注于讓您的程式碼更容易瞭解和使用。 如果您的專案包含程式庫程式碼，或如果您想要針對容易維護的程式碼強制執行最佳作法，則應該包含此規則集。
 ...
 基本的設計指導方針規則包含 Microsoft 最小 Recommeded 規則規則集中的所有規則。 如需最小規則的清單，請參閱 [managed 程式碼的 Managed 建議規則規則集](../code-quality/managed-recommended-rules-rule-set-for-managed-code.md)。
...
|[CA1801 必須](../code-quality/ca1801-review-unused-parameters.md)|必須檢閱未使用的參數|
|[CA1804 必須](../code-quality/ca1804-remove-unused-locals.md)|必須移除未使用的區域變數|
|[CA1809](../code-quality/ca1809-avoid-excessive-locals.md)|避免在方法中包含過多區域變數|
|[CA1810 必須](../code-quality/ca1810-initialize-reference-type-static-fields-inline.md)|必須將參考類型內部的靜態欄位初始化|
