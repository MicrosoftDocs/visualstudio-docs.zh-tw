...
本主題的最新的版本可從[CA2134： 覆寫基底方法時，方法必須保持一致的透明度](https://docs.microsoft.com/visualstudio/code-quality/ca2134-methods-must-keep-consistent-transparency-when-overriding-base-methods)。
