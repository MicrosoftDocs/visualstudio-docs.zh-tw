---
title: Ca2109： 必須檢閱可見的事件處理常式 |Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47588109"
---
# <a name="ca2109-review-visible-event-handlers"></a>CA2109：必須檢閱可見的事件處理常式
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主題的最新的版本可從[ca2109 必須： 檢閱可見的事件處理常式](https://docs.microsoft.com/visualstudio/code-quality/ca2109-review-visible-event-handlers)。
