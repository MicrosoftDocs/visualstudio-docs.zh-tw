...
|[CA1020](../code-quality/ca1020-avoid-namespaces-with-few-types.md)|避免一些類型，在命名空間|  
...
|[CA1045](../code-quality/ca1045-do-not-pass-types-by-reference.md)|不要參考所傳遞類型|  
...
|[CA1700](../code-quality/ca1700-do-not-name-enum-values-reserved.md)|未命名的列舉值 'Reserved'|  
...
|[CA1707](../code-quality/ca1707-identifiers-should-not-contain-underscores.md)|識別項不應該包含底線|  
...
|[CA1712](../code-quality/ca1712-do-not-prefix-enum-values-with-type-name.md)|不要使用型別名稱的列舉值的前置字元|  
|[CA1713](../code-quality/ca1713-events-should-not-have-before-or-after-prefix.md)|事件應該不會有 before 或 after 前置詞|  
|[CA1714](../code-quality/ca1714-flags-enums-should-have-plural-names.md)|旗標列舉應該使用複數名稱|  
|[CA1715](../code-quality/ca1715-identifiers-should-have-correct-prefix.md)|識別項應該使用正確的前置詞|  
...
|[CA1721](../code-quality/ca1721-property-names-should-not-match-get-methods.md)|屬性名稱不應該相符的 get 方法|  
