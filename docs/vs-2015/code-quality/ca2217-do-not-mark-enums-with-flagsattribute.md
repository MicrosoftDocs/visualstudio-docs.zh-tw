...
## <a name="cause"></a>原因
 外部可見的列舉會以 <xref:System.FlagsAttribute> 標示，而且有一或多個值不是兩個的乘冪，或在列舉上有其他已定義值的組合。

## <a name="rule-description"></a>規則描述
 只有當列舉中所定義的每個值是二的乘冪，或已定義值的組合時，列舉才會出現 <xref:System.FlagsAttribute>。
...
## <a name="related-rules"></a>相關規則
 [CA1027：以 FlagsAttribute ](../code-quality/ca1027-mark-enums-with-flagsattribute.md) 標記列舉
