---
title: 如何將 Web 應用程式移轉並發佈到 Azure 雲端服務
...
ms.locfileid: "62952846"
---
# <a name="how-to-migrate-and-publish-a-web-application-to-an-azure-cloud-service-from-visual-studio"></a>作法：從 Visual Studio 將 Web 應用程式移轉及發佈到 Azure 雲端服務
...
在建置應用程式、使用計算模擬器在本機執行應用程式，或將應用程式發佈至 Azure 時，您可能會看到錯誤：「指定的路徑、檔案名稱或兩者都太長」。 此錯誤指出完整的 Azure 專案名稱長度超過 146 個字元。 若要修正該問題，請將您的解決方案移到路徑較短的不同資料夾。
...
- [使用 .NET (C#) 搭配 Visual Studio 連線及查詢 Azure SQL Database](/azure/sql-database/sql-database-connect-query-dotnet-visual-studio)。
