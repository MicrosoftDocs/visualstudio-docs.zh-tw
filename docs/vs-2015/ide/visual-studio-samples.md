...
|區域圖|描述|
|----------|-----------------|
|[Windows 開發人員中心範例](http://go.microsoft.com/fwlink/?LinkID=255278)|示範如何開發 [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] 應用程式。|
...
|[Office 程式開發範例](https://msdn.microsoft.com/library/9ebc7de2-59dd-414c-888b-7549d3c3543c)|示範如何在 Visual Studio 中使用 Office 開發工具。 如需最新範例，請參閱 [MSDN 開發人員範例：透過程式碼來了解](http://go.microsoft.com/fwlink/?LinkID=248199)。|
