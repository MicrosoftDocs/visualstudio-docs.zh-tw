...
只需選擇適當的鍵盤快速鍵，您就可以在 Visual Studio 中更輕鬆地存取各種命令和視窗。 本主題列出 [一般開發] 設定檔的預設捷徑，您可能已在已安裝的 Visual Studio 中選擇該設定檔。 不管您選擇哪一個設定檔，都可以開啟 [選項]**** 對話方塊、展開 [環境]**** 節點，然後選擇 [鍵盤]**** 來識別命令的捷徑。 您也可以為指定的命令指派不同的捷徑，以自訂捷徑。
 ...
 下列清單中的各節包含全域的命令，您可以使用鍵盤快速鍵從 Visual Studio 中的任何地方存取它們：
...
- [診斷中樞](../ide/default-keyboard-shortcuts-in-visual-studio.md#bkmk_diagnostics)
 ...
 下列清單中的每個區段都包含命令，其鍵盤快速鍵專屬於區段所命名的內容。

- [ADO.NET 實體資料模型設計工具](../ide/default-keyboard-shortcuts-in-visual-studio.md#bkmk_ADONET)
- [分層圖](../ide/default-keyboard-shortcuts-in-visual-studio.md#bkmk_layerDiagram)
...
- [Microsoft SQL Server 資料工具，架構比較](../ide/default-keyboard-shortcuts-in-visual-studio.md#bkmk_SchemaCompare)
...
- [Microsoft SQL Server 資料工具，資料表設計工具](../ide/default-keyboard-shortcuts-in-visual-studio.md#bkmk_TableDesigner)
- [測試瀏覽器](../ide/default-keyboard-shortcuts-in-visual-studio.md#bkmk_TestExplorer)
...
- [UML 元件圖表](../ide/default-keyboard-shortcuts-in-visual-studio.md#bkmk_UMLcomponentDiagram)
...
## <a name="global"></a><a name="bkmk_global"></a>全域性
...
### <a name="project-and-solution-context-menus"></a><a name="bkmk_projectContext"></a>專案和方案操作功能表
...
### <a name="team-foundation-context-menus"></a><a name="bkmk_TFcontext"></a> Team Foundation 操作功能表

|命令|鍵盤快速鍵|
|--------------|------------------------|
|TeamFoundationContextMenus.Commands.GoToBuilds|Ctrl+0、Ctrl+B<br /><br /> 或<br /><br /> Ctrl+0、B|
|TeamFoundationContextMenus.Commands.GoToConnect|Ctrl+0、Ctrl+C<br /><br /> 或<br /><br /> Ctrl+0、C|
|TeamFoundationContextMenus.Commands.GoToDocuments|Ctrl+0、Ctrl+D<br /><br /> 或<br /><br /> Ctrl+0、D|
|TeamFoundationContextMenus.Commands.GoToHome|Ctrl+0、Ctrl+H<br /><br /> 或<br /><br /> Ctrl+0、H|
|TeamFoundationContextMenus.Commands.GoToMyWork|Ctrl+0、Ctrl+M<br /><br /> 或<br /><br /> Ctrl+0、M|
|TeamFoundationContextMenus.Commands.GoToPendingChanges|Ctrl+0、Ctrl+P<br /><br /> 或<br /><br /> Ctrl+0、P|
|TeamFoundationContextMenus.Commands.GoToReports|Ctrl+0、Ctrl+R<br /><br /> 或<br /><br /> Ctrl+0、R|
|TeamFoundationContextMenus.Commands.GoToSettings|Ctrl+0、Ctrl+S<br /><br /> 或<br /><br /> Ctrl+0、S|
...
## <a name="adonet-entity-data-model-designer"></a><a name="bkmk_ADONET"></a> ADO.NET 實體資料模型設計工具
...
## <a name="dataset-editor"></a><a name="bkmk_dataset"></a> 資料集編輯器
...
## <a name="html-editor-design-view"></a><a name="bkmk_HTMLeditorDesign"></a> HTML 編輯器設計檢視
...
## <a name="layer-diagram"></a><a name="bkmk_layerDiagram"></a>分層圖
...
## <a name="microsoft-sql-server-data-tools-table-designer"></a><a name="bkmk_TableDesigner"></a> Microsoft SQL Server Data Tools，資料表設計工具

|命令|鍵盤快速鍵|
|--------------|------------------------|
|CommitAllEdits|Shift+Alt+U|
|SQL.ExpandWildcards|Ctrl+R、E<br /><br /> 或<br /><br /> Ctrl+R、Ctrl+E|
|SQL.FullyqualifyNames|Ctrl+R、Q<br /><br /> 或<br /><br /> Ctrl+R、Ctrl+Q|
|SQL.MovetoSchema|Ctrl+R、M<br /><br /> 或<br /><br /> Ctrl+R、Ctrl+M|
|SQL.Rename|F2<br /><br /> 或<br /><br /> Ctrl+R、R<br /><br /> 或<br /><br /> Ctrl+R、Ctrl+R|
|ViewFileInScriptPanel|Shift+Alt+PgDn|

## <a name="microsoft-sql-server-data-tools-t-sql-editor"></a><a name="bkmk_TSQLeditor"></a> Microsoft SQL Server Data Tools，T-SQL 編輯器
...
## <a name="microsoft-sql-server-data-tools-t-sql-pdw-editor"></a><a name="bkmk_linkfix"></a> Microsoft SQL Server Data Tools，T-SQL PDW 編輯器
...
## <a name="query-results"></a><a name="bkmk_QueryResults"></a>查詢結果
...
## <a name="sequence-diagram"></a><a name="bkmk_SequenceDiagram"></a>順序圖表
...
|                        Edit.WordNextExtend                        |                Ctrl+Shift+向右鍵                 |
...
## <a name="vc-image-editor"></a><a name="bkmk_vcimageeditor"></a>VC 影像編輯器
...
## <a name="work-item-results-view"></a><a name="bkmk_WIresultsview"></a>工作專案結果檢視
...
## <a name="workflow-designer"></a><a name="bkmk_workflowdesigner"></a>工作流程設計工具

|命令|鍵盤快速鍵|
|--------------|------------------------|
|Edit.CompleteWord|Ctrl+K、W<br /><br /> 或<br /><br /> Ctrl+K、Ctrl+W<br /><br /> 或<br /><br /> Ctrl+空格鍵<br /><br /> 或<br /><br /> Alt+向右鍵|
|Edit.DecreaseFilterLevel|Alt+,|
|Edit.IncreaseFilterLevel|Alt+.|
|Edit.ListMembers|Ctrl+K、L<br /><br /> 或<br /><br /> Ctrl+K、Ctrl+L<br /><br /> 或<br /><br /> Ctrl+J|
|Edit.ParameterInfo|Ctrl+K、P<br /><br /> 或<br /><br /> Ctrl+K、Ctrl+P<br /><br /> 或<br /><br /> Ctrl+Shift+空格鍵|
|Edit.QuickInfo|Ctrl+K、I<br /><br /> 或<br /><br /> Ctrl+K、Ctrl+I|
|WorkflowDesigner.Collapse|Ctrl+E、Ctrl+C<br /><br /> 或<br /><br /> Ctrl+E、C|
|WorkflowDesigner.CollapseAll|或|
|WorkflowDesigner.ConnectNodes|Ctrl+E、Ctrl+F<br /><br /> 或<br /><br /> Ctrl+E、F|
|WorkflowDesigner.CreateVariable|Ctrl+E、Ctrl+N<br /><br /> 或<br /><br /> Ctrl+E、N|
|WorkflowDesigner.ExpandAll|Ctrl+E、Ctrl+X<br /><br /> 或<br /><br /> Ctrl+E、X|
|WorkflowDesigner.ExpandInPlace|Ctrl+E、Ctrl+E<br /><br /> 或<br /><br /> Ctrl+E、E|
|WorkflowDesigner.GoToParent|Ctrl+E、Ctrl+P<br /><br /> 或<br /><br /> Ctrl+E、P|
|WorkflowDesigner.MoveFocus|Ctrl+E、Ctrl+M<br /><br /> 或<br /><br /> Ctrl+E、M|
|WorkflowDesigner.NavigateThroughDesigner|Ctrl+Alt+F6|
|WorkflowDesigner.Restore|Ctrl+E、Ctrl+R<br /><br /> 或<br /><br /> Ctrl+E、R|
|WorkflowDesigner.ShowHideArgumentDesigner|Ctrl+E、Ctrl+A<br /><br /> 或<br /><br /> Ctrl+E、A|
|WorkflowDesigner.ShowHideImportsDesigner|Ctrl+E、Ctrl+I<br /><br /> 或<br /><br /> Ctrl+E、I|
|WorkflowDesigner.ShowHideOverviewMap|Ctrl+E、Ctrl+O<br /><br /> 或<br /><br /> Ctrl+E、O|
|WorkflowDesigner.ShowHideVariableDesigner|Ctrl+E、Ctrl+V<br /><br /> 或<br /><br /> Ctrl+E、V|
|WorkflowDesigner.ToggleSelection|Ctrl+E、Ctrl+S<br /><br /> 或<br /><br /> Ctrl+E、S|
