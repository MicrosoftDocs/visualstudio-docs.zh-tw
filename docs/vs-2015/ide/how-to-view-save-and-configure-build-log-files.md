...
1. 在 Windows 檔案總管  或檔案總管  中，開啟下列檔案：\\...\Visual Studio <版本>  \Projects\\<專案名稱>  \\<專案名稱>  \Debug\\<專案名稱>  .txt
...
## <a name="see-also"></a>另請參閱
 在 Visual Studio[編譯和建立](../ide/compiling-and-building-in-visual-studio.md)中[取得組建記錄](../msbuild/obtaining-build-logs-with-msbuild.md)[以建立和清除專案與方案](../ide/building-and-cleaning-projects-and-solutions-in-visual-studio.md)
