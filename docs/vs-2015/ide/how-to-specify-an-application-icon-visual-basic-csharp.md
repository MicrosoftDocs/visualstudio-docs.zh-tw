...
## <a name="see-also"></a>請參閱
 [應用程式頁面、專案設計工具（Visual Basic）](../ide/reference/application-page-project-designer-visual-basic.md) [應用程式頁面、C#專案設計工具（）](../ide/reference/application-page-project-designer-csharp.md) [管理應用程式屬性](../ide/application-properties.md)[如何：新增或移除資源](https://msdn.microsoft.com/7b77bc06-3952-4799-b029-def3f8f7f88d)
