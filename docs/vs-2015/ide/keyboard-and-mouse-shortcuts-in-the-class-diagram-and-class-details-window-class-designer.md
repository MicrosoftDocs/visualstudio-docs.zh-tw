...
## <a name="using-the-mouse-in-the-class-details-window"></a><a name="MouseClassDetails"></a>在類別細節視窗中使用滑鼠
...
|SPACE|在所有內容中|在目前的項目上切換選取項目。|

## <a name="using-the-keyboard-in-the-class-details-window"></a><a name="KeyboardClassDetails"></a>在類別細節視窗中使用鍵盤
