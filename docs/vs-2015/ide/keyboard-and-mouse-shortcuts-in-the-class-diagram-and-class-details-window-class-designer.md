...
本主題的最新的版本可從[鍵盤和滑鼠快速鍵，在類別圖表和 [類別細節] 視窗 （類別設計工具）](https://docs.microsoft.com/visualstudio/ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer)。  
