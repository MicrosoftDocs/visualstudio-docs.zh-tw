...
## <a name="general-security-considerations"></a>一般安全性考量  
 ...
 [NOT IN BUILD：安全性和程式設計 (C# 和 Visual Basic)](https://msdn.microsoft.com/227e2863-cf09-4c28-9611-bcd82be5e994)  
...
## <a name="securing-mobile-applications"></a>保護行動裝置應用程式  
 ...
 [裝置的安全性考量](https://msdn.microsoft.com/45fab484-8718-452e-8210-04fda3c6cb87)  
 描述幾個影響裝置安全性原則的因素。  
  
 [.NET Compact Framework 的安全性目標](https://msdn.microsoft.com/64ac2770-e2bc-40a3-abbf-56c8a2c0e364)  
 描述.NET Compact Framework 安全性的目標。  
  
 [設計安全的 Mobile Web 表單網頁](https://msdn.microsoft.com/b69727c1-f81f-4221-a116-8f92f769365f)  
...
## <a name="securing-web-applications"></a>偵錯網路應用程式  
 ...
 [ASP.NET 安全性架構](https://msdn.microsoft.com/library/c34d6f4f-f64d-4697-bd32-02dd2ddf726f)  
 提供 ASP.NET 基礎結構和子系統關聯性與安全性相關的概觀。  
  
 [ASP.NET Web 應用程式安全性](https://msdn.microsoft.com/library/658d0430-1644-4744-b52d-08b0d6fcacb8)  
 詳細說明如何解決在 ASP.NET 中的授權和驗證問題。  
  
 [JScript 的安全性考量](https://msdn.microsoft.com/8572efc9-071a-472d-a1a4-f0a3b42644c1)  
 詳細說明 JScript 程式設計人員可能會遇到的一些安全性陷阱。  
  
 [如何：使用傳輸安全性](https://msdn.microsoft.com/16210e41-5492-4cc8-9002-7366b1fc7297)  
 描述當您連接到 WCF 服務時，如何使用傳輸安全性進行驗證。  
  
## <a name="securing-desktop-applications"></a>部署桌面應用程式  
 設計桌面應用程式的安全性是應用程式開發的必要步驟。  
  
 [Windows Forms 安全性](https://msdn.microsoft.com/library/932d438a-5285-46d8-a958-8c93d0ad6cae)  
