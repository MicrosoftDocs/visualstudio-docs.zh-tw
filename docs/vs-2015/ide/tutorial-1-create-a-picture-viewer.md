...
- 撰寫事件處理常式方法。
  ...
  ![影片連結](../data-tools/media/playvideo.gif "PlayVideo")如需本主題的影片版本，請參閱[如何：在 Visual Basic 中建立圖片檢視器？](https://msdn.microsoft.com/vstudio/gg315352)或[如何：在中C#建立圖片檢視器？](https://msdn.microsoft.com/vcsharp/gg278960.aspx)。
...
>
> 若要查看 Visual Basic 的程式碼，請選擇程式碼區塊頂端的 [ **VB** ] 索引標籤，若C#要查看 Visual **C#** 的程式碼，請選擇 [] 索引標籤。如果您想要瞭解視覺效果C++，請參閱[消費者入門](../misc/getting-started-with-visual-cpp-in-visual-studio-2015.md)和[ C++語言教學](http://www.cplusplus.com/doc/tutorial/)課程。
>
