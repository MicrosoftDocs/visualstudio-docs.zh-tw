...
## <a name="see-also"></a>另請參閱
 [建立專案和專案範本](../ide/creating-project-and-item-templates.md)[範本參數](../ide/template-parameters.md) [Visual Studio 範本架構參考](../extensibility/visual-studio-template-schema-reference.md)專案專案專案[ (Visual Studio 專案範本) ](../extensibility/projectitem-element-visual-studio-item-templates.md)
