...
1. 在方案總管  中，選取方案 (最上層節點)。 以滑鼠右鍵按一下節點以取得操作功能表。

2. 選取 [屬性]  。 [方案屬性頁]  對話方塊隨即開啟。
...
## <a name="see-also"></a>另請參閱
 [編譯和建立](../ide/compiling-and-building-in-visual-studio.md)[方案和專案](../ide/creating-solutions-and-projects.md)
