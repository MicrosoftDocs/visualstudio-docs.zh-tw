...
本主題的最新的版本可從[如何： 管理組建組態套用的 Visual Basic 開發者設定](https://docs.microsoft.com/visualstudio/ide/how-to-manage-build-configurations-with-visual-basic-developer-settings-applied)。  
