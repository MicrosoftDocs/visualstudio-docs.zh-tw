...
類別設計工具支援 C++ `enum` 和範圍 `enum class` 類型。 以下是範例：
...
## <a name="see-also"></a>另請參閱
 [使用 Visual C++ 程式碼 (類別設計工具) ](../ide/working-with-visual-cpp-code-class-designer.md) [Enumerations](https://msdn.microsoft.com/library/081829db-5dca-411e-a53c-bffef315bcb3)列舉
