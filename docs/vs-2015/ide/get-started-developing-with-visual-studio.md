...
- **[以 HTML/Javascript (Apache Cordova) 製作跨平台行動應用程式](http://taco.visualstudio.com/docs/get-started-first-mobile-app/)** :             Apache Cordova 是以 HTML/CSS/Javascript 為基礎的開放原始碼跨平台環境。  您的 Javascript 程式碼可在以特定平台為目標的包裝函式中執行，並且能夠存取裝置的所有硬體功能。 為 Apple Store、Android 市集和 Windows 市集開發應用程式。
...
- **[製作跨平台行動應用程式，在C#或 Visual Basic (Xamarin)](../cross-platform/visual-studio-and-xamarin.md)**  :開始使用 Visual Studio 和 Xamarin 工具來建立與共用程式碼基底 Android、 iOS 和通用 Windows 平台執行的行動裝置應用程式。
