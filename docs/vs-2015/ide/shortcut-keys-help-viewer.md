...
|ToolBar|退格鍵<br /><br /> -或-<br /><br /> Alt + 向左鍵|顯示上一頁。|
|ToolBar|Alt + 向右鍵|顯示下一頁。|
|ToolBar|Alt + Home|顯示 Help Reviewer 的首頁。|
|ToolBar|Ctrl + S|反白顯示目前目錄中的主題 (於 [內容] 索引標籤)。|
|ToolBar|Ctrl + D|將目前主題新增至 [我的最愛] 索引標籤。|
|ToolBar|Ctrl + F|在主題區域中顯示 [尋找] 列，供您搜尋目前主題中的文字。|
|ToolBar|Ctrl + P|列印目前的頁面。|
|ToolBar|Ctrl + F2|顯示目前頁面的列印預覽。|
