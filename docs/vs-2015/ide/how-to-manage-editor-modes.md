...
## <a name="see-also"></a>請參閱
 [自訂編輯器](../ide/customizing-the-editor.md)[如何：排列和停駐 Windows](../misc/how-to-arrange-and-dock-windows.md)字型[和色彩、環境、選項對話方塊](../ide/reference/fonts-and-colors-environment-options-dialog-box.md)
