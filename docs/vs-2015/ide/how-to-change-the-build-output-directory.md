...
## <a name="see-also"></a>另請參閱
 [專案設計工具（C#） [組建] 頁面、](../ide/reference/build-page-project-designer-csharp.md) [[一般] 屬性頁（專案）](https://msdn.microsoft.com/library/593b383c-cd0f-4dcd-ad65-9ec9b4b19c45) [編譯和建立](../ide/compiling-and-building-in-visual-studio.md)
