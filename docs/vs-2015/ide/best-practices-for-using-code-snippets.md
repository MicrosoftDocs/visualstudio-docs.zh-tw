...
## <a name="see-also"></a>另請參閱
 [Visual Basic IntelliSense 程式碼片段](https://msdn.microsoft.com/library/ffdde4c9-8141-4906-b09b-15181357a643)[保護應用程式](../ide/securing-applications.md)[程式碼片段](../ide/code-snippets.md)
