...
## <a name="navigating-the-help-viewer"></a>巡覽說明檢視器
 您可以使用 [流覽] 索引標籤、在主題索引標籤或索引標籤中查看已安裝的內容，以及使用 [**管理內容**] 索引標籤，在已安裝的內容中尋找資訊。您也可以使用工具列上的按鈕來執行其他工作，並在視窗的右下角尋找其他資訊。
...
- 小三角形會開啟索引標籤清單，包括主題索引標籤和 [**管理內容**] 索引標籤。您可以選擇讓任何索引標籤成為使用中的索引標籤。

  [說明檢視器] 視窗的下方區域包含暫止的下載總大小、所需磁碟空間量和可用的磁碟空間量之相關資訊。 如果有可用的更新，這個區域也包含可能發生的錯誤之相關資訊，以及一個連結，您可以選擇選擇此連結來重新整理已安裝的內容。

## <a name="see-also"></a>另請參閱
 說明[檢視器系統管理員指南](../ide/help-viewer-administrator-guide.md)[安裝和管理本機內容](../ide/install-and-manage-local-content.md)[尋找](../ide/locate-information.md)[疑難排解 Help Viewer 的](../ide/troubleshooting-the-help-viewer.md)資訊
