...
- 在方案總管**** 中，開啟方案的捷徑功能表，然後選擇 [Configuration Manager]****。
...
3. 在 [**專案**內容] 窗格中，針對每個專案選取您想要的設定和**平臺**，然後選取是否要**建立**它 **，以及是否**要進行**部署**。

## <a name="see-also"></a>另請參閱
 [瞭解](../ide/understanding-build-configurations.md)[在 Visual Studio 中建立和清除專案和方案的](../ide/building-and-cleaning-projects-and-solutions-in-visual-studio.md)組建[設定如何：修改專案屬性和設定設定](https://msdn.microsoft.com/e7184bc5-2f2b-4b4f-aa9a-3ecfcbc48b67)
