...
## <a name="see-also"></a>另請參閱
 [瞭解](../ide/understanding-build-configurations.md)組建設定[在 Visual Studio 中建立及清理專案和方案](../ide/building-and-cleaning-projects-and-solutions-in-visual-studio.md)[如何：修改專案屬性和設定設定](https://msdn.microsoft.com/e7184bc5-2f2b-4b4f-aa9a-3ecfcbc48b67)
