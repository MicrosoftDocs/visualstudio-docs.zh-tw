...
|lock|建立 [lock](https://msdn.microsoft.com/library/656da1a4-707e-4ef6-9c6e-6d13b646af42) 區塊。|在方法、索引子、屬性存取子或事件存取子內。|  
...
## <a name="see-also"></a>另請參閱  
 ...
 [如何：使用替代項目建立新的程式碼片段](https://msdn.microsoft.com/8d56d43c-097a-475b-aa85-cae1554b6338)   
