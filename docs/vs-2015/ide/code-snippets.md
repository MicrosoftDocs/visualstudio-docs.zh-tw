...
## <a name="see-also"></a>請參閱
 [逐步解說：建立程式碼片段](../ide/walkthrough-creating-a-code-snippet.md)[如何：散發程式碼片段](../ide/how-to-distribute-code-snippets.md)[使用程式碼片段的最佳作法](../ide/best-practices-for-using-code-snippets.md)[疑難排解](../ide/troubleshooting-snippets.md)程式碼片段[visual C#程式碼片段](../ide/visual-csharp-code-snippets.md) [visual C++程式碼片段](../ide/visual-cpp-code-snippets.md)[程式碼片段架構參考](../ide/code-snippets-schema-reference.md)
