...
## <a name="see-also"></a>請參閱
 [如何：建立和編輯](../ide/how-to-create-and-edit-configurations.md)設定[瞭解](../ide/understanding-build-configurations.md)[以平行方式建立多個專案的](../msbuild/building-multiple-projects-in-parallel-with-msbuild.md)組建設定
