...
|**Microsoft Visual Studio 2010 for Office Runtime (x86 和 x64)**|Visual Studio 中的 Office Developer Tools 提供便於使用的整合式工具，可搭配 Microsoft Office 建立自訂商務方案。 您可以建立使用 Office 應用程式做為使用者介面的 Managed 智慧型用戶端解決方案。 這些工具讓開發人員能夠建立易於部署與維護的安全方案。<br /><br /> 如需詳細資訊，請參閱[＜How to：使用 ClickOnce 發行 Office 方案](http://msdn.microsoft.com/2b6c247e-bc04-4ce4-bb64-c4e79bb3d5b8)。|  
