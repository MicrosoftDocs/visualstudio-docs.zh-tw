...
Microsoft 致力於讓所有使用者都能輕鬆使用其產品與服務。 下列主題提供讓行動不便人士更容易存取 Microsoft Windows 之功能、產品和服務的相關資訊：

- [Windows 的協助工具功能](../../ide/reference/accessibility-products-and-services-from-microsoft.md#windows)

- [其他格式的文件](../../ide/reference/accessibility-products-and-services-from-microsoft.md#altfortmats)

- [聽覺障礙人士的客戶服務](../../ide/reference/accessibility-products-and-services-from-microsoft.md#hearing)

- [詳細資訊](../../ide/reference/accessibility-products-and-services-from-microsoft.md#moreinfo)

> [!NOTE]
> 本節中的資訊僅適用於美國地區的 Microsoft 產品授權使用者。 如果您在美國以外取得本產品，可以使用軟體封裝隨附的子公司資訊卡，或者造訪 [Microsoft 協助工具網站](https://www.microsoft.com/enable/default.aspx) ，取得一份 Microsoft 支援服務電話號碼及地址。 您可以連絡當地分公司，以了解當地是否有提供本節所描述的產品和服務類型。 關於協助工具的資訊，還有其他語言版本，包括日文和法文。

## <a name="accessibility-features-of-windows"></a><a name="windows"></a> Windows 的協助工具功能
...
## <a name="documentation-in-alternative-formats"></a>其他格式的 <a name="altfortmats"></a> 文件集
...
## <a name="customer-service-for-people-with-hearing-impairments"></a><a name="hearing"></a> 聽力障礙人士的客戶服務
...
## <a name="for-more-information"></a><a name="moreinfo"></a> 取得詳細資訊
 如需電腦協助工具技術如何改善身障人士生活的詳細資訊，請參閱 [Microsoft 協助工具網站](https://www.microsoft.com/enable/default.aspx)。

## <a name="see-also"></a>另請參閱
 用[來設計 Visual Studio 之可存取應用程式](../../ide/reference/resources-for-designing-accessible-applications.md)[協助工具功能的](../../ide/reference/accessibility-features-of-visual-studio.md)資源
