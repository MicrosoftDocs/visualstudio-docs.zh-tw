 ...
 **其他編譯符號** 指定執行條件式編譯的符號。 請以分號 (“;”) 分隔符號。 如需詳細資訊，請參閱 [/define (c # 編譯器選項) ](https://msdn.microsoft.com/library/f17d7b4d-82d0-4133-8563-68cced1cac6e)。
 ...
 **目標 CPU**：指定輸出檔案設為目標的處理器。 針對任何 32 位元 Intel 相容處理器選擇 [x86]****，針對任何 64 位元 Intel 相容處理器選擇 [x64]****，針對 ARM 處理器選擇 [ARM]****，或選擇 [任何 CPU]**** 指定可接受任何處理器。 [任何 CPU]**** 是專案的預設值，因為這可讓應用程式在種類範圍最廣的不同硬體上執行。
...
- 在 [應用程式]**** 頁面上，[目標 Framework]**** 清單指定 .NET Framework 4.5。
  ...
  **允許不安全的程式碼** 允許使用 [unsafe](https://msdn.microsoft.com/library/7e818009-1c6e-4b9e-b769-3728a01586a0) 關鍵字進行編譯的程式碼。 如需詳細資訊，請參閱 [/unsafe (C# 編譯器選項)](https://msdn.microsoft.com/library/fdb77ed9-da03-45bd-bb7f-250704da1bcc)。

  **將程式碼最佳化** 啟用或停用由編譯器執行的最佳化，讓您的輸出檔變得更小、更快且更有效率。 如需詳細資訊，請參閱 [/optimize (c # 編譯器選項) ](https://msdn.microsoft.com/library/6dd5b6f2-cd1d-4593-a9f4-1c2ed9404ca0)。

## <a name="errors-and-warnings"></a>錯誤和警告
 您可以使用下列設定，為建置流程設定錯誤和警告選項。

 **警告層級** 指定顯示編譯器警告的層級。 如需詳細資訊，請參閱 [/warn (C# 編譯器選項)](https://msdn.microsoft.com/library/5f80ff59-4991-4382-9f9a-77da18446e71)。

 **隱藏警告** 封鎖編譯器產生一或多個警告的功能。 請以逗號或分號分隔多個警告編號。 如需詳細資訊，請參閱 [/nowarn (C# 編譯器選項)](https://msdn.microsoft.com/library/6dcbc5e8-ae67-4566-9df3-f63cfdd9c4e4)。
 ...
 **輸出路徑** 指定此專案組態的輸出檔案位置。 在此方塊中輸入建置輸出的路徑，或選擇 [瀏覽]**** 按鈕以指定路徑。 請注意，路徑是相對的；如果您輸入絕對路徑，它會儲存為相對路徑。 預設路徑為 bin\Debug 或 bin\Release\\。 如需詳細資訊，請參閱[偵錯和發行專案組態](https://msdn.microsoft.com/0440b300-0614-4511-901a-105b771b236e)。
 ...
 **XML 文件檔案** 指定將要在其中處理文件註解之檔案的名稱。 如需詳細資訊，請參閱 [/doc (C# 編譯器選項)](https://msdn.microsoft.com/library/849eea59-c936-4311-bad8-d07404480f2a)。
...
## <a name="see-also"></a>另請參閱
 [專案屬性參考](../../ide/reference/project-properties-reference.md) [c # 編譯器選項](https://msdn.microsoft.com/library/d3403556-1816-4546-a782-e8223a772e44)
