...
## <a name="see-also"></a>另請參閱
 [如何：指定組建事件 (Visual Basic) ](../../ide/how-to-specify-build-events-visual-basic.md) [如何：指定組建事件 (c # ) ](../../ide/how-to-specify-build-events-csharp.md) [專案屬性參考](../../ide/reference/project-properties-reference.md)[編譯和建立](../../ide/compiling-and-building-in-visual-studio.md)
