...
## <a name="see-also"></a>請參閱
 [專案設計工具、編譯頁（Visual Basic）](../../ide/reference/compile-page-project-designer-visual-basic.md) [如何：指定組建事件（Visual Basic）](../../ide/how-to-specify-build-events-visual-basic.md) [預先建立事件/建立後事件命令列對話方塊](../../ide/reference/pre-build-event-post-build-event-command-line-dialog-box.md)
