...
## <a name="see-also"></a>另請參閱
 [設計可存取的應用程式 Visual Studio 資源](../../ide/reference/resources-for-designing-accessible-applications.md)[的協助工具功能](../../ide/reference/accessibility-features-of-visual-studio.md)
