...
> [!NOTE]
> 根據您目前使用的設定，出現的對話方塊與功能表命令可能不同於本文所述。 若要變更設定，請開啟 [工具]/[匯入和匯出設定]。 如需詳細資訊，請參閱 [在 Visual Studio 中自訂開發設定](https://msdn.microsoft.com/22c4debb-4e31-47a8-8f19-16f328d7dcd3)  
