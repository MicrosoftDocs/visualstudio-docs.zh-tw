...
|功能表|@menu<br /><br /> 例如， `@menu font`|限制搜尋功能表項目。|
...
## <a name="show-previous-results"></a>顯示先前的結果
 ...
 如需使用 [快速啟動]**** 的最新祕訣和訣竅，請參閱 [Visual Studio 部落格](https://blogs.msdn.com/b/visualstudio/)。

## <a name="see-also"></a>另請參閱
 Visual Studio) [環境選項] 對話方塊](../../ide/reference/environment-options-dialog-box.md)中的[一般消費者介面元素 (](../../ide/reference/general-user-interface-elements-visual-studio.md)
