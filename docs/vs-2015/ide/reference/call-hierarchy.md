...
## <a name="using-call-hierarchy"></a>使用呼叫階層
 ...
 成員名稱會顯示在 [呼叫階層]**** 視窗的樹狀檢視窗格中。 如果您展開成員節點，則 [呼叫目標 <成員名稱>]****__ 和 [呼叫來源 <成員名稱>]****__ 子節點會隨即出現。 下圖顯示 [呼叫階層]**** 視窗中的上述節點。

 ![開啟一個節點的呼叫](../../ide/reference/media/onenode.png "OneNode") 階層呼叫階層視窗
