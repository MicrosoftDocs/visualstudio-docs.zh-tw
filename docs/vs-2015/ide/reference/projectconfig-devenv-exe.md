...
## <a name="see-also"></a>另請參閱
 [Devenv 命令列參數](../../ide/reference/devenv-command-line-switches.md) [/Project （devenv）](../../ide/reference/project-devenv-exe.md) [/Build （devenv）](../../ide/reference/build-devenv-exe.md) [/Clean （devenv）](../../ide/reference/clean-devenv-exe.md) [/Rebuild （devenv）](../../ide/reference/rebuild-devenv-exe.md) [/Deploy （devenv](../../ide/reference/deploy-devenv-exe.md) .exe） [/out （devenv .exe）](../../ide/reference/out-devenv-exe.md)
