 ...
 **顯示參考訊息** 選取此選項，即可顯示所有 [尋找] 和 [取代具有 **永遠顯示此訊息** 的參考訊息] 選項。 例如，如果您選擇不要顯示「尋找已到達搜尋起點」訊息，則選取此選項會導致這則告知性訊息在您使用 [尋找和取代] 時再次出現。
 ...
 **顯示警告訊息** 選取此選項，即可顯示所有警告性 [尋找] 和 [取代具有 [ **永遠顯示此訊息** ] 選項的訊息。 例如，如果您選擇不顯示 [全部取代]**** 警告訊息，而這則警告訊息是在嘗試於目前未開啟進行編輯的檔案中進行取代時顯示，選取此選項會在您嘗試進行全部取代時再次出現這則警告訊息。
