...
## <a name="see-also"></a>另請參閱
 [控制選項設定](https://msdn.microsoft.com/library/a09ed242-7494-4cde-bbd1-7a8ec617965d)在 [選項頁][選項頁面、字型和色彩節點屬性](../../ide/reference/options-page-fonts-and-colors-node-properties.md)[選項頁面、文字編輯器節點屬性](../../ide/reference/options-page-text-editor-node-properties.md)一般、[調試]、[選項] 對話方塊中[決定屬性專案的名稱](https://msdn.microsoft.com/library/d450422d-47c7-4eeb-9f9f-3286264bc5aa) [](../../debugger/general-debugging-options-dialog-box.md)[[編輯後繼續]、[調試]、](https://msdn.microsoft.com/library/009d225f-ef65-463f-a146-e4c518f86103) [選項] 對話方塊、[即時調試]、[選項[] 對話方塊](../../debugger/just-in-time-debugging-options-dialog-box.md)
