...
## <a name="see-also"></a>另請參閱
 [強式命名的元件](https://msdn.microsoft.com/library/d4a80263-f3e0-4d81-9b61-f0cbeae3797b)[強式名稱元件（元件簽署）C++（/cli）](https://msdn.microsoft.com/library/c337cd3f-e5dd-4c6f-a1ad-437e85dba1cc)
