...
2. 選擇 **Enter** 事件，並輸入 `answer_Enter`，然後選擇 Enter 鍵。
     ...
     [![屬性] 對話方塊](../ide/media/express-answerenter.png "Express_AnswerEnter")[屬性] 對話方塊
...
- 若要回到上一個教學課程步驟，請參閱 [步驟4：新增 CheckTheAnswer ( # A1 方法](../ide/step-4-add-the-checktheanswer-parens-method.md)。
