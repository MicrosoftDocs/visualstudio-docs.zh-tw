...
- [新增、移除或移動功能表列上的功能表](../ide/how-to-customize-menus-and-toolbars-in-visual-studio.md#bkmk_addmenu)

- [新增、移除或移動工具列](../ide/how-to-customize-menus-and-toolbars-in-visual-studio.md#bkmk_addtoolbar)
...
## <a name="adding-removing-or-moving-a-menu-on-the-menu-bar"></a><a name="bkmk_addmenu"></a>加入、移除或移動功能表列上的功能表
...
## <a name="adding-removing-or-moving-a-toolbar"></a><a name="bkmk_addtoolbar"></a>加入、移除或移動工具列
...
## <a name="customizing-a-menu-or-a-toolbar"></a><a name="bkmk_customize"></a> 自訂功能表或工具列
...
## <a name="resetting-a-menu-or-a-toolbar"></a><a name="bkmk_reset"></a> 重設功能表或工具列
