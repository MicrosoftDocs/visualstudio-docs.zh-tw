...
## <a name="see-also"></a>另請參閱
 在 Visual Studio[編譯和建立](../ide/compiling-and-building-in-visual-studio.md)[中建立和清除專案與方案](../ide/building-and-cleaning-projects-and-solutions-in-visual-studio.md)[瞭解組建](../ide/understanding-build-configurations.md)[設定的筆尖如何：修改專案屬性和配置設定](https://msdn.microsoft.com/e7184bc5-2f2b-4b4f-aa9a-3ecfcbc48b67)
