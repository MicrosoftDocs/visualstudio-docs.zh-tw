...
## <a name="zoom-in-and-out-of-the-class-diagram"></a><a name="ZoomInOut"></a> 放大和縮小類別圖
...
## <a name="customize-grouping-and-sorting-of-type-members"></a><a name="CustomizeGroupingSorting"></a> 自訂類型成員的群組和排序
...
## <a name="hide-compartments-on-a-type"></a><a name="HideCompartments"></a> 隱藏類型上的區間
...
## <a name="hide-individual-members-on-a-type"></a><a name="HideMembers"></a> 隱藏類型上的個別成員
...
## <a name="show-hidden-compartments-and-members-on-a-type"></a><a name="DisplayHiddenCompartmentsAndMemberrs"></a> 在類型上顯示隱藏的區間和成員
...
## <a name="hide-relationships"></a><a name="HideAssociationAndInheritance"></a> 隱藏關聯性
...
## <a name="show-hidden-relationships"></a><a name="DisplayAssociationAndInheritance"></a> 顯示隱藏的關聯性
...
## <a name="remove-a-shape-from-a-class-diagram"></a><a name="RemoveCodeAndShape"></a> 從類別圖表移除圖形
...
## <a name="delete-a-type-shape-and-its-underlying-code"></a><a name="DeleteTypeShapeAndCode"></a> 刪除類型圖形及其基礎程式碼
...
## <a name="see-also"></a>另請參閱
 使用[類別圖表 (類別設計工具) ](../ide/working-with-class-diagrams-class-designer.md) [如何：在成員標記法和關聯標記法之間變更 (類別設計工具) ](../ide/how-to-change-between-member-notation-and-association-notation-class-designer.md) [如何：查看現有的類型 (](../ide/how-to-view-existing-types-class-designer.md)類別設計工具) 視圖[類型和](../ide/viewing-types-and-relationships-class-designer.md)關聯性 (類別設計工具) 
