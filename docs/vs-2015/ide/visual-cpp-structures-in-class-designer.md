...
## <a name="see-also"></a>另請參閱
 [使用C++ Visual Code （類別設計工具）](../ide/working-with-visual-cpp-code-class-designer.md) [類別和結構](https://msdn.microsoft.com/library/516dd496-13fb-4f17-845a-e9ca45437873)[結構](https://msdn.microsoft.com/library/3c6ba273-e248-4ff1-8c69-d2abcf1263c6)
