...
## <a name="see-also"></a>請參閱
 [偵錯工具和裝載進程](../debugger/debugging-and-the-hosting-process.md)[如何：停用主控進程](../ide/how-to-disable-the-hosting-process.md)即時運算[視窗](../ide/reference/immediate-window.md)[應用程式域](https://msdn.microsoft.com/library/113a8bbf-6875-4a72-a49d-ca2d92e19cc8)
