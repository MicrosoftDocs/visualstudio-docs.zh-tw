...
## <a name="see-also"></a>另請參閱
 [如何：查看、儲存和設定組建記錄檔 ](../ide/how-to-view-save-and-configure-build-log-files.md)[取得組建記錄](../msbuild/obtaining-build-logs-with-msbuild.md)檔[編譯和建立](../ide/compiling-and-building-in-visual-studio.md)[瞭解](../ide/understanding-build-configurations.md)組建設定[Debug 和發行專案](https://msdn.microsoft.com/0440b300-0614-4511-901a-105b771b236e)設定[C/C++建立參考](https://msdn.microsoft.com/library/100b4ccf-572c-4d1f-970c-fa0bc0cc0d2d)[Devenv 命令列參數](../ide/reference/devenv-command-line-switches.md)[方案和專案](../ide/solutions-and-projects-in-visual-studio.md)
