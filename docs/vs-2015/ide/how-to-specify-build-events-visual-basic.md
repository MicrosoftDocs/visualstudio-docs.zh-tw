...
6. 在 [專案設計工具] 中，移至 [ **編譯** ] 索引標籤，然後按一下 [ **建立事件** ] 按鈕以開啟 [ **建立事件** ] 對話方塊。
...
## <a name="see-also"></a>另請參閱
 [管理編譯屬性](https://msdn.microsoft.com/94308881-f10f-4caf-a729-f1028e596a2c)[編譯頁面、專案設計工具 (Visual Basic) ](../ide/reference/compile-page-project-designer-visual-basic.md) [發行頁面、專案設計](../ide/reference/publish-page-project-designer.md)工具[預先建立事件/後置事件命令列對話方塊](../ide/reference/pre-build-event-post-build-event-command-line-dialog-box.md)[如何：指定組建事件 (c # ) ](../ide/how-to-specify-build-events-csharp.md)
