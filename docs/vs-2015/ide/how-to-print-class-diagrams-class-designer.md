...
## <a name="see-also"></a>另請參閱
 [如何：將類別圖表元素複製到 Microsoft Office 檔 (類別設計工具) ](../ide/how-to-copy-class-diagram-elements-to-a-microsoft-office-document-class-designer.md) [如何：將類別圖表匯出為影像 (](../ide/how-to-export-class-diagrams-as-images-class-designer.md)類別設計工具) 
