...
2. 展開 [環境]  ，然後選擇 [鍵盤]  。
     ...
     ![顯示 [選項] 對話方塊中的鍵盤快速鍵](../ide/media/optionskeyboard.png "|::ref1::|")
...
5. 如果命令已具有鍵盤快速鍵，則會出現在 [所選取命令的快速鍵]  清單中。
     ...
     ![檢視所指定命令的快速鍵](../ide/media/viewshortcut.png "|::ref2::|")
...
2. 展開 [環境]  資料夾，然後選擇 [鍵盤]  。
     ...
     ![顯示 [選項] 對話方塊中的鍵盤快速鍵](../ide/media/optionskeyboard.png "|::ref3::|")
...
6. 在 [按快速鍵]  方塊中，輸入您要使用的捷徑。
    ...
    > 您可以建立組合字母與 Alt、Ctrl 或兩者的捷徑。 您也可以建立組合 Shift 鍵與字母，搭配 Alt、Ctrl 或兩者的捷徑。
     ...
     ![為命令指定不同的快速鍵](../ide/media/reassignshortcut.png "|::ref4::|")
...
4. 選取 [鍵盤]  核取方塊，然後選擇 [下一步]  按鈕。
     ...
     ![僅匯出自訂的鍵盤快速鍵](../ide/media/exportshortcuts.png "|::ref5::|")
...
7. 選取 [鍵盤]  核取方塊，然後選擇 [完成]  按鈕。
     ...
     ![僅匯入自訂的鍵盤快速鍵](../ide/media/importshortcuts.png "|::ref6::|")
