...
類別圖表可幫助您了解其他人撰寫 (或是您很久以前撰寫) 之專案的類別結構。 您可以使用這些類別圖表來自訂專案資訊、與其他人共用，以及向其他人展示。  
 ...
 除了定義每個類別圖表所展示的內容，您還可以變更資訊的呈現方式；如需詳細資訊，請參閱[如何：自訂類別圖表 （類別設計工具）](../ide/how-to-customize-class-diagrams-class-designer.md)。  
  
 微調過一或多個類別圖表之後，您可以將其複製到 Microsoft Office 文件並加以列印，或將其匯出成影像檔。 如需詳細資訊，請參閱[如何：將類別圖表項目複製到 Microsoft Office 文件 （類別設計工具）](../ide/how-to-copy-class-diagram-elements-to-a-microsoft-office-document-class-designer.md)， [How to:列印類別圖表 （類別設計工具）](../ide/how-to-print-class-diagrams-class-designer.md)和[How to:將類別圖表匯出為影像 （類別設計工具）](../ide/how-to-export-class-diagrams-as-images-class-designer.md)。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 [如何：將類別圖表元素複製到 Microsoft Office 文件 (類別設計工具)](../ide/how-to-copy-class-diagram-elements-to-a-microsoft-office-document-class-designer.md)  
...
## <a name="see-also"></a>另請參閱  
 ...
 [如何：自訂類別圖表 （類別設計工具）](../ide/how-to-customize-class-diagrams-class-designer.md)   
 [如何：從類別圖表 （類別設計工具） 中移除類型圖案](https://msdn.microsoft.com/ae41897d-d066-4b8c-bb9b-05436e12ff39)
