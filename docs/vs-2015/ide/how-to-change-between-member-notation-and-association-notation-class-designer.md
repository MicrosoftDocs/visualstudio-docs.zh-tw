...
本主題的最新的版本可從[如何： 變更之間成員標記法和關聯標記法 （類別設計工具）](https://docs.microsoft.com/visualstudio/ide/how-to-change-between-member-notation-and-association-notation-class-designer)。  
