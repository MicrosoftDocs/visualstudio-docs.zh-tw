...
## <a name="BKMK_ConfigureIDE"></a> 設定 IDE
 ...
 ![已套用一般設定的 IDE](../ide/media/exploreide-idewithgeneralsettings.png "|::ref1::|")
 ...
 ![包含 [顯示所有設定] 選項的 [選項] 對話方塊](../ide/media/exploreide-optionsdialogbox.png "|::ref2::|")
...
1. 選擇上方的 [工具] **選項** 功能表及 [選項 …]  項目，即可開啟 [選項] **選項 …** 對話方塊。
    ...
    ![[工具] 功能表上的 [選項] 命令](../ide/media/exploreide-toolsoptionsmenu.png "|::ref3::|")

2. 將 [ **色彩佈景主題。** ] 變更為 [ **深色**]，然後按一下 [ **確定**]。

    ![已選取深色色彩佈景主題](../ide/media/exploreide-darkthemeoptionsdlgbox.png "|::ref4::|")

   在 Visual Studio 顯示的色彩應該像下面的影像：

   ![已套用暗色調佈景主題的 IDE](../ide/media/exploreide-darkthemeide.png "|::ref5::|")
...
1. 建立新的專案。 在功能表列上，依序選擇 [檔案]  、[新增]  和 [專案…]  。
    ...
    ![在功能表列上，選擇 [檔案]、[新增]、[專案]](../ide/media/exploreide-filenewproject.png "|::ref6::|")

    您也可以在 [快速啟動]  方塊中輸入「新增專案」  ，執行相同的動作。

    ![在 [快速啟動] 方塊中，指定新增專案](../ide/media/exploreide-quicklaunchnewprojectsmall.png "|::ref7::|")
...
2. 例如，在左窗格選擇 [已安裝]  、[範本]  、[Visual C#]  、[Windows]  ，然後在中央窗格選擇 [WPF 應用程式]，即可選擇 Visual Basic 或 Visual C# WPF 應用程式範本。  在 [新增專案] 對話方塊下方，將專案命名為 HelloWPFApp。
    ...
    ![建立 HelloWPFApp 這個 Visual Basic WPF 專案](../ide/media/exploreide-newprojectvb.png "|::ref8::|")

    OR

    ![建立 Visual C&#35; WPF 專案，HelloWPFApp](../ide/media/exploreide-newprojectcsharp.png "|::ref9::|")
   ...
   ![已載入 HelloWPFApp 檔案的方案總管](../ide/media/exploreide-hellowpfappfiles.png "|::ref10::|")
...
1. 在下列程序中，您將會賦予 MainWindow 一個更為具體的名稱。 在 [ **方案總管**] 中，選取 MainWindow.xaml。 您應該會看到 [屬性]  視窗；如果沒有，請選擇 [檢視]  功能表和 [屬性視窗]  項目。 將 [ **檔案名稱** ] 屬性變更為 `Greetings.xaml`。
    ...
    ![已醒目提示檔名的 [屬性] 視窗](../ide/media/exploreide-filenameinpropertieswindow.png "|::ref11::|")
...
2. 在 [ **工具箱**] 中，搜尋 TextBlock 控制項。
    ...
    ![已醒目提示 TextBlock 控制項的 [工具箱]](../ide/media/exploreide-textblocktoolbox.png "|::ref12::|")
...
3. 選擇 TextBlock 項目並將它拖曳至設計介面上的視窗，即可將 TextBlock 控制項加入設計介面。  將控制項置中靠近視窗頂端。
   ...
   ![問候表單上的 TextBlock 控制項](../ide/media/exploreide-greetingswithtextblockonly.png "|::ref13::|")
...
1. 在 [ **工具箱**] 中，搜尋 RadioButton 控制項。
    ...
    ![已選取 RadioButton 控制項的 [工具箱] 視窗](../ide/media/exploreide-radiobuttontoolbox.png "|::ref14::|")
...
2. 選擇 RadioButton 項目並將它拖曳至設計介面上的視窗兩次，然後移動按鈕 (加以選取並使用方向鍵)，讓按鈕並排顯示於 TextBlock 控制項下方，即可將兩個 RadioButton 控制項加入設計介面。
    ...
    ![具有一個文字方塊和兩個選項按鈕的問候表單](../ide/media/exploreide-greetingswithradiobuttons.png "|::ref15::|")
...
2. 在 XAML 檢視中，將 Button 控制項的 [內容]  值從 `Content=”Button”` 變更為 `Content=”Display”`，然後儲存變更 (Ctrl-s 或使用 [檔案]  功能表)。
   ...
   ![具有控制項標籤的問候表單](../ide/media/exploreide-greetingswithconrollabels.png "|::ref16::|")
...
1. 依序選取 [ **偵錯**] 和 [ **開始偵錯**]，以啟動偵錯工具。
    ...
    ![[偵錯] 功能表上的 [開始偵錯] 命令](../ide/media/exploreide-startdebugging.png "|::ref17::|")

    此時會顯示對話方塊，表示發生 IOException：找不到資源 'mainwindow.xaml'。

2. 選擇 [ **確定** ] 按鈕，然後停止偵錯工具。

    ![[偵錯] 功能表上的 [停止偵錯] 命令](../ide/media/exploreide-stopdebugging.png "|::ref18::|")
...
2. 依序選取 [ **偵錯**] 和 [ **切換中斷點**]，以新增中斷點。
     ...
     ![[偵錯] 功能表上的 [切換中斷點] 命令](../ide/media/exploreide-togglebreakpoint.png "|::ref19::|")
...
1. 在主功能表上，選取 [建置]  及 [清除方案]  ，刪除在上一個建置期間建立的中繼檔和輸出檔。  這並非必要動作，但它可清除偵錯建置輸出。
    ...
    ![[建置] 功能表上的 [清除方案] 命令](../ide/media/exploreide-cleansolution.png "|::ref20::|")

2. 使用工具列上的下拉式控制項 (它目前的名稱是 "Debug")，將 HelloWPFApp 的建置組態從 [偵錯]  變更為 [發行]  。

    ![已選取 [發行] 的 [標準] 工具列](../ide/media/exploreide-releaseversion.png "|::ref21::|")

3. 選擇 [建置]  及 [建置方案]  或按 F6 鍵，即可建置方案。

    ![[建置] 功能表上的 [建置方案] 命令](../ide/media/exploreide-buildsolution.png "|::ref22::|")
...
## <a name="see-also"></a>另請參閱
 [Visual Studio 2015 的新功能](../what-s-new-in-visual-studio-2015.md)[開始使用 Visual Studio 的](../ide/get-started-developing-with-visual-studio.md)[生產力秘訣](../ide/productivity-tips-for-visual-studio.md)進行開發
