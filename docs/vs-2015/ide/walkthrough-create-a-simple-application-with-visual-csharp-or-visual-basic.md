...
本主題的最新的版本可從[逐步解說： 使用 Visual C# 或 Visual Basic 建立簡單的應用程式](https://docs.microsoft.com/visualstudio/ide/walkthrough-create-a-simple-application-with-visual-csharp-or-visual-basic)。  
