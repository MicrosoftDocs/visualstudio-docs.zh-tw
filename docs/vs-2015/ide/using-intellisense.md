...
## <a name="list-members"></a>列出成員
 ...
 ![Visual Studio 成員清單](../ide/media/vs2015-intellisense.png "|::ref1::|")
...
## <a name="parameter-info"></a>參數資訊
 ...
 ![參數資訊](../ide/media/vs2015-param-info.png "|::ref2::|")
...
## <a name="quick-info"></a>快速諮詢
 ...
 ![Visual Studio 快速諮詢](../ide/media/vs2015-quick-info.png "|::ref3::|")

 當您從 [列出成員]  方塊中選取成員時，也會出現 [快速諮詢]。

 ![C&#35; 程式碼檔案中的參數資訊](../ide/media/vs2015-paraminfo.png "|::ref4::|")
...
## <a name="see-also"></a>另請參閱
 [Visual Basic 特定的 intellisense](../ide/visual-basic-specific-intellisense.md) [Visual C# IntelliSense](../ide/visual-csharp-intellisense.md) [JavaScript intellisense](../ide/javascript-intellisense.md) [提供 XML 程式碼批註](../ide/supplying-xml-code-comments.md)
