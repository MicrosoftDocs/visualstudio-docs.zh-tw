...
## <a name="quick-info"></a>快速諮詢
 ...
 ![C&#35; 程式碼檔案中的參數資訊](../ide/media/vs2015-paraminfo.png "VS2015_ParamInfo")
...
## <a name="see-also"></a>另請參閱
 [Visual Basic 特定的 intellisense](../ide/visual-basic-specific-intellisense.md) [Visual c # intellisense](../ide/visual-csharp-intellisense.md) [提供 XML 程式碼批註](../ide/supplying-xml-code-comments.md)的[JavaScript intellisense](../ide/javascript-intellisense.md)
