...
- 針對 [!INCLUDE[csprcs](../includes/csprcs-md.md)] 專案，請參閱 [ [組建] 頁面、[專案設計工具] (c # ) ](../ide/reference/build-page-project-designer-csharp.md)。

- 若為 [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] 專案，請參閱 [/Clr (Common Language Runtime 編譯) ](https://msdn.microsoft.com/library/fec5a8c0-40ec-484c-a213-8dec918c1d6c)。
