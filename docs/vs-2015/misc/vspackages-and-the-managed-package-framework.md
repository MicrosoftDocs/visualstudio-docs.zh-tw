...
您可以使用 managed package framework (MPF) 類別來建立 VSPackage，而不是使用 COM interop 類別，藉此縮短開發時間。  
  
 有兩種方式可以建立受控 VSPackage：  
  
- 使用 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 封裝專案範本  
  
     如需詳細資訊，請參閱逐步解說 [：使用 Visual Studio 套件範本建立功能表命令](https://msdn.microsoft.com/library/1985fa7d-aad4-4866-b356-a125b6a246de)。  
  
- 在沒有 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 套件專案範本的情況下建立您的 VSPackage  
