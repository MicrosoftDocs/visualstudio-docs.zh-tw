...
ms.locfileid: "47496954"
---
# <a name="how-to-create-a-vsct-file-from-an-existing-ctc-file"></a>如何：從現有的 .ctc 檔建立 .vsct 檔
您可以從現有命令資料表 .ctc 原始程式檔建立 XML .vsct 檔。 如此一來，您可以利用新的 XML 架構[!INCLUDE[vsprvs](../includes/vsprvs-md.md)]命令資料表 (VSCT) 編譯器格式。  
...
5.  在 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]命令提示字元視窗中，瀏覽至目錄。  
