---
title: 如何：以手動方式將擴充功能封裝 (VSIX 部署) |Microsoft Docs
ms.date: 11/15/2016
...
> [!NOTE]
> VSIX 套件中的檔案名不能包含空格，也不能在統一資源識別項中保留的字元 (URI) ，如[ \[ RFC2396 \] ](https://go.microsoft.com/fwlink/?LinkId=90339)中所定義。  
...
5. 填入 [Content_types \] .Xml 檔案結構](../extensibility/the-structure-of-the-content-types-dot-xml-file.md)中所指定的 [Content_Types] .xml 檔案。  
