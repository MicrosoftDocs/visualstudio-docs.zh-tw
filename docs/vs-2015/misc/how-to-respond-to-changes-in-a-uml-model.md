...
## <a name="see-also"></a>另請參閱
 [導覽 UML 模型](../modeling/navigate-the-uml-model.md)[事件處理常式將變更傳播到模型的外部](../modeling/event-handlers-propagate-changes-outside-the-model.md)[範例：依造型的色彩](https://go.microsoft.com/fwlink/?LinkId=213841)