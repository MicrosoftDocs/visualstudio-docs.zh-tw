...
## <a name="identify-a-memory-issue-in-an-app"></a><a name="BKMK_Identify_a_memory_issue_in_an_app"></a>找出應用程式中的記憶體問題  
...
## <a name="analyze-memory-use"></a><a name="BKMK_Analyze_memory_use"></a>分析記憶體使用量  
 [篩選物件清單](#BKMK_Filter_the_list_of_objects) **&#124;** [分析單一快照中的記憶體資料](#BKMK_Analyze_memory_data_in_from_a_single_snapshot) **&#124;** [比較兩個記憶體快照](#BKMK_Compare_two_memory_snapshots)集  
...
### <a name="analyze-memory-data-in-from-a-single-snapshot"></a><a name="BKMK_Analyze_memory_data_in_from_a_single_snapshot"></a>從單一快照集分析中的記憶體資料  
...
- [**大小（位元組）** ] 是類型的所有實例大小，但不包括其持有參考的物件大小。 必須提供  
...
- [**大小（位元組）** ] 是物件的大小，但不包括其持有參考的物件大小。 必須提供  
...
## <a name="see-also"></a>另請參閱  
 ...
 [Channel 9 &#124; Visual Studio 工具箱 &#124; Visual Studio 2013 中的 Managed 記憶體分析](https://channel9.msdn.com/Shows/Visual-Studio-Toolbox/Managed-Memory-Analysis-in-Visual-Studio-2013)