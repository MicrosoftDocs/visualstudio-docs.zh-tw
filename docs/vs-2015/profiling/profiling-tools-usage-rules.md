...
|[DA0029：CLR 版本不受支援](../profiling/da0029-unsupported-clr-version.md)|分析工具不支援已進行程式碼剖析的二進位檔使用 [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] 版本。 分析工具報表無法解析符號名稱。|  
