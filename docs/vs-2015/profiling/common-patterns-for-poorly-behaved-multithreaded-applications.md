...
## <a name="uneven-workload-distribution"></a>工作負載分佈不均  
 ![工作負載不平均](../profiling/media/unevenworkload-1.png "UnevenWorkLoad_1")  
 ...
 ![工作負載不平均](../profiling/media/unevenworkload-2.png "UnevenWorkload_2")  
...
## <a name="inefficient-io"></a>無效率 I/O  
 ![無效率&#47;的 i/o](../profiling/media/inefficient-io.png "Inefficient_IO")  
...
## <a name="lock-convoys"></a>鎖定護送  
 ![鎖定群組](../profiling/media/lock-convoys.png "Lock_Convoys")  
