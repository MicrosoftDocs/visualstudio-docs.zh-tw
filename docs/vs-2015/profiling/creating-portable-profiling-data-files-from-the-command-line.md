...
> [!NOTE]
> 請確定 **VSPerfReport** 可以使用符號 (.pdb) 檔案。 如需詳細資訊，請參閱[如何：指定符號檔位置，從命令列](../profiling/how-to-specify-symbol-file-locations-from-the-command-line.md)。  
>   
