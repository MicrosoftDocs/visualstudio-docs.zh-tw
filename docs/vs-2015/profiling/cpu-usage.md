...
4. 當應用程式啟動時，按一下 [取得最大數目]。 顯示輸出之後，請等待大約 1 秒，然後選擇 [非同步取得最大數目]。 在按鈕點選之間等候，可讓您更輕鬆地隔離診斷報告中的按鈕點選常式。  
...
|![步驟4](../profiling/media/procguid-4.png "ProcGuid_4")|某個方法的子節點只包含父系方法呼叫的資料。 停用 [顯示外部程式碼] 時，應用程式方法也可以包含 [外部程式碼] 節點。|  
