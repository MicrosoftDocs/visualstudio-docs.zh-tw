...
> [!NOTE]
> 在許多情況下，使用效能精靈的預設屬性是收集分析資料的有效方式。 如需詳細資訊，請參閱 [效能分析](../profiling/beginners-guide-to-performance-profiling.md) 和 [消費者入門](../profiling/getting-started-with-performance-tools.md)的初級開發人員指南。  
