...
本主題的最新的版本可從[ASP.NET Web 應用程式使用 Profiler 命令列收集並行資料](https://docs.microsoft.com/visualstudio/profiling/collecting-concurrency-data-for-an-aspnet-web-application-using-the-profiler-command-line)。  
  
[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 分析工具的並行方法可讓您收集資源爭用資料。  
...
|工作|相關內容|  
|----------|---------------------|  
|**分析獨立 (用戶端) 應用程式**|-   [收集並行資料](../profiling/collecting-concurrency-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
