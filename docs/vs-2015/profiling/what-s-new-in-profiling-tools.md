...
## <a name="whats-new-in-update-1"></a>Update 1 的新功能  
 ...
 [診斷工具]  視窗已將搜尋和篩選選項加入 [事件]  索引標籤中。如需詳細資訊，請參閱 [Debugger-integrated profiling](https://msdn.microsoft.com/library/a1f40370-7b61-42c2-afc4-0e13eba98859) (整合偵錯工具的分析) 及 [Searching and filtering the Events tab of the Diagnostic Tools window](http://blogs.msdn.com/b/visualstudioalm/archive/2015/11/12/searching-and-filtering-the-events-tab-of-the-diagnostic-tools-window.aspx) (搜尋及篩選診斷工具視窗的事件索引標籤)。  
