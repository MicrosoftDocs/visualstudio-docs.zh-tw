...
5. 執行您要為其收集資料的情節。  
    ...
    ![在 [效能及診斷] pag 上收集資料](../profiling/media/pdhub-collectdata.png "PDHUB_CollectData")  
...
6. 若要結束診斷工作階段，請按一下 [停止收集]。  
   ...
   ![開啟已儲存的診斷會話檔案](../profiling/media/pdhub-openexistingdiagsession.png "PDHUB_OpenExistingDiagSession")  
