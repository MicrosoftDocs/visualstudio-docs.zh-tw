...
## <a name="create-the-cpuusedemo-project"></a><a name="BKMK_Create_the_CpuUseDemo_project"></a>建立 CpuUseDemo 專案  
...
## <a name="analyze-the-cpu-usage-report"></a><a name="BKMK_Analyze_the_CPU_Usage_report"></a>分析 CPU 使用量報告  
  
### <a name="cpu-utilization-timeline-graph"></a><a name="BKMK_CPU_utilization_timeline_graph"></a>CPU 使用率時間軸圖形  
 ![CpuUtilization &#40;% &#41; 時間軸圖形](../profiling/media/cpu-use-wt-timelinegraph.png "CPU_USE_WT_TimelineGraph")  
...
#### <a name="select-timeline-segments-to-view-details"></a><a name="BKMK_Select_timeline_segments_to_view_details"></a>選取時間軸區段以檢視詳細資料  
 使用 [Diagnostic session (診斷工作階段)]**** 時間軸上的選取列，聚焦於 GetMaxNumberButton_Click 資料：  
  
 ![GetMaxNumberButton&#95;按一下 [已選取]](../profiling/media/cpu-use-wt-getmaxnumberreport.png "CPU_USE_WT_GetMaxNumberReport")  
...
## <a name="next-steps"></a><a name="BKMK_Next_steps"></a> 後續步驟  
