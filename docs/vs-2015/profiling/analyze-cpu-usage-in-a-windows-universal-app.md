...
3. 在效能與診斷中樞中，選擇 [CPU Usage (CPU 使用量)]，然後選擇 [Start (開始)]。  
    ...
    ![啟動 CpuUsage 診斷會話](../profiling/media/cpu-use-wt-perfdiaghub.png "CPU_USE_WT_PerfDiagHub")  
...
#### <a name="BKMK_Select_timeline_segments_to_view_details"></a>選取時間軸區段以檢視詳細資料  
 ...
 ![GetMaxNumberButton&#95;按一下選取的](../profiling/media/cpu-use-wt-getmaxnumberreport.png "CPU_USE_WT_GetMaxNumberReport")  
...
|||  
|-|-|  
|![步驟1](../profiling/media/procguid-1.png "ProcGuid_1")|CPU 使用量呼叫樹狀圖中的最上層節點是虛擬節點|  
...
|![步驟3](../profiling/media/procguid-3.png "ProcGuid_3")|第二層節點的子系是第二層系統和 Framework 程式碼所呼叫或建立的使用者程式碼方法和非同步常式。|  
