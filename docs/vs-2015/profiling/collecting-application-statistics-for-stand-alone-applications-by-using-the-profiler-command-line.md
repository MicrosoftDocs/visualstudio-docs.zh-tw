...
本主題的最新的版本可從[收集獨立應用程式使用 Profiler 命令列應用程式統計資料](https://docs.microsoft.com/visualstudio/profiling/collecting-application-statistics-for-stand-alone-applications-by-using-the-profiler-command-line)。  
