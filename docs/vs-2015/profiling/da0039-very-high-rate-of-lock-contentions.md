...
ms.locfileid: "58355445"
---
# <a name="da0039-very-high-rate-of-lock-contentions"></a>DA0039：鎖定爭用的比率非常高
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

如需 Visual Studio 的最新文件，請參閱 < [DA0039： 非常高比率的鎖定爭用](https://docs.microsoft.com/visualstudio/profiling/da0039-very-high-rate-of-lock-contentions)docs.microsoft.com 上。  
