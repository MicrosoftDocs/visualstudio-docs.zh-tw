...
ms.locfileid: "47486123"
---
# <a name="sample-excel-extension-technologymanager-class"></a>範例 Excel 延伸模組：TechnologyManager 類別
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主題的最新的版本可從[範例 Excel 延伸模組： TechnologyManager 類別](https://docs.microsoft.com/visualstudio/test/sample-excel-extension-technologymanager-class)。  
