...
## <a name="working-with-the-code"></a>使用程式碼  
 若要使用此程式碼，您必須先在 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 中為其建立專案。 請依照下列中的 < 準備逐步解說 > 一節中的步驟[逐步解說：Managed 程式碼建立和執行單元測試](../test/walkthrough-creating-and-running-unit-tests-for-managed-code.md)。  
