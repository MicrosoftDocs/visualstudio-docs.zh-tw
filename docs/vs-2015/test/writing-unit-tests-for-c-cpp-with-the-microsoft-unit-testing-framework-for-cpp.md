...
2. 在新的專案中，檢查 **unittest1.cpp**
     ...
     ![測試專案與測試&#95;類別和測試&#95;方法](../test/media/utecpp2.png "UteCpp2")
...
3. 確認測試在測試總管中執行：
    ...
    2. 在 [測試] 功能表上，選擇 [執行] 、[所有測試]。
         ...
         ![具有一個通過測試的單元測試 Explorer](../test/media/utecpp04.png "UteCpp04")
...
2. 在 [Win32 應用程式精靈] 中選取 [DLL] 和 [匯出符號] 。
     ...
     ![為&#43; &#43; DLL 和匯出符號設定的 C project wizard](../test/media/utecpp06.png "UteCpp06")

3. 在主體 .h 檔案中宣告匯出的函式：

     ![具有 API 宏的新 DLL 程式碼專案和 .h 檔案](../test/media/utecpp07.png "UteCpp07")
...
1. 將 DLL 專案加入測試專案的專案參考中：
   ...
   2. 選擇 [加入新參考]。
        ...
        ![C&#43; &#43;專案屬性&#45;加入新的參考](../test/media/utecpp09.png "UteCpp09")
...
5. 在 [測試總管] 中，選擇 [ **全部執行**]。
    ...
    ![已通過單元&#45;測試 Explorer 基本測試](../test/media/utecpp10.png "UteCpp10")
...
4. 建置方案，然後在 [測試總管] 中選擇 [全部執行]。
     ...
     ![單元測試流覽&#45;器範圍測試已通過](../test/media/utecpp12.png "UteCpp12")
...
6. 現在所有測試都通過了。
     ...
     ![所有測試都通過](../test/media/ute-ult-alltestspass.png "UTE_ULT_AllTestsPass")
...
## <a name="see-also"></a>請參閱
 [使用 VisualStudio 將單元測試C++新增至現有的應用程式](../test/unit-testing-existing-cpp-applications-with-test-explorer.md)。 [Microsoft.visualstudio.testtools.cppunittestframework](../test/using-microsoft-visualstudio-testtools-cppunittestframework.md) [概述 Managed/非受控碼互通性](https://msdn.microsoft.com/library/ms973872.aspx)[偵錯工具機器碼](../debugger/debugging-native-code.md)[逐步解說：建立和使用動態連結程式庫（C++）](https://msdn.microsoft.com/library/3ae94848-44e7-4955-bbad-7d40f493e941)匯[入和匯出](https://msdn.microsoft.com/library/7c44c2aa-2117-4cec-9615-a65bfd3f8f7b)
