...
```  
 ...
 使用 app.config 檔案可讓您變更資料來源的位置，而不用變更單元測試本身。 如需有關如何建立和使用 app.config 檔案的資訊，請參閱[逐步解說：使用組態檔定義資料來源](../test/walkthrough-using-a-configuration-file-to-define-a-data-source.md)  
...
## <a name="see-also"></a>另請參閱  
 ...
 [如何：建立和執行單元測試](http://msdn.microsoft.com/5e0f43cf-5e51-48e2-9c98-0eb9324bdc48)   
