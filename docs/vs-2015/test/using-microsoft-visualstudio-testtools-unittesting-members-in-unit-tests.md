...
本主題的最新的版本可從[單元測試中使用 Microsoft.VisualStudio.TestTools.UnitTesting 成員](https://docs.microsoft.com/visualstudio/test/using-microsoft-visualstudio-testtools-unittesting-members-in-unit-tests)。
