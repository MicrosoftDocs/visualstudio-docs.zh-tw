...
|Chrome<br /><br /> Firefox|不支援記錄動作步驟。 裝有 Visual Studio 2012 Update 4 或更新版本的 Chrome 和 Firefox 瀏覽器可以播放自動程式碼 UI 測試。 如需詳細資訊，請參閱 [這裡](https://msdn.microsoft.com/library/jj835758.aspx) 。|
|Opera<br /><br /> Safari|不支援。|
|Silverlight|不支援。<br /><br /> 不過針對 Visual Studo 2013，您可以從 Visual Studio 組件庫下載 [適用於 Silverlight 的 Microsoft Visual Studio 2013 自動程式碼使用者介面測試外掛程式](https://marketplace.visualstudio.com/items?itemName=PrachiBoraMSFT.MicrosoftVisualStudio2013CodedUITestPluginforSilve) 。|
|Flash/Java|不支援。|
...
|MFC|部分支援。 如需有關支援哪些功能的詳細資料，請參閱下列 [Microsoft 網站](https://blogs.msdn.com/b/vstsqualitytools/archive/2010/04/15/uitest-framework-mfc-support-in-vs-2010.aspx) 。|
|SharePoint|完全支援。|
|Office 用戶端應用程式|不支援。|
|Dynamics CRM Web 用戶端|完全支援。|
|Dynamics (Ax) 2012 用戶端|部分支援動作記錄和播放。 如需詳細資訊，請參閱下列 [Microsoft 網站](https://blogs.msdn.com/b/dave_froslie/archive/2011/09/01/visual-studio-10-coded-ui-action-recordings-support-for-microsoft-dynamics-ax-2012.aspx) 。|
|SAP|不支援。|
...
## <a name="see-also"></a>請參閱
 [使用 UI 自動化來測試您的程式碼](../test/use-ui-automation-to-test-your-code.md)[從現有的動作記錄產生](https://msdn.microsoft.com/library/56736963-9027-493b-b5c4-2d4e86d1d497)自動程式化 UI 測試
