...
|架構|x86 和 x64。**注意：** 除非在 [!INCLUDE[win8](../includes/win8-md.md)] 或更新版本執行，否則 64 位元模式不支援 Internet Explorer。|  
...
|Flash/Java|不支援。|  
|Windows Forms 2.0 和更新版本|完全支援。 **注意：** 完全支援 NetFx 控制項，但並非所有協力廠商控制項都可支援。|  
