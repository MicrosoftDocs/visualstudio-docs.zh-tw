...
- [查看測試詳細資料](#BKMK_Viewing_test_details)

- [查看測試方法的原始程式碼](#BKMK_Viewing_the_source_code_of_a_test_method)
...
## <a name="viewing-test-results"></a><a name="BKMK_Viewing_test_results"></a>檢視測試結果
 當您執行、寫入、重新執行您的測試時，測試總管會顯示 [失敗的測試] ****、[通過的測試] ****、[略過的測試] **** 和 [未執行的測試] **** 群組中的結果。 在測試總管底部的詳細資料窗格會顯示測試回合的摘要。

### <a name="viewing-test-details"></a><a name="BKMK_Viewing_test_details"></a>檢視測試詳細資料
...
## <a name="debugging-unit-tests"></a><a name="BKMK_Debugging_unit_tests"></a>偵錯單元測試
