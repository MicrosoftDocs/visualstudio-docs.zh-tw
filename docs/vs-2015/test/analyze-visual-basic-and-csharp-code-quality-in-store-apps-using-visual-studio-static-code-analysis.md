---
title: '使用靜態程式碼分析來分析 Store 應用程式中的 Visual Basic 和 c # 程式碼品質'
ms.date: 11/15/2016
...
2. 在專案屬性頁面中，選擇 [程式碼分析]****，然後選擇 [建置時啟用程式碼分析] (定義 CODEANALYSIS 常數)****。
   ...
   ![[程式碼分析] 視窗](../test/media/ca-managed-collapsed.png "CA_Managed_Collapsed")
...
## <a name="analyzing-and-resolving-code-analysis-warnings"></a><a name="BKMK_Analyze"></a> 分析和解決程式碼分析警告
 ...
 ![反白顯示的程式碼分析文字](../test/media/ca-managed-sourceline.png "CA_Managed_SourceLine")
...
## <a name="visual-basic-and-c-code-analysis-warnings"></a><a name="BKMK_Warnings"></a> Visual Basic 和 C# 程式碼分析警告
 程式碼分析引發下列警告：
