...
本主題的最新的版本可從[市集應用程式使用 Visual Studio 靜態程式碼分析分析 c + + 程式碼品質](https://docs.microsoft.com/visualstudio/test/analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis)。  
