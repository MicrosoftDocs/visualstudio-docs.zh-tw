---
title: 如何：指定 Visual Studio 2015 複製檔案的位置 |Microsoft Docs
titleSuffix: ''
ms.date: 11/15/2016
...
3. 在 [發佈位置]**** 欄位中，使用下列其中一種格式輸入發佈位置：
   ...
   - 若要發行到 FTP 伺服器，請使用 ftp：/ftp.microsoft.com/ApplicationName 格式輸入路徑 \/ 。

     請注意，文字必須出現在 [ **發行位置** ] 方塊中，才能讓 [流覽 (**...**) 按鈕運作。

## <a name="see-also"></a>另請參閱
 [發行 Clickonce 應用程式](../deployment/publishing-clickonce-applications.md)[如何：使用發佈嚮導發行 clickonce 應用程式](../deployment/how-to-publish-a-clickonce-application-using-the-publish-wizard.md)
