...
發佈 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 應用程式時，在安裝期間顯示的使用者介面預設為開發電腦的語言和文化特性。 如果您要發行當地語系化的應用程式，則必須指定語言和文化特性以符合當地語系化的版本。 這取決於 `Publish language` 您專案的屬性。  
