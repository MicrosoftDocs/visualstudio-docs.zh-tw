---
title: 作法：停用 ClickOnce 應用程式的 URL 啟動 |Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "65697218"
---
# <a name="how-to-disable-url-activation-of-clickonce-applications"></a>作法：停用 ClickOnce 應用程式的 URL 啟動
...
一般而言，從 Web 伺服器安裝 [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] 應用程式後，其將立即自動啟動。 基於安全性理由，您可以決定停用此行為，並告知使用者改從 [開始] 功能表啟動應用程式。 下列程序描述如何停用 URL 啟用。  
 ...
 此程序使用 [!INCLUDE[winsdklong](../includes/winsdklong-md.md)] 工具 MageUI.exe。 如需有關這項工具的詳細資訊，請參閱 < [MageUI.exe (圖形用戶端、資訊清單產生和編輯工具)](https://msdn.microsoft.com/library/f9e130a6-8117-49c4-839c-c988f641dc14)。 您也可以使用 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 執行這項程序。  
