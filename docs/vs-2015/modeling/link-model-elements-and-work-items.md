---
title: 連結模型元素和工作專案 |Microsoft Docs
ms.date: 11/15/2016
...
- [連接至 team 專案](#ConnectTFS)

- [將模型元素連結至新的工作專案](#LinkNew)

- [將模型元素連結至現有的工作專案](#LinkExisting)

- [查看連結至模型專案的工作專案](#OpenWorkItem)

- [視圖連結至工作專案的模型元素](#ViewLinkedModels)

- [刪除模型元素與工作專案之間的連結](#RemoveLinks)

- [疑難排解](#Troubleshooting)

## <a name="ConnectTFS"></a>連接至 team 專案
...
## <a name="LinkNew"></a>將模型元素連結至新的工作專案
...
## <a name="LinkExisting"></a>將模型元素連結至現有的工作專案
...
## <a name="OpenWorkItem"></a>查看連結至模型專案的工作專案
...
## <a name="ViewLinkedModels"></a>視圖連結至工作專案的模型元素
...
2. 開啟工作項目，選擇 [ **連結**]。 在 [ **模型連結**] 底下，開啟所連結模型項目的捷徑功能表。 選擇 [ **開啟連結項目**]。
     ...
     ![從工作專案開啟連結的模型元素](../modeling/media/workitem-openlinkedmodelelement.png "WorkItem_OpenLinkedModelElement")

## <a name="RemoveLinks"></a>刪除模型元素與工作專案之間的連結
...
|找不到所連結的模型項目。|連結項目可能在已經移動、重新命名或刪除的圖表上。|1. 在工作專案中，刪除模型元素的連結。<br />2. 從工作專案建立新的連結至模型元素。|
...
## <a name="see-also"></a>請參閱
 [編輯 UML 模型和圖表](../modeling/edit-uml-models-and-diagrams.md)[建立您應用程式的模型](../modeling/create-models-for-your-app.md)
