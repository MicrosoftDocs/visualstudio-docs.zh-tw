...
-   [模型項目連結至新的工作項目](#LinkNew)  
  
-   [模型項目連結至現有的工作項目](#LinkExisting)  
  
-   [檢視工作項目連結至模型項目](#OpenWorkItem)  
  
-   [檢視模型項目連結至工作項目](#ViewLinkedModels)  
  
-   [刪除模型項目和工作項目之間的連結](#RemoveLinks)  
  
-   [疑難排解](#Troubleshooting)  
  
##  <a name="ConnectTFS"></a> 連接到 team 專案  
...
##  <a name="LinkNew"></a> 模型項目連結至新的工作項目  
...
##  <a name="RemoveLinks"></a> 刪除模型項目和工作項目之間的連結  
