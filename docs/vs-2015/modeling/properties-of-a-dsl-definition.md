...
|封裝 Guid|為此 DSL 產生之 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 封裝的 guid。|\<無>|
|封裝命名空間|為此 DSL 產生之 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 封裝的命名空間。|\<無>|
|產品名稱|將針對此 DSL 產生之 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 套件註冊的產品名稱。|\<無>|
|備註|與此網域類別相關聯的附注。|\<無>|
|描述|此網域類別的描述。|\<無>|
