---
title: 控制圖示或裝飾專案的可見度 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>另請參閱
 [定義圖形和](../modeling/defining-shapes-and-connectors.md)接點[設定圖表中的背景影像](../modeling/setting-a-background-image-on-a-diagram.md)[流覽和更新程式碼撰寫程式碼中的模型](../modeling/navigating-and-updating-a-model-in-program-code.md)，以自訂特定[領域語言](../modeling/writing-code-to-customise-a-domain-specific-language.md)
