...
本主題摘要說明各種不同方式，可讓您擴充 Visual Studio 隨附的 UML 模型工具。 若要查看支援各種模型類型和工具的 Visual Studio 版本有哪些，請參閱 [Version support for architecture and modeling tools](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport)。
 ...
 有關詳細資訊，請參閱此視頻：![連結到視頻](../data-tools/media/playvideo.gif "PlayVideo")[MSDN 如何執行 I 系列：UML 工具和可擴充性](https://msdn.microsoft.com/vstudio/ff859492)。
...
## <a name="profiles"></a>設定檔
 ...
 有關詳細資訊，請參閱[定義設定檔以擴展 UML](../modeling/define-a-profile-to-extend-uml.md)。
...
## <a name="custom-toolbox-items"></a>自訂工具箱項目
 ...
 有關詳細資訊，請參閱[定義自訂建模工具箱項](../modeling/define-a-custom-modeling-toolbox-item.md)。
...
## <a name="validation"></a>驗證
 ...
 有關詳細資訊，請參閱定義[UML 模型的驗證約束](../modeling/define-validation-constraints-for-uml-models.md)。
...
## <a name="menu-commands"></a>功能表命令
 ...
 請參閱[在建模圖上定義功能表命令](../modeling/define-a-menu-command-on-a-modeling-diagram.md)。
...
## <a name="gestures"></a>軌跡
 ...
 有關詳細資訊，請參閱[在建模關係圖上定義手勢處理常式](../modeling/define-a-gesture-handler-on-a-modeling-diagram.md)。
...
## <a name="responding-to-changes"></a>回應變更
 ...
 有關詳細資訊，請參閱[如何：回應 UML 模型中的更改](../misc/how-to-respond-to-changes-in-a-uml-model.md)。
...
## <a name="model-bus"></a>模型匯流排
 ...
 有關詳細資訊，請參閱將[UML 模型與其他模型和工具集成](../modeling/integrate-uml-models-with-other-models-and-tools.md)。
...
## <a name="generation"></a>世代
 ...
 有關詳細資訊，請參閱從[UML 模型生成檔](../modeling/generate-files-from-a-uml-model.md)。
...
## <a name="team-foundation-server-integration"></a>Team Foundation Server 整合
 ...
 有關詳細資訊，請參閱[定義工作項鍊接處理常式](../modeling/define-a-work-item-link-handler.md)。
...
## <a name="tools-that-update-models"></a>更新模型的工具
 ...
 有關詳細資訊，請參閱[在程式碼中讀取 UML 模型](../modeling/read-a-uml-model-in-program-code.md)。

## <a name="domain-specific-languages"></a>特定領域語言
 如果您經常使用特定類型的模型，建立特定領域語言可能會對您有所幫助。 相較於 UML 模型，建立此工具將可讓您更貼近商務需求，但也需付出更多心力在建置和維護上。 有關詳細資訊，請參閱[視覺化工作室 - 域特定語言的建模 SDK。](../modeling/modeling-sdk-for-visual-studio-domain-specific-languages.md)

## <a name="external-resources"></a>外部資源

|**類別目錄**|**連結**|
|------------------|---------------|
|**影片**|![連結到視頻](../data-tools/media/playvideo.gif "PlayVideo") [MSDN 如何執行系列：UML 工具和可擴充性](https://msdn.microsoft.com/vstudio/ff859492)<br /><br /> ![連結到視頻](../data-tools/media/playvideo.gif "PlayVideo")[頻道 9：UML 與視覺工作室](https://channel9.msdn.com/posts/clinted/)|
...
|**博客**|[Visual Studio ALM + Team Foundation Server 部落格](https://blogs.msdn.com/b/visualstudioalm)|
|**技術文件和日誌**|[MSDN 架構中心](https://msdn.microsoft.com/architecture/default.aspx)|

## <a name="see-also"></a>另請參閱
 [為應用](../modeling/create-models-for-your-app.md)API 參考創建模型[，用於 UML 建模擴充性](../modeling/api-reference-for-uml-modeling-extensibility.md)
