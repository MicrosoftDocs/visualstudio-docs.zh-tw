...
## <a name="see-also"></a>另請參閱
 [事件處理常式傳播模型外的變更](../modeling/event-handlers-propagate-changes-outside-the-model.md) [BoundsRules 限制圖形位置和大小](../modeling/boundsrules-constrain-shape-location-and-size.md)
