...
2. 以滑鼠右鍵按一下您的選取專案，然後按一下 [**複製**]。

3. 將選取項目貼到想要的應用程式。

### <a name="to-export-an-image-as-part-of-an-automated-process"></a>將影像匯出為自動化程序的一部分

- 請參閱[將 UML 圖表匯出至影像檔](../modeling/export-uml-diagrams-to-image-files.md)。
...
## <a name="see-also"></a>請參閱
 [建立應用程式的模型](../modeling/create-models-for-your-app.md)[共用模型和匯出圖表](../modeling/share-models-and-exporting-diagrams.md)
