...
|目標結束樣式|此連接器的目標端樣式（HollowArrow、EmptyArrow、FilledArrow、EmptyDiamond、FilledDiamond 或 None）。|無|
...
|公開色彩做為屬性<br /><br /> 以屬性形式公開的虛線樣式<br /><br /> 以屬性形式公開的粗細<br /><br /> 公開文字色彩|如果 `True`，使用者可以設定圖形的 [所述] 屬性。 若要進行此設定，請以滑鼠右鍵按一下圖形定義，然後按一下 [新增] [**公開**]。|偽|
|描述|用來記錄產生的設計工具。|\<無>|
