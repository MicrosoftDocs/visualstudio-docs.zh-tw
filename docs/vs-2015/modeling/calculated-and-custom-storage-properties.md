...
## <a name="see-also"></a>另請參閱
 在[網域屬性的](../modeling/properties-of-domain-properties.md)[程式碼屬性中流覽和更新模型](../modeling/navigating-and-updating-a-model-in-program-code.md)[如何定義特定領域語言](../modeling/how-to-define-a-domain-specific-language.md)
