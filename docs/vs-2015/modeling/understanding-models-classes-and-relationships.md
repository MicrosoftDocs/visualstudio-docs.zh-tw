---
title: 瞭解模型、類別和關聯性 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="the-dsl-definition"></a>DSL 定義
 當您開啟 `Dsl\DslDefinition.dsl` 時，[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 視窗會類似下圖。
...
## <a name="see-also"></a>請參閱
 [產生的 API](../misc/domain-relationships-in-the-generated-api.md) [網域特定語言工具詞彙](https://msdn.microsoft.com/ca5e84cb-a315-465c-be24-76aa3df276aa)中的網域關聯性
