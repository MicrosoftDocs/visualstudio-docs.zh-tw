...
## <a name="the-dsl-definition"></a>DSL 定義
 當您開啟時 `Dsl\DslDefinition.dsl` ，您 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 的視窗類似下圖。
...
## <a name="see-also"></a>另請參閱
 [產生的 API 中的網域關聯](../misc/domain-relationships-in-the-generated-api.md)性 [特定領域語言工具詞彙](https://msdn.microsoft.com/ca5e84cb-a315-465c-be24-76aa3df276aa)
