...
- 使用案例的執行步驟。 如需詳細資訊，請參閱[UML 使用案例圖：指導方針](../modeling/uml-use-case-diagrams-guidelines.md)。  
...
||**UML 活動圖表**|顯示活動的圖表。 若要查看其屬性，請按一下圖表的空白部分。 **注意：** 活動圖的名稱、包含圖表的檔案和圖表所顯示的活動，都可以不同。|  
