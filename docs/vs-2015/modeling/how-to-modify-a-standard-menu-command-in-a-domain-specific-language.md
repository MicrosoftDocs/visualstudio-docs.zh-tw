---
title: 如何：以特定領域語言修改標準功能表命令 |Microsoft Docs
ms.date: 11/15/2016
...
3. 覆[寫命令的 ProcessOnStatus 和 ProcessOnMenu 方法](#override)。
...
## <a name="what-commands-can-you-modify"></a><a name="what"></a> 您可以修改哪些命令？
...
## <a name="extend-the-appropriate-command-set-class"></a><a name="extend"></a> 擴充適當的命令集類別
 建立包含命令集類別之部分宣告的新檔案。
...
3. 在新檔案中，撰寫具有與產生部分類別相同之命名空間和名稱的部分宣告。 例如：
     ...
     **注意** 如果您使用類別檔案範本來建立新的檔案，您必須更正命名空間和類別名稱。

## <a name="override-the-command-methods"></a><a name="override"></a> 覆寫命令方法
...
## <a name="see-also"></a>另請參閱
 <xref:System.ComponentModel.Design.MenuCommand>[撰寫程式碼以自訂域特定的語言](../modeling/writing-code-to-customise-a-domain-specific-language.md)[如何：將命令新增至快捷方式功能表](../modeling/how-to-add-a-command-to-the-shortcut-menu.md)[逐步解說：從選取的連結取得資訊](../misc/walkthrough-getting-information-from-a-selected-link.md)[如何 vspackage 新增消費者介面](../extensibility/internals/how-vspackages-add-user-interface-elements.md)專案[Visual Studio 命令表格 (。.Vsct) Files](../extensibility/internals/visual-studio-command-table-dot-vsct-files.md) [.Vsct XML Schema Reference](../extensibility/vsct-xml-schema-reference.md)
