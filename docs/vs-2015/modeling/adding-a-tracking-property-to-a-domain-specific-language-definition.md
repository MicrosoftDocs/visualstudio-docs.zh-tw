---
title: 將追蹤屬性新增至網域指定的語言定義 |Microsoft Docs
ms.date: 11/15/2016
 ...
 *追蹤定義域*屬性是使用者可以更新的屬性，但是它的預設值是使用其他定義域屬性或專案的值來計算。
 ...
 在這個逐步解說中，您將建立特定領域語言 (DSL) 具有命名空間追蹤屬性，此屬性的預設值是以模型的預設 Namespace 屬性為基礎。 如需追蹤屬性的詳細資訊，請參閱 [定義追蹤屬性](https://msdn.microsoft.com/0538b0e4-6221-4e7d-911a-b92cd622f0be)。
...
## <a name="adding-custom-code-for-the-custom-type-descriptor"></a>加入自訂類型描述元的自訂程式碼
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>更新 DSL 套件以使用您的自訂類型描述元
...
## <a name="adding-custom-code-for-the-tracking-property"></a>新增追蹤屬性的自訂程式碼
...
## <a name="adding-custom-code-to-support-serialization"></a>加入自訂程式碼以支援序列化
...
## <a name="testing-the-language"></a>測試語言
 下一步是在新的實例中建立及執行 DSL 設計工具， [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] 讓您可以確認追蹤屬性是否正常運作。
...
2. 在 **[偵錯]** 功能表上，按一下 **[開始偵錯]** 。
     ...
     的實驗性組建 [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] 會開啟包含空白測試檔案的 **調試** 程式。
