---
title: 在圖表上設定背景影像 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>請參閱
 [定義圖形和連接器](../modeling/defining-shapes-and-connectors.md)[自訂文字和影像欄位](../modeling/customizing-text-and-image-fields.md)[在程式碼中導覽和更新模型撰寫程式碼](../modeling/navigating-and-updating-a-model-in-program-code.md) [，以設計特定領域語言](../modeling/writing-code-to-customise-a-domain-specific-language.md)
