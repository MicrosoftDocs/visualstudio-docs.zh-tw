---
title: 使用特定領域語言瀏覽器 |Microsoft Docs
ms.date: 11/15/2016
...
- **連接**產生器。 模型中的連接產生器清單。 如需連接產生器的詳細資訊，請參閱[自訂連結建立-重新導向](../misc/customizing-link-creation-redirection.md)。

- **連接器**。 模型中的連接器圖表項目清單。 如需連接器的詳細資訊，請參閱[圖形類型和連接器-重新導向](../misc/types-of-shapes-and-connectors-redirect.md)。
