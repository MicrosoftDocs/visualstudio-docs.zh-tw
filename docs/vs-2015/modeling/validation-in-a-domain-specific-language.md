---
title: 特定領域語言的驗證 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="running-validation-when-a-change-occurs"></a>發生變更時執行驗證
 ...
 除了驗證碼之外，也將自訂程式碼檔案新增至您的 **DslPackage** 專案，其中包含與下列範例類似的內容。 這個程式碼使用連結至文件的 `ValidationController`。 此控制器會在 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 錯誤清單中顯示驗證錯誤。
...
## <a name="see-also"></a>另請參閱
 [在程式碼事件處理常式中流覽和更新模型](../modeling/navigating-and-updating-a-model-in-program-code.md)會 [將變更傳播到模型之外](../modeling/event-handlers-propagate-changes-outside-the-model.md)
