---
title: 文字模板公用程式方法 |Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "72658529"
---
# <a name="text-template-utility-methods"></a>文字範本公用程式方法
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

當您在文字模板中撰寫程式碼時，有數種方法一律可供您使用 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 。 這些方法是在中定義 <xref:Microsoft.VisualStudio.TextTemplating.TextTransformation> 。

> [!TIP]
> 您也可以在一般 (未預先處理的) 文字模板中，使用主機環境所提供的其他方法和服務。 例如，您可以解析檔案路徑、記錄錯誤，以及取得所提供的服務， [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 以及任何已載入的封裝。  如需詳細資訊，請參閱 [從文字模板存取 Visual Studio](https://msdn.microsoft.com/0556f20c-fef4-41a9-9597-53afab4ab9e4)。
...
## <a name="error-and-warning-methods"></a>錯誤和警告方法
 您可以使用錯誤和警告公用程式方法，將訊息新增至 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 錯誤清單。 例如，下列程式碼會將錯誤訊息加入至錯誤清單。
...
## <a name="access-to-host-and-service-provider"></a>主機和服務提供者的存取權
 ...
 的類型 `this.Host` 取決於範本執行所在的主控制項類型。 在中執行的範本中 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ，您可以將轉換 `this.Host` 為， `IServiceProvider` 以取得 IDE 等服務的存取權。 例如：
