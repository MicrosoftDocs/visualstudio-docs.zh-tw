...
```  
 ...
 assembly 指示詞在前置處理過的文字範本中無效。 相反地，包含必要的參考中**參考**一節您[!INCLUDE[vsprvs](../includes/vsprvs-md.md)]專案。 如需詳細資訊，請參閱 <<c0> [ 執行階段使用 T4 文字範本產生文字](../modeling/run-time-text-generation-with-t4-text-templates.md)。  
