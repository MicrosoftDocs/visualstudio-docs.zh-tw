...
ms.locfileid: "74298158"
---
# <a name="supported-visual-studio-editions-for-visualization-amp-modeling-sdk"></a>視覺效果 &amp; 模型 SDK 支援的 Visual Studio 版本
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

以下是在撰寫和部署環境中 [!INCLUDE[dsl](../includes/dsl-md.md)] 支援的 Visual Studio 版本清單。 如需這些版本的詳細資訊，請參閱 Microsoft [!INCLUDE[vsprvs](../includes/vsprvs-md.md)][開發人員中心](https://go.microsoft.com/fwlink/?LinkId=75628)。
