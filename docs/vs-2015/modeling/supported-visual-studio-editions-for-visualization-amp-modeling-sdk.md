...
---
# <a name="supported-visual-studio-editions-for-visualization-amp-modeling-sdk"></a>視覺效果模型化 SDK 支援的 Visual Studio 版本 &amp;
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

以下是 [!INCLUDE[dsl](../includes/dsl-md.md)] 在撰寫和部署環境中支援的 Visual Studio 版本清單。 如需這些版本的詳細資訊，請參閱 Microsoft [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [開發人員中心](https://msdn.microsoft.com/vstudio/products/)。
