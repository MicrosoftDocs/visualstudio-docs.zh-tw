...
|**請確定您的軟體維持與系統的預定設計一致：**<br /><br /> 分層圖會描述應用程式元件之間的預定相依性。 在開發期間，您可以確認程式碼的實際相依性是否符合預定設計。|-   [從程式碼建立圖層圖表](../modeling/create-layer-diagrams-from-your-code.md)<br />-   [使用分層圖驗證程式代碼](../modeling/validate-code-with-layer-diagrams.md)|

## <a name="external-resources"></a>外部資源

|**類別**|**連結**|
|------------------|---------------|
|**影片**|![影片](../data-tools/media/playvideo.gif "PlayVideo") [Channel 9： Doug 7：程式碼瞭解和使用 Visual Studio 2010 的系統設計的](https://channel9.msdn.com/shows/VS2010Launch/Doug-Seven-Code-Understanding-and-Systems-Design-with-Visual-Studio-2010)連結<br /><br /> ![影片](../data-tools/media/playvideo.gif "PlayVideo") [Channel 9 的連結：使用分層圖架構應用程式](https://channel9.msdn.com/posts/clinted/UML-with-VS-2010-Part-5-Architecting-an-Application)<br /><br /> ![連結至影片](../data-tools/media/playvideo.gif "PlayVideo") [MSDN How Do I 系列：如何使用分層圖驗證程式代碼](https://msdn.microsoft.com/vstudio/gg501755)|
