---
title: 針對分層圖的擴充功能進行疑難排解 |Microsoft Docs
ms.date: 11/15/2016
...
1. 在 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 的實驗實例中開啟擴充方案，然後在 [**建立**] 功能表上，按一下 [**重建方案**]。

2. 按**F5**或**CTRL + F5**啟動 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 的實驗實例。 開啟分層圖並測試您的擴充功能。
...
1. 在 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 的實驗實例中，按一下 [**建立**] 功能表上的 [**清除方案**]。 這會清除上一次驗證分析的快取結果。
...
4. 在圖層驗證專案的**extension.vsixmanifest**中，確定您已在 [**內容**] 底下新增 [ **MEF 元件**] 專案和 [**自訂延伸模組類型**] 專案。
