...
## <a name="creating-a-basic-texture"></a>建立基本材質
 ...
 ![透明度以綠色呈現的「準星型」鏢靶](../designers/media/digit-bullseye-texture-in-editor.png "數位靶心-材質編輯器")
...
17. 繪製另一個從像素座標 `(192, 192)` 到像素座標 `(320, 320)` 的圓形。
    ...
    ![完成後的「準星型」鏢靶紋理](../designers/media/gfx-image-demo-bullseye.png "gfx_image_demo_bullseye")
