...
### <a name="shader-designer-toolbars"></a>著色器設計工具的工具列  
 ...
 ![[著色器設計工具] 強制回應工具列。](../designers/media/digit-dsd-modal-toolbar.png "Digit-DSD-Modal-Toolbar")  
...
|**材質環境**|**存取權**：                           [公用]  允許從模型編輯器設定此屬性，否則為 [私用]  。<br /><br /> **值**：間接或環境光源造成目前像素的擴散色彩。|  
