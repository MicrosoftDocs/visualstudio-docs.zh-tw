...
7. 在 [建立資料繫結] 對話方塊的 [路徑] 方塊中，選擇 **ItemCount : (int32)** 屬性，然後選擇 [確定] 按鈕。
     ...
     ![[建立資料系結] 對話方塊](../designers/media/xaml-create-data-binding.png "xaml_create_data_binding")
...
## <a name="see-also"></a>請參閱
 [使用 XAML 設計工具的](../designers/creating-a-ui-by-using-xaml-designer-in-visual-studio.md)[鋼筆：新增值轉換器對話方塊](https://msdn.microsoft.com/c5f3d110-a541-4b55-8bca-928f77778af8)來建立 UI
