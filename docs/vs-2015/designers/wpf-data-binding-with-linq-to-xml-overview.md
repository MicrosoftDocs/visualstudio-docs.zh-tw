...
## <a name="see-also"></a>另請參閱
 Wpf 資料系結搭配 LINQ to XML LINQ to XML WPF 資料系結中[的](../designers/wpf-data-binding-with-linq-to-xml.md)[動態屬性](../designers/linq-to-xml-dynamic-properties.md) [XAML](https://msdn.microsoft.com/library/5d858575-a83b-42df-ad3f-047ed2d6e3c8) [ (wpf) ](https://msdn.microsoft.com/library/90f79b97-17e7-40d1-abf0-3ba600ad1d7e) [使用工作流程標記](https://msdn2.microsoft.com/library/ms735921(vs.90).aspx)
