...
想像一下您想讓物件 (例如影像、按鈕和視訊等物件) 出現在頁面的什麼地方。 或許您想讓物件出現在資料列和資料行中、在垂直或水平的單一行中，或在固定位置中。
 ...
 在利用此機會思考頁面可能會如何出現之後，請選擇版面配置面板。 所有頁面都會以此開始，因為您需要一些項目來加入物件。 依預設，它是 **方格** ，但您可以變更它。
...
### <a name="grid"></a><a name="Grid"></a> 網 格
 將物件排列成資料列和資料行。

 ![](../designers/media/98b234b2-ac3b-441f-9136-98375fee87b7.png "98b234b2-ac3b-441f-9136-98375fee87b7")

 **觀看短片：** [使用網格](http://www.popscreen.com/v/6A4hj/Microsoft-Expression-Blend-Using-Grids)線![設定已安裝的功能](../designers/media/bldadminconsoleinitialconfigicon.PNG ">bldadminconsoleinitialconfigicon")
...
### <a name="canvas"></a><a name="Canvas"></a> 帆布
 ...
 **觀看短片：** 設定[使用畫布的](http://www.popscreen.com/v/6A4hT/Microsoft-Expression-Blend-Working-with-the-Canvas)![已安裝功能](../designers/media/bldadminconsoleinitialconfigicon.PNG ">bldadminconsoleinitialconfigicon")
 ...
 **觀看短片：** 設定搭配[StackPanel 和 WrapPanel 使用的](http://www.popscreen.com/v/6A4i5/Microsoft-Expression-Blend-Using-the-StackPanel-and-WrapPanel)![已安裝功能](../designers/media/bldadminconsoleinitialconfigicon.PNG ">bldadminconsoleinitialconfigicon")
...
### <a name="border"></a><a name="Border"></a> 邊境
 ...
 **觀看短片：** 設定[使用框線的](http://www.popscreen.com/v/6A4hB/Microsoft-Expression-Blend-Working-with-Borders)![已安裝功能](../designers/media/bldadminconsoleinitialconfigicon.PNG ">bldadminconsoleinitialconfigicon")

### <a name="popup"></a><a name="Popup"></a> 彈出
 在視窗中向使用者顯示資訊或選項。 您可以只將一個將物件新增至 **Popup**。 根據預設， **快顯視窗** 包含 **方格** ，但您可以變更它。
...
## <a name="see-also"></a>另請參閱
 使用[中的元素 XAML 設計工具](../designers/working-with-elements-in-xaml-designer.md)[建立使用 XAML 設計工具的 UI](../designers/creating-a-ui-by-using-xaml-designer-in-visual-studio.md)
