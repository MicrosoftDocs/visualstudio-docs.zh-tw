...
## <a name="see-also"></a>請參閱
 [Wpf 資料系結與 LINQ to XML](../designers/wpf-data-binding-with-linq-to-xml.md) [wpf 資料系結與 LINQ to XML 總覽](../designers/wpf-data-binding-with-linq-to-xml-overview.md) [LINQ 查詢簡介C#（）](https://msdn.microsoft.com/library/37895c02-268c-41d5-be39-f7d936fa88a8)
