...
## <a name="see-also"></a>另請參閱
 [鍵盤快速鍵和輔助按鍵](../designers/keyboard-shortcuts-and-modifier-keys-in-blend.md)[畫板輔助按鍵](../designers/artboard-modifier-keys-in-blend.md)[直接選取工具輔助](../designers/direct-selection-tool-modifier-keys-in-blend.md)按鍵[繪製圖案和路徑](../designers/draw-shapes-and-paths.md)
