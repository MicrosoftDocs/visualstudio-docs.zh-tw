...
ms.locfileid: "68148057"
---
# <a name="xelement-class-dynamic-properties"></a>XElement 類別動態屬性
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本節描述 <xref:System.Xml.Linq.XElement?displayProperty=fullName>[t](<!-- TODO: review code entity reference <xref:assetId:///t?qualifyHint=False&amp;autoUpgrade=True>  -->) 類別的動態屬性。  
