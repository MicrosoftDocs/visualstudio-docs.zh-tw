...
ms.locfileid: "72658013"
---
# <a name="artboard-modifier-keys-in-blend"></a>Blend 中的畫板輔助按鍵
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

某些鍵盤快速鍵沒有相關的功能表項目，這代表您不能使用 [!INCLUDE[blend_subs](../includes/blend-subs-md.md)] 使用者介面來找出它們。 下表列出可修改動作的快速鍵，例如調整物件大小。
...
## <a name="see-also"></a>請參閱
 [鍵盤快速鍵](../designers/keyboard-shortcuts-in-blend.md)[畫筆工具輔助按鍵](../designers/pen-tool-modifier-keys-in-blend.md)[直接選取工具輔助按鍵](../designers/direct-selection-tool-modifier-keys-in-blend.md)
