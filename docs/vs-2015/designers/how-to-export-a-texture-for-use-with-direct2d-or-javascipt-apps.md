---
title: 作法：匯出材質以搭配 Direct2D 或 Javascipt 應用程式 |Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "67823916"
---
# <a name="how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps"></a>作法：匯出紋理以與 Direct2D 或 Javascipt 應用程式搭配使用
