...
|您是 Windows Form 開發人員嗎？|[Windows Forms 控制項和對等 WPF 控制項](https://msdn.microsoft.com/library/ms750559\(v=vs.100\).aspx)<br /><br /> [WPF 和 Windows Forms 互通的支援案例](https://msdn.microsoft.com/library/ms751797\(v=vs.100\).aspx)|
