...
|剛開始使用 .NET 嗎？|[.NET Framework 的概觀](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [應用程式基本概念](https://msdn.microsoft.com/library/653da4ba-3752-4d1f-a08a-de017dc86ecc)<br /><br /> [Visual C# 和 Visual Basic 使用者入門](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx)|
|WPF 的相關詳細資訊...|[WPF 簡介](../designers/introduction-to-wpf.md)<br /><br /> [XAML 概觀 (WPF)](https://msdn.microsoft.com/library/ms752059\(v=vs.100\).aspx)<br /><br /> [控制項](https://msdn.microsoft.com/library/bb613551\(v=vs.100\).aspx)<br /><br /> [資料系結總覽](https://msdn.microsoft.com/library/ms752347\(v=vs.100\).aspx)<br /><br /> [WPF 資料繫結與 LINQ to XML](../designers/wpf-data-binding-with-linq-to-xml.md)|
