...
##### [如何：建立基本紋理](how-to-create-a-basic-texture.md)
...
##### [如何：建立基本紋理著色器](how-to-create-a-basic-texture-shader.md)
##### [如何：建立灰階紋理著色器](how-to-create-a-grayscale-texture-shader.md)
...
#### [如何：匯出包含 Mipmap 的紋理](how-to-export-a-texture-that-contains-mipmaps.md)
#### [如何：匯出包含預乘 Alpha 的紋理](how-to-export-a-texture-that-has-premultiplied-alpha.md)
#### [如何：匯出紋理以與 Direct2D 或 JavaScript 應用程式搭配使用](how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps.md)
