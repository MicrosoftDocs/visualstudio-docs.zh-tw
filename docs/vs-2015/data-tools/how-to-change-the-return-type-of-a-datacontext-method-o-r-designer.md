---
title: 如何：變更 DataCoNtext 方法的傳回型別 (O-R 設計工具) |Microsoft Docs
ms.date: 11/15/2016
...
2. 選取 [屬性]**** 視窗中的 [傳回型別]****，然後在 [傳回型別]**** 清單中選取可用的實體類別。 如果所需的實體類別不在清單中，請將它加入或在中建立， [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] 以將其加入清單中。
...
2. 將資料庫物件從**伺服器總管**的 / **資料庫總管**拖曳至 O/R 設計工具的空白區域。

3. 儲存 .dbml 檔案。

## <a name="see-also"></a>另請參閱
 [LINQ to SQL Visual Studio](../data-tools/linq-to-sql-tools-in-visual-studio2.md) [LINQ to SQL](https://msdn.microsoft.com/library/73d13345-eece-471a-af40-4cc7a2f11655) [DataCoNtext 方法中的工具 (o/r 設計工具) ](../data-tools/datacontext-methods-o-r-designer.md) [如何：建立對應至預存程式和函式的 DataCoNtext 方法 (O/r 設計工具) ](../data-tools/how-to-create-datacontext-methods-mapped-to-stored-procedures-and-functions-o-r-designer.md)
