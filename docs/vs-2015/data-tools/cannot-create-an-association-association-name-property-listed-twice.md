---
title: 無法建立關聯 &lt; 關聯名稱 &gt; -屬性已列出兩次 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>另請參閱
 [LINQ to SQL 中的工具 Visual Studio](https://msdn.microsoft.com/library/a57e82d5-f7e4-4894-8add-3d9ba4fce186) [如何：建立 LINQ to SQL 類別之間的關聯 (關聯性)  (o/R 設計工具) ](../data-tools/how-to-create-an-association-relationship-between-linq-to-sql-classes-o-r-designer.md) [逐步解說：建立 LINQ to SQL 類別 (o-r 設計工具) ](https://msdn.microsoft.com/library/35aad4a4-2e8a-46e2-ae09-5fbfd333c233) [LINQ to SQL](https://msdn.microsoft.com/library/73d13345-eece-471a-af40-4cc7a2f11655)
