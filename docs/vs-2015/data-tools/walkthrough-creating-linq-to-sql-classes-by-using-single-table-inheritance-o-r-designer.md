...
本主題的最新的版本可從[逐步解說： 建立的 LINQ to SQL 類別，以使用單一資料表繼承 （O-R 設計工具）](https://docs.microsoft.com/visualstudio/data-tools/walkthrough-creating-linq-to-sql-classes-by-using-single-table-inheritance-o-r-designer)。  
