---
title: 作法：建立對應至預存程序和函式 （O-R 設計工具） 的 DataContext 方法 |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>另請參閱  
 ...
 [如何：撰寫 LINQ 查詢C#](https://msdn.microsoft.com/library/45e47fcc-cfa1-4b72-b161-d038ae87bd23)
