...
> [!WARNING]
> 如果您將在 LocalDB 2014 (V12) 32 位中建立的 .mdf 檔案升級至 LocalDB 2016 (V13) ，您將無法再于 LocalDB 的32位版本中開啟該檔案。  在 Update 2 中，LocalDB V13 僅限64位。
...
### <a name="to-upgrade-to-a-newer-version-of-sql-server-express"></a>升級至較新版本的 SQL Server Express
