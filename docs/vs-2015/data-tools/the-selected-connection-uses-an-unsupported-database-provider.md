---
title: 選取的連接使用了不支援的資料庫提供者 |Microsoft Docs
ms.date: 11/15/2016
...
當您將未使用 .NET Framework Data Provider SQL Server 的專案從**伺服器總管**/**資料庫總管**拖曳至[LINQ to SQL 中的 Visual Studio 工具](../data-tools/linq-to-sql-tools-in-visual-studio2.md)時，會出現此訊息。
