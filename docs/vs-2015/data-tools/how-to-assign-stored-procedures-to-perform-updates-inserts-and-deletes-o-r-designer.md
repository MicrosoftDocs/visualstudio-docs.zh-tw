...
本主題的最新的版本可從[如何： 指派預存程序來執行更新、 插入和刪除 （O-R 設計工具）](https://docs.microsoft.com/visualstudio/data-tools/how-to-assign-stored-procedures-to-perform-updates-inserts-and-deletes-o-r-designer)。  
