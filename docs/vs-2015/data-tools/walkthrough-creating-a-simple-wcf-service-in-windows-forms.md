...
1. 按 **F5** 執行服務。 將會顯示 **WCF 測試用戶端** 表單，並且會載入服務。

2. 在 [WCF 測試用戶端]**** 表單中，按兩下 [IService1]**** 下的 [GetData()]**** 方法。 將 **會顯示 [有** 系統] 索引標籤。

     ![有&#40;&#41; 的方法](../data-tools/media/wcf4.png "wcf4")
...
2. 在 [ **新增專案** ] 對話方塊中，展開 [ **Visual Basic** ] 或 [ **Visual c #** ] 節點，然後選取 [ **Windows**]，再選取 [ **Windows Forms 應用程式**]。 按一下 [確定]**** 開啟專案。
