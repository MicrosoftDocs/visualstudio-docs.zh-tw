...
從**伺服器總管**/**資料庫總管**拖曳至 [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] 的一個或多個專案包含 [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] 不支援的資料類型（例如， [CLR 使用者定義的類型](https://msdn.microsoft.com/library/9f70e0b0-3a0d-4eb1-b914-07a5d0c167c2)）。
