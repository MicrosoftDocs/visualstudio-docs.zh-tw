...
- 使用 [[資料來源設定]](https://msdn.microsoft.com/library/c4df7de5-5da0-4064-940c-761dd6d9e28f)[建立] 來建立及設定資料集。
...
1. 選取 [ **InsertButton** ] 以建立 click 事件的事件處理常式，並在程式碼編輯器中開啟表單。
...
#### <a name="to-add-code-to-delete-records-from-the-database"></a>若要加入程式碼以從資料庫中刪除記錄

1. 選取 [ **DeleteButton** ] 以建立 click 事件的事件處理常式，並在程式碼編輯器中開啟表單。
...
- 選取 [**更新**] 按鈕，並確認已在方格中更新記錄。

- 選取 [**刪除**] 按鈕，並確認已從方格中移除該記錄。

## <a name="next-steps"></a>後續步驟
 根據您的應用程式需求，在建立資料系結表單之後，您可能會想要執行幾個步驟。 一些您可以加強這個逐步解說的部分包括：
