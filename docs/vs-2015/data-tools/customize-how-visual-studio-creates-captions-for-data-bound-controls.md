...
當您從 [[資料來源] 視窗](https://msdn.microsoft.com/library/0d20f699-cc95-45b3-8ecb-c7edf1f67992)將專案拖曳至 [Windows Form 設計工具] 時，會有一個特殊的考慮：當發現兩個或多個單字串連在一起時，標題標籤中的資料行名稱會重新格式化為更容易閱讀的字串。 您可以藉由在**HKEY_CURRENT_USER \Software\microsoft\visualstudio\10.0\data 設計**工具登錄機碼中設定**SmartCaptionExpression**、 **SmartCaptionReplacement**和**SmartCaptionSuffix**值，自訂這些標籤的建立方式。
...
|**SmartCaptionSuffix**|所解碼的字元：|表示附加至傳回字串的字元。 例如，如果標題為 `Company Name`，則尾碼會使其 `Company Name:`|
