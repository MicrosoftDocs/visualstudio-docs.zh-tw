---
title: 無法取得資料庫物件的架構資訊 &lt;object 名稱 &gt; |Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "72651104"
---
# <a name="could-not-retrieve-schema-information-for-database-object-ltobject-namegt"></a>無法取得資料庫物件的架構資訊 &lt;object 名稱 &gt;
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

當**伺服器總管/資料庫總管**中的物件複製到剪貼簿、從資料庫中刪除，然後貼入設計工具上時，通常會出現此訊息。 因為資料庫物件不再存在，所以會出現這則訊息。
