 ...
 **產生以工作為基礎的作業**  
 撰寫非同步程式碼時，這個選項可讓您利用 .Net 4 所引進的工作平行程式庫 (TPL)。 請參閱[工作平行程式庫 (TPL)](https://msdn.microsoft.com/library/dd460717.aspx)。  
  
 **總是產生訊息合約**  
 判斷是否會產生 WCF 用戶端的訊息合約類型。 如需有關訊息合約的詳細資訊，請參閱[Using Message Contracts](https://msdn.microsoft.com/library/1e19c64a-ae84-4c2f-9155-91c54a77c249)。  
 ...
 **新增 Web 參考**  
 顯示[NIB:加入 Web 參考對話方塊](https://msdn.microsoft.com/bdf05776-c591-40af-bfd7-e1e2aa1e87b5)。  
...
## <a name="see-also"></a>另請參閱  
 [如何：新增、 更新或移除服務參考](https://msdn.microsoft.com/library/cacc14bd-4455-4a44-be78-d2ac16113dd9)   
 [如何：將參考加入至 Web 服務](https://msdn.microsoft.com/library/952e49a1-567e-4a74-8cd7-f2e7b62c3168)   
