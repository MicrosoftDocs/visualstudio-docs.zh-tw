---
title: 作法：建立 LINQ to SQL 類別 （O-R 設計工具） 之間的關聯 （關聯性） |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>另請參閱  
 ...
 [如何：表示主索引鍵](https://msdn.microsoft.com/library/63c65289-6539-42b2-8493-891c232018fa)
