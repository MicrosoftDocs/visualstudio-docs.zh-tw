...
|繼承預設值|當指定為 **鑒別子屬性** 的屬性值不符合 **基類鑒別子值** 或 **衍生類別鑒別子值**時，應填入的類別。|
...
|[逐步解說：使用單一資料表繼承來建立 LINQ to SQL 類別 (O/R 設計工具) ](../data-tools/walkthrough-creating-linq-to-sql-classes-by-using-single-table-inheritance-o-r-designer.md)|提供逐步指示，說明如何透過 [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)]，設定使用單一資料表繼承的實體類別。|

## <a name="see-also"></a>另請參閱
 [Visual Studio 逐步解說中的 LINQ to SQL 工具](../data-tools/linq-to-sql-tools-in-visual-studio2.md) [：建立 LINQ to SQL 類別 (O-R 設計工具) ](https://msdn.microsoft.com/library/35aad4a4-2e8a-46e2-ae09-5fbfd333c233)逐步解說 [：使用單一資料表繼承建立 LINQ to SQL 類別 (o/R 設計 ](../data-tools/walkthrough-creating-linq-to-sql-classes-by-using-single-table-inheritance-o-r-designer.md)工具) [消費者入門](https://msdn.microsoft.com/library/db8a557a-fef8-4f4f-bb91-8cff7250ee25)
