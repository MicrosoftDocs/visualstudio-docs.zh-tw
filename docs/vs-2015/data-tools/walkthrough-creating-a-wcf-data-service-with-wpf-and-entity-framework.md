...
本主題的最新的版本可從[逐步解說： 使用 WPF 和 Entity Framework 建立 WCF 資料服務](https://docs.microsoft.com/visualstudio/data-tools/walkthrough-creating-a-wcf-data-service-with-wpf-and-entity-framework)。  
