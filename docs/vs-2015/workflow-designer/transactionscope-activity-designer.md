...
|<xref:System.Activities.Statements.TransactionScope.AbortInstanceOnTransactionFailure?qualifyHint=False&autoUpgrade=True>|True|指定值，這個值會指出當異動中止時，工作流程是否應隨之中止。|  
