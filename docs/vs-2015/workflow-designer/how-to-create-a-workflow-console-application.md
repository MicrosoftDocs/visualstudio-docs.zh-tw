---
title: 作法：建立工作流程主控台應用程式 |Microsoft Docs
ms.date: 11/15/2016
...
---
# <a name="how-to-create-a-workflow-console-application"></a>作法：建立工作流程主控台應用程式
[!INCLUDE[wf](../includes/wf-md.md)] 可讓您建立工作流程，以執行系統或人力進程。 [!INCLUDE[wfd1](../includes/wfd1-md.md)] 會提供建立這些工作流程的設計介面。 [!INCLUDE[wfd2](../includes/wfd2-md.md)] 可用來從 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 建立工作流程，或者可以整合到重新裝載設計工具的其他應用程式中。
...
3. 在 [**已安裝的範本**] 窗格中，根據您偏好的語言，從 [  **C#視覺效果**] 或 [ **Visual Basic** ] 群組選取 [**工作流程**]。
...
9. 若要撰寫工作流程，請將活動或其他工作流程專案從 [**工具箱**] 拖曳至工作流程中的設計介面。
