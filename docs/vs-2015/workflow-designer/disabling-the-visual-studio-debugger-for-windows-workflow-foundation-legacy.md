---
title: 針對 Windows Workflow Foundation (舊版) 停用偵錯工具 |Microsoft Docs
ms.date: 11/15/2016
...
本主題描述在舊版 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 中建置 [!INCLUDE[wf](../includes/wf-md.md)] 應用程式時，如何透過組態檔停用 [!INCLUDE[wfd1](../includes/wfd1-md.md)] 偵錯工具。 當您需要以 [!INCLUDE[wfd2](../includes/wfd2-md.md)] 或 [!INCLUDE[netfx35_long](../includes/netfx35-long-md.md)] 為目標時，請使用舊版 [!INCLUDE[vstecwinfx](../includes/vstecwinfx-md.md)]。
 ...
 根據預設，將會針對主機處理序啟用 [!INCLUDE[vs_current_long](../includes/vs-current-long-md.md)] Debugger for [!INCLUDE[wf](../includes/wf-md.md)]。 若要停用工作流程偵錯工具，您必須 **\<switches>** 在主機設定檔的區段中新增 "DisableWorkflowDebugging" 專案專案，以明確地將它關閉 **\<system.diagnostics>** 。
...
## <a name="see-also"></a>另請參閱
 叫用[Visual Studio 偵錯工具 Windows Workflow Foundation (舊版) ](../workflow-designer/invoking-the-visual-studio-debugger-for-windows-workflow-foundation-legacy.md)偵測[舊版工作流程](../workflow-designer/debugging-legacy-workflows.md)