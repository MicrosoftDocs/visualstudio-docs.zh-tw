...
ms.locfileid: "47490621"
---
# <a name="primitives-activity-designers"></a>基本活動設計工具
基本活動設計工具會用於在 <xref:System.Activities> 命名空間中建立及設定各種活動，例如 Assign 和 Delay 活動。 本節包含的主題會提供如何使用 [!INCLUDE[wfd2](../includes/wfd2-md.md)] 活動與範本設計工具的指引。  
