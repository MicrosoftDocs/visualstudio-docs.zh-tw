 ...
 **選取規則集** 對話方塊來選取規則集，您可以搭配[PolicyActivity](http://go.microsoft.com/fwlink?LinkID=65019)活動。 如需有關如何存取資訊**選取規則集** 對話方塊中，請參閱[How to:建立 PolicyActivity 規則集 （舊版）](../workflow-designer/how-to-create-a-policyactivity-rule-set-legacy.md)。  
