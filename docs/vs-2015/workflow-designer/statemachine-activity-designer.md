...
## <a name="using-the-statemachine-activity-designer"></a>使用 StateMachine 活動設計工具
 若要加入 <xref:System.Activities.Statements.StateMachine> 活動，請從 [**工具箱**] 的 [**狀態機器**] 區段，將 [ **StateMachine** ] 活動設計工具拖曳至 [!INCLUDE[wfd1](../includes/wfd1-md.md)] 介面上。 若要在此活動中新增子狀態 <xref:System.Activities.Statements.StateMachine> ，請 <xref:System.Activities.Statements.State> 從 [工具箱] 將或拖曳至 <xref:System.Activities.Core.Presentation.FinalState> [ **StateMachine**]。 **Toolbox**
