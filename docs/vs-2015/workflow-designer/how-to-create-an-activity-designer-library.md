...
3. 在 [**專案類型**] 窗格中，根據您偏好的語言，從 [**視覺效果C#**  ] 或 [ **Visual Basic** ] 群組選取 [**工作流程**]。
...
9. 將 [!INCLUDE[avalon1](../includes/avalon1-md.md)] 控制項從 [**工具箱**] 拖曳至設計介面，以便在您的自訂活動設計工具中使用它們。  如需如何執行自訂活動設計工具的範例，請參閱[如何：建立自訂活動設計](https://msdn.microsoft.com/library/2f3aade6-facc-44ef-9657-a407ef8b9b31)工具。

    > [!WARNING]
    > 自訂活動設計工具可用於自訂活動以及預設 [!INCLUDE[netfx40_short](../includes/netfx40-short-md.md)]activities。
