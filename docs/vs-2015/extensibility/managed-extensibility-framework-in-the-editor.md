...
### <a name="exporting-and-importing-component-parts"></a>匯出和匯入元件部分  
...
## <a name="getting-editor-functionality-from-a-mef-component-part"></a>從 MEF 元件部分取得編輯器功能  
...
5. 當您編譯元件之後，請將它放在中。Visual Studio 安裝的 \Common7\IDE\Components\ 資料夾。  
