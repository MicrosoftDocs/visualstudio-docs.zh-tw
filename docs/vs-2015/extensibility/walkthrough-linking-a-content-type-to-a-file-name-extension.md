...
您可以定義自己的內容類型，並使用編輯器 Managed Extensibility Framework (MEF) 擴充功能來連結副檔名。 在某些情況下，語言服務已定義了副檔名;不過，若要搭配 MEF 使用它，您仍然必須將它連結至內容類型。  
...
## <a name="linking-a-file-name-extension-to-a-content-type"></a>連結副檔名至內容類型  
  
- 若要將這個內容類型對應至副檔名，請匯出 <xref:Microsoft.VisualStudio.Utilities.FileExtensionToContentTypeDefinition> 副檔名為 ".. a" 且內容類型為 "hid" 的。  
