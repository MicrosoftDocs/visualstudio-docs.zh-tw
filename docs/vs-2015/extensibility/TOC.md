...
# [常見問題集：將增益集轉換成 VSPackage 擴充功能](faq-converting-add-ins-to-vspackage-extensions.md)
...
### [逐步解說：顯示成對大括弧](walkthrough-displaying-matching-braces.md)
...
### [逐步解說：搭配編輯器延伸模組使用 Shell 命令](walkthrough-using-a-shell-command-with-an-editor-extension.md)
### [逐步解說：在編輯器延伸模組中使用快速鍵](walkthrough-using-a-shortcut-key-with-an-editor-extension.md)
...
### [逐步解說：將功能新增至自訂編輯器](walkthrough-adding-features-to-a-custom-editor.md)
...
### [逐步解說：將自訂的 XAML 新增至起始頁](walkthrough-adding-custom-xaml-to-the-start-page.md)
...
### [逐步解說：在起始頁儲存使用者設定](walkthrough-saving-user-settings-on-a-start-page.md)
...
## [如何：針對 Visual Studio 延伸模組使用規則型的 UI 內容](how-to-use-rule-based-ui-context-for-visual-studio-extensions.md)
...
## [逐步解說：發佈 Visual Studio 延伸模組](walkthrough-publishing-a-visual-studio-extension.md)
## [如何：將相依性新增至 VSIX 套件](how-to-add-a-dependency-to-a-vsix-package.md)
...
### [如何：關閉原始程式碼控制外掛程式的相容性警告](how-to-turn-off-compatibility-warnings-for-source-control-plug-ins.md)
