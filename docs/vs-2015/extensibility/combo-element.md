...
ms.locfileid: "47486109"
---
# <a name="combo-element"></a>Combo 項目
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主題的最新的版本可從[Combo 元素](https://docs.microsoft.com/visualstudio/extensibility/combo-element)。  
