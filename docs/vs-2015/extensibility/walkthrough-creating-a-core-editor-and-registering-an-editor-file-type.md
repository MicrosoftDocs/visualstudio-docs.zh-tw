...
- 開始[!INCLUDE[vsprvs](../includes/vsprvs-md.md)]並建立[!INCLUDE[csprcs](../includes/csprcs-md.md)]名為 VSPackage`MyPackage`中所述，[逐步解說：建立功能表命令的 VSPackage](https://msdn.microsoft.com/d699c149-5d1e-47ff-94c7-e1222af02c32)。  
