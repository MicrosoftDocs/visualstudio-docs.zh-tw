...
本主題的最新的版本可從[EnableLocationBrowseButton 元素 （Visual Studio 範本）](https://docs.microsoft.com/visualstudio/extensibility/enablelocationbrowsebutton-element-visual-studio-templates)。  
