...
---
# <a name="extending-properties-and-the-property-window"></a>延伸屬性和屬性視窗
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

**屬性**視窗用來檢視和編輯的設計階段屬性和所選物件的事件。  
  
 當您選取的物件[!INCLUDE[vsprvs](../includes/vsprvs-md.md)]，該物件的公用屬性會出現在**屬性**視窗。 如需詳細資訊，請參閱 <<c0> [ 屬性視窗概觀](../extensibility/internals/properties-window-overview.md)。  
