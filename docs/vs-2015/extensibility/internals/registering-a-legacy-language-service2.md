...
ms.locfileid: "68188842"
---
# <a name="registering-a-legacy-language-service"></a>註冊舊版語言服務
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

下列各節提供中可用之各種語言服務選項的登錄專案清單 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 。  
  
 在下列登錄專案清單中， *VS Reg 根目錄*等於 HKEY_LOCAL_MACHINE \software\microsoft\visualstudio \\ *x.* y，其中， *x. y*是 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 版本號碼。  
