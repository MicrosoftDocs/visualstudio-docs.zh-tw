...
#### [概觀](configuration-options-overview.md)
...
#### [設計決策](source-control-design-decisions.md)
#### [組態詳細資料](source-control-configuration-details.md)
#### [專案和編輯器適用的其他方針](additional-source-control-guidelines-for-projects-and-editors.md)
#### [執行階段詳細資料](source-control-runtime-details.md)
...
### [架構](project-types-architecture.md)
...
#### [如何：安裝原始程式碼控制外掛程式](how-to-install-a-source-control-plug-in.md)
...
#### [測試區域 1：新增到原始程式碼控制或從中開啟](test-area-1-add-to-open-from-source-control.md)
