...
## <a name="in-this-section"></a>本節內容  
 ...
 描述如何[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]整合式的開發環境 (IDE) 會維護使用者的目前作用中物件的相關資訊，並讓追蹤貨幣的 Vspackage。  
 ...
 討論如何提供可用的功能[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]使用者目前的選取項目內容和整體 IDE 內容為基礎。  
