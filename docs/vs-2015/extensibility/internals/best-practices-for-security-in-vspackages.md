...
若要 [!INCLUDE[vsipsdk](../../includes/vsipsdk-md.md)] 在您的電腦上安裝，您必須在具有系統管理認證的內容中執行。 應用程式的基本安全性和部署單位 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 是 [vspackage](../../extensibility/internals/vspackages.md)。 VSPackage 必須使用註冊 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ，這也需要系統管理認證。  
 ...
 如需詳細資訊，請參閱 .NET Framework () 的安全程式碼撰寫方針 [https://msdn.microsoft.com/library/d55zzx87.aspx](https://msdn.microsoft.com/library/d55zzx87.aspx) 。  
