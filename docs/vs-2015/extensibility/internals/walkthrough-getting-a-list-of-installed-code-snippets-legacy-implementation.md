---
title: 逐步解說：取得已安裝的程式碼片段清單 (舊版的執行) |Microsoft Docs
ms.date: 11/15/2016
...
> [!NOTE]
> 基於效能考慮，會快取 `expansionsList` 陣列 listis。 程式碼段的變更不會反映在清單中，直到語言服務停止並重載 (例如，藉由停止和重新開機 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]) 。  
