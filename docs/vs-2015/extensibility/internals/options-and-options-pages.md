...
- <xref:System.ComponentModel.DescriptionAttribute> 決定選項的描述。  
  ...
  > [!NOTE]
  > 對等屬性（SRCategory、LocDisplayName 和 SRDescription）會使用字串資源進行當地語系化，並在[managed 專案範例](https://go.microsoft.com/fwlink/?LinkId=122774)中定義。  
