---
title: 工具列的 Guid 和 Id |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>另請參閱
 [將功能表控制器加入至工具列](../../extensibility/adding-a-menu-controller-to-a-toolbar.md)[新增的工具視窗的工具列](../../extensibility/adding-a-toolbar-to-a-tool-window.md) [Visual Studio 功能表的 Guid 和 Id](../../extensibility/internals/guids-and-ids-of-visual-studio-menus.md)
