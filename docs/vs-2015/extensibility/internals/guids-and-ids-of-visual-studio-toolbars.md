---
title: 工具列的 Guid 和識別碼 |Microsoft Docs
ms.date: 11/15/2016
...
> 許多可用來 Visual Studio 的工具列都不是由 Visual Studio 所定義，而且其 GUID 和識別碼值不是公用的。 本主題只會列出 Visual Studio .vsct 檔案中定義的工具列。
 ...
 Visual Studio IDE 所提供的預設工具列會使用 GUID `guidSHLMainMenu` ，但在其他情況下，則是使用 guid： ID 語法來指定。
...
## <a name="see-also"></a>另請參閱
 [將功能表控制器新增至工具列](../../extensibility/adding-a-menu-controller-to-a-toolbar.md)將 [工具列加入至工具視窗](../../extensibility/adding-a-toolbar-to-a-tool-window.md) [guid，以及 Visual Studio 功能表的識別碼](../../extensibility/internals/guids-and-ids-of-visual-studio-menus.md)
