---
title: '使用 Managed Package Framework (c # ) 執行專案類型 |Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="using-the-mpf-project-source-code"></a>使用 MPF 專案來源程式碼  
 適用于專案的 Managed 封裝架構 (MPFProj) 提供協助程式類別來建立和管理新的專案系統。 與 MPF 中的其他類別不同的是，專案類別不包含在隨附于 Visual Studio 的元件中。 相反地，專案類別會在 [適用于專案2013的 MPF](https://archive.codeplex.com/?p=mpfproj12)上以原始程式碼的形式提供。  
