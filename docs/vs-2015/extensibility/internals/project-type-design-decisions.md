...
## <a name="project-items"></a>專案項目  
 ...
 在以參考為基礎的專案中，專案可以出現在多個專案中。 不過，專案所代表的實際檔案僅位於單一目錄中。 在以目錄為基礎的專案中，所有專案專案都存在於目錄結構中。 如需詳細資訊，請參閱「 [筆尖：專案中的專案管理](https://msdn.microsoft.com/762e606b-7f44-4b66-97a1-e30a703654a0)」。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [鋼筆：專案中的專案管理](https://msdn.microsoft.com/762e606b-7f44-4b66-97a1-e30a703654a0)   
