...
ms.locfileid: "90839062"
---
# <a name="syntax-coloring-in-a-legacy-language-service"></a>舊版語言服務中的語法著色
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 使用著色服務來識別語言的元素，並在編輯器中以指定的色彩顯示。  
...
> [!NOTE]
> 除了使用 language service 著色器之外，VSPackage 也可以使用一般用途的 [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 文字著色機制。 如需此機制的詳細資訊，請參閱 [使用字型和色彩](../../extensibility/using-fonts-and-colors.md)。  
