...
|**Attribute**|**定義**|  
|-|-|  
|Uri|必URI，定義可從中載入映射的位置。 可以是下列其中一項：<br /><br /> -使用 application:///授權單位的[套件 URI](https://msdn.microsoft.com/library/aa970069\(v=vs.100\).aspx)<br /><br /> -絕對元件資源參考<br /><br /> -包含原生資源之檔案的路徑|  
 ...
 **驗證自訂映射資訊清單**  
 ...
 按一下 [**新增 ...** ] 選取新的搜尋目錄以搜尋資訊清單及其對應的 Dll。 此工具將會記住這些搜尋目錄，並藉由檢查或取消選取目錄來開啟或關閉它們。  
