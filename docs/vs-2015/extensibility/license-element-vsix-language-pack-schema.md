...
ms.locfileid: "47490289"
---
# <a name="license-element-vsix-language-pack-schema"></a>License 元素 （VSIX 語言套件結構描述）
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

本主題的最新的版本可從[License 元素 （VSIX 語言套件結構描述）](https://docs.microsoft.com/visualstudio/extensibility/license-element-vsix-language-pack-schema)。  
