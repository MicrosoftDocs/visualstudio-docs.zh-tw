...
|編輯器/設計工具|程式碼瀏覽工具合併的尋找、 來源定義 （繼承）<br /><br /> IntelliSense<br /><br /> SmartTags<br /><br /> 程式碼片段管理員<br /><br /> 程式碼片段<br /><br /> 重構<br /><br /> 美化排列<br /><br /> IntelliSense 篩選<br /><br /> 程式碼定義視窗<br /><br /> 應用程式設計工具<br /><br /> Windows Form 設計工具<br /><br /> Windows Presentation Foundation (WPF) 設計工具|  
