...
1. 依照 [變更功能表命令文字](../extensibility/changing-the-text-of-a-menu-command.md) 的指示，建立名為的功能表項目 `New Text` 。  
...
7. 在 [ **工具** ] 功能表上，按一下 [叫用 **ChangeMenuText** ] 命令。 此時，命令名稱是 **Invoke ChangeMenuText**，因此命令處理常式不會呼叫 ChangeMyCommand ( # A1。  
