...
2.  AssemblyInfo.cs 檔案複製**屬性**資料夾，以**Projects\SimpleProject**資料夾。  
...
6.  在 **屬性**視窗中，將**建置動作**AssemblyInfo.cs、 Program.cs、 SimpleProject.ico，和以 SimpleProject.myproj**內容**，並將其**包含在 VSIX**屬性，以 **，則為 True**。  
