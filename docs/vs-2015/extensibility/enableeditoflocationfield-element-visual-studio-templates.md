...
本主題的最新的版本可從[EnableEditOfLocationField 元素 （Visual Studio 範本）](https://docs.microsoft.com/visualstudio/extensibility/enableeditoflocationfield-element-visual-studio-templates)。  
