...
## <a name="error-result-codes-and-reporting"></a>錯誤結果碼和報告  
 ...
 報告的規則是，如果 IDE 中發生錯誤，IDE 會負責報告它。 如果原始檔控制系統中發生錯誤，則原始檔控制外掛程式負責報告它。 例如，「目前未選取任何檔案」會由 IDE 報告，但外掛程式會報告「這個檔案已經簽出」。  
