...
本主題的最新的版本可從[NumberOfParentCategoriesToRollUp （Visual Studio 範本）](https://docs.microsoft.com/visualstudio/extensibility/numberofparentcategoriestorollup-visual-studio-templates)。  
