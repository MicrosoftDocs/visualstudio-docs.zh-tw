...
1. 每個 Visual Studio 擴充功能都會以 VSIX 部署專案開始，其中將包含延伸模組資產。 建立 [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 名為的 VSIX 專案 `SettingsStoreExtension` 。 您可以在 [ **新增專案** ] 對話方塊中的 **Visual c #/** 擴充性下找到 VSIX 專案範本。  
...
1. 在 SettingsStorageCommand.cs 檔案中，新增下列 using 語句：  
