...
## <a name="notes-for-callers"></a>呼叫者注意事項  
 [IDebugBinder](../../../extensibility/debugger/reference/idebugbinder.md)介面會使用[QueryInterface](https://msdn.microsoft.com/library/62fce95e-aafa-4187-b50b-e6611b74c3b3)取得這個介面。  
