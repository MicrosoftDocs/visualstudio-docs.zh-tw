...
ms.locfileid: "47492089"
---
# <a name="idebuggenericparamfieldgetconstraints"></a>IDebugGenericParamField::GetConstraints
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

本主題的最新的版本可從[IDebugGenericParamField::GetConstraints](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebuggenericparamfield-getconstraints)。  
...
#### <a name="parameters"></a>參數  
 ...
 `ppConstraints`  
 [out]傳回陣列，其中包含與這個欄位相關聯的條件約束。  
  
 `pcConstraints`  
 [in、 out]中的條件約束數目`ppConstraints`陣列。  
