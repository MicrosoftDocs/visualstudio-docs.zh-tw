...
## <a name="notes-for-callers"></a>呼叫者注意事項  
 此介面是運算式評估工具在剖析的運算式中使用之所有物件的基類。 它是由 [Bind](../../../extensibility/debugger/reference/idebugbinder-bind.md) 方法的呼叫所傳回。 [QueryInterface](https://msdn.microsoft.com/library/62fce95e-aafa-4187-b50b-e6611b74c3b3) 從這個介面取得更特製化的介面。  
