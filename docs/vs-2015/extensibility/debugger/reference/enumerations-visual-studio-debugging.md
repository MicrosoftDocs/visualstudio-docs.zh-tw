...
以下是偵錯工具 SDK 的列舉 [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] 。  
 ...
 列舉選擇性旗標的有效值，這個值可用來在設定中斷點時指定其他資訊。 此列舉會擴充 [BP_FLAGS](../../../extensibility/debugger/reference/bp-flags.md) 列舉。  
  
 [BP_LOCATION_TYPE](../../../extensibility/debugger/reference/bp-location-type.md)  
 指定中斷點要求之中斷點的位置類型。  
  
 [BP_PASSCOUNT_STYLE](../../../extensibility/debugger/reference/bp-passcount-style.md)  
 指定與中斷點傳遞計數相關聯的條件，這會導致中斷點引發。  
 ...
 值，這個值表示要用來在偵錯工具伺服器與 debug 封裝之間進行通訊的通訊協定。  
 ...
 描述 [IDebugProperty2](../../../extensibility/debugger/reference/idebugproperty2.md) 或 [IDebugReference2](../../../extensibility/debugger/reference/idebugreference2.md) 介面的各種屬性。  
