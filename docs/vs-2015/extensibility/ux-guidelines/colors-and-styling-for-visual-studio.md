...
ms.locfileid: "47484936"
---
# <a name="colors-and-styling-for-visual-studio"></a>色彩和樣式設定適用於 Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

本主題的最新的版本可從[色彩和樣式設定適用於 Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/colors-and-styling-for-visual-studio)。  
 ...
 **附註：** 所傳回的值 COLORREF **GetVSSysColorEx()** 包含只是 R、 G、 B 元件的佈景主題色彩。 如果佈景主題項目使用透明度的 alpha 色頻值會被捨棄之前傳回。 因此，如果感興趣的環境色彩需要使用在其中透明通道是重要的地方，您應該使用 IVsUIShell5.GetThemedColor 代替 IVsUIShell2::GetVSSysColorEx，本主題稍後所述。  
...
|Package|REG_SZ|GUID|服務的 GUID VSPackage 支援類別|  
 ...
 ![以得知是 IVsFontAndColorGroup](../../extensibility/ux-guidelines/media/0304-a-fontandcolorgroup.png "0304 a_FontAndColorGroup")  
