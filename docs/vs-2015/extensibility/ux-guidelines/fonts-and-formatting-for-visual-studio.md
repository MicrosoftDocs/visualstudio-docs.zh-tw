...
- **特定集合**– 提供使用者自訂其介面元素的設計器視窗可能會在**工具>選項**）中自己的設置頁中公開特定于其設計介面的字體。
...
2. 介面的所有其他元素應綁定到環境字體設置，並回應環境中的任何全域更改。 這包括（但不限於）：
    ...
    - 在對話方塊中標注文本，如"在檔中查找"或"重構"

### <a name="accessing-the-environment-font"></a>訪問環境字體
 在本機或 WinForms 代碼中，可以通過調用方法**IUIHostLocale：：getDialogFont**在從SID_SUIHostLocale服務查詢介面來訪問環境字體。

 對於 Windows 演示文稿基礎 （WPF），從 shell 的**對話方塊視窗**類而不是 WPF**的視窗類**派生對話方塊視窗類。
...
```
 ...
 要顯示對話方塊，請通過**ShowDialog（）** 在類上調用"**顯示模式（）"。** **ShowModal（）** 在 shell 中設置正確的模態狀態，確保對話方塊在父視窗中居中，等等。
 ...
 **顯示模態**返回布林？ （空布林）與**對話方塊Result**，如果需要，可以使用。 如果對話方塊以 **"確定"** 關閉，則傳回值為 true。

 如果需要顯示一些不是對話方塊的 WPF UI，並且託管在其自己的**HwndSource**中，例如快顯視窗或 Win32/WinForms 父視窗的 WPF 子視窗，則需要在 WPF 元素的根項目上設置**FontFamily**和**FontSize。** （shell 在主視窗中設置屬性，但不會繼承到 HWND 之後）。 shell 提供可以綁定屬性的資源，如下所示：
...
### <a name="formatting-scalingbolding-reference"></a><a name="BKMK_Formatting"></a>格式（縮放/粗體）引用
 某些對話方塊要求特定文本為粗體或環境字體以外的大小。 以前，大於環境字體的字體被編碼為"環境字體 +2"或類似。 使用提供的程式碼片段將支援高 DPI 監視器，並確保顯示文本始終以正確的大小和重量顯示（如"光"或"半光"）。

> **注意：在應用格式之前，請確保遵循[文本樣式](../../extensibility/ux-guidelines/fonts-and-formatting-for-visual-studio.md#BKMK_TextStyle)中的指南。**

 要縮放環境字體，可以按指示設置 TextBlock 或 Label 的樣式。 正確使用的每個程式碼片段都將生成正確的字體，包括適當的大小和重量變化。

 其中"vsui"是對名稱空間 Microsoft 的引用。
 ...
 **程式碼：** 其中"文字區塊"是以前定義的 TextBlock，"標籤"是以前定義的標籤。
 ...
 **用於：** 簽名對話方塊中的節標題、樹狀檢視中的頂部節點、垂直選項卡導航
...
### <a name="localizable-styles"></a>可當地語系化樣式
 ...
 解決方案是掛接對話方塊表單的**Font"更改**"事件。 在**Font"更改"** 事件中，遍歷所有控制項並檢查其字體是否已設置。 如果已設置，則根據表單的字體和控制項以前的字體樣式將其更改為新字體。 代碼中這方面的一個示例是：
...
```
 ...
 使用此代碼可確保在更新表單的字體時，控制項的字體也將更新。 還應從表單的建構函式調用此方法，因為對話方塊可能無法獲取**IUIService**的實例，**而 FontGet 事件**永遠不會觸發。 鉤**字體更改**將允許對話方塊動態選取新字體，即使對話方塊已打開也是如此。

### <a name="testing-the-environment-font"></a>測試環境字體
 為確保 UI 使用環境字體並尊重大小設置，請打開 **"工具>選項>環境>字體和顏色**"，並在"顯示設定"下拉式功能表下選擇"環境字體"。

 !["工具&#62;選項"對話方塊中的字體和顏色頁面](../../extensibility/ux-guidelines/media/0201-a-optionsfonts.png "0201-a_OptionsFonts")
...
- 在標題中使用顏色時，必須遵守[Windows 顏色準則](https://msdn.microsoft.com/library/dn742482.aspx)，包括對比度和其他協助工具注意事項。
...
|||
|-|-|
|**用法：** 罕見。 僅具有唯一品牌 UI。<br /><br /> **執行：**<br /><br /> - 使用句子案例<br />- 始終使用重量輕<br /><br /> **請勿：**<br /><br /> - 用於簽名 UI 以外的 UI，如起始頁<br />- 粗體、斜體或粗斜體<br />- 用於正文文本<br />- 在工具視窗中使用|**顯示為：** 34 pt 塞戈 UI 燈<br /><br /> **視覺示例：**<br /><br /> *當前未使用。可在"開始頁"中使用。*|

#### <a name="310-environment-font--light"></a>310% 環境字體 + 淺色

|||
|-|-|
|**Usage :**<br /><br /> - 簽名對話方塊中較大的標題<br />- 主要報告標題<br /><br /> **執行：**<br /><br /> - 使用句子案例<br />- 始終使用重量輕<br /><br /> **請勿：**<br /><br /> - 用於簽名 UI 以外的 UI，如起始頁<br />- 粗體、斜體或粗斜體<br />- 用於正文文本<br />- 在工具視窗中使用|**顯示為：** 28 pt 塞戈 UI 燈<br /><br /> **視覺示例：**<br /><br /> ![310% 環境字體&#43;游標題的示例](../../extensibility/ux-guidelines/media/0202-a-ef310.png "0202-a_EF310")|

#### <a name="200-environment-font--semilight"></a>200% 環境字體 + 半光

|||
|-|-|
|**Usage :**<br /><br /> - 副標題<br />- 中小型對話方塊中的標題<br /><br /> **執行：**<br /><br /> - 使用句子案例<br />- 始終使用半輕重量<br /><br /> **請勿：**<br /><br /> - 粗體、斜體或粗斜體<br />- 用於正文文本<br />- 在工具視窗中使用|**顯示為：** 18 pt 塞戈 UI 塞米萊特<br /><br /> **視覺示例：**<br /><br /> ![200% 環境字體&#43;半光的示例](../../extensibility/ux-guidelines/media/0202-b-ef200.png "0202-b_EF200")|

#### <a name="155-environment-font"></a>155% 環境字體

|||
|-|-|
|**Usage :**<br /><br /> - 文檔井 UI 中的節標題<br />- 報告<br /><br /> **執行：** 使用句子案例<br /><br /> **請勿：**<br /><br /> - 粗體、斜體或粗斜體<br />- 用於正文文本<br />- 在標準視覺工作室控制項中使用<br />- 在工具視窗中使用|**顯示為：** 14 pt 塞戈 UI<br /><br /> **視覺示例：**<br /><br /> ![155% 環境字型標題的範例](../../extensibility/ux-guidelines/media/0202-c-ef155.png "0202-c_EF155")|

#### <a name="133-environment-font"></a>133% 環境字體

|||
|-|-|
|**Usage :**<br /><br /> - 簽名對話方塊中的較小子標題<br />- 文檔井 UI 中的較小子標題<br /><br /> **執行：** 使用句子案例<br /><br /> **請勿：**<br /><br /> - 粗體、斜體或粗斜體<br />- 用於正文文本<br />- 在標準視覺工作室控制項中使用<br />- 在工具視窗中使用|**顯示為：** 12 pt 塞戈 UI<br /><br /> **視覺示例：**<br /><br /> ![133% 環境字型標題的範例](../../extensibility/ux-guidelines/media/0202-d-ef133.png "0202-d_EF133")|

#### <a name="122-environment-font"></a>122% 環境字體

|||
|-|-|
|**Usage :**<br /><br /> - 簽名對話方塊中的節標題<br />- 樹狀檢視中的頂部節點<br />- 垂直選項卡導航<br /><br /> **執行：** 使用句子案例<br /><br /> **請勿：**<br /><br /> - 粗體、斜體或粗斜體<br />- 用於正文文本<br />- 在標準視覺工作室控制項中使用<br />- 在工具視窗中使用|**顯示為：** 11 pt Segoe UI<br /><br /> **視覺示例：**<br /><br /> ![122% 環境字型標題的範例](../../extensibility/ux-guidelines/media/0202-e-ef122.png "0202-e_EF122")|

#### <a name="environment-font--bold"></a>環境字體 = 粗體

|||
|-|-|
|**Usage :**<br /><br /> - 簽名對話方塊中的標籤和子頭<br />- 報表中的標籤和子頭<br />- 文檔井 UI 中的標籤和子頭<br /><br /> **執行：**<br /><br /> - 使用句子案例<br />- 使用粗體重量<br /><br /> **請勿：**<br /><br /> - 斜體或粗斜體<br />- 用於正文文本<br />- 在標準視覺工作室控制項中使用<br />- 在工具視窗中使用|**顯示為：** 粗體 9 pt Segoe UI<br /><br /> **視覺示例：**<br /><br /> ![環境字體&#43;粗體標題的示例](../../extensibility/ux-guidelines/media/0202-f-efb.png "0202-f_EFB")|

#### <a name="environment-font"></a>環境字體

|||
|-|-|
|**用法：** 所有其他文本<br /><br /> **執行：** 使用句子案例<br /><br /> **不要：** 斜體或粗斜體|**顯示為：** 9 pt Segoe UI<br /><br /> **視覺示例：**<br /><br /> ![環境字型的範例](../../extensibility/ux-guidelines/media/0202-g-ef.png "0202-g_EF")|
...
## <a name="see-also"></a>另請參閱
 [MSDN： 字體 （視窗）](https://msdn.microsoft.com/library/windows/desktop/dn742483\(v=vs.85\).aspx) [MSDN： 使用者介面文本 （視窗）](https://msdn.microsoft.com/library/windows/desktop/dn742478\(v=vs.85\).aspx)
