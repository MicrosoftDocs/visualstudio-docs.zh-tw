...
## <a name="in-this-section"></a>本節內容
 ...
 [安裝程式設定](https://msdn.microsoft.com/library/faa4ed55-66ce-4792-939f-a5b093f13a2e) 用於探索 Visual Studio 2017 實例的設定 API。
 ...
 <xref:Microsoft.VisualStudio.Text.Formatting> 新編輯器中用於格式化的類別。
 ...
 <xref:Microsoft.VisualStudio.ConnectedServices?qualifyHint=False&autoUpgrade=True> 用於 Visual Studio 連接的服務。
