# [偵錯介面存取 SDK](debug-interface-access-sdk.md)
## [快速入門](getting-started-debug-interface-access-sdk.md)
### [概觀](overview-debug-interface-access-sdk.md)
### [查詢 .Pdb 檔案](querying-the-dot-pdb-file.md)
## [符號和符號標記](symbols-and-symbol-tags.md)
### [符號位置](symbol-locations.md)
### [符號類型的語彙階層架構](lexical-hierarchy-of-symbol-types.md)
#### [註釋](annotation.md)
#### [區塊](block.md)
#### [編譯模組](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [Custom (偵錯介面存取 SDK)](custom-debug-interface-access-sdk.md)
#### [資料 (偵錯介面存取 SDK)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [函式 (偵錯介面存取 SDK)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [標籤 (偵錯介面存取 SDK)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Thunk](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [符號類型的類別階層架構](class-hierarchy-of-symbol-types.md)
#### [ArrayType](arraytype.md)
#### [BaseClass](baseclass.md)
#### [BaseType](basetype.md)
#### [CustomType](customtype.md)
#### [維度](dimension.md)
#### [Enum (偵錯介面存取 SDK)](enum-debug-interface-access-sdk.md)
#### [Friend (偵錯介面存取 SDK)](friend-debug-interface-access-sdk.md)
#### [FunctionArgType](functionargtype.md)
#### [FunctionType](functiontype.md)
#### [ManagedType](managedtype.md)
#### [PointerType](pointertype.md)
#### [Typedef (偵錯介面存取 SDK)](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
#### [VTableShape](vtableshape.md)
## [參考資料](debug-interface-access-sdk-reference.md)
