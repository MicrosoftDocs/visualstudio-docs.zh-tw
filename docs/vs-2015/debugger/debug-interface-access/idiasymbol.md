...
|[IDiaSymbol::get_hasSecurityChecks](../../debugger/debug-interface-access/idiasymbol-get-hassecuritychecks.md)|抓取旗標，這個旗標會指出函式或編譯單位是否有在 (中透過 [/gs (緩衝區安全性檢查) ](https://msdn.microsoft.com/library/8d8a5ea1-cd5e-42e1-bc36-66e1cd7e731e) 編譯器參數) 編譯的安全性檢查。|  
...
|[IDiaSymbol::get_isAcceleratorPointerTagLiveRange](../../debugger/debug-interface-access/idiasymbol-get-isacceleratorpointertagliverange.md)|抓取旗標，這個旗標會指出符號是否對應到針對 C++ AMP 加速器編譯之程式碼中指標變數標記元件的 *定義範圍符號* 。 定義範圍符號是位址範圍的變數位置。|  
...
|[IDiaSymbol::get_isHotpatchable](../../debugger/debug-interface-access/idiasymbol-get-ishotpatchable.md)|抓取旗標，指出模組是否以 [/hotpatch (Create 可線上修補 Image) ](https://msdn.microsoft.com/library/aad539b6-c053-4c78-8682-853d98327798) 編譯器參數編譯。|  
...
|[IDiaSymbol::get_isNaked](../../debugger/debug-interface-access/idiasymbol-get-isnaked.md)|抓取指出函式是否有 [naked](https://msdn.microsoft.com/library/69723241-05e1-439b-868e-20a83a16ab6d) 屬性的旗標。|  
...
|[IDiaSymbol::get_noInline](../../debugger/debug-interface-access/idiasymbol-get-noinline.md)|抓取旗標，指出函式是否以 [noinline](https://msdn.microsoft.com/library/f259d55b-dec7-4bde-8cf9-14521e4fdc42) 屬性標記。|  
|[IDiaSymbol::get_noReturn](../../debugger/debug-interface-access/idiasymbol-get-noreturn.md)|抓取旗標，這個旗標會指出是否已使用 [noreturn](https://msdn.microsoft.com/library/9c6517e5-22d7-4051-9974-3d2200ae4d1d) 屬性宣告函數。|  
