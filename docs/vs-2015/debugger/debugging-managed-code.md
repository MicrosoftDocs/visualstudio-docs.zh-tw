...
## <a name="related-sections"></a>相關章節  
 ...
 [追蹤和檢測應用程式](https://msdn.microsoft.com/library/773b6fc4-9013-4322-b728-5dec7a72e743) (機器翻譯)  
...
## <a name="see-also"></a>另請參閱  
 [逐步解說：在設計階段時對自訂 Windows Forms 控制項進行調試](https://msdn.microsoft.com/library/1fd83ccd-3798-42fc-85a3-6cba99467387)   
