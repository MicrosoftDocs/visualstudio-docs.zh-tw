...
## <a name="using-intellitrace-with-events-only"></a><a name="GettingStarted"></a> 只對事件使用 IntelliTrace  
...
## <a name="using-intellitrace-with-events-and-function-calls"></a>對事件及函式呼叫使用 IntelliTrace  
