...
> [!IMPORTANT]
> 如果您確信收到這則訊息是因為產品錯誤，請向 Visual Studio 報告這個問題： [傳送笑臉](https://msdn.microsoft.com/library/5cc9b67a-54d0-41b0-aa8f-80dff4475a6b)。 如果您需要更多協助，請參閱 [Talk to Us](../ide/talk-to-us.md) 與 Microsoft 連絡。  
