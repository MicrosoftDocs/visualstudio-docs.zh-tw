---
title: 如何：使用編輯後繼續在中斷模式中套用編輯 |Microsoft Docs
ms.date: 11/15/2016
...
- 使用**附加至來**對應用程式進行偵錯工具，而不是從**調試**程式功能表**啟動**應用程式。  
  
- 偵錯最佳化程式碼  
  
- 當目標為 64 位元應用程式時，偵錯 Managed 程式碼。 如果要使用 [編輯後繼續]，就必須將目標設定為 x86  [ (_專案_**屬性**]、[ **編譯** ] 索引標籤、[ **Advanced 編譯器** ] 設定。 ) 。  
