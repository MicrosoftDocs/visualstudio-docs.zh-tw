...
## <a name="how-do-i-start-using-historical-debugging"></a>如何開始使用歷程偵錯？  
 預設會開啟 IntelliTrace。 您只需要決定感興趣的事件和函式呼叫。 如需定義您想要尋找之項目的詳細資訊，請參閱 [IntelliTrace 功能](../debugger/intellitrace-features.md)。 如需使用 IntelliTrace 進行偵錯工具的逐步解說，請參閱逐步解說 [：使用 intellitrace](../debugger/walkthrough-using-intellitrace.md)。  
...
4. 開啟 **診斷工具** 視窗 (**Debug/Show 診斷工具**) 。 程式碼視窗應該如下所示：  
