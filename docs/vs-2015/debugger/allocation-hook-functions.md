...
```  
 ...
 您傳入至 [_CrtSetAllocHook](http://msdn.microsoft.com/library/405df37b-2fd1-42c8-83bc-90887f17f29d) 的指標是在 CRTDBG.H 中定義的 **_CRT_ALLOC_HOOK** 類型：  
