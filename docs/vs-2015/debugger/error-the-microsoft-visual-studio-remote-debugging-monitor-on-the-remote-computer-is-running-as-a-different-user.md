---
title: 錯誤：遠端電腦上的 Microsoft Visual Studio 遠端偵錯監視以不同的使用者執行 |Microsoft Docs
ms.date: 11/15/2016
...
> 將進行連接的權限授與其他使用者，可能會意外連接至錯誤的遠端偵錯工作階段。 以 [非驗證]**** 模式進行偵錯非常不安全，請務必小心使用。  
 ...
 如需詳細資訊，請參閱 [開始遠端偵錯監視](https://msdn.microsoft.com/library/55b60ce7-834b-4e83-a10e-fe4248260a4c)。  
