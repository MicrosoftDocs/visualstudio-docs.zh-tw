...
2. 在 [專案類型] 窗格中，開啟**Visual Basic**，**視覺化C#** ，或**Visual C++** 節點，然後  
    ...
    2. 視覺效果C++，選取**CLR**節點，然後選取**Windows Form 應用程式**中**範本**窗格...  
...
5. 在 **監看式 1**視窗中，按一下空白資料列。 在 **名稱**資料行中輸入`textBox1.Text`(如果您使用 Visual Basic、 Visual C#，或 J#) 或`textBox1->Text`(如果您使用C++)，然後按 ENTER 鍵。  
