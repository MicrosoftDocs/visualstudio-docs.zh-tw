...
1. 從 **Spy** 功能表中，選擇 [ **執行緒**]。  
   ...
   ![Spy&#43;&#43; 執行緒視圖](../debugger/media/spy-threads.png "Spy + + _Threads")  
   Spy++ 執行緒檢視  
  
   上圖顯示執行緒的觀點。  
  
## <a name="in-this-section"></a>本節內容  
 [線上程視圖中搜尋執行緒](../debugger/how-to-search-for-a-thread-in-threads-view.md)  
 說明如何線上程視圖中尋找特定的執行緒。  
