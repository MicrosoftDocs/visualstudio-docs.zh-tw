...
6.  按一下 [確定 **Deploying Office Solutions**]。  
     ...
     [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 會建立新的專案，並且顯示預設的 HTML 原始程式碼。 其也會在 IIS 中 [預設的網站] 下方，建立名為 [網站] 的新虛擬目錄。  
...
11. 在您所放置的 Button 控制項上按兩下。  
     ...
     這會帶您前往字碼頁：Default.aspx.cs，如C#） 或 Default.aspx.vb ( [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]。 資料指標 (Cursor) 應該在 `Button1_Click` 函式中。  
