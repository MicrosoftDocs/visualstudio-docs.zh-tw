...
- [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 遠端偵錯元件必須安裝在您要偵錯的伺服器上。 如需詳細資訊，請參閱 <<c0> [ 設定遠端偵錯](https://msdn.microsoft.com/library/90f45630-0d26-4698-8c1f-63f85a12db9c)。  
