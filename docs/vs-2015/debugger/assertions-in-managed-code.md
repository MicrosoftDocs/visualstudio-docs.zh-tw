...
## <a name="customizing-assert-behavior"></a><a name="BKMK_Customizing_Assert_behavior"></a> 自訂 Assert 行為  
 ...
 如需詳細資訊，請參閱 [追蹤](https://msdn.microsoft.com/library/444b0d33-67ea-4c36-9e94-79c50f839025)接聽程式。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [如何：使用追蹤和 Debug 條件式編譯](https://msdn.microsoft.com/library/56d051c3-012c-42c1-9a58-7270edc624aa)   
