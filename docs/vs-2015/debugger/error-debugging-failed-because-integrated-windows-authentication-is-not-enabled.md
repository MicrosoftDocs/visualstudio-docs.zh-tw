...
本主題的最新的版本可從[錯誤： 偵錯失敗，因為整合式 Windows 驗證沒有啟用](https://docs.microsoft.com/visualstudio/debugger/error-debugging-failed-because-integrated-windows-authentication-is-not-enabled)。  
