---
title: 如何：在混合模式中進行調試 |Microsoft Docs
ms.date: 11/15/2016
...
- 呼叫 DLL 的呼叫應用程式是以機器碼撰寫。 在這個情況中，您的 DLL 是 Managed，而且 Managed 和原生偵錯工具都必須啟用，才能為兩種程式碼偵錯。 您可以在 [ ** \<Project> 屬性頁**] 對話方塊中檢查。 不同的做法是取決於您是由 DLL 專案啟動偵錯，或者由呼叫應用程式專案啟動偵錯。  
...
3. 在 [ ** \<Project> 屬性頁**] 對話方塊中，展開 [設定**屬性**] 節點，然後選取 [**調試**]。  
