...
ms.locfileid: "58943603"
---
# <a name="report-hook-functions"></a>報告攔截函式
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

報告攔截函式，使用 [_CrtSetReportHook](http://msdn.microsoft.com/library/1ae7c64f-8c84-4797-9574-b59f00f7a509) 安裝，會在每次 [_CrtDbgReport](http://msdn.microsoft.com/library/6e581fb6-f7fb-4716-9432-f0145d639ecc) 產生偵錯報告時呼叫。 除此之外，您可以使用它來篩選報告以專注於特定類型的配置。 報告攔截函式應該有像下列的原型：  
