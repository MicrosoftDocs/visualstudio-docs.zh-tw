...
## <a name="solution"></a>解決方法  
 ...
 請參閱知識庫 (Knowledge Base) 文件 Q133174「How to Locate Where a General Protection (GP) Fault Occurs」。 您可以在 MSDN Library CD 上或藉由搜尋來找到知識庫文章 [http://support.microsoft.com/](https://support.microsoft.com/) 。  
