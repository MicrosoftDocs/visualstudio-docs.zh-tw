...
## <a name="see-also"></a>另請參閱  
 ...
 [OCLIENT 範例：說明如何視覺化編輯容器應用程式](http://msdn.microsoft.com/8cd5c234-9a4e-4934-8f5d-bac189ad92c4)   
 [SUPERPAD 範例：示範視覺化編輯伺服器編輯使用 CEditView 的文字](http://msdn.microsoft.com/7b14e975-d986-4e6a-8289-226485cfcb72)
