...
|--------------------------------|-----------------|--------------------------|---------------------|
|Visual Studio Enterprise (最新的公開版本)|Visual Studio Enterprise 含更新 (可從[My.VisualStudio.com](https://my.visualstudio.com/downloads?q=visual%20studio%20enterprise%202015))|`vs_enterprise.exe` **注意：** 此安裝的預設行為可提供最新的選擇性功能，因此不需要任何命令列參數。|Visual Studio 安裝程式會使用最新的 feed.xml 並安裝最新的檔案|
