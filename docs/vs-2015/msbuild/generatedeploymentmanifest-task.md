...
|`ErrorReportUrl`|選擇性的 <!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  -->String 參數。<br /><br /> 指定在 ClickOnce 安裝期間顯示在對話方塊中的網頁 URL。|  
