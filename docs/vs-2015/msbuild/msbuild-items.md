...
- [在執行期間建立專案](#BKMK_Creating2)  
  
- [參考專案檔中的專案](#BKMK_ReferencingItems)  
  
- [使用萬用字元指定專案](#BKMK_Wildcards)  
  
- [使用 Exclude 屬性](#BKMK_ExcludeAttribute)  
  
- [專案中繼資料](#BKMK_ItemMetadata)  
  
  - [參考專案檔中的專案中繼資料](#BKMK_ReferencingItemMetadata)  

  - [已知的項目中繼資料](#BKMK_WellKnownItemMetadata)  

  - [使用中繼資料轉換項目類型](#BKMK_Transforming)  
  
- [專案定義](#BKMK_ItemDefinitions)  
...
## <a name="creating-items-in-a-project-file"></a><a name="BKMK_Creating1"></a> 在專案檔中建立專案  
...
## <a name="creating-items-during-execution"></a><a name="BKMK_Creating2"></a> 在執行期間建立項目  
...
## <a name="referencing-items-in-a-project-file"></a><a name="BKMK_ReferencingItems"></a> 在專案檔中參考項目  
...
## <a name="using-wildcards-to-specify-items"></a><a name="BKMK_Wildcards"></a> 使用萬用字元指定項目  
...
## <a name="using-the-exclude-attribute"></a><a name="BKMK_ExcludeAttribute"></a> 使用 Exclude 屬性  
...
## <a name="item-metadata"></a><a name="BKMK_ItemMetadata"></a> 專案中繼資料  
...
### <a name="referencing-item-metadata-in-a-project-file"></a><a name="BKMK_ReferencingItemMetadata"></a> 在專案檔中參考項目中繼資料  
 您可以使用語法 %(`ItemMetadataName`)，在整個專案檔中參考項目中繼資料。 如果發生模稜兩可的情況，您可以使用項目類型的名稱來限定參考。 例如，您可以指定 %(*ItemType.ItemMetaDataName*)。下列範例會使用 Display 中繼資料來批次處理 Message 工作。 如需如何使用專案中繼資料進行批次處理的詳細資訊，請參閱工作 [批次處理中的專案中繼資料](../msbuild/item-metadata-in-task-batching.md)。  
...
### <a name="transforming-item-types-by-using-metadata"></a><a name="BKMK_Transforming"></a> 使用中繼資料轉換專案類型  
...
## <a name="item-definitions"></a><a name="BKMK_ItemDefinitions"></a> 專案定義  
...
```  
 ...
 如需詳細資訊，請參閱 [專案定義](../msbuild/item-definitions.md)。  
  
## <a name="attributes-for-items-in-an-itemgroup-of-a-target"></a><a name="BKMK_AttributesWithinTargets"></a> 目標 ItemGroup 中專案的屬性  
...
### <a name="remove-attribute"></a><a name="BKMK_RemoveAttribute"></a> Remove 屬性  
...
## <a name="see-also"></a>另請參閱  
 ...
 [Msbuild](msbuild.md)   
 [如何：選取要建立的檔案](../msbuild/how-to-select-the-files-to-build.md)   
 ...
 [專案定義](../msbuild/item-definitions.md)   
