...
## <a name="remarks"></a>備註  
 ...
 依照慣例，共用的匯入專案檔儲存為 .targets 檔案，但它們是標準 [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] 專案檔。 [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] 可讓您匯入副檔名不同的專案，但基於一致性，建議您使用 .targets 副檔名。  
