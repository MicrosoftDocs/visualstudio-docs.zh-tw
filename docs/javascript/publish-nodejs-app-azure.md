...
1. 建立新的 TypeScript Express 應用程式。
    ...
    ::: moniker-end
    ::: moniker range="vs-2017"
    從頂部功能表欄中,選擇 **「檔** > **新專案** > **」。。** 在 [新增專案]**** 對話方塊的左窗格中，展開 **TypeScript**，然後選擇 **Node.js**。 在中間窗格中,選擇**基本 Azure Node.js Express 4 應用程式**,然後選擇 **"確定**"。
...
1. 選擇**檔案** > **新增到源控制項**以建立項目的本地 Git 儲存庫。
...
2. 從功能表中選擇 **「查看** > **其他 Windows** > **GitHub」。。**
...
7. 在 **「應用程式設定**」下,添加另`WEBSITE_NODE_DEFAULT_VERSION`一個`8.9.0`名稱和值的設置。
