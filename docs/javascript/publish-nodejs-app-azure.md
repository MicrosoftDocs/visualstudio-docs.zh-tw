...
1. 建立新的 TypeScript Express 應用程式。
    ...
    ::: moniker-end
    ::: moniker range="vs-2017"
    從頂部功能表列中，選擇 **"檔** > **新專案** > **"。** 在 [新增專案]**** 對話方塊的左窗格中，展開 **TypeScript**，然後選擇 **Node.js**。 在中間窗格中，選擇**基本 Azure Node.js Express 4 應用程式**，然後選擇 **"確定**"。
...
1. 選擇 **"檔** > **添加到源控制項**"以創建專案的本地 Git 存儲庫。
...
7. 在 **"應用程式設定**"下，添加另一個`WEBSITE_NODE_DEFAULT_VERSION`名稱和 值`8.9.0`的設置。
