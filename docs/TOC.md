...
## [在 Visual Studio 中偵錯](debugger/getting-started-with-the-debugger.md?context=visualstudio/default)
# 作法指南
## [開發](ide/index-writing-code.md)
### [在 IDE 中四處移動](ide/how-to-move-around-in-the-visual-studio-ide.md)
...
#### [64 位元支援](ide/visual-studio-ide-64-bit-support.md)
...
####### [進行程式碼片段疑難排解](ide/troubleshooting-snippets.md)
...
###### [For 迴圈與 foreach 陳述式之間的轉換](ide/reference/convert-for-loop-to-foreach.md)
###### [Get 方法與屬性之間的轉換](ide/reference/convert-get-method-to-property.md)
###### [將 LINQ 查詢轉換成 foreach 陳述式](ide/reference/convert-linq-to-foreach.md)
...
###### [使用明確類型](ide/reference/convert-var-to-explicit-type.md)
...
#### [使用 CodeLens 來尋找程式碼歷程記錄](ide/find-code-changes-and-other-history-with-codelens.md)
...
### [逐步解說：建立多電腦組建環境](ide/walkthrough-creating-a-multiple-computer-build-environment.md)
...
## [Visual Studio 經驗改進計畫](ide/visual-studio-experience-improvement-program.md)
