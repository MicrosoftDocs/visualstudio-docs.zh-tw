...
## [Visual Studio 中的 Python...](python/vs-tutorial-01-01.md)
...
#### [大綱](ide/outlining.md)
#### [自動產生程式碼](ide/code-generation-in-visual-studio.md)
...
###### C# 的快速動作
####### [產生類別/類型](ide/reference/generate-class-type-csharp.md)
####### [產生方法](ide/reference/generate-method-csharp.md)
####### [產生欄位/屬性/區域](ide/reference/generate-field-property-local-csharp.md)
####### [產生建構函式](ide/reference/generate-constructor-csharp.md)
####### [產生覆寫](ide/reference/generate-override-csharp.md)
####### [產生 Equals 與 GetHashCode 方法的覆寫](ide/reference/generate-overrides-csharp.md)
####### [產生 XML 文件註解](ide/reference/generate-xml-documentation-comments-csharp.md)
####### [實作抽象類別](ide/reference/implement-abstract-class-csharp.md)
####### [實作介面](ide/reference/implement-interface-csharp.md)
####### [引進區域變數](ide/reference/introduce-local-variable-csharp.md)
###### Visual Basic 的快速動作
####### [產生類別/類型](ide/reference/generate-class-type-vb.md)
####### [產生方法](ide/reference/generate-method-vb.md)
####### [產生欄位/屬性/區域](ide/reference/generate-field-property-local-vb.md)
####### [產生建構函式](ide/reference/generate-constructor-vb.md)
####### [產生覆寫](ide/reference/generate-override-vb.md)
####### [產生 XML 文件註解](ide/reference/generate-xml-documentation-comments-vb.md)
####### [實作抽象類別](ide/reference/implement-abstract-class-vb.md)
####### [實作介面](ide/reference/implement-interface-vb.md)
####### [引進區域變數](ide/reference/introduce-local-variable-vb.md)
#### [重構程式碼](ide/refactoring-in-visual-studio.md)
##### C# 的重構
###### [變更方法簽章](ide/reference/change-method-signature-csharp.md)
###### [將 Get 方法轉換成屬性](ide/reference/convert-get-method-to-property-csharp.md)
###### [封裝欄位](ide/reference/encapsulate-field-csharp.md)
###### [擷取介面](ide/reference/extract-interface-csharp.md)
###### [擷取方法](ide/reference/extract-method-csharp.md)
###### [內嵌暫存變數](ide/reference/inline-temporary-variable-csharp.md)
###### [移動參考附近的宣告](ide/reference/move-declaration-near-reference-csharp.md)
###### [將類型移至相符的檔案](ide/reference/move-type-to-matching-file-csharp.md)
###### [移除執行不到的程式碼](ide/reference/remove-unreachable-code-csharp.md)
###### [重新命名](ide/reference/rename-csharp.md)
###### [同步類型與檔案名稱](ide/reference/sync-type-and-file-csharp.md)
##### Visual Basic 的重構
###### [變更方法簽章](ide/reference/change-method-signature-vb.md)
###### [封裝欄位](ide/reference/encapsulate-field-vb.md)
###### [擷取介面](ide/reference/extract-interface-vb.md)
###### [擷取方法](ide/reference/extract-method-vb.md)
###### [內嵌暫存變數](ide/reference/inline-temporary-variable-vb.md)
###### [將類型移至相符的檔案](ide/reference/move-type-to-matching-file-vb.md)
###### [重新命名](ide/reference/rename-vb.md)
###### [同步類型及檔案名稱](ide/reference/sync-type-and-file-vb.md)
#### [產能的秘訣](ide/productivity-tips-for-visual-studio.md)
##### [秘訣與訣竅](ide/tips-and-tricks-for-visual-studio.md)
...
##### [逐步解說：以使用時產生功能支援測試優先](ide/walkthrough-test-first-support-with-the-generate-from-usage-feature.md)
...
## [專案與項目範本](ide/creating-project-and-item-templates.md)
...
### [範本結構描述參考 (擴充性)](extensibility/visual-studio-template-schema-reference.md)
