...
##### [使用 NuGet 和延伸模組 SDK 兩種方式新增參考](ide/adding-references-using-nuget-versus-an-extension-sdk.md)
...
#### [使用適用於 VB 的 IDE...](vb-ide/refactoring-vb.md)
#### [重構、程式碼產生及快速動作](ide/refactoring-code-generation-quick-actions.md)
...
##### [在程式碼中尋找參考](ide/finding-references.md)
...
##### [EditorConfig 的 .NET 語言與格式設定慣例](ide/editorconfig-code-style-settings-reference.md)
...
##### [設計和檢視類別與類型](ide/class-designer/TOC.md)
...
### [協助工具秘訣與訣竅](ide/reference/accessibility-tips-and-tricks.md)
...
#### [手動建立網站範本](ide/how-to-manually-create-web-templates.md)
#### [建立入門套件](ide/how-to-create-starter-kits.md)
#### [尋找及組織專案與項目範本](ide/how-to-locate-and-organize-project-and-item-templates.md)
#### [自訂專案範本和項目範本](ide/customizing-project-and-item-templates.md)
